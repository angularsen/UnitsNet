...
namespace UnitsNet
{
    ...
    public partial struct PressureChangeRate : IQuantity<PressureChangeRateUnit>, IComparable, IComparable<PressureChangeRate>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<PressureChangeRateUnit>)this).As(unitAsPressureChangeRateUnit);
        }
        ...
        /// <summary>
        ///     Converts this PressureChangeRate to another PressureChangeRate with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A PressureChangeRate with the specified unit.</returns>
        public QuantityValue ToQuantity(PressureChangeRateUnit unit)
        {
