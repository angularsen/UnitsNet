...
namespace UnitsNet
{
    ...
    public partial struct LinearPowerDensity : IQuantity<LinearPowerDensityUnit>, IEquatable<LinearPowerDensity>, IComparable, IComparable<LinearPowerDensity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="LinearPowerDensity" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<LinearPowerDensity>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(LinearPowerDensityUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<LinearPowerDensity>(inBaseUnits.Unit, unit, out var conversionFunction))
