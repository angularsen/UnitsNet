...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            CompressibilityUnit[] unitsOrderedByName = EnumHelper.GetValues<CompressibilityUnit>().OrderBy(x => x.ToString(), StringComparer.Ordinal).ToArray();
        ...
        {
            var units = Enum.GetValues<CompressibilityUnit>();
