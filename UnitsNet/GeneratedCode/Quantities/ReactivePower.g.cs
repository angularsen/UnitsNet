...
namespace UnitsNet
{
    ...
    public readonly partial struct ReactivePower :
        ...
        IComparisonOperators<ReactivePower, ReactivePower, bool>,
        IParsable<ReactivePower>,
#endif
        IComparable,
        ...
        static ReactivePower()
        {
            ...
            Info = new QuantityInfo<ReactivePowerUnit>("ReactivePower",
                new UnitInfo<ReactivePowerUnit>[]
                {
                    ...
                    new UnitInfo<ReactivePowerUnit>(ReactivePowerUnit.VoltampereReactive, "VoltamperesReactive", new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second), "ReactivePower"),
                },
