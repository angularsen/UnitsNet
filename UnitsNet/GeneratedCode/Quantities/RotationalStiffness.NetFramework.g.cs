...
namespace UnitsNet
{
    ...
    public partial struct RotationalStiffness : IQuantity<RotationalStiffnessUnit>, IEquatable<RotationalStiffness>, IComparable, IComparable<RotationalStiffness>, IConvertible
    {
        ...
        public RotationalStiffness(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static RotationalStiffnessUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static RotationalStiffnessUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
