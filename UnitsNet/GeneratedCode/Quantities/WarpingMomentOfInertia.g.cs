...
namespace UnitsNet
{
    ...
    public partial struct WarpingMomentOfInertia : IQuantity<WarpingMomentOfInertiaUnit>, IEquatable<WarpingMomentOfInertia>, IComparable, IComparable<WarpingMomentOfInertia>, IConvertible, IFormattable
    {
        ...
        public WarpingMomentOfInertia ToUnit(WarpingMomentOfInertiaUnit unit, UnitConverter unitConverter)
        {
            ...
            if(!unitConverter.TryGetConversionFunction((typeof(WarpingMomentOfInertia), inBaseUnits.Unit, typeof(WarpingMomentOfInertia), unit), out var conversionFunction))
