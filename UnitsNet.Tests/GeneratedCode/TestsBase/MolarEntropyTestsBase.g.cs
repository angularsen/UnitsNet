...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = MolarEntropy.From(1.0, MolarEntropy.BaseUnit);
        ...
        {
            var inBaseUnit = MolarEntropy.From(1.0, MolarEntropy.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(MolarEntropyUnit)));
        }
        ...
        {
            var quantity = MolarEntropy.FromJoulesPerMoleKelvin(1.0);
            Assert.Equal(MolarEntropy.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
