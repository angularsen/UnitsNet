...
namespace UnitsNet
{
    ...
    public partial struct RelativeHumidity : IQuantity<RelativeHumidityUnit>, IEquatable<RelativeHumidity>, IComparable, IComparable<RelativeHumidity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="RelativeHumidity" /> instances.
        /// </summary>
        ...
        private double GetValueAs(RelativeHumidityUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<RelativeHumidity>(inBaseUnits.Unit, unit, out var conversionFunction))
