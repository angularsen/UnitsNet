...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricConductance()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, ElectricConductanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, ElectricConductanceUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(ElectricConductanceUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(ElectricConductanceUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.ElectricConductance";
                var resourceManager = new ResourceManager(resourceName, typeof(ElectricConductance).Assembly);
