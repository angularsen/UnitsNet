...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = Temperature.From(1.0, Temperature.BaseUnit);
        ...
        {
            var inBaseUnit = Temperature.From(1.0, Temperature.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(TemperatureUnit)));
        }
        ...
        {
            var value = 1.0;
            var quantity = Temperature.FromKelvins(value);
        ...
        {
            var quantity = Temperature.FromKelvins(1.0);
            Assert.Equal(Temperature.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
