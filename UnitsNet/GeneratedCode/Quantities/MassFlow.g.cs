...
namespace UnitsNet
{
    ...
    public partial struct MassFlow : IQuantity<MassFlowUnit>, IEquatable<MassFlow>, IComparable, IComparable<MassFlow>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="MassFlow"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="MassFlow"/> from.</param>
        public static implicit operator MassFlow(ValueTuple<QuantityValue, MassFlowUnit> tuple) => new MassFlow((double)tuple.Item1, tuple.Item2);
