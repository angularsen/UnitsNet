...
namespace UnitsNet.Tests.CustomCode
{
    public class DurationTests : DurationTestsBase
    {
        ...
        public static void DurationGreaterThanOrEqualTimeSpanShouldReturnCorrectly()
        {
            ...
            var duration = Duration.FromHours(12);
        ...
        {
            var timeSpan = TimeSpan.FromHours(11);
            var duration = Duration.FromHours(10);
        ...
        {
            var volume = Duration.FromSeconds(20) * VolumeFlow.FromCubicMetersPerSecond(2);
        ...
        {
            var duration = Duration.FromSeconds(60);
        ...
        public static void TimeSpanGreaterThanDurationShouldReturnCorrectly()
        {
            ...
            var duration = Duration.FromHours(11);
        ...
        {
            var duration = Duration.FromSeconds(TimeSpan.MinValue.TotalSeconds + 1);
        ...
        {
            var duration = Duration.FromSeconds(TimeSpan.MaxValue.TotalSeconds - 1);
            var timeSpan = duration.ToTimeSpan();
            AssertEx.EqualTolerance(duration.Seconds, timeSpan.TotalSeconds, 1e-3);
        }
