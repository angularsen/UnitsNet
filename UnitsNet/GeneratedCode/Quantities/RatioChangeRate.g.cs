...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static RatioChangeRate()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, RatioChangeRateUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, RatioChangeRateUnit Unit), List<string>> Abbreviations { get; }
