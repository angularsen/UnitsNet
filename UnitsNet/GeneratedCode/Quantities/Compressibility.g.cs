...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Compressibility()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, CompressibilityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, CompressibilityUnit Unit), List<string>> Abbreviations { get; }
