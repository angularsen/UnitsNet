...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MolarEnergy()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MolarEnergyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MolarEnergyUnit Unit), List<string>> Abbreviations { get; }
