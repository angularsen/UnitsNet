...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MagneticFlux()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MagneticFluxUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MagneticFluxUnit Unit), List<string>> Abbreviations { get; }
