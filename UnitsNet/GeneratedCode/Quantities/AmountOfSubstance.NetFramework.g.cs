...
namespace UnitsNet
{
    ...
    public partial struct AmountOfSubstance : IQuantity<AmountOfSubstanceUnit>, IEquatable<AmountOfSubstance>, IComparable, IComparable<AmountOfSubstance>, IConvertible
    {
        ...
        public AmountOfSubstance(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static AmountOfSubstanceUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static AmountOfSubstanceUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
