...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Information()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, InformationUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, InformationUnit Unit), List<string>> Abbreviations { get; }
