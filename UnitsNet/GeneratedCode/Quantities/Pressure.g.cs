        ...
        IFormattable
    {
        ...
        private bool TryToUnit(PressureUnit unit, [NotNullWhen(true)] out Pressure? converted)
        {
            ...
            Pressure? convertedOrNull = (Unit, unit) switch
            {
                ...
                (PressureUnit.CentimeterOfWaterColumn, PressureUnit.Pascal) => new Pressure((_value * 999.9720 * 9.80665) * 1e-2d, PressureUnit.Pascal),
                ...
                (PressureUnit.InchOfWaterColumn, PressureUnit.Pascal) => new Pressure(_value * 2.54e-2 * 999.9720 * 9.80665, PressureUnit.Pascal),
                ...
                (PressureUnit.MeterOfWaterColumn, PressureUnit.Pascal) => new Pressure(_value * 999.9720 * 9.80665, PressureUnit.Pascal),
                ...
                (PressureUnit.MillimeterOfWaterColumn, PressureUnit.Pascal) => new Pressure((_value * 999.9720 * 9.80665) * 1e-3d, PressureUnit.Pascal),
                ...
                (PressureUnit.Pascal, PressureUnit.CentimeterOfWaterColumn) => new Pressure((_value / (999.9720 * 9.80665)) / 1e-2d, PressureUnit.CentimeterOfWaterColumn),
                ...
                (PressureUnit.Pascal, PressureUnit.InchOfWaterColumn) => new Pressure(_value / (2.54e-2 * 999.9720 * 9.80665), PressureUnit.InchOfWaterColumn),
                ...
                (PressureUnit.Pascal, PressureUnit.MeterOfWaterColumn) => new Pressure(_value / (999.9720 * 9.80665), PressureUnit.MeterOfWaterColumn),
                ...
                (PressureUnit.Pascal, PressureUnit.MillimeterOfWaterColumn) => new Pressure((_value / (999.9720 * 9.80665)) / 1e-3d, PressureUnit.MillimeterOfWaterColumn),
