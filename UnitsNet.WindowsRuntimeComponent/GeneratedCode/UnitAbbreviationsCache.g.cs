    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(MassConcentrationUnit), (int)MassConcentrationUnit.GramPerLiter, new string[]{"g/l", "g/L"}),
                ...
                ("en-US", typeof(MolarityUnit), (int)MolarityUnit.Micromolar, new string[]{"µM"}),
                ("en-US", typeof(MolarityUnit), (int)MolarityUnit.MicromolesPerLiter, new string[]{"µmol/L"}),
                ("en-US", typeof(MolarityUnit), (int)MolarityUnit.Millimolar, new string[]{"mM"}),
                ("en-US", typeof(MolarityUnit), (int)MolarityUnit.MillimolesPerLiter, new string[]{"mmol/L"}),
                ("en-US", typeof(MolarityUnit), (int)MolarityUnit.Molar, new string[]{"M"}),
                ...
                ("en-US", typeof(MolarityUnit), (int)MolarityUnit.Nanomolar, new string[]{"nM"}),
                ("en-US", typeof(MolarityUnit), (int)MolarityUnit.NanomolesPerLiter, new string[]{"nmol/L"}),
                ("en-US", typeof(MolarityUnit), (int)MolarityUnit.Picomolar, new string[]{"pM"}),
