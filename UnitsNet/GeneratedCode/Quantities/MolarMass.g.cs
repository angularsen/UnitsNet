...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<MolarMassUnit>(str, culture);
        }
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<MolarMassUnit>(str, culture, out unit);
        }
