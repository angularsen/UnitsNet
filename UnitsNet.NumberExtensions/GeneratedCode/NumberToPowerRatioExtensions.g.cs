...
namespace OasysUnitsNet.NumberExtensions.NumberToPowerRatio
{
    /// <summary>
    ...
    {
        /// <inheritdoc cref="PowerRatio.FromDecibelMilliwatts(OasysUnitsNet.QuantityValue)" />
        public static PowerRatio DecibelMilliwatts<T>(this T value) =>
            PowerRatio.FromDecibelMilliwatts(Convert.ToDouble(value));

        /// <inheritdoc cref="PowerRatio.FromDecibelWatts(OasysUnitsNet.QuantityValue)" />
