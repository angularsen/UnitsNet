...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ToString_WithSwedishCulture_ReturnsUnitAbbreviationForEnglishCultureSinceThereAreNoMappings()
        {
            ...
            Assert.Equal("1 ac-ft", new Volume(1, VolumeUnit.AcreFoot).ToString(null, swedishCulture));
            Assert.Equal("1 tablespoon (A.U.)", new Volume(1, VolumeUnit.AuTablespoon).ToString(null, swedishCulture));
            Assert.Equal("1 bf", new Volume(1, VolumeUnit.BoardFoot).ToString(null, swedishCulture));
            Assert.Equal("1 cl", new Volume(1, VolumeUnit.Centiliter).ToString(null, swedishCulture));
            Assert.Equal("1 cm³", new Volume(1, VolumeUnit.CubicCentimeter).ToString(null, swedishCulture));
            Assert.Equal("1 dm³", new Volume(1, VolumeUnit.CubicDecimeter).ToString(null, swedishCulture));
            Assert.Equal("1 ft³", new Volume(1, VolumeUnit.CubicFoot).ToString(null, swedishCulture));
            Assert.Equal("1 hm³", new Volume(1, VolumeUnit.CubicHectometer).ToString(null, swedishCulture));
            Assert.Equal("1 in³", new Volume(1, VolumeUnit.CubicInch).ToString(null, swedishCulture));
            Assert.Equal("1 km³", new Volume(1, VolumeUnit.CubicKilometer).ToString(null, swedishCulture));
            Assert.Equal("1 m³", new Volume(1, VolumeUnit.CubicMeter).ToString(null, swedishCulture));
            Assert.Equal("1 µm³", new Volume(1, VolumeUnit.CubicMicrometer).ToString(null, swedishCulture));
            Assert.Equal("1 mi³", new Volume(1, VolumeUnit.CubicMile).ToString(null, swedishCulture));
            Assert.Equal("1 mm³", new Volume(1, VolumeUnit.CubicMillimeter).ToString(null, swedishCulture));
            Assert.Equal("1 yd³", new Volume(1, VolumeUnit.CubicYard).ToString(null, swedishCulture));
            Assert.Equal("1 dal", new Volume(1, VolumeUnit.Decaliter).ToString(null, swedishCulture));
            Assert.Equal("1 dagal (U.S.)", new Volume(1, VolumeUnit.DecausGallon).ToString(null, swedishCulture));
            Assert.Equal("1 dl", new Volume(1, VolumeUnit.Deciliter).ToString(null, swedishCulture));
            Assert.Equal("1 dgal (U.S.)", new Volume(1, VolumeUnit.DeciusGallon).ToString(null, swedishCulture));
            Assert.Equal("1 hft³", new Volume(1, VolumeUnit.HectocubicFoot).ToString(null, swedishCulture));
            Assert.Equal("1 hm³", new Volume(1, VolumeUnit.HectocubicMeter).ToString(null, swedishCulture));
            Assert.Equal("1 hl", new Volume(1, VolumeUnit.Hectoliter).ToString(null, swedishCulture));
            Assert.Equal("1 hgal (U.S.)", new Volume(1, VolumeUnit.HectousGallon).ToString(null, swedishCulture));
            Assert.Equal("1 bl (imp.)", new Volume(1, VolumeUnit.ImperialBeerBarrel).ToString(null, swedishCulture));
            Assert.Equal("1 gal (imp.)", new Volume(1, VolumeUnit.ImperialGallon).ToString(null, swedishCulture));
            Assert.Equal("1 oz (imp.)", new Volume(1, VolumeUnit.ImperialOunce).ToString(null, swedishCulture));
            Assert.Equal("1 pt (imp.)", new Volume(1, VolumeUnit.ImperialPint).ToString(null, swedishCulture));
            Assert.Equal("1 qt (imp.)", new Volume(1, VolumeUnit.ImperialQuart).ToString(null, swedishCulture));
            Assert.Equal("1 kft³", new Volume(1, VolumeUnit.KilocubicFoot).ToString(null, swedishCulture));
            Assert.Equal("1 km³", new Volume(1, VolumeUnit.KilocubicMeter).ToString(null, swedishCulture));
            Assert.Equal("1 kgal (imp.)", new Volume(1, VolumeUnit.KiloimperialGallon).ToString(null, swedishCulture));
            Assert.Equal("1 kl", new Volume(1, VolumeUnit.Kiloliter).ToString(null, swedishCulture));
            Assert.Equal("1 kgal (U.S.)", new Volume(1, VolumeUnit.KilousGallon).ToString(null, swedishCulture));
            Assert.Equal("1 l", new Volume(1, VolumeUnit.Liter).ToString(null, swedishCulture));
            Assert.Equal("1 Mft³", new Volume(1, VolumeUnit.MegacubicFoot).ToString(null, swedishCulture));
            Assert.Equal("1 Mgal (imp.)", new Volume(1, VolumeUnit.MegaimperialGallon).ToString(null, swedishCulture));
            Assert.Equal("1 Ml", new Volume(1, VolumeUnit.Megaliter).ToString(null, swedishCulture));
            Assert.Equal("1 Mgal (U.S.)", new Volume(1, VolumeUnit.MegausGallon).ToString(null, swedishCulture));
            Assert.Equal("1 metric cup", new Volume(1, VolumeUnit.MetricCup).ToString(null, swedishCulture));
            Assert.Equal("1 tsp", new Volume(1, VolumeUnit.MetricTeaspoon).ToString(null, swedishCulture));
            Assert.Equal("1 µl", new Volume(1, VolumeUnit.Microliter).ToString(null, swedishCulture));
            Assert.Equal("1 ml", new Volume(1, VolumeUnit.Milliliter).ToString(null, swedishCulture));
            Assert.Equal("1 nl", new Volume(1, VolumeUnit.Nanoliter).ToString(null, swedishCulture));
            Assert.Equal("1 bbl", new Volume(1, VolumeUnit.OilBarrel).ToString(null, swedishCulture));
            Assert.Equal("1 tablespoon (U.K.)", new Volume(1, VolumeUnit.UkTablespoon).ToString(null, swedishCulture));
            Assert.Equal("1 bl (U.S.)", new Volume(1, VolumeUnit.UsBeerBarrel).ToString(null, swedishCulture));
            Assert.Equal("1 cup (U.S. customary)", new Volume(1, VolumeUnit.UsCustomaryCup).ToString(null, swedishCulture));
            Assert.Equal("1 gal (U.S.)", new Volume(1, VolumeUnit.UsGallon).ToString(null, swedishCulture));
            Assert.Equal("1 cup (U.S.)", new Volume(1, VolumeUnit.UsLegalCup).ToString(null, swedishCulture));
            Assert.Equal("1 oz (U.S.)", new Volume(1, VolumeUnit.UsOunce).ToString(null, swedishCulture));
            Assert.Equal("1 pt (U.S.)", new Volume(1, VolumeUnit.UsPint).ToString(null, swedishCulture));
            Assert.Equal("1 qt (U.S.)", new Volume(1, VolumeUnit.UsQuart).ToString(null, swedishCulture));
            Assert.Equal("1 tablespoon (U.S.)", new Volume(1, VolumeUnit.UsTablespoon).ToString(null, swedishCulture));
            Assert.Equal("1 teaspoon (U.S.)", new Volume(1, VolumeUnit.UsTeaspoon).ToString(null, swedishCulture));
        }
