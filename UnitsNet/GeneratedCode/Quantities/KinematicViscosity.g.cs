...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static KinematicViscosity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, KinematicViscosityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, KinematicViscosityUnit Unit), List<string>> Abbreviations { get; }
