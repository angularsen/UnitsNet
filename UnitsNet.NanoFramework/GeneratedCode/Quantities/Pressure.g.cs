            ...
            return new Pressure(value, fromUnit);
                ...
                private double GetValueInBaseUnit()
                {
                    return Unit switch
                    {
                        ...
                        PressureUnit.FootOfElevation => Math.Pow(1.0 - ((double)_value / 145366.45), 5.2553026003237266401799415610351) * 101325.0,
                        ...
                        PressureUnit.MeterOfElevation => Math.Pow(1.0 - ((double)_value / 44307.69396), 5.2553026003237266401799415610351) * 101325.0,
                ...
                private double GetValueAs(PressureUnit unit)
                {
                    ...
                    return unit switch
                    {
                        ...
                        PressureUnit.FootOfElevation => (1.0 - Math.Pow((double)baseUnitValue / 101325.0, 0.190284)) * 145366.45,
                        ...
                        PressureUnit.MeterOfElevation => (1.0 - Math.Pow((double)baseUnitValue / 101325.0, 0.190284)) * 44307.69396,
