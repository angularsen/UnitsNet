...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static SpecificFuelConsumption()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, SpecificFuelConsumptionUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, SpecificFuelConsumptionUnit Unit), List<string>> Abbreviations { get; }
