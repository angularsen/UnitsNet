...
namespace UnitsNet
{
    ...
    public class UnitInfo
    {
        ...
        /// <param name="abbreviations">One or more abbreviations for this unit, with the first one being the default abbreviation.</param>
        /// <param name="baseUnits">The <see cref="BaseUnits"/> for this unit.</param>
        public UnitInfo(Enum value, string pluralName, IReadOnlyList<string> abbreviations, BaseUnits baseUnits)
        {
            Value = value ?? throw new ArgumentNullException(nameof(value));
            Name = value.ToString();
            PluralName = pluralName ?? throw new ArgumentNullException(nameof(pluralName));
            Abbreviations = abbreviations ?? throw new ArgumentNullException(nameof(abbreviations));
            BaseUnits = baseUnits ?? throw new ArgumentNullException(nameof(baseUnits));
        }

        /// <summary>
        /// One or more abbreviations for this unit, with the first one being the default abbreviation.
        /// </summary>
    ...
    {
        /// <inheritdoc />
        public UnitInfo(TUnit value, string pluralName, IReadOnlyList<string> abbreviations, BaseUnits baseUnits) : base(value, pluralName, abbreviations, baseUnits)
        {
            Value = value;
        }
