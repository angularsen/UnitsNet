...
namespace OasysUnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial struct Moment : IQuantity<MomentUnit>, IEquatable<Moment>, IComparable, IComparable<Moment>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        static Moment()
        {
            ...
            MaxValue = new Moment(double.MaxValue, BaseUnit);
            MinValue = new Moment(double.MinValue, BaseUnit);
            QuantityType = QuantityType.Moment;
            Units = Enum.GetValues(typeof(MomentUnit)).Cast<MomentUnit>().Except(new MomentUnit[]{ MomentUnit.Undefined }).ToArray();
            ...
            Info = new QuantityInfo<MomentUnit>("Moment",
                ...
                BaseUnit, Zero, BaseDimensions, QuantityType.Moment);
        ...
        public static Moment MaxValue { get; }

        /// <summary>
        /// Represents the smallest possible value of Moment
        /// </summary>
        [Obsolete("MaxValue and MinValue will be removed. Choose your own value or use nullability for unbounded lower/upper range checks. See discussion in https://github.com/angularsen/UnitsNet/issues/848.")]
        public static Moment MinValue { get; }
        ...
        /// </summary>
        [Obsolete("QuantityType will be removed in the future. Use the Info property instead.")]
        public QuantityType Type => QuantityType.Moment;
        ...
        /// <inheritdoc cref="TryParseUnit(string,IFormatProvider,out OasysUnitsNet.Units.MomentUnit)"/>
        ...
        /// <remarks>Consider using <see cref="Equals(Moment, double, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(Moment left, Moment right)
        {
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is Moment objMoment)) throw new ArgumentException("Expected type Moment.", nameof(obj));

            return CompareTo(objMoment);
        }
        ...
        {
            if (obj is null || !(obj is Moment objMoment))
                return false;

            return Equals(objMoment);
        }
        ...
        /// <returns>True if successful, otherwise false.</returns>
        private bool TryToUnit(MomentUnit unit, out Moment? converted)
        {
            if (Unit == unit)
            {
                converted = this;
        ...
        IQuantity IQuantity.ToUnit(Enum unit)
        {
            ...
            return ToUnit(unitAsMomentUnit, DefaultConversionFunctions);
        }
