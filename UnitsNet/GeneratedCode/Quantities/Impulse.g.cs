...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Impulse()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ImpulseUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ImpulseUnit Unit), List<string>> Abbreviations { get; }
