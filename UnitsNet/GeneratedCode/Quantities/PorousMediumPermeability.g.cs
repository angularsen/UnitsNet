...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static PorousMediumPermeability()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, PorousMediumPermeabilityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, PorousMediumPermeabilityUnit Unit), List<string>> Abbreviations { get; }
