...
* If you use ReSharper there is a [settings file](https://github.com/angularsen/UnitsNet/blob/master/OasysUnitsNet.sln.DotSettings) that will take effect automatically
