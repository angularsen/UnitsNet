            ...
            return new Pressure(value, fromUnit);
                ...
                private double GetValueInBaseUnit()
                {
                    return Unit switch
                    {
                        ...
                        PressureUnit.CentimeterOfWaterColumn => (_value * 999.9720 * 9.80665) * 1e-2d,
                        ...
                        PressureUnit.InchOfWaterColumn => _value * 2.54e-2 * 999.9720 * 9.80665,
                        ...
                        PressureUnit.MeterOfWaterColumn => _value * 999.9720 * 9.80665,
                        ...
                        PressureUnit.MillimeterOfWaterColumn => (_value * 999.9720 * 9.80665) * 1e-3d,
                ...
                private double GetValueAs(PressureUnit unit)
                {
                    ...
                    return unit switch
                    {
                        ...
                        PressureUnit.CentimeterOfWaterColumn => (baseUnitValue / (999.9720 * 9.80665)) / 1e-2d,
                        ...
                        PressureUnit.InchOfWaterColumn => baseUnitValue / (2.54e-2 * 999.9720 * 9.80665),
                        ...
                        PressureUnit.MeterOfWaterColumn => baseUnitValue / (999.9720 * 9.80665),
                        ...
                        PressureUnit.MillimeterOfWaterColumn => (baseUnitValue / (999.9720 * 9.80665)) / 1e-3d,
