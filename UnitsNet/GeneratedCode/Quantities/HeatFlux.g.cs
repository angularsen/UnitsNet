...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static HeatFlux()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, HeatFluxUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, HeatFluxUnit Unit), List<string>> Abbreviations { get; }
