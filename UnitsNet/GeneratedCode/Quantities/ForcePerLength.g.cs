...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<ForcePerLengthUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.ForcePerLengthUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<ForcePerLengthUnit>(str, culture, out unit);
        }
