...
namespace UnitsNet
{
    ...
    public partial struct CoefficientOfThermalExpansion : IQuantity<CoefficientOfThermalExpansionUnit>, IEquatable<CoefficientOfThermalExpansion>, IComparable, IComparable<CoefficientOfThermalExpansion>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="CoefficientOfThermalExpansionUnit.InverseDegreeCelsius"/>
        /// </summary>
        public QuantityValue InverseDegreeCelsius => As(CoefficientOfThermalExpansionUnit.InverseDegreeCelsius);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="CoefficientOfThermalExpansionUnit.InverseDegreeFahrenheit"/>
        /// </summary>
        public QuantityValue InverseDegreeFahrenheit => As(CoefficientOfThermalExpansionUnit.InverseDegreeFahrenheit);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="CoefficientOfThermalExpansionUnit.InverseKelvin"/>
        /// </summary>
        ...
        /// <remarks>Consider using <see cref="Equals(CoefficientOfThermalExpansion, QuantityValue, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(CoefficientOfThermalExpansion left, CoefficientOfThermalExpansion right)
        {
        ...
        public bool Equals(CoefficientOfThermalExpansion other, QuantityValue tolerance, ComparisonType comparisonType)
        {
            if (tolerance < 0)
        ...
        public CoefficientOfThermalExpansion ToUnit(CoefficientOfThermalExpansionUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (Enum.IsDefined(typeof(CoefficientOfThermalExpansionUnit), unit))
            {
