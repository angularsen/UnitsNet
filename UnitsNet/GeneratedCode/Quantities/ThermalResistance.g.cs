...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ThermalResistance()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ThermalResistanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ThermalResistanceUnit Unit), List<string>> Abbreviations { get; }
