...
namespace UnitsNet
{
    ...
    public partial struct Acceleration : IQuantity<AccelerationUnit>, IEquatable<Acceleration>, IComparable, IComparable<Acceleration>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Acceleration" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<Acceleration>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(AccelerationUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Acceleration>(inBaseUnits.Unit, unit, out var conversionFunction))
