...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial struct ThermalConductivity : IQuantity<ThermalConductivityUnit>, IComparable, IComparable<ThermalConductivity>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ThermalConductivityUnit>)this).As(unitAsThermalConductivityUnit);
        }
        ...
        /// <summary>
        ///     Converts this ThermalConductivity to another ThermalConductivity with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ThermalConductivity with the specified unit.</returns>
        public QuantityValue ToQuantity(ThermalConductivityUnit unit)
        {
