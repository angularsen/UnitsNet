...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricAdmittance()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, ElectricAdmittanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, ElectricAdmittanceUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(ElectricAdmittanceUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(ElectricAdmittanceUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.ElectricAdmittance";
                var resourceManager = new ResourceManager(resourceName, typeof(ElectricAdmittance).Assembly);
        ...
        [Obsolete("For null checks, use `x is null` syntax to not invoke overloads. For quantity comparisons, use Equals(ElectricAdmittance, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator ==(ElectricAdmittance left, ElectricAdmittance right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(ElectricAdmittance, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("For null checks, use `x is not null` syntax to not invoke overloads. For quantity comparisons, use Equals(ElectricAdmittance, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator !=(ElectricAdmittance left, ElectricAdmittance right)
        {
            return !(left == right);
        }
        ...
        /// <summary>Indicates strict equality of two <see cref="ElectricAdmittance"/> quantities, where both <see cref="Value" /> and <see cref="Unit" /> are exactly equal.</summary>
        /// <remarks>Consider using <see cref="Equals(ElectricAdmittance, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("Consider using Equals(ElectricAdmittance, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
