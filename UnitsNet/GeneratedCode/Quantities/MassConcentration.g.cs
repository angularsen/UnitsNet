...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MassConcentration()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MassConcentrationUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MassConcentrationUnit Unit), List<string>> Abbreviations { get; }
