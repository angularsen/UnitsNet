...
namespace UnitsNet
{
    ...
    public partial struct Force : IQuantity<ForceUnit>, IEquatable<Force>, IComparable, IComparable<Force>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Force" /> instances.
        /// </summary>
        ...
        private double GetValueAs(ForceUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Force>(inBaseUnits.Unit, unit, out var conversionFunction))
