    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.DecawattPeak, new string[]{"daWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.DecawattPeak, new string[]{"daWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.DeciwattPeak, new string[]{"dWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.DeciwattPeak, new string[]{"dWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.FemtowattPeak, new string[]{"fWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.FemtowattPeak, new string[]{"fWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.GigawattPeak, new string[]{"GWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.GigawattPeak, new string[]{"GWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.KilowattPeak, new string[]{"kWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.KilowattPeak, new string[]{"kWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.MegawattPeak, new string[]{"MWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.MegawattPeak, new string[]{"MWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.MicrowattPeak, new string[]{"µWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.MicrowattPeak, new string[]{"µWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.MilliwattPeak, new string[]{"mWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.MilliwattPeak, new string[]{"mWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.NanowattPeak, new string[]{"nWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.NanowattPeak, new string[]{"nWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.PetawattPeak, new string[]{"PWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.PetawattPeak, new string[]{"PWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.PicowattPeak, new string[]{"pWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.PicowattPeak, new string[]{"pWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.TerawattPeak, new string[]{"TWp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.TerawattPeak, new string[]{"TWc"}),
                ("en-US", typeof(NominalPowerUnit), (int)NominalPowerUnit.WattPeak, new string[]{"Wp"}),
                ("fr-FR", typeof(NominalPowerUnit), (int)NominalPowerUnit.WattPeak, new string[]{"Wc"}),
