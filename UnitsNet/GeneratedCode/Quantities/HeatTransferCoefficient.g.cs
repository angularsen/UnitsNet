...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial struct HeatTransferCoefficient : IQuantity<HeatTransferCoefficientUnit>, IComparable, IComparable<HeatTransferCoefficient>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<HeatTransferCoefficientUnit>)this).As(unitAsHeatTransferCoefficientUnit);
        }
        ...
        /// <summary>
        ///     Converts this HeatTransferCoefficient to another HeatTransferCoefficient with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A HeatTransferCoefficient with the specified unit.</returns>
        public QuantityValue ToQuantity(HeatTransferCoefficientUnit unit)
        {
