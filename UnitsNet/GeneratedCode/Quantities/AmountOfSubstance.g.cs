...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static AmountOfSubstance()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, AmountOfSubstanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, AmountOfSubstanceUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(AmountOfSubstanceUnit unit) => GetAbbreviation(unit, null);
