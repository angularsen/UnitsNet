...
namespace UnitsNet
{
    ...
    {
        /// <summary>
        /// Dynamically constructs a quantity using the given <see cref="QuantityType"/> and <see cref="QuantityValue"/>.
        /// The unit will be in the quantity's base units.
        /// </summary>
        /// <param name="quantityType">The quantity type to construct.</param>
        /// <param name="value">The value of the quantity which will be in the quantitity's base units.</param>
        /// <returns></returns>
