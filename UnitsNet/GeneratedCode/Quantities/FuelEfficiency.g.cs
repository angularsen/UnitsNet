...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static FuelEfficiency()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, FuelEfficiencyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, FuelEfficiencyUnit Unit), List<string>> Abbreviations { get; }
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(FuelEfficiencyUnit unit, CultureInfo? culture = null)
        {
