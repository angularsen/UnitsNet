...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricConductance.From(1.0, ElectricConductance.BaseUnit);
        ...
        {
            var inBaseUnit = ElectricConductance.From(1.0, ElectricConductance.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricConductanceUnit)));
        }
        ...
        {
            var quantity = ElectricConductance.FromSiemens(1.0);
            Assert.Equal(ElectricConductance.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
