    ...
    public readonly partial struct Length : IArithmeticQuantity<Length, LengthUnit, double>, IEquatable<Length>, IComparable, IComparable<Length>, IConvertible, IFormattable
    {
        ...
        private bool TryToUnit(LengthUnit unit, [NotNullWhen(true)] out Length? converted)
        {
            ...
            Length? convertedOrNull = (Unit, unit) switch
            {
                ...
                (LengthUnit.Megameter, LengthUnit.Meter) => new Length(_value * 1e+6, LengthUnit.Meter),
                ...
                (LengthUnit.Meter, LengthUnit.Megameter) => new Length(_value / 1e+6, LengthUnit.Megameter),
