...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = Scalar.From(1.0, Scalar.BaseUnit);
        ...
        {
            var inBaseUnit = Scalar.From(1.0, Scalar.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ScalarUnit)));
        }
        ...
        {
            var quantity = Scalar.FromAmount(1.0);
            Assert.Equal(Scalar.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
