...
namespace UnitsNet
{
    ...
    public partial struct RatioChangeRate : IQuantity<RatioChangeRateUnit>, IComparable, IComparable<RatioChangeRate>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<RatioChangeRateUnit>)this).As(unitAsRatioChangeRateUnit);
        }
        ...
        /// <summary>
        ///     Converts this RatioChangeRate to another RatioChangeRate with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A RatioChangeRate with the specified unit.</returns>
        public QuantityValue ToQuantity(RatioChangeRateUnit unit)
        {
