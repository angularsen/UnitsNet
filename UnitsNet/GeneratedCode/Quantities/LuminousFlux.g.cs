...
namespace UnitsNet
{
    ...
    public partial struct LuminousFlux : IQuantity<LuminousFluxUnit>, IEquatable<LuminousFlux>, IComparable, IComparable<LuminousFlux>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="LuminousFlux"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="LuminousFlux"/> from.</param>
        public static implicit operator LuminousFlux(ValueTuple<QuantityValue, LuminousFluxUnit> tuple) => new LuminousFlux((double)tuple.Item1, tuple.Item2);
