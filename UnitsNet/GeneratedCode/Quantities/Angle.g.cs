...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<AngleUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.AngleUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<AngleUnit>(str, culture, out unit);
        }
