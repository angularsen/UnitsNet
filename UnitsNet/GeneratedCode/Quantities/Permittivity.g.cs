...
namespace UnitsNet
{
    ...
    public partial struct Permittivity : IQuantity<PermittivityUnit>, IEquatable<Permittivity>, IComparable, IComparable<Permittivity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="PermittivityUnit.FaradPerMeter"/>
        /// </summary>
        ...
        /// <remarks>Consider using <see cref="Equals(Permittivity, QuantityValue, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(Permittivity left, Permittivity right)
        {
        ...
        public bool Equals(Permittivity other, QuantityValue tolerance, ComparisonType comparisonType)
        {
            if (tolerance < 0)
        ...
        public Permittivity ToUnit(PermittivityUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (Enum.IsDefined(typeof(PermittivityUnit), unit))
            {
