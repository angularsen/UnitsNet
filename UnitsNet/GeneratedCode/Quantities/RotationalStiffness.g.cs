...
namespace UnitsNet
{
    ...
    public partial struct RotationalStiffness : IQuantity<RotationalStiffnessUnit>, IEquatable<RotationalStiffness>, IComparable, IComparable<RotationalStiffness>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="RotationalStiffness" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<RotationalStiffness>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(RotationalStiffnessUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<RotationalStiffness>(inBaseUnits.Unit, unit, out var conversionFunction))
