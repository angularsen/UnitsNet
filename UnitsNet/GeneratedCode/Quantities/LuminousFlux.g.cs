...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static LuminousFlux()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, LuminousFluxUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, LuminousFluxUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(LuminousFluxUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(LuminousFluxUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.LuminousFlux";
                var resourceManager = new ResourceManager(resourceName, typeof(LuminousFlux).Assembly);
        ...
        [Obsolete("For null checks, use `x is null` syntax to not invoke overloads. For quantity comparisons, use Equals(LuminousFlux, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator ==(LuminousFlux left, LuminousFlux right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(LuminousFlux, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("For null checks, use `x is not null` syntax to not invoke overloads. For quantity comparisons, use Equals(LuminousFlux, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator !=(LuminousFlux left, LuminousFlux right)
        {
            return !(left == right);
        }
        ...
        /// <summary>Indicates strict equality of two <see cref="LuminousFlux"/> quantities, where both <see cref="Value" /> and <see cref="Unit" /> are exactly equal.</summary>
        /// <remarks>Consider using <see cref="Equals(LuminousFlux, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("Consider using Equals(LuminousFlux, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
