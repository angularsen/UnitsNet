...
namespace UnitsNet
{
    ...
    public partial struct ElectricConductance : IQuantity<ElectricConductanceUnit>, IEquatable<ElectricConductance>, IComparable, IComparable<ElectricConductance>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="ElectricConductance"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="ElectricConductance"/> from.</param>
        public static implicit operator ElectricConductance(ValueTuple<QuantityValue, ElectricConductanceUnit> tuple) => new ElectricConductance((double)tuple.Item1, tuple.Item2);
