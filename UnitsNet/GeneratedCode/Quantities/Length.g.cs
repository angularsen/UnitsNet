...
namespace UnitsNet
{
    ...
    public partial struct Length : IQuantity<LengthUnit>, IEquatable<Length>, IComparable, IComparable<Length>, IConvertible, IFormattable
    {
        ...
        static Length()
        {
            ...
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.AstronomicalUnit, q => q.ToUnit(LengthUnit.AstronomicalUnit));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Centimeter, q => q.ToUnit(LengthUnit.Centimeter));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Chain, q => q.ToUnit(LengthUnit.Chain));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Decimeter, q => q.ToUnit(LengthUnit.Decimeter));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.DtpPica, q => q.ToUnit(LengthUnit.DtpPica));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.DtpPoint, q => q.ToUnit(LengthUnit.DtpPoint));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Fathom, q => q.ToUnit(LengthUnit.Fathom));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Foot, q => q.ToUnit(LengthUnit.Foot));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Hand, q => q.ToUnit(LengthUnit.Hand));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Hectometer, q => q.ToUnit(LengthUnit.Hectometer));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Inch, q => q.ToUnit(LengthUnit.Inch));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.KilolightYear, q => q.ToUnit(LengthUnit.KilolightYear));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Kilometer, q => q.ToUnit(LengthUnit.Kilometer));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Kiloparsec, q => q.ToUnit(LengthUnit.Kiloparsec));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.LightYear, q => q.ToUnit(LengthUnit.LightYear));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.MegalightYear, q => q.ToUnit(LengthUnit.MegalightYear));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Megaparsec, q => q.ToUnit(LengthUnit.Megaparsec));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Microinch, q => q.ToUnit(LengthUnit.Microinch));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Micrometer, q => q.ToUnit(LengthUnit.Micrometer));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Mil, q => q.ToUnit(LengthUnit.Mil));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Mile, q => q.ToUnit(LengthUnit.Mile));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Millimeter, q => q.ToUnit(LengthUnit.Millimeter));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Nanometer, q => q.ToUnit(LengthUnit.Nanometer));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.NauticalMile, q => q.ToUnit(LengthUnit.NauticalMile));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Parsec, q => q.ToUnit(LengthUnit.Parsec));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.PrinterPica, q => q.ToUnit(LengthUnit.PrinterPica));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.PrinterPoint, q => q.ToUnit(LengthUnit.PrinterPoint));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Shackle, q => q.ToUnit(LengthUnit.Shackle));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.SolarRadius, q => q.ToUnit(LengthUnit.SolarRadius));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Twip, q => q.ToUnit(LengthUnit.Twip));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.UsSurveyFoot, q => q.ToUnit(LengthUnit.UsSurveyFoot));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Yard, q => q.ToUnit(LengthUnit.Yard));
            
            // Register in default unit converter: BaseUnit <-> BaseUnit
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Meter, LengthUnit.Meter, q => q);

            // Register in default unit converter: LengthUnit -> BaseUnit
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.AstronomicalUnit, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Centimeter, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Chain, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Decimeter, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.DtpPica, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.DtpPoint, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Fathom, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Foot, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Hand, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Hectometer, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Inch, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.KilolightYear, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Kilometer, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Kiloparsec, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.LightYear, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.MegalightYear, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Megaparsec, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Microinch, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Micrometer, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Mil, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Mile, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Millimeter, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Nanometer, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.NauticalMile, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Parsec, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.PrinterPica, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.PrinterPoint, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Shackle, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.SolarRadius, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Twip, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.UsSurveyFoot, LengthUnit.Meter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Yard, LengthUnit.Meter, q => q.ToBaseUnit());
        }
