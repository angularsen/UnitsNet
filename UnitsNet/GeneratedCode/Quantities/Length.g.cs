        ...
        static Length()
        {
            ...
            Info = new QuantityInfo<LengthUnit>(QuantityType.Length,
                new UnitInfo<LengthUnit>[] {
                    new UnitInfo<LengthUnit>(LengthUnit.AstronomicalUnit, new BaseUnits(length: LengthUnit.Meter)),
                    ...
                    new UnitInfo<LengthUnit>(LengthUnit.LightYear, new BaseUnits(length: LengthUnit.Meter)),
                    ...
                    new UnitInfo<LengthUnit>(LengthUnit.Parsec, new BaseUnits(length: LengthUnit.Meter)),
