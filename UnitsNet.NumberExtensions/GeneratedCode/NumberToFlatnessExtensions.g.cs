...
namespace UnitsNet.NumberExtensions.NumberToFlatness
{
    ...
    {
        /// <inheritdoc cref="Flatness.FromIUnits(double)" />
        public static Flatness IUnits<T>(this T value)
            where T : notnull
#if NET7_0_OR_GREATER
            , INumber<T>
        ...
        /// <inheritdoc cref="Flatness.FromMicrometersPerMeter(double)" />
        public static Flatness MicrometersPerMeter<T>(this T value)
            where T : notnull
#if NET7_0_OR_GREATER
            , INumber<T>
