...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Energy()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, EnergyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, EnergyUnit Unit), List<string>> Abbreviations { get; }
