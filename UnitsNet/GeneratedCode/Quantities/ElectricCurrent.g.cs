...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricCurrent()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricCurrentUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricCurrentUnit Unit), List<string>> Abbreviations { get; }
