    ...
    public partial struct Mass : IQuantity<MassUnit>, IEquatable<Mass>, IComparable, IComparable<Mass>, IConvertible, IFormattable
    {
        ...
        static Mass()
        {
            ...
            Info = new QuantityInfo<MassUnit>(QuantityType.Mass,
                new UnitInfo<MassUnit>[] {
                    ...
                    new UnitInfo<MassUnit>(MassUnit.EarthMass, new BaseUnits(mass: MassUnit.Gram)),
                    ...
                    new UnitInfo<MassUnit>(MassUnit.SolarMass, new BaseUnits(mass: MassUnit.Gram)),
        ...
        private double GetValueInBaseUnit()
        {
            switch(Unit)
            {
                ...
                case MassUnit.EarthMass: return _value * 6e24;
                ...
                case MassUnit.SolarMass: return _value * 1.98847e30;
        ...
        private double GetValueAs(MassUnit unit)
        {
            ...
            switch(unit)
            {
                ...
                case MassUnit.EarthMass: return baseUnitValue / 6e24;
