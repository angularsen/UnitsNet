...
namespace UnitsNet
{
    public sealed partial class UnitConverter
    {
        ...
        public static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.CentimolePerDay, q => q.ToUnit(MolarFlowUnit.CentimolePerDay));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.CentimolePerDay, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.CentimolePerSecond, q => q.ToUnit(MolarFlowUnit.CentimolePerSecond));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.CentimolePerSecond, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.DecamolePerDay, q => q.ToUnit(MolarFlowUnit.DecamolePerDay));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.DecamolePerDay, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.DecamolePerSecond, q => q.ToUnit(MolarFlowUnit.DecamolePerSecond));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.DecamolePerSecond, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.DecimolePerDay, q => q.ToUnit(MolarFlowUnit.DecimolePerDay));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.DecimolePerDay, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.DecimolePerSecond, q => q.ToUnit(MolarFlowUnit.DecimolePerSecond));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.DecimolePerSecond, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.HectomolePerDay, q => q.ToUnit(MolarFlowUnit.HectomolePerDay));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.HectomolePerDay, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.HectomolePerSecond, q => q.ToUnit(MolarFlowUnit.HectomolePerSecond));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.HectomolePerSecond, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.KilomolePerDay, q => q.ToUnit(MolarFlowUnit.KilomolePerDay));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.KilomolePerDay, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.KilomolePerHour, q => q.ToUnit(MolarFlowUnit.KilomolePerHour));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.KilomolePerHour, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.KilomolePerMinute, q => q.ToUnit(MolarFlowUnit.KilomolePerMinute));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.KilomolePerMinute, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.KilomolePerSecond, q => q.ToUnit(MolarFlowUnit.KilomolePerSecond));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.KilomolePerSecond, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.MegamolePerDay, q => q.ToUnit(MolarFlowUnit.MegamolePerDay));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.MegamolePerDay, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.MicromolePerDay, q => q.ToUnit(MolarFlowUnit.MicromolePerDay));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.MicromolePerDay, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.MicromolePerSecond, q => q.ToUnit(MolarFlowUnit.MicromolePerSecond));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.MicromolePerSecond, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.MillimolePerDay, q => q.ToUnit(MolarFlowUnit.MillimolePerDay));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.MillimolePerDay, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.MillimolePerSecond, q => q.ToUnit(MolarFlowUnit.MillimolePerSecond));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.MillimolePerSecond, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.MolePerDay, q => q.ToUnit(MolarFlowUnit.MolePerDay));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.MolePerDay, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.MolePerHour, q => q.ToUnit(MolarFlowUnit.MolePerHour));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.MolePerHour, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlow.BaseUnit, q => q);
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.NanomolePerDay, q => q.ToUnit(MolarFlowUnit.NanomolePerDay));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.NanomolePerDay, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlow.BaseUnit, MolarFlowUnit.NanomolePerSecond, q => q.ToUnit(MolarFlowUnit.NanomolePerSecond));
            unitConverter.SetConversionFunction<MolarFlow>(MolarFlowUnit.NanomolePerSecond, MolarFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.CentimolePerHourPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.CentimolePerHourPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.CentimolePerHourPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.CentimolePerHourPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.CentimolePerHourPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.CentimolePerHourPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.CentimolePerHourPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.CentimolePerHourPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.CentimolePerHourPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.CentimolePerMinutePerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.CentimolePerMinutePerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.CentimolePerMinutePerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.CentimolePerMinutePerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.CentimolePerMinutePerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.CentimolePerMinutePerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.CentimolePerMinutePerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.CentimolePerMinutePerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.CentimolePerMinutePerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.CentimolePerSecondPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.CentimolePerSecondPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.CentimolePerSecondPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.CentimolePerSecondPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.CentimolePerSecondPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.CentimolePerSecondPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.CentimolePerSecondPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.CentimolePerSecondPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.CentimolePerSecondPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecamolePerHourPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecamolePerHourPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecamolePerHourPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecamolePerHourPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecamolePerHourPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecamolePerHourPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecamolePerHourPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecamolePerHourPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecamolePerHourPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecamolePerMinutePerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecamolePerMinutePerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecamolePerMinutePerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecamolePerMinutePerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecamolePerMinutePerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecamolePerMinutePerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecamolePerMinutePerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecamolePerMinutePerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecamolePerMinutePerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecamolePerSecondPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecamolePerSecondPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecamolePerSecondPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecamolePerSecondPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecamolePerSecondPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecamolePerSecondPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecamolePerSecondPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecamolePerSecondPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecamolePerSecondPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecimolePerHourPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecimolePerHourPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecimolePerHourPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecimolePerHourPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecimolePerHourPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecimolePerHourPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecimolePerHourPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecimolePerHourPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecimolePerHourPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecimolePerMinutePerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecimolePerMinutePerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecimolePerMinutePerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecimolePerMinutePerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecimolePerMinutePerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecimolePerMinutePerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecimolePerMinutePerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecimolePerMinutePerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecimolePerMinutePerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecimolePerSecondPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecimolePerSecondPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecimolePerSecondPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecimolePerSecondPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecimolePerSecondPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecimolePerSecondPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.DecimolePerSecondPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.DecimolePerSecondPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.DecimolePerSecondPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.HectomolePerHourPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.HectomolePerHourPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.HectomolePerHourPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.HectomolePerHourPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.HectomolePerHourPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.HectomolePerHourPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.HectomolePerHourPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.HectomolePerHourPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.HectomolePerHourPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.HectomolePerMinutePerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.HectomolePerMinutePerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.HectomolePerMinutePerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.HectomolePerMinutePerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.HectomolePerMinutePerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.HectomolePerMinutePerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.HectomolePerMinutePerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.HectomolePerMinutePerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.HectomolePerMinutePerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.HectomolePerSecondPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.HectomolePerSecondPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.HectomolePerSecondPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.HectomolePerSecondPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.HectomolePerSecondPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.HectomolePerSecondPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.HectomolePerSecondPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.HectomolePerSecondPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.HectomolePerSecondPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.KilomolePerHourPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.KilomolePerHourPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.KilomolePerHourPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.KilomolePerHourPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.KilomolePerHourPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.KilomolePerHourPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.KilomolePerHourPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.KilomolePerHourPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.KilomolePerHourPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.KilomolePerMinutePerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.KilomolePerMinutePerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.KilomolePerMinutePerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.KilomolePerMinutePerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.KilomolePerMinutePerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.KilomolePerMinutePerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.KilomolePerMinutePerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.KilomolePerMinutePerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.KilomolePerMinutePerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.KilomolePerSecondPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.KilomolePerSecondPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.KilomolePerSecondPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.KilomolePerSecondPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.KilomolePerSecondPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.KilomolePerSecondPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.KilomolePerSecondPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.KilomolePerSecondPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.KilomolePerSecondPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MicromolePerHourPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MicromolePerHourPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MicromolePerHourPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MicromolePerHourPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MicromolePerHourPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MicromolePerHourPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MicromolePerHourPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MicromolePerHourPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MicromolePerHourPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MicromolePerMinutePerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MicromolePerMinutePerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MicromolePerMinutePerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MicromolePerMinutePerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MicromolePerMinutePerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MicromolePerMinutePerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MicromolePerMinutePerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MicromolePerMinutePerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MicromolePerMinutePerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MicromolePerSecondPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MicromolePerSecondPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MicromolePerSecondPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MicromolePerSecondPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MicromolePerSecondPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MicromolePerSecondPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MicromolePerSecondPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MicromolePerSecondPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MicromolePerSecondPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MillimolePerHourPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MillimolePerHourPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MillimolePerHourPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MillimolePerHourPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MillimolePerHourPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MillimolePerHourPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MillimolePerHourPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MillimolePerHourPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MillimolePerHourPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MillimolePerMinutePerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MillimolePerMinutePerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MillimolePerMinutePerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MillimolePerMinutePerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MillimolePerMinutePerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MillimolePerMinutePerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MillimolePerMinutePerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MillimolePerMinutePerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MillimolePerMinutePerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MillimolePerSecondPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MillimolePerSecondPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MillimolePerSecondPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MillimolePerSecondPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MillimolePerSecondPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MillimolePerSecondPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MillimolePerSecondPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MillimolePerSecondPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MillimolePerSecondPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MolePerHourPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MolePerHourPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MolePerHourPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MolePerHourPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MolePerHourPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MolePerHourPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MolePerHourPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MolePerHourPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MolePerHourPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MolePerMinutePerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MolePerMinutePerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MolePerMinutePerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MolePerMinutePerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MolePerMinutePerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MolePerMinutePerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MolePerMinutePerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MolePerMinutePerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MolePerMinutePerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReaction.BaseUnit, q => q);
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MolePerSecondPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MolePerSecondPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MolePerSecondPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.MolePerSecondPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.MolePerSecondPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.MolePerSecondPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.NanomolePerHourPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.NanomolePerHourPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.NanomolePerHourPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.NanomolePerHourPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.NanomolePerHourPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.NanomolePerHourPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.NanomolePerHourPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.NanomolePerHourPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.NanomolePerHourPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.NanomolePerMinutePerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.NanomolePerMinutePerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.NanomolePerMinutePerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.NanomolePerMinutePerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.NanomolePerMinutePerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.NanomolePerMinutePerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.NanomolePerMinutePerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.NanomolePerMinutePerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.NanomolePerMinutePerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.NanomolePerSecondPerGram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.NanomolePerSecondPerGram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.NanomolePerSecondPerGram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.NanomolePerSecondPerMicrogram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.NanomolePerSecondPerMicrogram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.NanomolePerSecondPerMicrogram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReaction.BaseUnit, MolarMaximumRateOfReactionUnit.NanomolePerSecondPerMilligram, q => q.ToUnit(MolarMaximumRateOfReactionUnit.NanomolePerSecondPerMilligram));
            unitConverter.SetConversionFunction<MolarMaximumRateOfReaction>(MolarMaximumRateOfReactionUnit.NanomolePerSecondPerMilligram, MolarMaximumRateOfReaction.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.CentiliterPerHour, q => q.ToUnit(VolumeFlowUnit.CentiliterPerHour));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.CentiliterPerHour, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.DeciliterPerHour, q => q.ToUnit(VolumeFlowUnit.DeciliterPerHour));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.DeciliterPerHour, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.KiloliterPerHour, q => q.ToUnit(VolumeFlowUnit.KiloliterPerHour));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.KiloliterPerHour, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.MicroliterPerHour, q => q.ToUnit(VolumeFlowUnit.MicroliterPerHour));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.MicroliterPerHour, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.MilliliterPerHour, q => q.ToUnit(VolumeFlowUnit.MilliliterPerHour));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.MilliliterPerHour, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.NanoliterPerHour, q => q.ToUnit(VolumeFlowUnit.NanoliterPerHour));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.NanoliterPerHour, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
