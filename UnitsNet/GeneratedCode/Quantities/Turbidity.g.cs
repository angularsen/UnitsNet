...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Turbidity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, TurbidityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, TurbidityUnit Unit), List<string>> Abbreviations { get; }
