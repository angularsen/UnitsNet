...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static TemperatureChangeRate()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, TemperatureChangeRateUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, TemperatureChangeRateUnit Unit), List<string>> Abbreviations { get; }
