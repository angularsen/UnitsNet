...
namespace UnitsNet
{
    ...
    public sealed class UnitConverter
    {
        ...
        public static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            foreach (var quantity in Quantity.QuantityTypes)
            {
                // TODO Cache reflection.
                var registerMethod = quantity.GetMethod("RegisterDefaultConversions", BindingFlags.NonPublic | BindingFlags.Static);
