        ...
        IFormattable
    {
        ...
        private bool TryToUnit(RotationalAccelerationUnit unit, [NotNullWhen(true)] out RotationalAcceleration? converted)
        {
            ...
            RotationalAcceleration? convertedOrNull = (Unit, unit) switch
            {
                ...
                (RotationalAccelerationUnit.MillirevolutionPerMinutePerSecond, RotationalAccelerationUnit.RadianPerSecondSquared) => new RotationalAcceleration(((2 * Math.PI) / 60) * _value * 1e-3, RotationalAccelerationUnit.RadianPerSecondSquared),
                ...
                (RotationalAccelerationUnit.RadianPerSecondSquared, RotationalAccelerationUnit.MillirevolutionPerMinutePerSecond) => new RotationalAcceleration((60 / (2 * Math.PI)) * _value / 1e-3, RotationalAccelerationUnit.MillirevolutionPerMinutePerSecond),
