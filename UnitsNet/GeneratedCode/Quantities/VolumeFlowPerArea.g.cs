...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static VolumeFlowPerArea()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, VolumeFlowPerAreaUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, VolumeFlowPerAreaUnit Unit), List<string>> Abbreviations { get; }
