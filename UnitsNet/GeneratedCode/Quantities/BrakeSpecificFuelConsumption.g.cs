...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial struct BrakeSpecificFuelConsumption : IQuantity<BrakeSpecificFuelConsumptionUnit>, IComparable, IComparable<BrakeSpecificFuelConsumption>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<BrakeSpecificFuelConsumptionUnit>)this).As(unitAsBrakeSpecificFuelConsumptionUnit);
        }
        ...
        /// <summary>
        ///     Converts this BrakeSpecificFuelConsumption to another BrakeSpecificFuelConsumption with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A BrakeSpecificFuelConsumption with the specified unit.</returns>
        public QuantityValue ToQuantity(BrakeSpecificFuelConsumptionUnit unit)
        {
