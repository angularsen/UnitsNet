...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            ReciprocalAreaUnit[] unitsOrderedByName = EnumHelper.GetValues<ReciprocalAreaUnit>().OrderBy(x => x.ToString(), StringComparer.Ordinal).ToArray();
        ...
        {
            var units = Enum.GetValues<ReciprocalAreaUnit>();
