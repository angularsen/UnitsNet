...
namespace UnitsNet
{
    ...
    public partial struct Magnetization : IQuantity<MagnetizationUnit>, IEquatable<Magnetization>, IComparable, IComparable<Magnetization>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="Magnetization"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="Magnetization"/> from.</param>
        public static implicit operator Magnetization(ValueTuple<QuantityValue, MagnetizationUnit> tuple) => new Magnetization((double)tuple.Item1, tuple.Item2);
