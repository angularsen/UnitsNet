...
namespace UnitsNet
{
    ...
    public partial struct ElectricInductance : IQuantity<ElectricInductanceUnit>, IEquatable<ElectricInductance>, IComparable, IComparable<ElectricInductance>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="ElectricInductanceUnit.Henry"/>
        /// </summary>
        public QuantityValue Henries => As(ElectricInductanceUnit.Henry);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="ElectricInductanceUnit.Microhenry"/>
        /// </summary>
        public QuantityValue Microhenries => As(ElectricInductanceUnit.Microhenry);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="ElectricInductanceUnit.Millihenry"/>
        /// </summary>
        public QuantityValue Millihenries => As(ElectricInductanceUnit.Millihenry);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="ElectricInductanceUnit.Nanohenry"/>
        /// </summary>
        ...
        /// <remarks>Consider using <see cref="Equals(ElectricInductance, QuantityValue, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(ElectricInductance left, ElectricInductance right)
        {
        ...
        public bool Equals(ElectricInductance other, QuantityValue tolerance, ComparisonType comparisonType)
        {
            if (tolerance < 0)
        ...
        public ElectricInductance ToUnit(ElectricInductanceUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (Enum.IsDefined(typeof(ElectricInductanceUnit), unit))
            {
