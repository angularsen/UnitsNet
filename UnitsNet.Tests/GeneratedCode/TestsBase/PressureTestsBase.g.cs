...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ParseUnit(string abbreviation, PressureUnit expectedUnit)
        {
        ...
        public void ParseUnitWithCulture(string culture, string abbreviation, PressureUnit expectedUnit)
        {
        ...
        [InlineData("tf/mm²", PressureUnit.TonneForcePerSquareMillimeter)]
        [InlineData("torr", PressureUnit.Torr)]
        public void TryParseUnit(string abbreviation, PressureUnit expectedUnit)
        {
            // regardless of the CurrentCulture is, this should always work with the FallbackCulture ("en-US")
        ...
        [InlineData("ru-RU", "ат", PressureUnit.TechnicalAtmosphere)]
        [InlineData("ru-RU", "торр", PressureUnit.Torr)]
        public void TryParseUnitWithCulture(string culture, string abbreviation, PressureUnit expectedUnit)
        {
