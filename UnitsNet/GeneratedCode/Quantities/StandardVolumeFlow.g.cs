...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static StandardVolumeFlow()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, StandardVolumeFlowUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, StandardVolumeFlowUnit Unit), List<string>> Abbreviations { get; }
