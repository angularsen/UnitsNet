...
namespace UnitsNet
{
    ...
    public partial struct TemperatureChangeRate : IQuantity<TemperatureChangeRateUnit>, IEquatable<TemperatureChangeRate>, IComparable, IComparable<TemperatureChangeRate>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="TemperatureChangeRate" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<TemperatureChangeRate>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(TemperatureChangeRateUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<TemperatureChangeRate>(inBaseUnits.Unit, unit, out var conversionFunction))
