...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            MassMomentOfInertiaUnit[] unitsOrderedByName = EnumHelper.GetValues<MassMomentOfInertiaUnit>().OrderBy(x => x.ToString(), StringComparer.Ordinal).ToArray();
        ...
        {
            Assert.All(EnumHelper.GetValues<MassMomentOfInertiaUnit>(), unit =>
            {
                var quantity = MassMomentOfInertia.From(1, unit);
                Assert.Equal(1, quantity.Value);
