...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public LuminousFlux(Fraction value, LuminousFluxUnit unit)
        {
            _value = value;
            _unit = unit;
        }
        ...
        public LuminousFlux(Fraction value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public Fraction Lumens => As(LuminousFluxUnit.Lumen);
        ...
        /// </summary>
        public static LuminousFlux FromLumens(Fraction value)
        {
        ...
        public static LuminousFlux From(Fraction value, LuminousFluxUnit fromUnit)
        {
        ...
        {
            return new LuminousFlux(right.Value.Invert(), right.Unit);
        }
        ...
        public static LuminousFlux operator *(Fraction left, LuminousFlux right)
        {
            return new LuminousFlux(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="LuminousFlux"/> from multiplying value and <see cref="LuminousFlux"/>.</summary>
        public static LuminousFlux operator *(LuminousFlux left, Fraction right)
        {
        ...
        public static Fraction operator /(LuminousFlux left, LuminousFlux right)
        {
        ...
        public Fraction As(LuminousFluxUnit unit)
        {
            if (Unit == unit)
                return Value;
