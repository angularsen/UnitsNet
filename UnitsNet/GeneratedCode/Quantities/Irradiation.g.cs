...
namespace UnitsNet
{
    ...
    public partial struct Irradiation : IQuantity<IrradiationUnit>, IComparable, IComparable<Irradiation>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<IrradiationUnit>)this).As(unitAsIrradiationUnit);
        }
        ...
        /// <summary>
        ///     Converts this Irradiation to another Irradiation with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A Irradiation with the specified unit.</returns>
        public QuantityValue ToQuantity(IrradiationUnit unit)
        {
