...
namespace UnitsNet
{
    ...
    public class DisplayAsUnitAttribute : DefaultUnitAttribute
    {
        ...
        ///     <see cref="IQuantity.ToString(System.IFormatProvider)" />
        /// </summary>
    ...
    ///         Implements a TypeConverter for IQuantitys. This allows eg the PropertyGrid to read and write properties of type
    ///         IQuantity.
    ///     </para>
    ...
    ///         <see cref="ConvertToUnitAttribute" />.
    ///     </para>
    ///     <para>
    ...
    public class QuantityTypeConverter<TQuantity> : TypeConverter where TQuantity : IQuantity
    {
        ...
        private static TAttribute GetAttribute<TAttribute>(ITypeDescriptorContext context) where TAttribute : UnitAttributeBase
        {
            ...
            var ua = context?.PropertyDescriptor.Attributes;

            attribute = (TAttribute) ua?[typeof(TAttribute)];

            if (attribute != null)
            {
                var expected = default(TQuantity).Type;
                var actual = QuantityType.Undefined;
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                if (double.TryParse(stringValue, NumberStyles.Any, culture, out var dvalue))
                {
                ...
                var convertToUnit = GetAttribute<ConvertToUnitAttribute>(context);
        ...
        /// <summary>
        ///     Returns true whether this converter can convert the <see cref="IQuantity" /> to string, using the specified
        ///     context.
        /// </summary>
        /// <returns>true if this converter can perform the conversion; otherwise, false.</returns>
        ...
        /// <summary>
        ///     Converts the given <see cref="IQuantity" /> object to <see cref="string" />, using the specified context and
        ///     culture information.
        /// </summary>
        ...
        {
            var qvalue = value as IQuantity;
            object result = null;
            var displayAsUnit = GetAttribute<DisplayAsUnitAttribute>(context);
