...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<IlluminanceUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.IlluminanceUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<IlluminanceUnit>(str, culture, out unit);
        }
