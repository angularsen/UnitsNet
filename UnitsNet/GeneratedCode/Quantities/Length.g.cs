...
namespace UnitsNet
{
    ...
    public partial struct Length : IQuantity<LengthUnit>, IEquatable<Length>, IComparable, IComparable<Length>, IConvertible, IFormattable
    {
        ...
        static Length()
        {
            ...
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.AstronomicalUnit, q => q.ToUnit(LengthUnit.AstronomicalUnit));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.AstronomicalUnit, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Centimeter, q => q.ToUnit(LengthUnit.Centimeter));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Centimeter, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Chain, q => q.ToUnit(LengthUnit.Chain));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Chain, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Decimeter, q => q.ToUnit(LengthUnit.Decimeter));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Decimeter, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.DtpPica, q => q.ToUnit(LengthUnit.DtpPica));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.DtpPica, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.DtpPoint, q => q.ToUnit(LengthUnit.DtpPoint));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.DtpPoint, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Fathom, q => q.ToUnit(LengthUnit.Fathom));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Fathom, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Foot, q => q.ToUnit(LengthUnit.Foot));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Foot, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Hand, q => q.ToUnit(LengthUnit.Hand));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Hand, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Hectometer, q => q.ToUnit(LengthUnit.Hectometer));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Hectometer, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Inch, q => q.ToUnit(LengthUnit.Inch));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Inch, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.KilolightYear, q => q.ToUnit(LengthUnit.KilolightYear));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.KilolightYear, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Kilometer, q => q.ToUnit(LengthUnit.Kilometer));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Kilometer, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Kiloparsec, q => q.ToUnit(LengthUnit.Kiloparsec));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Kiloparsec, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.LightYear, q => q.ToUnit(LengthUnit.LightYear));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.LightYear, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.MegalightYear, q => q.ToUnit(LengthUnit.MegalightYear));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.MegalightYear, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Megaparsec, q => q.ToUnit(LengthUnit.Megaparsec));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Megaparsec, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, Length.BaseUnit, q => q);
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Microinch, q => q.ToUnit(LengthUnit.Microinch));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Microinch, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Micrometer, q => q.ToUnit(LengthUnit.Micrometer));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Micrometer, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Mil, q => q.ToUnit(LengthUnit.Mil));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Mil, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Mile, q => q.ToUnit(LengthUnit.Mile));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Mile, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Millimeter, q => q.ToUnit(LengthUnit.Millimeter));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Millimeter, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Nanometer, q => q.ToUnit(LengthUnit.Nanometer));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Nanometer, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.NauticalMile, q => q.ToUnit(LengthUnit.NauticalMile));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.NauticalMile, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Parsec, q => q.ToUnit(LengthUnit.Parsec));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Parsec, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.PrinterPica, q => q.ToUnit(LengthUnit.PrinterPica));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.PrinterPica, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.PrinterPoint, q => q.ToUnit(LengthUnit.PrinterPoint));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.PrinterPoint, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Shackle, q => q.ToUnit(LengthUnit.Shackle));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Shackle, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.SolarRadius, q => q.ToUnit(LengthUnit.SolarRadius));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.SolarRadius, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Twip, q => q.ToUnit(LengthUnit.Twip));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Twip, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.UsSurveyFoot, q => q.ToUnit(LengthUnit.UsSurveyFoot));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.UsSurveyFoot, Length.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.Yard, q => q.ToUnit(LengthUnit.Yard));
            UnitConverter.Default.SetConversionFunction<Length>(LengthUnit.Yard, Length.BaseUnit, q => q.ToBaseUnit());
        }
