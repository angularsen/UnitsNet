...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Jerk()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, JerkUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, JerkUnit Unit), List<string>> Abbreviations { get; }
