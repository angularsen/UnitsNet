...
namespace UnitsNet
{
    ...
    public partial struct Volume : IQuantity<VolumeUnit>, IEquatable<Volume>, IComparable, IComparable<Volume>, IConvertible, IFormattable
    {
        ...
        static Volume()
        {
            ...
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.AcreFoot, q => q.ToUnit(VolumeUnit.AcreFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.AuTablespoon, q => q.ToUnit(VolumeUnit.AuTablespoon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.BoardFoot, q => q.ToUnit(VolumeUnit.BoardFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.Centiliter, q => q.ToUnit(VolumeUnit.Centiliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.CubicCentimeter, q => q.ToUnit(VolumeUnit.CubicCentimeter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.CubicDecimeter, q => q.ToUnit(VolumeUnit.CubicDecimeter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.CubicFoot, q => q.ToUnit(VolumeUnit.CubicFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.CubicHectometer, q => q.ToUnit(VolumeUnit.CubicHectometer));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.CubicInch, q => q.ToUnit(VolumeUnit.CubicInch));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.CubicKilometer, q => q.ToUnit(VolumeUnit.CubicKilometer));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.CubicMicrometer, q => q.ToUnit(VolumeUnit.CubicMicrometer));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.CubicMile, q => q.ToUnit(VolumeUnit.CubicMile));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.CubicMillimeter, q => q.ToUnit(VolumeUnit.CubicMillimeter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.CubicYard, q => q.ToUnit(VolumeUnit.CubicYard));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.DecausGallon, q => q.ToUnit(VolumeUnit.DecausGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.Deciliter, q => q.ToUnit(VolumeUnit.Deciliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.DeciusGallon, q => q.ToUnit(VolumeUnit.DeciusGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.HectocubicFoot, q => q.ToUnit(VolumeUnit.HectocubicFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.HectocubicMeter, q => q.ToUnit(VolumeUnit.HectocubicMeter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.Hectoliter, q => q.ToUnit(VolumeUnit.Hectoliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.HectousGallon, q => q.ToUnit(VolumeUnit.HectousGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.ImperialBeerBarrel, q => q.ToUnit(VolumeUnit.ImperialBeerBarrel));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.ImperialGallon, q => q.ToUnit(VolumeUnit.ImperialGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.ImperialOunce, q => q.ToUnit(VolumeUnit.ImperialOunce));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.ImperialPint, q => q.ToUnit(VolumeUnit.ImperialPint));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.KilocubicFoot, q => q.ToUnit(VolumeUnit.KilocubicFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.KilocubicMeter, q => q.ToUnit(VolumeUnit.KilocubicMeter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.KiloimperialGallon, q => q.ToUnit(VolumeUnit.KiloimperialGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.Kiloliter, q => q.ToUnit(VolumeUnit.Kiloliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.KilousGallon, q => q.ToUnit(VolumeUnit.KilousGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.Liter, q => q.ToUnit(VolumeUnit.Liter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.MegacubicFoot, q => q.ToUnit(VolumeUnit.MegacubicFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.MegaimperialGallon, q => q.ToUnit(VolumeUnit.MegaimperialGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.Megaliter, q => q.ToUnit(VolumeUnit.Megaliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.MegausGallon, q => q.ToUnit(VolumeUnit.MegausGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.MetricCup, q => q.ToUnit(VolumeUnit.MetricCup));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.MetricTeaspoon, q => q.ToUnit(VolumeUnit.MetricTeaspoon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.Microliter, q => q.ToUnit(VolumeUnit.Microliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.Milliliter, q => q.ToUnit(VolumeUnit.Milliliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.OilBarrel, q => q.ToUnit(VolumeUnit.OilBarrel));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.UkTablespoon, q => q.ToUnit(VolumeUnit.UkTablespoon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.UsBeerBarrel, q => q.ToUnit(VolumeUnit.UsBeerBarrel));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.UsCustomaryCup, q => q.ToUnit(VolumeUnit.UsCustomaryCup));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.UsGallon, q => q.ToUnit(VolumeUnit.UsGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.UsLegalCup, q => q.ToUnit(VolumeUnit.UsLegalCup));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.UsOunce, q => q.ToUnit(VolumeUnit.UsOunce));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.UsPint, q => q.ToUnit(VolumeUnit.UsPint));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.UsQuart, q => q.ToUnit(VolumeUnit.UsQuart));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.UsTablespoon, q => q.ToUnit(VolumeUnit.UsTablespoon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.UsTeaspoon, q => q.ToUnit(VolumeUnit.UsTeaspoon));
            
            // Register in default unit converter: BaseUnit <-> BaseUnit
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMeter, VolumeUnit.CubicMeter, q => q);

            // Register in default unit converter: VolumeUnit -> BaseUnit
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.AcreFoot, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.AuTablespoon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.BoardFoot, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Centiliter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicCentimeter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicDecimeter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicFoot, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicHectometer, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicInch, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicKilometer, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMicrometer, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMile, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMillimeter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicYard, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.DecausGallon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Deciliter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.DeciusGallon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.HectocubicFoot, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.HectocubicMeter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Hectoliter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.HectousGallon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.ImperialBeerBarrel, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.ImperialGallon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.ImperialOunce, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.ImperialPint, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.KilocubicFoot, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.KilocubicMeter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.KiloimperialGallon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Kiloliter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.KilousGallon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Liter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.MegacubicFoot, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.MegaimperialGallon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Megaliter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.MegausGallon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.MetricCup, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.MetricTeaspoon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Microliter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Milliliter, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.OilBarrel, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UkTablespoon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsBeerBarrel, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsCustomaryCup, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsGallon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsLegalCup, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsOunce, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsPint, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsQuart, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsTablespoon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsTeaspoon, VolumeUnit.CubicMeter, q => q.ToBaseUnit());
        }
