...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<BrakeSpecificFuelConsumptionUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.BrakeSpecificFuelConsumptionUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<BrakeSpecificFuelConsumptionUnit>(str, culture, out unit);
        }
