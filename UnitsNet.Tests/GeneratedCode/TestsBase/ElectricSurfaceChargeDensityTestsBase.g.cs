...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ElectricSurfaceChargeDensity_QuantityInfo_ReturnsQuantityInfoDescribingQuantity()
        {
            ...
            var units = EnumHelpers.GetValues<ElectricSurfaceChargeDensityUnit>().OrderBy(x => x.ToString()).ToArray();
        ...
        {
            var units = EnumHelpers.GetValues<ElectricSurfaceChargeDensityUnit>();
