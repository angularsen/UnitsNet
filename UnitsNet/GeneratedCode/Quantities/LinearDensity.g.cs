...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static LinearDensity()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, LinearDensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, LinearDensityUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(LinearDensityUnit unit) => GetAbbreviation(unit, null);
