...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<DoseAreaProductUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.DoseAreaProductUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<DoseAreaProductUnit>(str, culture, out unit);
        }
