...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial struct MassMomentOfInertia : IQuantity<MassMomentOfInertiaUnit>, IComparable, IComparable<MassMomentOfInertia>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<MassMomentOfInertiaUnit>)this).As(unitAsMassMomentOfInertiaUnit);
        }
        ...
        /// <summary>
        ///     Converts this MassMomentOfInertia to another MassMomentOfInertia with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A MassMomentOfInertia with the specified unit.</returns>
        public QuantityValue ToQuantity(MassMomentOfInertiaUnit unit)
        {
