...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ToString_WithSwedishCulture_ReturnsUnitAbbreviationForEnglishCultureSinceThereAreNoMappings()
        {
            ...
            Assert.Equal("1 cg/dl", new Density(1, DensityUnit.CentigramPerDeciliter).ToString(null, swedishCulture));
            Assert.Equal("1 cg/l", new Density(1, DensityUnit.CentigramPerLiter).ToString(null, swedishCulture));
            Assert.Equal("1 cg/ml", new Density(1, DensityUnit.CentigramPerMilliliter).ToString(null, swedishCulture));
            Assert.Equal("1 dg/dl", new Density(1, DensityUnit.DecigramPerDeciliter).ToString(null, swedishCulture));
            Assert.Equal("1 dg/l", new Density(1, DensityUnit.DecigramPerLiter).ToString(null, swedishCulture));
            Assert.Equal("1 dg/ml", new Density(1, DensityUnit.DecigramPerMilliliter).ToString(null, swedishCulture));
            Assert.Equal("1 fg/dl", new Density(1, DensityUnit.FemtogramPerDeciliter).ToString(null, swedishCulture));
            Assert.Equal("1 fg/l", new Density(1, DensityUnit.FemtogramPerLiter).ToString(null, swedishCulture));
            Assert.Equal("1 fg/ml", new Density(1, DensityUnit.FemtogramPerMilliliter).ToString(null, swedishCulture));
            Assert.Equal("1 g/cm³", new Density(1, DensityUnit.GramPerCubicCentimeter).ToString(null, swedishCulture));
            Assert.Equal("1 g/ft³", new Density(1, DensityUnit.GramPerCubicFoot).ToString(null, swedishCulture));
            Assert.Equal("1 g/in³", new Density(1, DensityUnit.GramPerCubicInch).ToString(null, swedishCulture));
            Assert.Equal("1 g/m³", new Density(1, DensityUnit.GramPerCubicMeter).ToString(null, swedishCulture));
            Assert.Equal("1 g/mm³", new Density(1, DensityUnit.GramPerCubicMillimeter).ToString(null, swedishCulture));
            Assert.Equal("1 g/dl", new Density(1, DensityUnit.GramPerDeciliter).ToString(null, swedishCulture));
            Assert.Equal("1 g/l", new Density(1, DensityUnit.GramPerLiter).ToString(null, swedishCulture));
            Assert.Equal("1 g/ml", new Density(1, DensityUnit.GramPerMilliliter).ToString(null, swedishCulture));
            Assert.Equal("1 kg/cm³", new Density(1, DensityUnit.KilogramPerCubicCentimeter).ToString(null, swedishCulture));
            Assert.Equal("1 kg/m³", new Density(1, DensityUnit.KilogramPerCubicMeter).ToString(null, swedishCulture));
            Assert.Equal("1 kg/mm³", new Density(1, DensityUnit.KilogramPerCubicMillimeter).ToString(null, swedishCulture));
            Assert.Equal("1 kg/l", new Density(1, DensityUnit.KilogramPerLiter).ToString(null, swedishCulture));
            Assert.Equal("1 kip/ft³", new Density(1, DensityUnit.KilopoundPerCubicFoot).ToString(null, swedishCulture));
            Assert.Equal("1 kip/in³", new Density(1, DensityUnit.KilopoundPerCubicInch).ToString(null, swedishCulture));
            Assert.Equal("1 kip/yd³", new Density(1, DensityUnit.KilopoundPerCubicYard).ToString(null, swedishCulture));
            Assert.Equal("1 µg/m³", new Density(1, DensityUnit.MicrogramPerCubicMeter).ToString(null, swedishCulture));
            Assert.Equal("1 µg/dl", new Density(1, DensityUnit.MicrogramPerDeciliter).ToString(null, swedishCulture));
            Assert.Equal("1 µg/l", new Density(1, DensityUnit.MicrogramPerLiter).ToString(null, swedishCulture));
            Assert.Equal("1 µg/ml", new Density(1, DensityUnit.MicrogramPerMilliliter).ToString(null, swedishCulture));
            Assert.Equal("1 mg/m³", new Density(1, DensityUnit.MilligramPerCubicMeter).ToString(null, swedishCulture));
            Assert.Equal("1 mg/dl", new Density(1, DensityUnit.MilligramPerDeciliter).ToString(null, swedishCulture));
            Assert.Equal("1 mg/l", new Density(1, DensityUnit.MilligramPerLiter).ToString(null, swedishCulture));
            Assert.Equal("1 mg/ml", new Density(1, DensityUnit.MilligramPerMilliliter).ToString(null, swedishCulture));
            Assert.Equal("1 ng/dl", new Density(1, DensityUnit.NanogramPerDeciliter).ToString(null, swedishCulture));
            Assert.Equal("1 ng/l", new Density(1, DensityUnit.NanogramPerLiter).ToString(null, swedishCulture));
            Assert.Equal("1 ng/ml", new Density(1, DensityUnit.NanogramPerMilliliter).ToString(null, swedishCulture));
            Assert.Equal("1 pg/dl", new Density(1, DensityUnit.PicogramPerDeciliter).ToString(null, swedishCulture));
            Assert.Equal("1 pg/l", new Density(1, DensityUnit.PicogramPerLiter).ToString(null, swedishCulture));
            Assert.Equal("1 pg/ml", new Density(1, DensityUnit.PicogramPerMilliliter).ToString(null, swedishCulture));
            Assert.Equal("1 lb/cm³", new Density(1, DensityUnit.PoundPerCubicCentimeter).ToString(null, swedishCulture));
            Assert.Equal("1 lb/ft³", new Density(1, DensityUnit.PoundPerCubicFoot).ToString(null, swedishCulture));
            Assert.Equal("1 lb/in³", new Density(1, DensityUnit.PoundPerCubicInch).ToString(null, swedishCulture));
            Assert.Equal("1 lb/m³", new Density(1, DensityUnit.PoundPerCubicMeter).ToString(null, swedishCulture));
            Assert.Equal("1 lb/mm³", new Density(1, DensityUnit.PoundPerCubicMillimeter).ToString(null, swedishCulture));
            Assert.Equal("1 lb/yd³", new Density(1, DensityUnit.PoundPerCubicYard).ToString(null, swedishCulture));
            Assert.Equal("1 ppg (imp.)", new Density(1, DensityUnit.PoundPerImperialGallon).ToString(null, swedishCulture));
            Assert.Equal("1 ppg (U.S.)", new Density(1, DensityUnit.PoundPerUSGallon).ToString(null, swedishCulture));
            Assert.Equal("1 slug/cm³", new Density(1, DensityUnit.SlugPerCubicCentimeter).ToString(null, swedishCulture));
            Assert.Equal("1 slug/ft³", new Density(1, DensityUnit.SlugPerCubicFoot).ToString(null, swedishCulture));
            Assert.Equal("1 slug/in³", new Density(1, DensityUnit.SlugPerCubicInch).ToString(null, swedishCulture));
            Assert.Equal("1 slug/m³", new Density(1, DensityUnit.SlugPerCubicMeter).ToString(null, swedishCulture));
            Assert.Equal("1 slug/mm³", new Density(1, DensityUnit.SlugPerCubicMillimeter).ToString(null, swedishCulture));
            Assert.Equal("1 t/cm³", new Density(1, DensityUnit.TonnePerCubicCentimeter).ToString(null, swedishCulture));
            Assert.Equal("1 t/ft³", new Density(1, DensityUnit.TonnePerCubicFoot).ToString(null, swedishCulture));
            Assert.Equal("1 t/in³", new Density(1, DensityUnit.TonnePerCubicInch).ToString(null, swedishCulture));
            Assert.Equal("1 t/m³", new Density(1, DensityUnit.TonnePerCubicMeter).ToString(null, swedishCulture));
            Assert.Equal("1 t/mm³", new Density(1, DensityUnit.TonnePerCubicMillimeter).ToString(null, swedishCulture));
        }
