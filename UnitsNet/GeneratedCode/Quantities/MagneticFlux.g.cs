...
namespace UnitsNet
{
    ...
    public partial struct MagneticFlux : IQuantity<MagneticFluxUnit>, IEquatable<MagneticFlux>, IComparable, IComparable<MagneticFlux>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="MagneticFlux" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<MagneticFlux>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(MagneticFluxUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<MagneticFlux>(inBaseUnits.Unit, unit, out var conversionFunction))
