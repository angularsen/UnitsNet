...
namespace UnitsNet
{
    ...
    public partial struct TemperatureGradient : IQuantity<TemperatureGradientUnit>, IEquatable<TemperatureGradient>, IComparable, IComparable<TemperatureGradient>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="TemperatureGradient" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<TemperatureGradient>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(TemperatureGradientUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<TemperatureGradient>(inBaseUnits.Unit, unit, out var conversionFunction))
