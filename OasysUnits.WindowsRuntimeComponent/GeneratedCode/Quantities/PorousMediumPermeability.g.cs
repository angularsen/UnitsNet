...
namespace OasysUnits
{
    ...
    public sealed partial class PorousMediumPermeability : IQuantity
    {
        /// <summary>
        ...
        static PorousMediumPermeability()
        {
            ...
            Info = new QuantityInfo(QuantityType.PorousMediumPermeability, Units.Cast<Enum>().ToArray(), BaseUnit, Zero, BaseDimensions);
        }
        ...
        /// </remarks>
        public PorousMediumPermeability()
        {
            _value = 0;
            _unit = BaseUnit;
        }
        ...
        /// </summary>
        [Obsolete("QuantityType will be removed in the future. Use the Info property instead.")]
        public QuantityType Type => PorousMediumPermeability.QuantityType;
        ...
        /// </exception>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static PorousMediumPermeability Parse(string str, [CanBeNull] string cultureName)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        ///     Length.Parse("5.5 m", new CultureInfo("en-US"));
        /// </example>
        public static bool TryParse([CanBeNull] string str, out PorousMediumPermeability result)
        {
        ...
        /// </example>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static bool TryParse([CanBeNull] string str, [CanBeNull] string cultureName, out PorousMediumPermeability result)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        /// <exception cref="OasysUnitsException">Error parsing string.</exception>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static PorousMediumPermeabilityUnit ParseUnit(string str, [CanBeNull] string cultureName)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        internal int CompareTo(PorousMediumPermeability other)
        {
        ...
        double IQuantity.As(object unit) => As((PorousMediumPermeabilityUnit)unit);
        ...
        private double AsBaseUnit()
        {
            switch(Unit)
            {
                case PorousMediumPermeabilityUnit.Darcy: return _value * 9.869233e-13;
                case PorousMediumPermeabilityUnit.Microdarcy: return (_value * 9.869233e-13) * 1e-6d;
                case PorousMediumPermeabilityUnit.Millidarcy: return (_value * 9.869233e-13) * 1e-3d;
                case PorousMediumPermeabilityUnit.SquareCentimeter: return _value * 1e-4;
                case PorousMediumPermeabilityUnit.SquareMeter: return _value;
                default:
