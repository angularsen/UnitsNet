...
namespace UnitsNet
{
    ...
    public partial struct CoefficientOfThermalExpansion : IQuantity<CoefficientOfThermalExpansionUnit>, IEquatable<CoefficientOfThermalExpansion>, IComparable, IComparable<CoefficientOfThermalExpansion>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="CoefficientOfThermalExpansion" /> instances.
        /// </summary>
        ...
        internal CoefficientOfThermalExpansion ToBaseUnit()
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<CoefficientOfThermalExpansion>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(CoefficientOfThermalExpansionUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<CoefficientOfThermalExpansion>(inBaseUnits.Unit, unit, out var conversionFunction))
