...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = BitRate.From(1.0, BitRate.BaseUnit);
        ...
        {
            var inBaseUnit = BitRate.From(1.0, BitRate.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(BitRateUnit)));
        }
        ...
        {
            var quantity = BitRate.FromBitsPerSecond(1.0);
            Assert.Equal(BitRate.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
