...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void EnergyDensity_QuantityInfo_ReturnsQuantityInfoDescribingQuantity()
        {
            ...
            var units = EnumUtils.GetEnumValues<EnergyDensityUnit>().Except(new[] {EnergyDensityUnit.Undefined}).OrderBy(x => x.ToString()).ToArray();
        ...
        public void ToUnit_FromNonBaseUnit_ReturnsQuantityWithGivenUnit(EnergyDensityUnit unit)
        {
            ...
            var fromUnit = EnergyDensity.Units.FirstOrDefault(u => u != EnergyDensity.BaseUnit && u != EnergyDensityUnit.Undefined);

            // If there is only one unit for the quantity, we must use the base unit.
            if (fromUnit == EnergyDensityUnit.Undefined)
                fromUnit = EnergyDensity.BaseUnit;
