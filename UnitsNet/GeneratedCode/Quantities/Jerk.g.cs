...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Jerk()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, JerkUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, JerkUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(JerkUnit unit) => GetAbbreviation(unit, null);
