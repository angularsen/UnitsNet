...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricCurrentDensity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricCurrentDensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricCurrentDensityUnit Unit), List<string>> Abbreviations { get; }
