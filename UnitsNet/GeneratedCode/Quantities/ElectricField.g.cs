...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricField()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, ElectricFieldUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, ElectricFieldUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(ElectricFieldUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(ElectricFieldUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.ElectricField";
                var resourceManager = new ResourceManager(resourceName, typeof(ElectricField).Assembly);
