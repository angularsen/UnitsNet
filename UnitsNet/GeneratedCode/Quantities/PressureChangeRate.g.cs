...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static PressureChangeRate()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, PressureChangeRateUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, PressureChangeRateUnit Unit), List<string>> Abbreviations { get; }
