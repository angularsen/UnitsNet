...
namespace OasysUnits.Serialization.JsonNet.Tests
{
    public sealed class OasysUnitsBaseJsonConverterTest
    {
        ...
        [Fact]
        public void OasysUnitsBaseJsonConverter_ConvertIQuantity_works_with_decimal_type()
        {
        ...
        [Fact]
        public void OasysUnitsBaseJsonConverter_ConvertValueUnit_works_with_NULL_value()
        {
        ...
        {
            var result = Assert.Throws<OasysUnitsException>(() => _sut.Test_ConvertDecimalValueUnit("PowerUnit Watt", 10.2365m));
        ...
        [Fact]
        public void OasysUnitsBaseJsonConverter_ReadValueUnit_works_with_decimal_quantity()
        {
        ...
        [Fact]
        public void OasysUnitsBaseJsonConverter_ReadValueUnit_returns_null_when_value_type_is_not_a_string()
        {
