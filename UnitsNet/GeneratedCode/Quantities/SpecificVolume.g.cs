...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static SpecificVolume()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, SpecificVolumeUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, SpecificVolumeUnit Unit), List<string>> Abbreviations { get; }
