...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricResistivity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricResistivityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricResistivityUnit Unit), List<string>> Abbreviations { get; }
