...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ThermalConductivity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ThermalConductivityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ThermalConductivityUnit Unit), List<string>> Abbreviations { get; }
