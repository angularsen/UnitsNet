...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = TemperatureGradient.From(1.0, TemperatureGradient.BaseUnit);
        ...
        {
            var inBaseUnit = TemperatureGradient.From(1.0, TemperatureGradient.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(TemperatureGradientUnit)));
        }
        ...
        {
            var quantity = TemperatureGradient.FromKelvinsPerMeter(1.0);
            Assert.Equal(TemperatureGradient.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
