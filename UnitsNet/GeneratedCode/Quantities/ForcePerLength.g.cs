...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ForcePerLength()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ForcePerLengthUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ForcePerLengthUnit Unit), List<string>> Abbreviations { get; }
