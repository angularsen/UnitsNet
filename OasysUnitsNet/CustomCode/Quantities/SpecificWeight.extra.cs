...
namespace OasysUnitsNet
{
    public partial struct SpecificWeight
    {
        ...
        {
            return new Pressure(specificWeight.NewtonsPerCubicMeter * length.Meters, OasysUnitsNet.Units.PressureUnit.Pascal);
        }
        ...
        {
            return new Acceleration(specificWeight.NewtonsPerCubicMeter / density.KilogramsPerCubicMeter, OasysUnitsNet.Units.AccelerationUnit.MeterPerSecondSquared);
        }
        ...
        {
            return new Density(specific.NewtonsPerCubicMeter / acceleration.MetersPerSecondSquared, OasysUnitsNet.Units.DensityUnit.KilogramPerCubicMeter);
        }
    }
}
