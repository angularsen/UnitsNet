...
namespace UnitsNet.Tests
{
    public class PressureTests : PressureTestsBase
    {
        ...
        protected override double MeterOfWaterColumnInOnePascal => 1.0197162129779283e-4;

        protected override double CentimeterOfWaterColumnInOnePascal => 1.0197162129779283e-2;
