...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricCurrentDensity()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, ElectricCurrentDensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, ElectricCurrentDensityUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(ElectricCurrentDensityUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(ElectricCurrentDensityUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.ElectricCurrentDensity";
                var resourceManager = new ResourceManager(resourceName, typeof(ElectricCurrentDensity).Assembly);
