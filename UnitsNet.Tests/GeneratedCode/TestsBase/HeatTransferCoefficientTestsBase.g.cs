...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = HeatTransferCoefficient.From(1.0, HeatTransferCoefficient.BaseUnit);
        ...
        {
            var inBaseUnit = HeatTransferCoefficient.From(1.0, HeatTransferCoefficient.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(HeatTransferCoefficientUnit)));
        }
        ...
        {
            var quantity = HeatTransferCoefficient.FromWattsPerSquareMeterKelvin(1.0);
            Assert.Equal(HeatTransferCoefficient.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
