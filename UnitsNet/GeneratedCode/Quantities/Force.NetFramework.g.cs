...
namespace UnitsNet
{
    ...
    /// </summary>
    public partial struct Force : IQuantity<ForceUnit>, IEquatable<Force>, IComparable, IComparable<Force>, IConvertible
    {
        /// <summary>
        ...
        public static ForceUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static ForceUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
