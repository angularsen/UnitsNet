        ...
        IFormattable
    {
        ...
        private bool TryToUnit(MolarFlowUnit unit, [NotNullWhen(true)] out MolarFlow? converted)
        {
            ...
            MolarFlow? convertedOrNull = (Unit, unit) switch
            {
                ...
                (MolarFlowUnit.KilomolePerHour, MolarFlowUnit.MolePerSecond) => new MolarFlow(_value * new QuantityValue(5, 18, false), MolarFlowUnit.MolePerSecond),
                (MolarFlowUnit.KilomolePerMinute, MolarFlowUnit.MolePerSecond) => new MolarFlow(_value * new QuantityValue(50, 3, false), MolarFlowUnit.MolePerSecond),
                ...
                (MolarFlowUnit.PoundMolePerHour, MolarFlowUnit.MolePerSecond) => new MolarFlow(_value * new QuantityValue(45359237, 360000000, false), MolarFlowUnit.MolePerSecond),
                (MolarFlowUnit.PoundMolePerMinute, MolarFlowUnit.MolePerSecond) => new MolarFlow(_value * new QuantityValue(45359237, 6000000, false), MolarFlowUnit.MolePerSecond),
                (MolarFlowUnit.PoundMolePerSecond, MolarFlowUnit.MolePerSecond) => new MolarFlow(_value * new QuantityValue(45359237, 100000, false), MolarFlowUnit.MolePerSecond),

                // BaseUnit -> MolarFlowUnit
                (MolarFlowUnit.MolePerSecond, MolarFlowUnit.KilomolePerHour) => new MolarFlow(_value * new QuantityValue(18, 5, false), MolarFlowUnit.KilomolePerHour),
                (MolarFlowUnit.MolePerSecond, MolarFlowUnit.KilomolePerMinute) => new MolarFlow(_value * new QuantityValue(3, 50, false), MolarFlowUnit.KilomolePerMinute),
                ...
                (MolarFlowUnit.MolePerSecond, MolarFlowUnit.PoundMolePerHour) => new MolarFlow(_value * new QuantityValue(360000000, 45359237, false), MolarFlowUnit.PoundMolePerHour),
                (MolarFlowUnit.MolePerSecond, MolarFlowUnit.PoundMolePerMinute) => new MolarFlow(_value * new QuantityValue(6000000, 45359237, false), MolarFlowUnit.PoundMolePerMinute),
                (MolarFlowUnit.MolePerSecond, MolarFlowUnit.PoundMolePerSecond) => new MolarFlow(_value * new QuantityValue(100000, 45359237, false), MolarFlowUnit.PoundMolePerSecond),
