...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial struct ElectricConductivity : IQuantity<ElectricConductivityUnit>, IComparable, IComparable<ElectricConductivity>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ElectricConductivityUnit>)this).As(unitAsElectricConductivityUnit);
        }
        ...
        /// <summary>
        ///     Converts this ElectricConductivity to another ElectricConductivity with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ElectricConductivity with the specified unit.</returns>
        public QuantityValue ToQuantity(ElectricConductivityUnit unit)
        {
