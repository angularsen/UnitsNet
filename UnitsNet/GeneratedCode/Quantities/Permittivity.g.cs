...
namespace UnitsNet
{
    ...
    public partial struct Permittivity : IQuantity<PermittivityUnit>, IEquatable<Permittivity>, IComparable, IComparable<Permittivity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Permittivity" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<Permittivity>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(PermittivityUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Permittivity>(inBaseUnits.Unit, unit, out var conversionFunction))
