            ...
            return new LinearDensity(value, fromUnit);
                ...
                private double GetValueInBaseUnit()
                {
                    return Unit switch
                    {
                        ...
                        LinearDensityUnit.GramPerFoot => _value * 3.28084e-3,
                        ...
                        LinearDensityUnit.KilogramPerFoot => (_value * 3.28084e-3) * 1e3d,
                        ...
                        LinearDensityUnit.MicrogramPerFoot => (_value * 3.28084e-3) * 1e-6d,
                        ...
                        LinearDensityUnit.MilligramPerFoot => (_value * 3.28084e-3) * 1e-3d,
                ...
                private double GetValueAs(LinearDensityUnit unit)
                {
                    ...
                    return unit switch
                    {
                        ...
                        LinearDensityUnit.GramPerFoot => baseUnitValue / 3.28084e-3,
                        ...
                        LinearDensityUnit.KilogramPerFoot => (baseUnitValue / 3.28084e-3) / 1e3d,
                        ...
                        LinearDensityUnit.MicrogramPerFoot => (baseUnitValue / 3.28084e-3) / 1e-6d,
                        ...
                        LinearDensityUnit.MilligramPerFoot => (baseUnitValue / 3.28084e-3) / 1e-3d,
