...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static RotationalSpeed()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, RotationalSpeedUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, RotationalSpeedUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(RotationalSpeedUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(RotationalSpeedUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.RotationalSpeed";
                var resourceManager = new ResourceManager(resourceName, typeof(RotationalSpeed).Assembly);
