...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static RotationalStiffnessPerLength()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, RotationalStiffnessPerLengthUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, RotationalStiffnessPerLengthUnit Unit), List<string>> Abbreviations { get; }
