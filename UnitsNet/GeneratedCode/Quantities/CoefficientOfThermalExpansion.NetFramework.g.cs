...
namespace UnitsNet
{
    ...
    /// </summary>
    public partial struct CoefficientOfThermalExpansion : IQuantity<CoefficientOfThermalExpansionUnit>, IEquatable<CoefficientOfThermalExpansion>, IComparable, IComparable<CoefficientOfThermalExpansion>, IConvertible
    {
        /// <summary>
        ...
        public static CoefficientOfThermalExpansionUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static CoefficientOfThermalExpansionUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
