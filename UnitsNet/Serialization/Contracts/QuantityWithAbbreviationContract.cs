...
namespace UnitsNet.Serialization.Contracts
{
    ...
    /// <remarks>
    /// <para>Given the ambiguous nature of the unit-abbreviation mapping, an addition identifier, associated with the quantity type, is required</para>
    /// </remarks>
    /// </summary>
    ...
    [DataContract]
    public class QuantityWithAbbreviationContract<TQuantity, TValue> : QuantityValueContract<TValue, string>
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public QuantityWithAbbreviationContract(TQuantity quantityType, TValue value, string unitAbbreviation) : base(value, unitAbbreviation)
        {
