...
namespace UnitsNet
{
    ...
    public partial struct TemperatureGradient : IQuantity<TemperatureGradientUnit>, IComparable, IComparable<TemperatureGradient>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<TemperatureGradientUnit>)this).As(unitAsTemperatureGradientUnit);
        }
        ...
        /// <summary>
        ///     Converts this TemperatureGradient to another TemperatureGradient with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A TemperatureGradient with the specified unit.</returns>
        public QuantityValue ToQuantity(TemperatureGradientUnit unit)
        {
