...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<ElectricCurrentGradientUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.ElectricCurrentGradientUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<ElectricCurrentGradientUnit>(str, culture, out unit);
        }
