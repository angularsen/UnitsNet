...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricAdmittance()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricAdmittanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricAdmittanceUnit Unit), List<string>> Abbreviations { get; }
