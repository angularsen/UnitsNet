...
namespace UnitsNet
{
    ...
    public partial struct Energy : IQuantity<EnergyUnit>, IEquatable<Energy>, IComparable, IComparable<Energy>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="Energy"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="Energy"/> from.</param>
        public static implicit operator Energy(ValueTuple<QuantityValue, EnergyUnit> tuple) => new Energy((double)tuple.Item1, tuple.Item2);
