...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.KiloohmCentimeter).KiloohmsCentimeter, KiloohmsCentimeterTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.KiloohmMeter).KiloohmMeters, KiloohmMetersTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.MegaohmCentimeter).MegaohmsCentimeter, MegaohmsCentimeterTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.MegaohmMeter).MegaohmMeters, MegaohmMetersTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.MicroohmCentimeter).MicroohmsCentimeter, MicroohmsCentimeterTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.MicroohmMeter).MicroohmMeters, MicroohmMetersTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.MilliohmCentimeter).MilliohmsCentimeter, MilliohmsCentimeterTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.MilliohmMeter).MilliohmMeters, MilliohmMetersTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.NanoohmCentimeter).NanoohmsCentimeter, NanoohmsCentimeterTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.NanoohmMeter).NanoohmMeters, NanoohmMetersTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.OhmCentimeter).OhmsCentimeter, OhmsCentimeterTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.OhmMeter).OhmMeters, OhmMetersTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.PicoohmCentimeter).PicoohmsCentimeter, PicoohmsCentimeterTolerance);
            AssertEx.EqualTolerance(1, ElectricResistivity<double>.From(1, ElectricResistivityUnit.PicoohmMeter).PicoohmMeters, PicoohmMetersTolerance);
        }
