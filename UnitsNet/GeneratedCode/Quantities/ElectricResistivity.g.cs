...
namespace UnitsNet
{
    ...
    public partial struct ElectricResistivity : IQuantity<ElectricResistivityUnit>, IEquatable<ElectricResistivity>, IComparable, IComparable<ElectricResistivity>, IConvertible, IFormattable
    {
        ...
        static ElectricResistivity()
        {
            ...
            Info = new QuantityInfo<ElectricResistivityUnit>("ElectricResistivity",
                new UnitInfo<ElectricResistivityUnit>[] {
                    ...
                    new UnitInfo<ElectricResistivityUnit>(ElectricResistivityUnit.OhmFoot, BaseUnits.Undefined),
                    new UnitInfo<ElectricResistivityUnit>(ElectricResistivityUnit.OhmInch, BaseUnits.Undefined),
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricResistivity FromOhmFeet(QuantityValue ohmfeet)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricResistivity FromOhmInches(QuantityValue ohminches)
        {
