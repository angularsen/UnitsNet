...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<CoefficientOfThermalExpansionUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.CoefficientOfThermalExpansionUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<CoefficientOfThermalExpansionUnit>(str, culture, out unit);
        }
