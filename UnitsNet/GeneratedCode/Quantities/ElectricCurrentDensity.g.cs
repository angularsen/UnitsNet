...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial struct ElectricCurrentDensity : IQuantity<ElectricCurrentDensityUnit>, IComparable, IComparable<ElectricCurrentDensity>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ElectricCurrentDensityUnit>)this).As(unitAsElectricCurrentDensityUnit);
        }
        ...
        /// <summary>
        ///     Converts this ElectricCurrentDensity to another ElectricCurrentDensity with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ElectricCurrentDensity with the specified unit.</returns>
        public QuantityValue ToQuantity(ElectricCurrentDensityUnit unit)
        {
