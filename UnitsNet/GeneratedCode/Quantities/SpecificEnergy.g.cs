...
namespace UnitsNet
{
    ...
    public partial struct SpecificEnergy : IQuantity<SpecificEnergyUnit>, IEquatable<SpecificEnergy>, IComparable, IComparable<SpecificEnergy>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="SpecificEnergy" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<SpecificEnergy>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(SpecificEnergyUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<SpecificEnergy>(inBaseUnits.Unit, unit, out var conversionFunction))
