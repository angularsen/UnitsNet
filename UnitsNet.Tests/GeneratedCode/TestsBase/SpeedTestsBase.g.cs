...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ToString_WithSwedishCulture_ReturnsUnitAbbreviationForEnglishCultureSinceThereAreNoMappings()
        {
            ...
            Assert.Equal("1 cm/h", new Speed(1, SpeedUnit.CentimeterPerHour).ToString(null, swedishCulture));
            Assert.Equal("1 cm/min", new Speed(1, SpeedUnit.CentimeterPerMinute).ToString(null, swedishCulture));
            Assert.Equal("1 cm/s", new Speed(1, SpeedUnit.CentimeterPerSecond).ToString(null, swedishCulture));
            Assert.Equal("1 dm/min", new Speed(1, SpeedUnit.DecimeterPerMinute).ToString(null, swedishCulture));
            Assert.Equal("1 dm/s", new Speed(1, SpeedUnit.DecimeterPerSecond).ToString(null, swedishCulture));
            Assert.Equal("1 ft/h", new Speed(1, SpeedUnit.FootPerHour).ToString(null, swedishCulture));
            Assert.Equal("1 ft/min", new Speed(1, SpeedUnit.FootPerMinute).ToString(null, swedishCulture));
            Assert.Equal("1 ft/s", new Speed(1, SpeedUnit.FootPerSecond).ToString(null, swedishCulture));
            Assert.Equal("1 in/h", new Speed(1, SpeedUnit.InchPerHour).ToString(null, swedishCulture));
            Assert.Equal("1 in/min", new Speed(1, SpeedUnit.InchPerMinute).ToString(null, swedishCulture));
            Assert.Equal("1 in/s", new Speed(1, SpeedUnit.InchPerSecond).ToString(null, swedishCulture));
            Assert.Equal("1 km/h", new Speed(1, SpeedUnit.KilometerPerHour).ToString(null, swedishCulture));
            Assert.Equal("1 km/min", new Speed(1, SpeedUnit.KilometerPerMinute).ToString(null, swedishCulture));
            Assert.Equal("1 km/s", new Speed(1, SpeedUnit.KilometerPerSecond).ToString(null, swedishCulture));
            Assert.Equal("1 kn", new Speed(1, SpeedUnit.Knot).ToString(null, swedishCulture));
            Assert.Equal("1 M", new Speed(1, SpeedUnit.Mach).ToString(null, swedishCulture));
            Assert.Equal("1 m/h", new Speed(1, SpeedUnit.MeterPerHour).ToString(null, swedishCulture));
            Assert.Equal("1 m/min", new Speed(1, SpeedUnit.MeterPerMinute).ToString(null, swedishCulture));
            Assert.Equal("1 m/s", new Speed(1, SpeedUnit.MeterPerSecond).ToString(null, swedishCulture));
            Assert.Equal("1 µm/min", new Speed(1, SpeedUnit.MicrometerPerMinute).ToString(null, swedishCulture));
            Assert.Equal("1 µm/s", new Speed(1, SpeedUnit.MicrometerPerSecond).ToString(null, swedishCulture));
            Assert.Equal("1 mph", new Speed(1, SpeedUnit.MilePerHour).ToString(null, swedishCulture));
            Assert.Equal("1 mm/h", new Speed(1, SpeedUnit.MillimeterPerHour).ToString(null, swedishCulture));
            Assert.Equal("1 mm/min", new Speed(1, SpeedUnit.MillimeterPerMinute).ToString(null, swedishCulture));
            Assert.Equal("1 mm/s", new Speed(1, SpeedUnit.MillimeterPerSecond).ToString(null, swedishCulture));
            Assert.Equal("1 nm/min", new Speed(1, SpeedUnit.NanometerPerMinute).ToString(null, swedishCulture));
            Assert.Equal("1 nm/s", new Speed(1, SpeedUnit.NanometerPerSecond).ToString(null, swedishCulture));
            Assert.Equal("1 ftUS/h", new Speed(1, SpeedUnit.UsSurveyFootPerHour).ToString(null, swedishCulture));
            Assert.Equal("1 ftUS/min", new Speed(1, SpeedUnit.UsSurveyFootPerMinute).ToString(null, swedishCulture));
            Assert.Equal("1 ftUS/s", new Speed(1, SpeedUnit.UsSurveyFootPerSecond).ToString(null, swedishCulture));
            Assert.Equal("1 yd/h", new Speed(1, SpeedUnit.YardPerHour).ToString(null, swedishCulture));
            Assert.Equal("1 yd/min", new Speed(1, SpeedUnit.YardPerMinute).ToString(null, swedishCulture));
            Assert.Equal("1 yd/s", new Speed(1, SpeedUnit.YardPerSecond).ToString(null, swedishCulture));
        }
