...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            FuelEfficiencyUnit[] unitsOrderedByName = EnumHelper.GetValues<FuelEfficiencyUnit>().OrderBy(x => x.ToString(), StringComparer.Ordinal).ToArray();
        ...
        {
            var units = Enum.GetValues<FuelEfficiencyUnit>();
