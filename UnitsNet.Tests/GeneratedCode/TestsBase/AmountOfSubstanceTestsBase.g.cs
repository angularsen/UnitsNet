...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = AmountOfSubstance.From(1.0, AmountOfSubstance.BaseUnit);
        ...
        {
            var inBaseUnit = AmountOfSubstance.From(1.0, AmountOfSubstance.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(AmountOfSubstanceUnit)));
        }
        ...
        {
            var quantity = AmountOfSubstance.FromMoles(1.0);
            Assert.Equal(AmountOfSubstance.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
