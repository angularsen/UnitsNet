...
namespace UnitsNet
{
    ...
    public partial struct BitRate : IQuantity<BitRateUnit>, IDecimalQuantity, IEquatable<BitRate>, IComparable, IComparable<BitRate>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="BitRate" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<BitRate>(Unit, BaseUnit, out var conversionFunction))
        ...
        private decimal GetValueAs(BitRateUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<BitRate>(inBaseUnits.Unit, unit, out var conversionFunction))
