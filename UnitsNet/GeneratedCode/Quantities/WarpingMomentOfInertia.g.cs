...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static WarpingMomentOfInertia()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, WarpingMomentOfInertiaUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, WarpingMomentOfInertiaUnit Unit), List<string>> Abbreviations { get; }
