...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ToString_WithSwedishCulture_ReturnsUnitAbbreviationForEnglishCultureSinceThereAreNoMappings()
        {
            ...
            Assert.Equal("1 Å", new Length(1, LengthUnit.Angstrom).ToString(null, swedishCulture));
            Assert.Equal("1 au", new Length(1, LengthUnit.AstronomicalUnit).ToString(null, swedishCulture));
            Assert.Equal("1 cm", new Length(1, LengthUnit.Centimeter).ToString(null, swedishCulture));
            Assert.Equal("1 ch", new Length(1, LengthUnit.Chain).ToString(null, swedishCulture));
            Assert.Equal("1 DM", new Length(1, LengthUnit.DataMile).ToString(null, swedishCulture));
            Assert.Equal("1 dam", new Length(1, LengthUnit.Decameter).ToString(null, swedishCulture));
            Assert.Equal("1 dm", new Length(1, LengthUnit.Decimeter).ToString(null, swedishCulture));
            Assert.Equal("1 pica", new Length(1, LengthUnit.DtpPica).ToString(null, swedishCulture));
            Assert.Equal("1 pt", new Length(1, LengthUnit.DtpPoint).ToString(null, swedishCulture));
            Assert.Equal("1 fathom", new Length(1, LengthUnit.Fathom).ToString(null, swedishCulture));
            Assert.Equal("1 fm", new Length(1, LengthUnit.Femtometer).ToString(null, swedishCulture));
            Assert.Equal("1 ft", new Length(1, LengthUnit.Foot).ToString(null, swedishCulture));
            Assert.Equal("1 Gm", new Length(1, LengthUnit.Gigameter).ToString(null, swedishCulture));
            Assert.Equal("1 h", new Length(1, LengthUnit.Hand).ToString(null, swedishCulture));
            Assert.Equal("1 hm", new Length(1, LengthUnit.Hectometer).ToString(null, swedishCulture));
            Assert.Equal("1 in", new Length(1, LengthUnit.Inch).ToString(null, swedishCulture));
            Assert.Equal("1 kft", new Length(1, LengthUnit.Kilofoot).ToString(null, swedishCulture));
            Assert.Equal("1 kly", new Length(1, LengthUnit.KilolightYear).ToString(null, swedishCulture));
            Assert.Equal("1 km", new Length(1, LengthUnit.Kilometer).ToString(null, swedishCulture));
            Assert.Equal("1 kpc", new Length(1, LengthUnit.Kiloparsec).ToString(null, swedishCulture));
            Assert.Equal("1 kyd", new Length(1, LengthUnit.Kiloyard).ToString(null, swedishCulture));
            Assert.Equal("1 ly", new Length(1, LengthUnit.LightYear).ToString(null, swedishCulture));
            Assert.Equal("1 Mly", new Length(1, LengthUnit.MegalightYear).ToString(null, swedishCulture));
            Assert.Equal("1 Mm", new Length(1, LengthUnit.Megameter).ToString(null, swedishCulture));
            Assert.Equal("1 Mpc", new Length(1, LengthUnit.Megaparsec).ToString(null, swedishCulture));
            Assert.Equal("1 m", new Length(1, LengthUnit.Meter).ToString(null, swedishCulture));
            Assert.Equal("1 µin", new Length(1, LengthUnit.Microinch).ToString(null, swedishCulture));
            Assert.Equal("1 µm", new Length(1, LengthUnit.Micrometer).ToString(null, swedishCulture));
            Assert.Equal("1 mil", new Length(1, LengthUnit.Mil).ToString(null, swedishCulture));
            Assert.Equal("1 mi", new Length(1, LengthUnit.Mile).ToString(null, swedishCulture));
            Assert.Equal("1 mm", new Length(1, LengthUnit.Millimeter).ToString(null, swedishCulture));
            Assert.Equal("1 nm", new Length(1, LengthUnit.Nanometer).ToString(null, swedishCulture));
            Assert.Equal("1 NM", new Length(1, LengthUnit.NauticalMile).ToString(null, swedishCulture));
            Assert.Equal("1 pc", new Length(1, LengthUnit.Parsec).ToString(null, swedishCulture));
            Assert.Equal("1 pm", new Length(1, LengthUnit.Picometer).ToString(null, swedishCulture));
            Assert.Equal("1 pica", new Length(1, LengthUnit.PrinterPica).ToString(null, swedishCulture));
            Assert.Equal("1 pt", new Length(1, LengthUnit.PrinterPoint).ToString(null, swedishCulture));
            Assert.Equal("1 shackle", new Length(1, LengthUnit.Shackle).ToString(null, swedishCulture));
            Assert.Equal("1 R⊙", new Length(1, LengthUnit.SolarRadius).ToString(null, swedishCulture));
            Assert.Equal("1 twip", new Length(1, LengthUnit.Twip).ToString(null, swedishCulture));
            Assert.Equal("1 ftUS", new Length(1, LengthUnit.UsSurveyFoot).ToString(null, swedishCulture));
            Assert.Equal("1 yd", new Length(1, LengthUnit.Yard).ToString(null, swedishCulture));
        }
