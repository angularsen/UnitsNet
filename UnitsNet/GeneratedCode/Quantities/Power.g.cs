...
namespace UnitsNet
{
    ...
    public partial struct Power : IQuantity<PowerUnit>, IEquatable<Power>, IComparable, IComparable<Power>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="Power"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="Power"/> from.</param>
        public static implicit operator Power(ValueTuple<QuantityValue, PowerUnit> tuple) => new Power((decimal)tuple.Item1, tuple.Item2);
