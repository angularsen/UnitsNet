...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricResistance()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, ElectricResistanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, ElectricResistanceUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(ElectricResistanceUnit unit) => GetAbbreviation(unit, null);
