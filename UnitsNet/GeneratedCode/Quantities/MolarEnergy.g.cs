...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MolarEnergy()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, MolarEnergyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, MolarEnergyUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(MolarEnergyUnit unit) => GetAbbreviation(unit, null);
        ...
        [Obsolete("For null checks, use `x is null` syntax to not invoke overloads. For quantity comparisons, use Equals(MolarEnergy, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator ==(MolarEnergy left, MolarEnergy right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(MolarEnergy, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("For null checks, use `x is not null` syntax to not invoke overloads. For quantity comparisons, use Equals(MolarEnergy, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator !=(MolarEnergy left, MolarEnergy right)
        {
            return !(left == right);
        }
        ...
        /// <summary>Indicates strict equality of two <see cref="MolarEnergy"/> quantities, where both <see cref="Value" /> and <see cref="Unit" /> are exactly equal.</summary>
        /// <remarks>Consider using <see cref="Equals(MolarEnergy, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("Consider using Equals(MolarEnergy, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
