...
namespace UnitsNet
{
    ...
    public partial struct RatioChangeRate : IQuantity<RatioChangeRateUnit>, IEquatable<RatioChangeRate>, IComparable, IComparable<RatioChangeRate>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="RatioChangeRate" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<RatioChangeRate>(Unit, BaseUnit, out var conversionFunction))
