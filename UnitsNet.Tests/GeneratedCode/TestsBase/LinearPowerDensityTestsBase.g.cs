...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            LinearPowerDensityUnit[] unitsOrderedByName = EnumHelper.GetValues<LinearPowerDensityUnit>().OrderBy(x => x.ToString(), StringComparer.Ordinal).ToArray();
        ...
        {
            var units = Enum.GetValues<LinearPowerDensityUnit>();
