...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricCurrentDensity.From(1.0, ElectricCurrentDensity.BaseUnit);
        ...
        {
            var inBaseUnit = ElectricCurrentDensity.From(1.0, ElectricCurrentDensity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricCurrentDensityUnit)));
        }
        ...
        {
            var quantity = ElectricCurrentDensity.FromAmperesPerSquareMeter(1.0);
            Assert.Equal(ElectricCurrentDensity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
