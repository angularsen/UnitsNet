...
namespace UnitsNet
{
    ...
    public partial struct Temperature : IQuantity<TemperatureUnit>, IComparable, IComparable<Temperature>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<TemperatureUnit>)this).As(unitAsTemperatureUnit);
        }
        ...
        /// <summary>
        ///     Converts this Temperature to another Temperature with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A Temperature with the specified unit.</returns>
        public QuantityValue ToQuantity(TemperatureUnit unit)
        {
