...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricSurfaceChargeDensity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricSurfaceChargeDensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricSurfaceChargeDensityUnit Unit), List<string>> Abbreviations { get; }
