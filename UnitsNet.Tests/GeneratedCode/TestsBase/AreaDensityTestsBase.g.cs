...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = AreaDensity.From(1.0, AreaDensity.BaseUnit);
        ...
        {
            var inBaseUnit = AreaDensity.From(1.0, AreaDensity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(AreaDensityUnit)));
        }
        ...
        {
            var quantity = AreaDensity.FromKilogramsPerSquareMeter(1.0);
            Assert.Equal(AreaDensity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
