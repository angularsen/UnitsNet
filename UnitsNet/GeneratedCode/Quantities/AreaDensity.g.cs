...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static AreaDensity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, AreaDensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, AreaDensityUnit Unit), List<string>> Abbreviations { get; }
