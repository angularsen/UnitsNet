...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Frequency()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, FrequencyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, FrequencyUnit Unit), List<string>> Abbreviations { get; }
