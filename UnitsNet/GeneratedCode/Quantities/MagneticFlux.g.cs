...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MagneticFlux()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, MagneticFluxUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, MagneticFluxUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(MagneticFluxUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(MagneticFluxUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.MagneticFlux";
                var resourceManager = new ResourceManager(resourceName, typeof(MagneticFlux).Assembly);
        ...
        [Obsolete("For null checks, use `x is null` syntax to not invoke overloads. For quantity comparisons, use Equals(MagneticFlux, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator ==(MagneticFlux left, MagneticFlux right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(MagneticFlux, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("For null checks, use `x is not null` syntax to not invoke overloads. For quantity comparisons, use Equals(MagneticFlux, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator !=(MagneticFlux left, MagneticFlux right)
        {
            return !(left == right);
        }
        ...
        /// <summary>Indicates strict equality of two <see cref="MagneticFlux"/> quantities, where both <see cref="Value" /> and <see cref="Unit" /> are exactly equal.</summary>
        /// <remarks>Consider using <see cref="Equals(MagneticFlux, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("Consider using Equals(MagneticFlux, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
