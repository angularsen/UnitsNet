...
namespace OasysUnits
{
    public partial struct SpecificWeight
    {
        ...
        {
            return new Pressure(specificWeight.NewtonsPerCubicMeter * length.Meters, OasysUnits.Units.PressureUnit.Pascal);
        }
        ...
        {
            return new Acceleration(specificWeight.NewtonsPerCubicMeter / density.KilogramsPerCubicMeter, OasysUnits.Units.AccelerationUnit.MeterPerSecondSquared);
        }
        ...
        {
            return new Density(specific.NewtonsPerCubicMeter / acceleration.MetersPerSecondSquared, OasysUnits.Units.DensityUnit.KilogramPerCubicMeter);
        }
    }
}
