...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Torque()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, TorqueUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, TorqueUnit Unit), List<string>> Abbreviations { get; }
