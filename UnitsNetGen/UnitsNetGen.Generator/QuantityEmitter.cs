...
internal static class QuantityEmitter
{
        ...
        IReadOnlyDictionary<string, QuantitySelection> selectionsBySemanticId)
    {
        ...
        writer.Append("    public ").Append(quantity.Name)
            .AppendLine("(double value, global::UnitsNetGen.UnitSystem unitSystem)");
        writer.AppendLine("        : this(value, global::UnitsNetGen.QuantityOperations.GetUnit(unitSystem, Metadata))");
        writer.AppendLine("    {");
        writer.AppendLine("    }");
        writer.AppendLine();
        ...
        writer.Append("    public static ").Append(quantity.Name)
            .AppendLine(" From(double value, global::UnitsNetGen.UnitSystem unitSystem) => new(value, unitSystem);");
        ...
        writer.AppendLine("    public static global::UnitsNetGen.BaseDimensions BaseDimensions { get; } = new(");
        ...
        writer.AppendLine("    public double As(global::UnitsNetGen.UnitSystem unitSystem) =>");
        writer.AppendLine("        As(global::UnitsNetGen.QuantityOperations.GetUnit(unitSystem, Metadata));");
        writer.AppendLine();
        writer.Append("    public ").Append(quantity.Name).Append(" ToUnit(").Append(unitType).AppendLine(" unit) => new(As(unit), unit);");
        writer.Append("    public ").Append(quantity.Name)
            .AppendLine(" ToUnit(global::UnitsNetGen.UnitSystem unitSystem)");
        writer.AppendLine("    {");
        writer.AppendLine("        var unit = global::UnitsNetGen.QuantityOperations.GetUnit(unitSystem, Metadata);");
        ...
        writer.AppendLine("        global::UnitsNetGen.QuantityOperations.GetAbbreviation(unit, formatProvider, Metadata);");
        writer.AppendLine();
        ...
        writer.AppendLine("        global::UnitsNetGen.QuantityOperations.TryParseUnit(text, formatProvider, Metadata, out unit);");
        writer.AppendLine();
        ...
        writer.Append("        public global::UnitsNetGen.BaseDimensions BaseDimensions => ")
    ...
    private static void EmitBaseUnits(StringBuilder writer, BaseUnitsDefinition baseUnits)
    {
        ...
        {
            writer.Append("global::UnitsNetGen.BaseUnits.Undefined");
            return;
        }

        writer.Append("new global::UnitsNetGen.BaseUnits(");
