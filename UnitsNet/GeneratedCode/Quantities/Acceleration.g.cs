...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Acceleration()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, AccelerationUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, AccelerationUnit Unit), List<string>> Abbreviations { get; }
