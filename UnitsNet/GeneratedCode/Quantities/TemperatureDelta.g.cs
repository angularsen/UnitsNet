...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static TemperatureDelta()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, TemperatureDeltaUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, TemperatureDeltaUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(TemperatureDeltaUnit unit) => GetAbbreviation(unit, null);
