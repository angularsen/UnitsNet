...
namespace UnitsNet.Tests
{
    ...
    public partial class QuantityTests
    {
        ...
        public class Ctor
        {
            ...
            ///     UnitSystem is still experimental and this design will probably change at some point as we see problems with
            ///     ambiguity
...
#pragma warning restore 618
            ...
            ///     ways to implement this; either assume BaseUnit of unit is not specified or throw if quantity did not have unit
            ///     explicitly set.
            ///     Struct types do not allow custom default ctor implementations, so that exception would then be thrown when trying
            ///     to convert.
            /// </summary>
            [Fact]
