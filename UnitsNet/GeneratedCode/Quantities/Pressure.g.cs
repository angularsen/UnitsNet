...
namespace UnitsNet
{
    ...
    public partial struct Pressure : IQuantity<PressureUnit>, IEquatable<Pressure>, IComparable, IComparable<Pressure>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Pressure" /> instances.
        /// </summary>
        ...
        private double GetValueAs(PressureUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Pressure>(inBaseUnits.Unit, unit, out var conversionFunction))
