...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            ElectricChargeDensityUnit[] unitsOrderedByName = EnumHelper.GetValues<ElectricChargeDensityUnit>().OrderBy(x => x.ToString(), StringComparer.Ordinal).ToArray();
        ...
        {
            Assert.All(EnumHelper.GetValues<ElectricChargeDensityUnit>(), unit =>
            {
                var quantity = ElectricChargeDensity.From(1, unit);
                Assert.Equal(1, quantity.Value);
