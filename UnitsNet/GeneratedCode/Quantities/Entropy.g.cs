...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Entropy()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, EntropyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, EntropyUnit Unit), List<string>> Abbreviations { get; }
