...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return DoseAreaProduct.FromGraySquareMeters(absorbedDoseOfIonizingRadiation.Grays * area.SquareMeters);
        }
        ...
        {
            return As(unitKey.ToUnit<AbsorbedDoseOfIonizingRadiationUnit>());
        }
