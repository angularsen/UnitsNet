...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static AmountOfSubstance()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, AmountOfSubstanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, AmountOfSubstanceUnit Unit), List<string>> Abbreviations { get; }
