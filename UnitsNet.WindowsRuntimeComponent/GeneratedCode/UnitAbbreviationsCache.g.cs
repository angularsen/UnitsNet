    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.KilovoltPerHour, new string[]{"kV/h"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.KilovoltPerMinute, new string[]{"kV/min"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.KilovoltPerSecond, new string[]{"kV/s"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.MegavoltPerHour, new string[]{"MV/h"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.MegavoltPerMinute, new string[]{"MV/min"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.MegavoltPerSecond, new string[]{"MV/s"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.MicrovoltPerHour, new string[]{"µV/h"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.MicrovoltPerMinute, new string[]{"µV/min"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.MicrovoltPerSecond, new string[]{"µV/s"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.MillivoltPerHour, new string[]{"mV/h"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.MillivoltPerMinute, new string[]{"mV/min"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.MillivoltPerSecond, new string[]{"mV/s"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.VoltPerHour, new string[]{"V/h"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.VoltPerMinute, new string[]{"V/min"}),
                ("en-US", typeof(ElectricPotentialRateUnit), (int)ElectricPotentialRateUnit.VoltPerSecond, new string[]{"V/s"}),
