...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<EntropyUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.EntropyUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<EntropyUnit>(str, culture, out unit);
        }
