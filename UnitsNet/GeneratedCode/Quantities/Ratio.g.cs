...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public static string GetAbbreviation(RatioUnit unit, CultureInfo? culture)
        {
        ...
        /// <exception cref="ArgumentNullException">The value of 'str' cannot be null. </exception>
        /// <exception cref="UnitsNetException">Error parsing string.</exception>
        public static RatioUnit ParseUnit(string str, CultureInfo? culture)
        {
            return UnitsNetSetup.Default.UnitParser.Parse<RatioUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.RatioUnit)"/>
        ...
        /// </example>
        /// <param name="culture">The localization culture. Defaults to <see cref="CultureInfo.CurrentCulture" /> if null.</param>
        public static bool TryParseUnit([NotNullWhen(true)]string? str, CultureInfo? culture, out RatioUnit unit)
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<RatioUnit>(str, culture, out unit);
        }
