...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static TorquePerLength()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, TorquePerLengthUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, TorquePerLengthUnit Unit), List<string>> Abbreviations { get; }
