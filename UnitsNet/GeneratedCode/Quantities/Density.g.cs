...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Density()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, DensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, DensityUnit Unit), List<string>> Abbreviations { get; }
