...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricSurfaceChargeDensity.From(1.0, ElectricSurfaceChargeDensity.BaseUnit);
        ...
        {
            var inBaseUnit = ElectricSurfaceChargeDensity.From(1.0, ElectricSurfaceChargeDensity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricSurfaceChargeDensityUnit)));
        }
        ...
        {
            var quantity = ElectricSurfaceChargeDensity.FromCoulombsPerSquareMeter(1.0);
            Assert.Equal(ElectricSurfaceChargeDensity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
