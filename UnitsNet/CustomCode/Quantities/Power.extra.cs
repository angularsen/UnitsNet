...
namespace UnitsNet
{
    public partial struct Power
    {
        ...
        {
            return Energy.FromJoules(power.Watts.ToQuantityValue() * time.TotalSeconds);
        }
        ...
        {
            return Energy.FromJoules(power.Watts.ToQuantityValue() * duration.Seconds);
        }
        ...
        {
            return Force.FromNewtons(power.Watts.ToQuantityValue() / speed.MetersPerSecond);
        }
        ...
        {
            return Torque.FromNewtonMeters(power.Watts.ToQuantityValue() / rotationalSpeed.RadiansPerSecond);
        }
        ...
        {
            return RotationalSpeed.FromRadiansPerSecond(power.Watts.ToQuantityValue() / torque.NewtonMeters);
        }
        ...
        {
            return MassFlow.FromKilogramsPerSecond(bsfc.KilogramsPerJoule * power.Watts.ToQuantityValue());
        }
        ...
        {
            return SpecificEnergy.FromJoulesPerKilogram(power.Watts.ToQuantityValue() / massFlow.KilogramsPerSecond);
        }
        ...
        {
            return MassFlow.FromKilogramsPerSecond(power.Watts.ToQuantityValue() / specificEnergy.JoulesPerKilogram);
        }
        ...
        {
            return HeatFlux.FromWattsPerSquareMeter(power.Watts.ToQuantityValue() / area.SquareMeters);
        }
        ...
        {
            return Area.FromSquareMeters(power.Watts.ToQuantityValue() / heatFlux.WattsPerSquareMeter );
        }
        ...
        {
            return ElectricCurrent.FromAmperes(power.Watts.ToQuantityValue() / potential.Volts);
        }
        ...
        {
            return ElectricPotential.FromVolts(power.Watts.ToQuantityValue() / current.Amperes);
        }
    }
}
