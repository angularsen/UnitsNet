...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void Ctor_UnitSystem_ThrowsArgumentExceptionIfNotSupported()
        {
            ...
            Assert.Throws<ArgumentException>(() => new ApparentPower(value: 1, unitSystem: unsupportedUnitSystem));
        }
        ...
        {
            var baseUnitInfo = ApparentPower.Info.BaseUnitInfo;
        ...
        public virtual void As_UnitSystem_SI_ReturnsQuantityInSIUnits()
        {
            ...
            var expectedValue = quantity.As(ApparentPower.Info.GetDefaultUnit(UnitSystem.SI));
        ...
        {
            var quantity = new ApparentPower(value: 1, unit: ApparentPower.BaseUnit);
            var expectedUnit = ApparentPower.Info.GetDefaultUnit(UnitSystem.SI);
            var expectedValue = quantity.As(expectedUnit);

            Assert.Multiple(() =>
            {
                ApparentPower quantityToConvert = quantity;

                ApparentPower convertedQuantity = quantityToConvert.ToUnit(UnitSystem.SI);

                Assert.Equal(expectedUnit, convertedQuantity.Unit);
                Assert.Equal(expectedValue, convertedQuantity.Value);
            }, () =>
            {
                IQuantity<ApparentPowerUnit> quantityToConvert = quantity;

                IQuantity<ApparentPowerUnit> convertedQuantity = quantityToConvert.ToUnit(UnitSystem.SI);
        ...
        public void ToUnit_UnitSystem_ThrowsArgumentNullExceptionIfNull()
        {
            ...
            {
                IQuantity<ApparentPowerUnit> quantity = new ApparentPower(value: 1, unit: ApparentPower.BaseUnit);
                Assert.Throws<ArgumentNullException>(() => quantity.ToUnit(nullUnitSystem));
            }, () =>
            {
                IQuantity quantity = new ApparentPower(value: 1, unit: ApparentPower.BaseUnit);
                Assert.Throws<ArgumentNullException>(() => quantity.ToUnit(nullUnitSystem));
            });
        }
