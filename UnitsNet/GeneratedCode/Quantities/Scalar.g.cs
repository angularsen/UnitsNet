...
namespace UnitsNet
{
    ...
    public partial struct Scalar : IQuantity<ScalarUnit>, IEquatable<Scalar>, IComparable, IComparable<Scalar>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Scalar" /> instances.
        /// </summary>
        ...
        internal Scalar ToBaseUnit()
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Scalar>(Unit, BaseUnit, out var conversionFunction))
