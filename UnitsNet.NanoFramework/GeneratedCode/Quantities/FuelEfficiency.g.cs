...
namespace UnitsNet
{
    ...
    public struct  FuelEfficiency
    {
        ...
        /// <summary>
        ///     Gets this <see cref="FuelEfficiency"/> converted into <see cref="FuelEfficiencyUnit.KilometerPerLiter">KilometersPerLiters</see> as a <see cref="double"/>.
        /// </summary>
        [Obsolete("Use the ToKilometersPerLiters property.")]
        public double KilometersPerLiters => As(FuelEfficiencyUnit.KilometerPerLiter);

        /// <summary>
        ///     Gets this <see cref="FuelEfficiency"/> converted into <see cref="FuelEfficiencyUnit.LiterPer100Kilometers">LitersPer100Kilometers</see> as a <see cref="double"/>.
        /// </summary>
        ...
        /// <summary>
        ///     Gets this <see cref="FuelEfficiency"/> converted into <see cref="FuelEfficiencyUnit.MilePerUkGallon">MilesPerUkGallon</see> as a <see cref="double"/>.
        /// </summary>
        [Obsolete("Use the ToMilesPerUkGallon property.")]
        public double MilesPerUkGallon => As(FuelEfficiencyUnit.MilePerUkGallon);

        /// <summary>
        ///     Gets this <see cref="FuelEfficiency"/> converted into <see cref="FuelEfficiencyUnit.MilePerUsGallon">MilesPerUsGallon</see> as a <see cref="double"/>.
        /// </summary>
        [Obsolete("Use the ToMilesPerUsGallon property.")]
        public double MilesPerUsGallon => As(FuelEfficiencyUnit.MilePerUsGallon);

        /// <summary>
        ///     Gets this <see cref="FuelEfficiency"/> converted into <see cref="FuelEfficiencyUnit.KilometerPerLiter">KilometersPerLiters</see>.
        /// </summary>
        public FuelEfficiency ToKilometersPerLiters => ToUnit(FuelEfficiencyUnit.KilometerPerLiter);

        /// <summary>
        ///     Gets this <see cref="FuelEfficiency"/> converted into <see cref="FuelEfficiencyUnit.LiterPer100Kilometers">LitersPer100Kilometers</see>.
        /// </summary>
        public FuelEfficiency ToLitersPer100Kilometers => ToUnit(FuelEfficiencyUnit.LiterPer100Kilometers);

        /// <summary>
        ///     Gets this <see cref="FuelEfficiency"/> converted into <see cref="FuelEfficiencyUnit.MilePerUkGallon">MilesPerUkGallon</see>.
        /// </summary>
        public FuelEfficiency ToMilesPerUkGallon => ToUnit(FuelEfficiencyUnit.MilePerUkGallon);

        /// <summary>
        ///     Gets this <see cref="FuelEfficiency"/> converted into <see cref="FuelEfficiencyUnit.MilePerUsGallon">MilesPerUsGallon</see>.
        /// </summary>
