...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<ElectricReactanceUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.ElectricReactanceUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<ElectricReactanceUnit>(str, culture, out unit);
        }
