...
namespace UnitsNet
{
    ...
    public partial struct HeatTransferCoefficient : IQuantity<HeatTransferCoefficientUnit>, IEquatable<HeatTransferCoefficient>, IComparable, IComparable<HeatTransferCoefficient>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="HeatTransferCoefficientUnit.BtuPerSquareFootDegreeFahrenheit"/>
        /// </summary>
        public QuantityValue BtusPerSquareFootDegreeFahrenheit => As(HeatTransferCoefficientUnit.BtuPerSquareFootDegreeFahrenheit);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="HeatTransferCoefficientUnit.WattPerSquareMeterCelsius"/>
        /// </summary>
        public QuantityValue WattsPerSquareMeterCelsius => As(HeatTransferCoefficientUnit.WattPerSquareMeterCelsius);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="HeatTransferCoefficientUnit.WattPerSquareMeterKelvin"/>
        /// </summary>
        ...
        /// <remarks>Consider using <see cref="Equals(HeatTransferCoefficient, QuantityValue, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(HeatTransferCoefficient left, HeatTransferCoefficient right)
        {
        ...
        public bool Equals(HeatTransferCoefficient other, QuantityValue tolerance, ComparisonType comparisonType)
        {
            if (tolerance < 0)
        ...
        public HeatTransferCoefficient ToUnit(HeatTransferCoefficientUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (Enum.IsDefined(typeof(HeatTransferCoefficientUnit), unit))
            {
