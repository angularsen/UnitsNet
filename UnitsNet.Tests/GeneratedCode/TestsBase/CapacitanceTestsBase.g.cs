...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void Ctor_UnitSystem_ThrowsArgumentExceptionIfNotSupported()
        {
            ...
            Assert.Throws<ArgumentException>(() => new Capacitance(value: 1, unitSystem: unsupportedUnitSystem));
        }
        ...
        {
            var baseUnitInfo = Capacitance.Info.BaseUnitInfo;
        ...
        public virtual void As_UnitSystem_SI_ReturnsQuantityInSIUnits()
        {
            ...
            var expectedValue = quantity.As(Capacitance.Info.GetDefaultUnit(UnitSystem.SI));
        ...
        {
            var quantity = new Capacitance(value: 1, unit: Capacitance.BaseUnit);
            var expectedUnit = Capacitance.Info.GetDefaultUnit(UnitSystem.SI);
            var expectedValue = quantity.As(expectedUnit);

            Assert.Multiple(() =>
            {
                Capacitance quantityToConvert = quantity;

                Capacitance convertedQuantity = quantityToConvert.ToUnit(UnitSystem.SI);

                Assert.Equal(expectedUnit, convertedQuantity.Unit);
                Assert.Equal(expectedValue, convertedQuantity.Value);
            }, () =>
            {
                IQuantity<CapacitanceUnit> quantityToConvert = quantity;

                IQuantity<CapacitanceUnit> convertedQuantity = quantityToConvert.ToUnit(UnitSystem.SI);
        ...
        public void ToUnit_UnitSystem_ThrowsArgumentNullExceptionIfNull()
        {
            ...
            {
                IQuantity<CapacitanceUnit> quantity = new Capacitance(value: 1, unit: Capacitance.BaseUnit);
                Assert.Throws<ArgumentNullException>(() => quantity.ToUnit(nullUnitSystem));
            }, () =>
            {
                IQuantity quantity = new Capacitance(value: 1, unit: Capacitance.BaseUnit);
                Assert.Throws<ArgumentNullException>(() => quantity.ToUnit(nullUnitSystem));
            });
        }
