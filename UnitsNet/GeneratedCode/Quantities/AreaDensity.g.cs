...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<AreaDensityUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.AreaDensityUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<AreaDensityUnit>(str, culture, out unit);
        }
