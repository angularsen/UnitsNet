...
namespace UnitsNet
{
    ...
    public partial struct AreaDensity : IQuantity<AreaDensityUnit>, IEquatable<AreaDensity>, IComparable, IComparable<AreaDensity>, IConvertible
    {
        ...
        public AreaDensity(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static AreaDensityUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static AreaDensityUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
