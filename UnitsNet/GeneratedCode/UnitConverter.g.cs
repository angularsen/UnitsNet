...
namespace UnitsNet
{
    public sealed partial class UnitConverter
    {
        ...
        public static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<Radioactivity>(Radioactivity.BaseUnit, Radioactivity.BaseUnit, q => q);
            unitConverter.SetConversionFunction<Radioactivity>(Radioactivity.BaseUnit, RadioactivityUnit.Curie, q => q.ToUnit(RadioactivityUnit.Curie));
            unitConverter.SetConversionFunction<Radioactivity>(RadioactivityUnit.Curie, Radioactivity.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Radioactivity>(Radioactivity.BaseUnit, RadioactivityUnit.Gigabecquerel, q => q.ToUnit(RadioactivityUnit.Gigabecquerel));
            unitConverter.SetConversionFunction<Radioactivity>(RadioactivityUnit.Gigabecquerel, Radioactivity.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Radioactivity>(Radioactivity.BaseUnit, RadioactivityUnit.Kilobecquerel, q => q.ToUnit(RadioactivityUnit.Kilobecquerel));
            unitConverter.SetConversionFunction<Radioactivity>(RadioactivityUnit.Kilobecquerel, Radioactivity.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Radioactivity>(Radioactivity.BaseUnit, RadioactivityUnit.Megabecquerel, q => q.ToUnit(RadioactivityUnit.Megabecquerel));
            unitConverter.SetConversionFunction<Radioactivity>(RadioactivityUnit.Megabecquerel, Radioactivity.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Radioactivity>(Radioactivity.BaseUnit, RadioactivityUnit.Microcurie, q => q.ToUnit(RadioactivityUnit.Microcurie));
            unitConverter.SetConversionFunction<Radioactivity>(RadioactivityUnit.Microcurie, Radioactivity.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Radioactivity>(Radioactivity.BaseUnit, RadioactivityUnit.Millicurie, q => q.ToUnit(RadioactivityUnit.Millicurie));
            unitConverter.SetConversionFunction<Radioactivity>(RadioactivityUnit.Millicurie, Radioactivity.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Radioactivity>(Radioactivity.BaseUnit, RadioactivityUnit.Terabecquerel, q => q.ToUnit(RadioactivityUnit.Terabecquerel));
            unitConverter.SetConversionFunction<Radioactivity>(RadioactivityUnit.Terabecquerel, Radioactivity.BaseUnit, q => q.ToBaseUnit());
