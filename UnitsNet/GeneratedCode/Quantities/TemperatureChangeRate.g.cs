...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static TemperatureChangeRate()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, TemperatureChangeRateUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, TemperatureChangeRateUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(TemperatureChangeRateUnit unit) => GetAbbreviation(unit, null);
