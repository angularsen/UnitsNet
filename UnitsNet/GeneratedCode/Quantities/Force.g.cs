...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Force()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ForceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ForceUnit Unit), List<string>> Abbreviations { get; }
