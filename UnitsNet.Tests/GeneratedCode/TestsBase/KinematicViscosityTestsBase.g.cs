...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = KinematicViscosity.From(1.0, KinematicViscosity.BaseUnit);
        ...
        {
            var inBaseUnit = KinematicViscosity.From(1.0, KinematicViscosity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(KinematicViscosityUnit)));
        }
        ...
        {
            var quantity = KinematicViscosity.FromSquareMetersPerSecond(1.0);
            Assert.Equal(KinematicViscosity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
