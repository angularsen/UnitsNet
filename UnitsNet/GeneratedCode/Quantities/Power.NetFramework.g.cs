...
namespace UnitsNet
{
    ...
    public partial struct Power : IQuantity<PowerUnit>, IEquatable<Power>, IComparable, IComparable<Power>, IConvertible
    {
        ...
        public Power(decimal numericValue, BaseUnits baseUnits)
        {
        ...
        public static PowerUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static PowerUnit GetUnitFor(BaseUnits baseUnits)
        {
