...
namespace UnitsNet
{
    ...
    public partial struct ApparentPower : IQuantity<ApparentPowerUnit>, IComparable, IComparable<ApparentPower>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ApparentPowerUnit>)this).As(unitAsApparentPowerUnit);
        }
        ...
        /// <summary>
        ///     Converts this ApparentPower to another ApparentPower with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ApparentPower with the specified unit.</returns>
        public QuantityValue ToQuantity(ApparentPowerUnit unit)
        {
