...
namespace UnitsNet
{
    ...
    public partial struct ElectricField : IQuantity<ElectricFieldUnit>, IComparable, IComparable<ElectricField>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Converts this ElectricField to another ElectricField with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ElectricField with the specified unit.</returns>
        public QuantityValue ToQuantity(ElectricFieldUnit unit)
        {
