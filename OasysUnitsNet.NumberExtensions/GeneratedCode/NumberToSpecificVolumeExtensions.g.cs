...
namespace OasysUnitsNet.NumberExtensions.NumberToSpecificVolume
{
    /// <summary>
    ...
    {
        /// <inheritdoc cref="SpecificVolume.FromCubicFeetPerPound(OasysUnitsNet.QuantityValue)" />
        public static SpecificVolume CubicFeetPerPound<T>(this T value) =>
            SpecificVolume.FromCubicFeetPerPound(Convert.ToDouble(value));

        /// <inheritdoc cref="SpecificVolume.FromCubicMetersPerKilogram(OasysUnitsNet.QuantityValue)" />
        ...
        /// <inheritdoc cref="SpecificVolume.FromMillicubicMetersPerKilogram(OasysUnitsNet.QuantityValue)" />
