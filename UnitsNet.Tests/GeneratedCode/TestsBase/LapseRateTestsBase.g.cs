...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = LapseRate.From(1.0, LapseRate.BaseUnit);
        ...
        {
            var inBaseUnit = LapseRate.From(1.0, LapseRate.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(LapseRateUnit)));
        }
        ...
        {
            var quantity = LapseRate.FromDegreesCelciusPerKilometer(1.0);
            Assert.Equal(LapseRate.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
