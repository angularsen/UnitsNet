...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static RatioChangeRate()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, RatioChangeRateUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, RatioChangeRateUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(RatioChangeRateUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(RatioChangeRateUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.RatioChangeRate";
                var resourceManager = new ResourceManager(resourceName, typeof(RatioChangeRate).Assembly);
