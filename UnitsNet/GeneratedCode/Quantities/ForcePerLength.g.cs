    ...
    public partial struct ForcePerLength : IQuantity<ForcePerLengthUnit>, IEquatable<ForcePerLength>, IComparable, IComparable<ForcePerLength>, IConvertible, IFormattable
    {
        ...
        private double GetValueInBaseUnit()
        {
            switch(Unit)
            {
                ...
                case ForcePerLengthUnit.PoundForcePerFoot: return _value*14.5939;
                case ForcePerLengthUnit.PoundForcePerInch: return _value*175.1268;
                default:
        ...
        private double GetValueAs(ForcePerLengthUnit unit)
        {
            ...
            switch(unit)
            {
                ...
                case ForcePerLengthUnit.PoundForcePerFoot: return baseUnitValue/14.5939;
                case ForcePerLengthUnit.PoundForcePerInch: return baseUnitValue/175.1268;
                default:
