...
namespace UnitsNet
{
    ...
    /// </summary>
    public partial struct ReactivePower : IQuantity<ReactivePowerUnit>, IEquatable<ReactivePower>, IComparable, IComparable<ReactivePower>, IConvertible
    {
        /// <summary>
        ...
        public static ReactivePowerUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static ReactivePowerUnit GetUnitFor(BaseUnits baseUnits)
        {
