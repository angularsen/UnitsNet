...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricPotentialChangeRate()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricPotentialChangeRateUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricPotentialChangeRateUnit Unit), List<string>> Abbreviations { get; }
