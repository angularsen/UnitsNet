...
namespace UnitsNet
{
    ...
    public partial struct ElectricCurrent : IQuantity<ElectricCurrentUnit>, IEquatable<ElectricCurrent>, IComparable, IComparable<ElectricCurrent>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ElectricCurrent" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<ElectricCurrent>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(ElectricCurrentUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ElectricCurrent>(inBaseUnits.Unit, unit, out var conversionFunction))
