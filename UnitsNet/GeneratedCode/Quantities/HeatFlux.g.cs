...
namespace UnitsNet
{
    ...
    public partial struct HeatFlux : IQuantity<HeatFluxUnit>, IComparable, IComparable<HeatFlux>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<HeatFluxUnit>)this).As(unitAsHeatFluxUnit);
        }
        ...
        /// <summary>
        ///     Converts this HeatFlux to another HeatFlux with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A HeatFlux with the specified unit.</returns>
        public QuantityValue ToQuantity(HeatFluxUnit unit)
        {
