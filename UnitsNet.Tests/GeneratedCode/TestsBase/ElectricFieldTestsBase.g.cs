...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricField.From(1.0, ElectricField.BaseUnit);
        ...
        {
            var inBaseUnit = ElectricField.From(1.0, ElectricField.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricFieldUnit)));
        }
        ...
        {
            var quantity = ElectricField.FromVoltsPerMeter(1.0);
            Assert.Equal(ElectricField.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
