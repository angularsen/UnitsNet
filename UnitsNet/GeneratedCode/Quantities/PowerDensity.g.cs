...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static PowerDensity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, PowerDensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, PowerDensityUnit Unit), List<string>> Abbreviations { get; }
