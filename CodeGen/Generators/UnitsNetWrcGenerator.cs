...
using System.IO;
using System.Linq;
using CodeGen.Generators.OasysUnitsWrcGen;
...
{
    /// <summary>
    ///     Code generator for OasysUnits.WindowsRuntimeComponent project.
    /// </summary>
    internal static class OasysUnitsWrcGenerator
    {
        ...
        ///         <item>
        ///             <description>
        ///                 OasysUnits.WindowsRuntimeComponent/GeneratedCode (quantity and unit types, Quantity,
        ...
        {
            var outputDir = $"{rootDir}/OasysUnits.WindowsRuntimeComponent/GeneratedCode";
