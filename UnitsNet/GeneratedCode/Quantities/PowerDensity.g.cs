...
namespace UnitsNet
{
    ...
    public partial struct PowerDensity : IQuantity<PowerDensityUnit>, IEquatable<PowerDensity>, IComparable, IComparable<PowerDensity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="PowerDensity" /> instances.
        /// </summary>
        ...
        public PowerDensity ToUnit(PowerDensityUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<PowerDensity>(inBaseUnits.Unit, unit, out var conversionFunction))
