...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Duration()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, DurationUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, DurationUnit Unit), List<string>> Abbreviations { get; }
