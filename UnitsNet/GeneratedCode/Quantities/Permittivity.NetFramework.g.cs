...
namespace UnitsNet
{
    ...
    /// </remarks>
    public partial struct Permittivity : IQuantity<PermittivityUnit>, IEquatable<Permittivity>, IComparable, IComparable<Permittivity>, IConvertible
    {
        /// <summary>
        ...
        public static PermittivityUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static PermittivityUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
