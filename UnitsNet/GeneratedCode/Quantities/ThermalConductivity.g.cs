...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ThermalConductivity()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, ThermalConductivityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, ThermalConductivityUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(ThermalConductivityUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(ThermalConductivityUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.ThermalConductivity";
                var resourceManager = new ResourceManager(resourceName, typeof(ThermalConductivity).Assembly);
