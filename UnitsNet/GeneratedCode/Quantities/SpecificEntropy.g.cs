...
namespace UnitsNet
{
    ...
    public partial struct SpecificEntropy : IQuantity<SpecificEntropyUnit>, IEquatable<SpecificEntropy>, IComparable, IComparable<SpecificEntropy>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="SpecificEntropy" /> instances.
        /// </summary>
        ...
        private double GetValueAs(SpecificEntropyUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<SpecificEntropy>(inBaseUnits.Unit, unit, out var conversionFunction))
