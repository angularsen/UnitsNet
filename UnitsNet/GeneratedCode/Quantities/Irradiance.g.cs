...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Irradiance()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, IrradianceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, IrradianceUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(IrradianceUnit unit) => GetAbbreviation(unit, null);
