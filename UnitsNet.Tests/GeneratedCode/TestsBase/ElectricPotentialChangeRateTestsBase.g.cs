...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricPotentialChangeRate.From(1.0, ElectricPotentialChangeRate.BaseUnit);
        ...
        {
            var inBaseUnit = ElectricPotentialChangeRate.From(1.0, ElectricPotentialChangeRate.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricPotentialChangeRateUnit)));
        }
        ...
        {
            var quantity = ElectricPotentialChangeRate.FromVoltsPerSeconds(1.0);
            Assert.Equal(ElectricPotentialChangeRate.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
