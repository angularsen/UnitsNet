...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<DensityUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.DensityUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<DensityUnit>(str, culture, out unit);
        }
