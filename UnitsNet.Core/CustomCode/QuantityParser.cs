...
namespace UnitsNet
{
    ...
    internal class QuantityParser
    {
        ...
        internal bool TryParse(string? str,
            IFormatProvider? formatProvider,
            Type unitType,
            IEnumerable<string> unitAbbreviations,
        ...
        private static string GetRegexPatternForUnitAbbreviations(IEnumerable<string> unitAbbreviations, bool matchEntireString)
        {
        ...
        {
            IReadOnlyList<string> unitAbbreviations = _unitAbbreviationsCache.GetAllUnitAbbreviationsForQuantity(typeof(TUnitType), formatProvider);
        ...
        private static Regex CreateRegexForUnitAbbreviations(IEnumerable<string> unitAbbreviations)
        {
            var pattern = GetRegexPatternForUnitAbbreviations(unitAbbreviations);
            return new Regex(pattern, RegexOptions.Singleline | RegexOptions.IgnoreCase);
        }
