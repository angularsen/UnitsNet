...
namespace UnitsNet
{
    ...
    public readonly partial struct Information : IQuantity<InformationUnit>, IDecimalQuantity, IEquatable<Information>, IComparable, IComparable<Information>, IConvertible, IFormattable
    {
        ...
        /// <remarks>Consider using <see cref="Equals(Information, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
