...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static PorousMediumPermeability()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, PorousMediumPermeabilityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, PorousMediumPermeabilityUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(PorousMediumPermeabilityUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(PorousMediumPermeabilityUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.PorousMediumPermeability";
                var resourceManager = new ResourceManager(resourceName, typeof(PorousMediumPermeability).Assembly);
