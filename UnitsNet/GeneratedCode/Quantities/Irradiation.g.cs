...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Irradiation()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, IrradiationUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, IrradiationUnit Unit), List<string>> Abbreviations { get; }
