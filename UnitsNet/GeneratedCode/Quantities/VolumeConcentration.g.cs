...
namespace UnitsNet
{
    ...
    public partial struct VolumeConcentration : IQuantity<VolumeConcentrationUnit>, IEquatable<VolumeConcentration>, IComparable, IComparable<VolumeConcentration>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="VolumeConcentration" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<VolumeConcentration>(Unit, BaseUnit, out var conversionFunction))
