...
namespace UnitsNet
{
    ...
    public partial struct Density : IQuantity<DensityUnit>, IComparable, IComparable<Density>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<DensityUnit>)this).As(unitAsDensityUnit);
        }
        ...
        /// <summary>
        ///     Converts this Density to another Density with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A Density with the specified unit.</returns>
        public QuantityValue ToQuantity(DensityUnit unit)
        {
