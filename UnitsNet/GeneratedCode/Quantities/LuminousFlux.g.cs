...
namespace UnitsNet
{
    ...
    public partial struct LuminousFlux : IQuantity<LuminousFluxUnit>, IEquatable<LuminousFlux>, IComparable, IComparable<LuminousFlux>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="LuminousFluxUnit.Lumen"/>
        /// </summary>
        ...
        /// <remarks>Consider using <see cref="Equals(LuminousFlux, QuantityValue, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(LuminousFlux left, LuminousFlux right)
        {
        ...
        public bool Equals(LuminousFlux other, QuantityValue tolerance, ComparisonType comparisonType)
        {
            if (tolerance < 0)
        ...
        public LuminousFlux ToUnit(LuminousFluxUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (Enum.IsDefined(typeof(LuminousFluxUnit), unit))
            {
