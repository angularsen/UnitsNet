...
namespace UnitsNet
{
    ...
    public partial struct Speed : IQuantity<SpeedUnit>, IEquatable<Speed>, IComparable, IComparable<Speed>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Speed" /> instances.
        /// </summary>
        ...
        internal Speed ToBaseUnit()
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Speed>(Unit, BaseUnit, out var conversionFunction))
