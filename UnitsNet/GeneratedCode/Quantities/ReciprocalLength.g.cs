...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ReciprocalLength()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ReciprocalLengthUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ReciprocalLengthUnit Unit), List<string>> Abbreviations { get; }
