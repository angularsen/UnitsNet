...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static HeatTransferCoefficient()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, HeatTransferCoefficientUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, HeatTransferCoefficientUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(HeatTransferCoefficientUnit unit) => GetAbbreviation(unit, null);
