...
namespace UnitsNet
{
    ...
    public partial struct ElectricField : IQuantity<ElectricFieldUnit>, IEquatable<ElectricField>, IComparable, IComparable<ElectricField>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="ElectricField"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="ElectricField"/> from.</param>
        public static implicit operator ElectricField(ValueTuple<QuantityValue, ElectricFieldUnit> tuple) => new ElectricField((double)tuple.Item1, tuple.Item2);
