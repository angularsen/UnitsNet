    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(ForceChangeRateUnit), (int)ForceChangeRateUnit.DecapoundForcePerMinute, new string[]{"dalbf/min"}),
                ("en-US", typeof(ForceChangeRateUnit), (int)ForceChangeRateUnit.DecapoundForcePerSecond, new string[]{"dalbf/s"}),
                ...
                ("en-US", typeof(ForceChangeRateUnit), (int)ForceChangeRateUnit.KilopoundForcePerMinute, new string[]{"klbf/min"}),
                ("en-US", typeof(ForceChangeRateUnit), (int)ForceChangeRateUnit.KilopoundForcePerSecond, new string[]{"klbf/s"}),
                ...
                ("en-US", typeof(PressureUnit), (int)PressureUnit.KilopoundForcePerSquareInch, new string[]{"kipf/in²", "ksi"}),
                ("ru-RU", typeof(PressureUnit), (int)PressureUnit.KilopoundForcePerSquareInch, new string[]{"kipf/in²", "ksi"}),
                ...
                ("en-US", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.KilopoundForcePerSquareInchPerMinute, new string[]{"kipf/in²/min", "ksi/min"}),
                ("ru-RU", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.KilopoundForcePerSquareInchPerMinute, new string[]{"kipf/in²/мин", "ksi/мин"}),
                ("en-US", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.KilopoundForcePerSquareInchPerSecond, new string[]{"kipf/in²/s", "ksi/s"}),
                ("ru-RU", typeof(PressureChangeRateUnit), (int)PressureChangeRateUnit.KilopoundForcePerSquareInchPerSecond, new string[]{"kipf/in²/с", "ksi/с"}),
