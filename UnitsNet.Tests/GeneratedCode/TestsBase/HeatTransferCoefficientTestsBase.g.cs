...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        [InlineData("en-US", "4.2 Btu/(hr·in²·°F)", HeatTransferCoefficientUnit.BtuPerSecondSquareInchDegreeFahrenheit, 4.2)]
        [InlineData("en-US", "4.2 Btu/(in²·hr·°F)", HeatTransferCoefficientUnit.BtuPerSecondSquareInchDegreeFahrenheit, 4.2)]
        ...
        [InlineData("Btu/(hr·in²·°F)", HeatTransferCoefficientUnit.BtuPerSecondSquareInchDegreeFahrenheit)]
        [InlineData("Btu/(in²·hr·°F)", HeatTransferCoefficientUnit.BtuPerSecondSquareInchDegreeFahrenheit)]
        ...
        [InlineData("en-US", "Btu/(hr·in²·°F)", HeatTransferCoefficientUnit.BtuPerSecondSquareInchDegreeFahrenheit)]
        [InlineData("en-US", "Btu/(in²·hr·°F)", HeatTransferCoefficientUnit.BtuPerSecondSquareInchDegreeFahrenheit)]
