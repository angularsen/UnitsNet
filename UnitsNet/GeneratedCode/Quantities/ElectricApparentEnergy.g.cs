...
namespace UnitsNet
{
    ...
    public readonly partial struct ElectricApparentEnergy :
        IArithmeticQuantity<ElectricApparentEnergy, ElectricApparentEnergyUnit, double>,
        IComparable,
        ...
        IFormattable
    {
        ...
        /// <inheritdoc />
        [Obsolete("This property will be removed in the next major release. Consider using ElectricApparentEnergy.BaseDimensions instead.")]
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricApparentEnergy FromKilovoltampereHours(QuantityValue kilovoltamperehours)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricApparentEnergy FromMegavoltampereHours(QuantityValue megavoltamperehours)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ElectricApparentEnergy FromVoltampereHours(QuantityValue voltamperehours)
        {
        ...
        {
            return new ElectricApparentEnergy((double)value, fromUnit);
        }
        ...
        ///     Length.Parse("5.5 m", CultureInfo.GetCultureInfo("en-US"));
        /// </example>
        public static bool TryParse(string? str, out ElectricApparentEnergy result)
        {
        ...
        /// </example>
        /// <param name="provider">Format to use when parsing number and unit. Defaults to <see cref="CultureInfo.CurrentCulture" /> if null.</param>
        public static bool TryParse(string? str, IFormatProvider? provider, out ElectricApparentEnergy result)
        {
        ...
        public static bool TryParseUnit(string str, out ElectricApparentEnergyUnit unit)
        {
        ...
        /// </example>
        /// <param name="provider">Format to use when parsing number and unit. Defaults to <see cref="CultureInfo.CurrentCulture" /> if null.</param>
        public static bool TryParseUnit(string str, IFormatProvider? provider, out ElectricApparentEnergyUnit unit)
        {
