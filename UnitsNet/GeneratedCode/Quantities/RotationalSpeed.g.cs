        ...
        IFormattable
    {
        ...
        private bool TryToUnit(RotationalSpeedUnit unit, [NotNullWhen(true)] out RotationalSpeed? converted)
        {
            ...
            RotationalSpeed? convertedOrNull = (Unit, unit) switch
            {
                ...
                (RotationalSpeedUnit.MillirevolutionPerMinute, RotationalSpeedUnit.RadianPerSecond) => new RotationalSpeed((_value * 2 * Math.PI) / 60000, RotationalSpeedUnit.RadianPerSecond),
                ...
                (RotationalSpeedUnit.RadianPerSecond, RotationalSpeedUnit.MillirevolutionPerMinute) => new RotationalSpeed((_value / (2 * Math.PI)) * 60000, RotationalSpeedUnit.MillirevolutionPerMinute),
