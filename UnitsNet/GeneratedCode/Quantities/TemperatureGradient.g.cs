...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static TemperatureGradient()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, TemperatureGradientUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, TemperatureGradientUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(TemperatureGradientUnit unit) => GetAbbreviation(unit, null);
        ...
        [Obsolete("For null checks, use `x is null` syntax to not invoke overloads. For quantity comparisons, use Equals(TemperatureGradient, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator ==(TemperatureGradient left, TemperatureGradient right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(TemperatureGradient, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("For null checks, use `x is not null` syntax to not invoke overloads. For quantity comparisons, use Equals(TemperatureGradient, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator !=(TemperatureGradient left, TemperatureGradient right)
        {
            return !(left == right);
        }
        ...
        /// <summary>Indicates strict equality of two <see cref="TemperatureGradient"/> quantities, where both <see cref="Value" /> and <see cref="Unit" /> are exactly equal.</summary>
        /// <remarks>Consider using <see cref="Equals(TemperatureGradient, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("Consider using Equals(TemperatureGradient, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
