...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MassMomentOfInertia()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MassMomentOfInertiaUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MassMomentOfInertiaUnit Unit), List<string>> Abbreviations { get; }
