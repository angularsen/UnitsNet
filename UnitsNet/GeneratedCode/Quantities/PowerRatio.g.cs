...
namespace UnitsNet
{
    ...
    public partial struct PowerRatio : IQuantity<PowerRatioUnit>, IEquatable<PowerRatio>, IComparable, IComparable<PowerRatio>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="PowerRatio" /> instances.
        /// </summary>
        ...
        private double GetValueAs(PowerRatioUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<PowerRatio>(inBaseUnits.Unit, unit, out var conversionFunction))
