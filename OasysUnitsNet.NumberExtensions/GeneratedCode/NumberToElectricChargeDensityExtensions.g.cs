...
namespace OasysUnitsNet.NumberExtensions.NumberToElectricChargeDensity
{
    /// <summary>
    ...
    {
        /// <inheritdoc cref="ElectricChargeDensity.FromCoulombsPerCubicMeter(OasysUnitsNet.QuantityValue)" />
