...
namespace UnitsNet
{
    ...
    public partial struct ReactiveEnergy : IQuantity<ReactiveEnergyUnit>, IEquatable<ReactiveEnergy>, IComparable, IComparable<ReactiveEnergy>, IConvertible
    {
        ...
        public ReactiveEnergy(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static ReactiveEnergyUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static ReactiveEnergyUnit GetUnitFor(BaseUnits baseUnits)
        {
