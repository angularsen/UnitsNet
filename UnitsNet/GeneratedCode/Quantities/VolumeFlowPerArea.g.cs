...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static VolumeFlowPerArea()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, VolumeFlowPerAreaUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, VolumeFlowPerAreaUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(VolumeFlowPerAreaUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(VolumeFlowPerAreaUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.VolumeFlowPerArea";
                var resourceManager = new ResourceManager(resourceName, typeof(VolumeFlowPerArea).Assembly);
