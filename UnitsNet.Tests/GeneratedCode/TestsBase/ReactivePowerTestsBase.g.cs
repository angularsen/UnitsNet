...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void Ctor_UnitSystem_ThrowsArgumentExceptionIfNotSupported()
        {
            ...
            Assert.Throws<ArgumentException>(() => new ReactivePower(value: 1, unitSystem: unsupportedUnitSystem));
        }
        ...
        {
            var baseUnitInfo = ReactivePower.Info.BaseUnitInfo;
        ...
        public virtual void As_UnitSystem_SI_ReturnsQuantityInSIUnits()
        {
            ...
            var expectedValue = quantity.As(ReactivePower.Info.GetDefaultUnit(UnitSystem.SI));
        ...
        {
            var quantity = new ReactivePower(value: 1, unit: ReactivePower.BaseUnit);
            var expectedUnit = ReactivePower.Info.GetDefaultUnit(UnitSystem.SI);
            var expectedValue = quantity.As(expectedUnit);

            Assert.Multiple(() =>
            {
                ReactivePower quantityToConvert = quantity;

                ReactivePower convertedQuantity = quantityToConvert.ToUnit(UnitSystem.SI);

                Assert.Equal(expectedUnit, convertedQuantity.Unit);
                Assert.Equal(expectedValue, convertedQuantity.Value);
            }, () =>
            {
                IQuantity<ReactivePowerUnit> quantityToConvert = quantity;

                IQuantity<ReactivePowerUnit> convertedQuantity = quantityToConvert.ToUnit(UnitSystem.SI);
        ...
        public void ToUnit_UnitSystem_ThrowsArgumentNullExceptionIfNull()
        {
            ...
            {
                IQuantity<ReactivePowerUnit> quantity = new ReactivePower(value: 1, unit: ReactivePower.BaseUnit);
                Assert.Throws<ArgumentNullException>(() => quantity.ToUnit(nullUnitSystem));
            }, () =>
            {
                IQuantity quantity = new ReactivePower(value: 1, unit: ReactivePower.BaseUnit);
                Assert.Throws<ArgumentNullException>(() => quantity.ToUnit(nullUnitSystem));
            });
        }
