...
namespace UnitsNet
{
    ...
    public partial struct ForcePerLength : IQuantity<ForcePerLengthUnit>, IEquatable<ForcePerLength>, IComparable, IComparable<ForcePerLength>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ForcePerLength" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<ForcePerLength>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(ForcePerLengthUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ForcePerLength>(inBaseUnits.Unit, unit, out var conversionFunction))
