...
namespace UnitsNet
{
    ...
    public partial struct Permeability : IQuantity<PermeabilityUnit>, IEquatable<Permeability>, IComparable, IComparable<Permeability>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Permeability" /> instances.
        /// </summary>
        ...
        private double GetValueAs(PermeabilityUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Permeability>(inBaseUnits.Unit, unit, out var conversionFunction))
