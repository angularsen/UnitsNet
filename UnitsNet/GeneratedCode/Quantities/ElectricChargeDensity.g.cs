...
namespace UnitsNet
{
    ...
    public partial struct ElectricChargeDensity : IQuantity<ElectricChargeDensityUnit>, IEquatable<ElectricChargeDensity>, IComparable, IComparable<ElectricChargeDensity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ElectricChargeDensity" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<ElectricChargeDensity>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(ElectricChargeDensityUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ElectricChargeDensity>(inBaseUnits.Unit, unit, out var conversionFunction))
