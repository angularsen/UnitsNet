...
namespace UnitsNet
{
    ...
    public readonly partial struct ApparentEnergy :
        ...
        IComparisonOperators<ApparentEnergy, ApparentEnergy, bool>,
        IParsable<ApparentEnergy>,
#endif
        IComparable,
        ...
        static ApparentEnergy()
        {
            ...
            Info = new QuantityInfo<ApparentEnergyUnit>("ApparentEnergy",
                new UnitInfo<ApparentEnergyUnit>[]
                {
                    ...
                    new UnitInfo<ApparentEnergyUnit>(ApparentEnergyUnit.VoltampereHour, "VoltampereHours", new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second), "ApparentEnergy"),
                },
