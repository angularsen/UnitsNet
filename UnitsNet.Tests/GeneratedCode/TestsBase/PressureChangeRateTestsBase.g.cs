...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = PressureChangeRate.From(1.0, PressureChangeRate.BaseUnit);
        ...
        {
            var inBaseUnit = PressureChangeRate.From(1.0, PressureChangeRate.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(PressureChangeRateUnit)));
        }
        ...
        {
            var quantity = PressureChangeRate.FromPascalsPerSecond(1.0);
            Assert.Equal(PressureChangeRate.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
