...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial struct VolumePerLength : IQuantity<VolumePerLengthUnit>, IComparable, IComparable<VolumePerLength>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<VolumePerLengthUnit>)this).As(unitAsVolumePerLengthUnit);
        }
        ...
        /// <summary>
        ///     Converts this VolumePerLength to another VolumePerLength with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A VolumePerLength with the specified unit.</returns>
        public QuantityValue ToQuantity(VolumePerLengthUnit unit)
        {
