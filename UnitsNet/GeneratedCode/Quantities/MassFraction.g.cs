...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MassFraction()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MassFractionUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MassFractionUnit Unit), List<string>> Abbreviations { get; }
