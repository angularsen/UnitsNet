        ...
        IFormattable
    {
        ...
        private bool TryToUnit(ThermalResistanceUnit unit, [NotNullWhen(true)] out ThermalResistance? converted)
        {
            ...
            ThermalResistance? convertedOrNull = (Unit, unit) switch
            {
                ...
                (ThermalResistanceUnit.HourSquareFeetDegreeFahrenheitPerBtu, ThermalResistanceUnit.SquareMeterKelvinPerKilowatt) => new ThermalResistance(_value * new QuantityValue(1761121482159839, 10000000000000, false), ThermalResistanceUnit.SquareMeterKelvinPerKilowatt),
                (ThermalResistanceUnit.SquareCentimeterHourDegreeCelsiusPerKilocalorie, ThermalResistanceUnit.SquareMeterKelvinPerKilowatt) => new ThermalResistance(_value * new QuantityValue(859779507590433, 10000000000000000, false), ThermalResistanceUnit.SquareMeterKelvinPerKilowatt),
                ...
                (ThermalResistanceUnit.SquareMeterKelvinPerKilowatt, ThermalResistanceUnit.HourSquareFeetDegreeFahrenheitPerBtu) => new ThermalResistance(_value * new QuantityValue(10000000000000, 1761121482159839, false), ThermalResistanceUnit.HourSquareFeetDegreeFahrenheitPerBtu),
                (ThermalResistanceUnit.SquareMeterKelvinPerKilowatt, ThermalResistanceUnit.SquareCentimeterHourDegreeCelsiusPerKilocalorie) => new ThermalResistance(_value * new QuantityValue(10000000000000000, 859779507590433, false), ThermalResistanceUnit.SquareCentimeterHourDegreeCelsiusPerKilocalorie),
