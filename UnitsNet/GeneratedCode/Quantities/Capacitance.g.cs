...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Capacitance()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, CapacitanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, CapacitanceUnit Unit), List<string>> Abbreviations { get; }
