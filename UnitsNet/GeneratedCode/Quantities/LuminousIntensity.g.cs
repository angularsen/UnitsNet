...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static LuminousIntensity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, LuminousIntensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, LuminousIntensityUnit Unit), List<string>> Abbreviations { get; }
