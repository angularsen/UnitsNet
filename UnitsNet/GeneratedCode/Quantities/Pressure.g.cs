...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public readonly partial struct Pressure : IArithmeticQuantity<Pressure, PressureUnit, double>, IEquatable<Pressure>, IComparable, IComparable<Pressure>, IConvertible, IFormattable
    {
        /// <summary>
