...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Permittivity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, PermittivityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, PermittivityUnit Unit), List<string>> Abbreviations { get; }
