...
namespace UnitsNet
{
    ...
    /// </remarks>
    public partial struct ElectricConductivity : IQuantity<ElectricConductivityUnit>, IEquatable<ElectricConductivity>, IComparable, IComparable<ElectricConductivity>, IConvertible
    {
        /// <summary>
        ...
        public ElectricConductivity(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static ElectricConductivityUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static ElectricConductivityUnit GetUnitFor(BaseUnits baseUnits)
        {
