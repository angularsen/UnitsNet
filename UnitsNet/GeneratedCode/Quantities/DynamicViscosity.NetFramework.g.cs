...
namespace UnitsNet
{
    ...
    public partial struct DynamicViscosity : IQuantity<DynamicViscosityUnit>, IEquatable<DynamicViscosity>, IComparable, IComparable<DynamicViscosity>, IConvertible
    {
        ...
        public DynamicViscosity(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static DynamicViscosityUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static DynamicViscosityUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
