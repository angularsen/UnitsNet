...
namespace UnitsNet
{
    ...
    public partial struct AmountOfSubstance : IQuantity<AmountOfSubstanceUnit>, IComparable, IComparable<AmountOfSubstance>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<AmountOfSubstanceUnit>)this).As(unitAsAmountOfSubstanceUnit);
        }
        ...
        /// <summary>
        ///     Converts this AmountOfSubstance to another AmountOfSubstance with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A AmountOfSubstance with the specified unit.</returns>
        public QuantityValue ToQuantity(AmountOfSubstanceUnit unit)
        {
