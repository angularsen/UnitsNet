...
namespace UnitsNet
{
    ...
    public partial struct Frequency : IQuantity<FrequencyUnit>, IComparable, IComparable<Frequency>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<FrequencyUnit>)this).As(unitAsFrequencyUnit);
        }
        ...
        /// <summary>
        ///     Converts this Frequency to another Frequency with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A Frequency with the specified unit.</returns>
        public QuantityValue ToQuantity(FrequencyUnit unit)
        {
