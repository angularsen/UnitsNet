...
namespace UnitsNet
{
    ...
    public partial struct Length
    {
        ...
        public class FeetInchesCombo
        {
            public double Feet { get; private set; }
            public double Inches { get; private set; }

            public FeetInchesCombo(double feet, double inches)
            {
                Feet = feet;
                Inches = inches;
            }
        ...
        /// </summary>
        public FeetInchesCombo FeetInches
        {
            get {
                ...
                return new FeetInchesCombo(wholeFeet, inches); 
            }
        }
