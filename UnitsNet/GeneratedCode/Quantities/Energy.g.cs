...
namespace UnitsNet
{
    ...
    public partial struct Energy : IQuantity<EnergyUnit>, IEquatable<Energy>, IComparable, IComparable<Energy>, IConvertible, IFormattable
    {
        ...
        static Energy()
        {
            ...
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.BritishThermalUnit, q => q.ToUnit(EnergyUnit.BritishThermalUnit));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.BritishThermalUnit, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.Calorie, q => q.ToUnit(EnergyUnit.Calorie));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Calorie, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.DecathermEc, q => q.ToUnit(EnergyUnit.DecathermEc));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.DecathermEc, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.DecathermImperial, q => q.ToUnit(EnergyUnit.DecathermImperial));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.DecathermImperial, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.DecathermUs, q => q.ToUnit(EnergyUnit.DecathermUs));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.DecathermUs, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.ElectronVolt, q => q.ToUnit(EnergyUnit.ElectronVolt));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.ElectronVolt, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.Erg, q => q.ToUnit(EnergyUnit.Erg));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Erg, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.FootPound, q => q.ToUnit(EnergyUnit.FootPound));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.FootPound, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.GigabritishThermalUnit, q => q.ToUnit(EnergyUnit.GigabritishThermalUnit));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.GigabritishThermalUnit, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.GigaelectronVolt, q => q.ToUnit(EnergyUnit.GigaelectronVolt));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.GigaelectronVolt, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.Gigajoule, q => q.ToUnit(EnergyUnit.Gigajoule));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Gigajoule, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.GigawattDay, q => q.ToUnit(EnergyUnit.GigawattDay));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.GigawattDay, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.GigawattHour, q => q.ToUnit(EnergyUnit.GigawattHour));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.GigawattHour, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.HorsepowerHour, q => q.ToUnit(EnergyUnit.HorsepowerHour));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.HorsepowerHour, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, Energy.BaseUnit, q => q);
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.KilobritishThermalUnit, q => q.ToUnit(EnergyUnit.KilobritishThermalUnit));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.KilobritishThermalUnit, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.Kilocalorie, q => q.ToUnit(EnergyUnit.Kilocalorie));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Kilocalorie, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.KiloelectronVolt, q => q.ToUnit(EnergyUnit.KiloelectronVolt));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.KiloelectronVolt, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.Kilojoule, q => q.ToUnit(EnergyUnit.Kilojoule));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Kilojoule, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.KilowattDay, q => q.ToUnit(EnergyUnit.KilowattDay));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.KilowattDay, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.KilowattHour, q => q.ToUnit(EnergyUnit.KilowattHour));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.KilowattHour, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.MegabritishThermalUnit, q => q.ToUnit(EnergyUnit.MegabritishThermalUnit));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.MegabritishThermalUnit, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.Megacalorie, q => q.ToUnit(EnergyUnit.Megacalorie));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Megacalorie, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.MegaelectronVolt, q => q.ToUnit(EnergyUnit.MegaelectronVolt));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.MegaelectronVolt, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.Megajoule, q => q.ToUnit(EnergyUnit.Megajoule));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Megajoule, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.MegawattDay, q => q.ToUnit(EnergyUnit.MegawattDay));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.MegawattDay, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.MegawattHour, q => q.ToUnit(EnergyUnit.MegawattHour));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.MegawattHour, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.Millijoule, q => q.ToUnit(EnergyUnit.Millijoule));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Millijoule, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.TeraelectronVolt, q => q.ToUnit(EnergyUnit.TeraelectronVolt));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.TeraelectronVolt, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.TerawattDay, q => q.ToUnit(EnergyUnit.TerawattDay));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.TerawattDay, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.TerawattHour, q => q.ToUnit(EnergyUnit.TerawattHour));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.TerawattHour, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.ThermEc, q => q.ToUnit(EnergyUnit.ThermEc));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.ThermEc, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.ThermImperial, q => q.ToUnit(EnergyUnit.ThermImperial));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.ThermImperial, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.ThermUs, q => q.ToUnit(EnergyUnit.ThermUs));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.ThermUs, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.WattDay, q => q.ToUnit(EnergyUnit.WattDay));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.WattDay, Energy.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.WattHour, q => q.ToUnit(EnergyUnit.WattHour));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.WattHour, Energy.BaseUnit, q => q.ToBaseUnit());
        }
