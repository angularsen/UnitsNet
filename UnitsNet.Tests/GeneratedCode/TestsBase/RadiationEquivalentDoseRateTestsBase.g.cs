...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void RadiationEquivalentDoseRate_QuantityInfo_ReturnsQuantityInfoDescribingQuantity()
        {
            ...
            var units = EnumHelpers.GetValues<RadiationEquivalentDoseRateUnit>().OrderBy(x => x.ToString()).ToArray();
        ...
        {
            var units = EnumHelpers.GetValues<RadiationEquivalentDoseRateUnit>();
