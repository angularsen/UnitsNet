...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = MagneticFlux.From(1.0, MagneticFlux.BaseUnit);
        ...
        {
            var inBaseUnit = MagneticFlux.From(1.0, MagneticFlux.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(MagneticFluxUnit)));
        }
        ...
        {
            var quantity = MagneticFlux.FromWebers(1.0);
            Assert.Equal(MagneticFlux.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
