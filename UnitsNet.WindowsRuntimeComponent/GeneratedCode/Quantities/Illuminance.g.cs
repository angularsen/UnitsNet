...
namespace UnitsNet
{
    ...
    public sealed partial class Illuminance : IQuantity
    {
        ...
        /// <summary>
        ///     Gets this <see cref="Illuminance"/> converted into <see cref="IlluminanceUnit.Kilolux">Kilolux</see> as a <see cref="double"/>.
        /// </summary>
        [Obsolete("Use the ToKilolux property.")]
        public double Kilolux => As(IlluminanceUnit.Kilolux);

        /// <summary>
        ///     Gets this <see cref="Illuminance"/> converted into <see cref="IlluminanceUnit.Lux">Lux</see> as a <see cref="double"/>.
        /// </summary>
        [Obsolete("Use the ToLux property.")]
        public double Lux => As(IlluminanceUnit.Lux);

        /// <summary>
        ///     Gets this <see cref="Illuminance"/> converted into <see cref="IlluminanceUnit.Megalux">Megalux</see> as a <see cref="double"/>.
        /// </summary>
        [Obsolete("Use the ToMegalux property.")]
        public double Megalux => As(IlluminanceUnit.Megalux);

        /// <summary>
        ///     Gets this <see cref="Illuminance"/> converted into <see cref="IlluminanceUnit.Millilux">Millilux</see> as a <see cref="double"/>.
        /// </summary>
        [Obsolete("Use the ToMillilux property.")]
        public double Millilux => As(IlluminanceUnit.Millilux);

        /// <summary>
        ///     Gets this <see cref="Illuminance"/> converted into <see cref="IlluminanceUnit.Kilolux">Kilolux</see>.
        /// </summary>
        public Illuminance ToKilolux => ToUnit(IlluminanceUnit.Kilolux);

        /// <summary>
        ///     Gets this <see cref="Illuminance"/> converted into <see cref="IlluminanceUnit.Lux">Lux</see>.
        /// </summary>
        public Illuminance ToLux => ToUnit(IlluminanceUnit.Lux);

        /// <summary>
        ///     Gets this <see cref="Illuminance"/> converted into <see cref="IlluminanceUnit.Megalux">Megalux</see>.
        /// </summary>
        public Illuminance ToMegalux => ToUnit(IlluminanceUnit.Megalux);

        /// <summary>
        ///     Gets this <see cref="Illuminance"/> converted into <see cref="IlluminanceUnit.Millilux">Millilux</see>.
        /// </summary>
