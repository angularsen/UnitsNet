...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = SpecificVolume.From(1.0, SpecificVolume.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(SpecificVolumeUnit)));
        }
        ...
        {
            var quantity = SpecificVolume.FromCubicMetersPerKilogram(1.0);
            Assert.Equal(SpecificVolume.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
