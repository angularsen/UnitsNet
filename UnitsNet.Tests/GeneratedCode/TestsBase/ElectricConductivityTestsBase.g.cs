...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricConductivity.From(1.0, ElectricConductivity.BaseUnit);
        ...
        {
            var inBaseUnit = ElectricConductivity.From(1.0, ElectricConductivity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricConductivityUnit)));
        }
        ...
        {
            var quantity = ElectricConductivity.FromSiemensPerMeter(1.0);
            Assert.Equal(ElectricConductivity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
