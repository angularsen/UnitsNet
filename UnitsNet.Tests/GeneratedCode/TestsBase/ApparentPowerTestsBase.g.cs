...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ApparentPower.From(1.0, ApparentPower.BaseUnit);
        ...
        {
            var inBaseUnit = ApparentPower.From(1.0, ApparentPower.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ApparentPowerUnit)));
        }
        ...
        {
            var quantity = ApparentPower.FromVoltamperes(1.0);
            Assert.Equal(ApparentPower.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
