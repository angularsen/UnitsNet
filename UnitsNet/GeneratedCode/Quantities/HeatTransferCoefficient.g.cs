...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<HeatTransferCoefficientUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.HeatTransferCoefficientUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<HeatTransferCoefficientUnit>(str, culture, out unit);
        }
