...
namespace UnitsNet
{
    ...
    public partial struct RotationalStiffnessPerLength : IQuantity<RotationalStiffnessPerLengthUnit>, IComparable, IComparable<RotationalStiffnessPerLength>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<RotationalStiffnessPerLengthUnit>)this).As(unitAsRotationalStiffnessPerLengthUnit);
        }
        ...
        /// <summary>
        ///     Converts this RotationalStiffnessPerLength to another RotationalStiffnessPerLength with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A RotationalStiffnessPerLength with the specified unit.</returns>
        public QuantityValue ToQuantity(RotationalStiffnessPerLengthUnit unit)
        {
