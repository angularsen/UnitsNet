...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Luminosity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, LuminosityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, LuminosityUnit Unit), List<string>> Abbreviations { get; }
