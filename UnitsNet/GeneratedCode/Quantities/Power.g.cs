...
namespace UnitsNet
{
    ...
    public partial struct Power : IQuantity<PowerUnit>, IDecimalQuantity, IComparable, IComparable<Power>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<PowerUnit>)this).As(unitAsPowerUnit);
        }
        ...
        /// <summary>
        ///     Converts this Power to another Power with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A Power with the specified unit.</returns>
        public QuantityValue ToQuantity(PowerUnit unit)
        {
