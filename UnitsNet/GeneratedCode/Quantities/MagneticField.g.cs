...
namespace UnitsNet
{
    ...
    public partial struct MagneticField : IQuantity<MagneticFieldUnit>, IEquatable<MagneticField>, IComparable, IComparable<MagneticField>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="MagneticField" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<MagneticField>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(MagneticFieldUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<MagneticField>(inBaseUnits.Unit, unit, out var conversionFunction))
