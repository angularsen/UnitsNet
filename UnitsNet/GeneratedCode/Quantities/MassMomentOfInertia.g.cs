...
namespace UnitsNet
{
    ...
    public partial struct MassMomentOfInertia : IQuantity<MassMomentOfInertiaUnit>, IEquatable<MassMomentOfInertia>, IComparable, IComparable<MassMomentOfInertia>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="MassMomentOfInertia" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<MassMomentOfInertia>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(MassMomentOfInertiaUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<MassMomentOfInertia>(inBaseUnits.Unit, unit, out var conversionFunction))
