...
namespace UnitsNet
{
    ...
    public partial struct Length : IQuantity<LengthUnit>, IComparable, IComparable<Length>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<LengthUnit>)this).As(unitAsLengthUnit);
        }
        ...
        /// <summary>
        ///     Converts this Length to another Length with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A Length with the specified unit.</returns>
        public QuantityValue ToQuantity(LengthUnit unit)
        {
