...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = LuminousFlux.From(1.0, LuminousFlux.BaseUnit);
        ...
        {
            var inBaseUnit = LuminousFlux.From(1.0, LuminousFlux.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(LuminousFluxUnit)));
        }
        ...
        {
            var quantity = LuminousFlux.FromLumens(1.0);
            Assert.Equal(LuminousFlux.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
