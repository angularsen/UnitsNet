...
namespace UnitsNet
{
    public partial struct Pressure
    {
        ...
        {
            return new Length(pressure.Pascals / specificWeight.NewtonsPerCubicMeter, LengthUnit.Meter);
        }
        ...
        {
            return new SpecificWeight(pressure.Pascals / length.Meters, SpecificWeightUnit.NewtonPerCubicMeter);
        }
    }
}
