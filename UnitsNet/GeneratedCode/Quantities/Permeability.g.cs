...
namespace UnitsNet
{
    ...
    public partial struct Permeability : IQuantity<PermeabilityUnit>, IEquatable<Permeability>, IComparable, IComparable<Permeability>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="PermeabilityUnit.HenryPerMeter"/>
        /// </summary>
        ...
        /// <remarks>Consider using <see cref="Equals(Permeability, QuantityValue, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(Permeability left, Permeability right)
        {
        ...
        public bool Equals(Permeability other, QuantityValue tolerance, ComparisonType comparisonType)
        {
            if (tolerance < 0)
        ...
        public Permeability ToUnit(PermeabilityUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (Enum.IsDefined(typeof(PermeabilityUnit), unit))
            {
