...
namespace OasysUnits.Serialization.JsonNet.Tests
{
    ...
    {
        private OasysUnitsIQuantityJsonConverter _sut;
        ...
        public void OasysUnitsIQuantityJsonConverter_WriteJson_works_with_decimal_quantity(decimal value, string expectedValue, string expectedValueString)
        {
            var result = new StringBuilder();
