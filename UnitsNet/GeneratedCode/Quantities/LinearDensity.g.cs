        ...
        IFormattable
    {
        ...
        private bool TryToUnit(LinearDensityUnit unit, [NotNullWhen(true)] out LinearDensity? converted)
        {
            ...
            LinearDensity? convertedOrNull = (Unit, unit) switch
            {
                ...
                (LinearDensityUnit.GramPerFoot, LinearDensityUnit.KilogramPerMeter) => new LinearDensity(_value * 3.28084e-3, LinearDensityUnit.KilogramPerMeter),
                ...
                (LinearDensityUnit.KilogramPerFoot, LinearDensityUnit.KilogramPerMeter) => new LinearDensity((_value * 3.28084e-3) * 1e3d, LinearDensityUnit.KilogramPerMeter),
                ...
                (LinearDensityUnit.MicrogramPerFoot, LinearDensityUnit.KilogramPerMeter) => new LinearDensity((_value * 3.28084e-3) * 1e-6d, LinearDensityUnit.KilogramPerMeter),
                ...
                (LinearDensityUnit.MilligramPerFoot, LinearDensityUnit.KilogramPerMeter) => new LinearDensity((_value * 3.28084e-3) * 1e-3d, LinearDensityUnit.KilogramPerMeter),
                ...
                (LinearDensityUnit.KilogramPerMeter, LinearDensityUnit.GramPerFoot) => new LinearDensity(_value / 3.28084e-3, LinearDensityUnit.GramPerFoot),
                ...
                (LinearDensityUnit.KilogramPerMeter, LinearDensityUnit.KilogramPerFoot) => new LinearDensity((_value / 3.28084e-3) / 1e3d, LinearDensityUnit.KilogramPerFoot),
                ...
                (LinearDensityUnit.KilogramPerMeter, LinearDensityUnit.MicrogramPerFoot) => new LinearDensity((_value / 3.28084e-3) / 1e-6d, LinearDensityUnit.MicrogramPerFoot),
                ...
                (LinearDensityUnit.KilogramPerMeter, LinearDensityUnit.MilligramPerFoot) => new LinearDensity((_value / 3.28084e-3) / 1e-3d, LinearDensityUnit.MilligramPerFoot),
