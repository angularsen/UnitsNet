...
namespace UnitsNet
{
    ...
    public partial struct Information : IQuantity<InformationUnit>, IDecimalQuantity, IEquatable<Information>, IComparable, IComparable<Information>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Information" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<Information>(Unit, BaseUnit, out var conversionFunction))
        ...
        private decimal GetValueAs(InformationUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Information>(inBaseUnits.Unit, unit, out var conversionFunction))
