...
namespace UnitsNet
{
    ...
    public partial struct Temperature : IQuantity<TemperatureUnit>, IEquatable<Temperature>, IComparable, IComparable<Temperature>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="Temperature"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="Temperature"/> from.</param>
        public static implicit operator Temperature(ValueTuple<QuantityValue, TemperatureUnit> tuple) => new Temperature((double)tuple.Item1, tuple.Item2);
