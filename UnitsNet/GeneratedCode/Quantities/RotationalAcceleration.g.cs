...
namespace UnitsNet
{
    ...
    public partial struct RotationalAcceleration : IQuantity<RotationalAccelerationUnit>, IEquatable<RotationalAcceleration>, IComparable, IComparable<RotationalAcceleration>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="RotationalAcceleration"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="RotationalAcceleration"/> from.</param>
        public static implicit operator RotationalAcceleration(ValueTuple<QuantityValue, RotationalAccelerationUnit> tuple) => new RotationalAcceleration((double)tuple.Item1, tuple.Item2);
