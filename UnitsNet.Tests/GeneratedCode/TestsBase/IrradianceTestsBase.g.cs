...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = Irradiance.From(1.0, Irradiance.BaseUnit);
        ...
        {
            var inBaseUnit = Irradiance.From(1.0, Irradiance.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(IrradianceUnit)));
        }
        ...
        {
            var quantity = Irradiance.FromWattsPerSquareMeter(1.0);
            Assert.Equal(Irradiance.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
