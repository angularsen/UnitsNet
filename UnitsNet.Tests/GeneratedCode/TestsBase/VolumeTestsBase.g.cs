...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ParseUnit(string abbreviation, VolumeUnit expectedUnit)
        {
        ...
        [InlineData("pt (U.S.)", VolumeUnit.UsPint)]
        [InlineData("qt (U.S.)", VolumeUnit.UsQuart)]
        public void TryParseUnit(string abbreviation, VolumeUnit expectedUnit)
        {
            // regardless of the CurrentCulture is, this should always work with the FallbackCulture ("en-US")
        ...
        [InlineData("fr-CA", "pied-planche", VolumeUnit.BoardFoot)]
        [InlineData("fr-CA", "pied de planche", VolumeUnit.BoardFoot)]
        public void TryParseUnitWithCulture(string culture, string abbreviation, VolumeUnit expectedUnit)
        {
