...
namespace UnitsNet
{
    ...
    public partial struct VolumeFlow : IQuantity<VolumeFlowUnit>, IComparable, IComparable<VolumeFlow>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<VolumeFlowUnit>)this).As(unitAsVolumeFlowUnit);
        }
        ...
        /// <summary>
        ///     Converts this VolumeFlow to another VolumeFlow with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A VolumeFlow with the specified unit.</returns>
        public QuantityValue ToQuantity(VolumeFlowUnit unit)
        {
