...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = TemperatureDelta.From(1.0, TemperatureDelta.BaseUnit);
        ...
        {
            var inBaseUnit = TemperatureDelta.From(1.0, TemperatureDelta.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(TemperatureDeltaUnit)));
        }
        ...
        {
            var quantity = TemperatureDelta.FromKelvins(1.0);
            Assert.Equal(TemperatureDelta.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
