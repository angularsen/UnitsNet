...
namespace OasysUnits
{
    ...
    public class QuantityInfo
    {
        ...
        /// <summary>
        ///     Quantity type, such as <see cref="OasysUnits.QuantityType.Length" /> or <see cref="OasysUnits.QuantityType.Mass" />.
        /// </summary>
    ...
    public class QuantityInfo<TUnit> : QuantityInfo
        where TUnit : Enum
    {
        /// <inheritdoc cref="QuantityInfo{TUnit}(string,OasysUnits.UnitInfo{TUnit}[],TUnit,OasysUnits.IQuantity{TUnit},OasysUnits.BaseDimensions,OasysUnits.QuantityType)" />
