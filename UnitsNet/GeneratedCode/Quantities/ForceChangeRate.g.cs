...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<ForceChangeRateUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.ForceChangeRateUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<ForceChangeRateUnit>(str, culture, out unit);
        }
