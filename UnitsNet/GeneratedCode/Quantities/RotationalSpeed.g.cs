...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static RotationalSpeed()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, RotationalSpeedUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, RotationalSpeedUnit Unit), List<string>> Abbreviations { get; }
