...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<FuelEfficiencyUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.FuelEfficiencyUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<FuelEfficiencyUnit>(str, culture, out unit);
        }
