...
namespace UnitsNet
{
    ...
    public partial struct Irradiation : IQuantity<IrradiationUnit>, IEquatable<Irradiation>, IComparable, IComparable<Irradiation>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Irradiation" /> instances.
        /// </summary>
        ...
        private double GetValueAs(IrradiationUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Irradiation>(inBaseUnits.Unit, unit, out var conversionFunction))
