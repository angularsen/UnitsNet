...
namespace UnitsNet
{
    ...
    public partial struct PowerDensity : IQuantity<PowerDensityUnit>, IComparable, IComparable<PowerDensity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Converts this PowerDensity to another PowerDensity with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A PowerDensity with the specified unit.</returns>
        public QuantityValue ToQuantity(PowerDensityUnit unit)
        {
