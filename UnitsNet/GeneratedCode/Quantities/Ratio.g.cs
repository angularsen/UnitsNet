...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Ratio()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, RatioUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, RatioUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(RatioUnit unit) => GetAbbreviation(unit, null);
