...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricConductance()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricConductanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricConductanceUnit Unit), List<string>> Abbreviations { get; }
