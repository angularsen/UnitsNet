...
namespace UnitsNet
{
    ...
    public partial struct Density : IQuantity<DensityUnit>, IEquatable<Density>, IComparable, IComparable<Density>, IConvertible, IFormattable
    {
        ...
        private static bool TryConvert(Density value, DensityUnit targetUnit, out Density? converted)
        {
            converted = (value.Unit, targetUnit) switch
            {
                // DensityUnit -> BaseUnit
                (DensityUnit.CentigramPerDeciliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-1) * 1e-2d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.CentigramPerLiter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1) * 1e-2d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.CentigramPerMilliliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-3) * 1e-2d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.DecigramPerDeciliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-1) * 1e-1d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.DecigramPerLiter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1) * 1e-1d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.DecigramPerMilliliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-3) * 1e-1d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.GramPerCubicCentimeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 1e-3, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.GramPerCubicFoot, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 0.0353146667214886, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.GramPerCubicInch, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 61.0237440947323, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.GramPerCubicMeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 1e3, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.GramPerCubicMillimeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 1e-6, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.GramPerDeciliter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 1e-1, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.GramPerLiter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 1, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.GramPerMilliliter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 1e-3, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.KilogramPerCubicCentimeter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-3) * 1e3d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.KilogramPerCubicMillimeter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-6) * 1e3d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.KilogramPerLiter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 1e3, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.KilopoundPerCubicFoot, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 0.062427961) * 1e3d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.KilopoundPerCubicInch, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 3.6127298147753e-5) * 1e3d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.MicrogramPerCubicMeter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e3) * 1e-6d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.MicrogramPerDeciliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-1) * 1e-6d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.MicrogramPerLiter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1) * 1e-6d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.MicrogramPerMilliliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-3) * 1e-6d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.MilligramPerCubicMeter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e3) * 1e-3d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.MilligramPerDeciliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-1) * 1e-3d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.MilligramPerLiter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1) * 1e-3d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.MilligramPerMilliliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-3) * 1e-3d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.NanogramPerDeciliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-1) * 1e-9d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.NanogramPerLiter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1) * 1e-9d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.NanogramPerMilliliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-3) * 1e-9d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.PicogramPerDeciliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-1) * 1e-12d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.PicogramPerLiter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1) * 1e-12d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.PicogramPerMilliliter, DensityUnit.KilogramPerCubicMeter) => new Density((value.Value / 1e-3) * 1e-12d, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.PoundPerCubicCentimeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 2.204622621848775e-6, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.PoundPerCubicFoot, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 0.062427961, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.PoundPerCubicInch, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 3.6127298147753e-5, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.PoundPerCubicMeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 2.204622621848775, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.PoundPerCubicMillimeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 2.204622621848775e-9, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.PoundPerImperialGallon, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 9.9776398e1, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.PoundPerUSGallon, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 1.19826427e2, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.SlugPerCubicCentimeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 14593903, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.SlugPerCubicFoot, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 515.378818, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.SlugPerCubicInch, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 890574.60201535, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.SlugPerCubicMeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 14.5939, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.SlugPerCubicMillimeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 14593903000, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.TonnePerCubicCentimeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 1e-9, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.TonnePerCubicFoot, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 3.53146667214886e4, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.TonnePerCubicInch, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value * 6.10237440947323e7, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.TonnePerCubicMeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 0.001, DensityUnit.KilogramPerCubicMeter),
                (DensityUnit.TonnePerCubicMillimeter, DensityUnit.KilogramPerCubicMeter) => new Density(value.Value / 1e-12, DensityUnit.KilogramPerCubicMeter),

                // BaseUnit <-> BaseUnit
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.KilogramPerCubicMeter) => value,

                // BaseUnit -> DensityUnit
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.CentigramPerDeciliter) => new Density((value.Value * 1e-1) / 1e-2d, DensityUnit.CentigramPerDeciliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.CentigramPerLiter) => new Density((value.Value * 1) / 1e-2d, DensityUnit.CentigramPerLiter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.CentigramPerMilliliter) => new Density((value.Value * 1e-3) / 1e-2d, DensityUnit.CentigramPerMilliliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.DecigramPerDeciliter) => new Density((value.Value * 1e-1) / 1e-1d, DensityUnit.DecigramPerDeciliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.DecigramPerLiter) => new Density((value.Value * 1) / 1e-1d, DensityUnit.DecigramPerLiter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.DecigramPerMilliliter) => new Density((value.Value * 1e-3) / 1e-1d, DensityUnit.DecigramPerMilliliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.GramPerCubicCentimeter) => new Density(value.Value * 1e-3, DensityUnit.GramPerCubicCentimeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.GramPerCubicFoot) => new Density(value.Value / 0.0353146667214886, DensityUnit.GramPerCubicFoot),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.GramPerCubicInch) => new Density(value.Value / 61.0237440947323, DensityUnit.GramPerCubicInch),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.GramPerCubicMeter) => new Density(value.Value * 1e3, DensityUnit.GramPerCubicMeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.GramPerCubicMillimeter) => new Density(value.Value * 1e-6, DensityUnit.GramPerCubicMillimeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.GramPerDeciliter) => new Density(value.Value * 1e-1, DensityUnit.GramPerDeciliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.GramPerLiter) => new Density(value.Value * 1, DensityUnit.GramPerLiter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.GramPerMilliliter) => new Density(value.Value * 1e-3, DensityUnit.GramPerMilliliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.KilogramPerCubicCentimeter) => new Density((value.Value * 1e-3) / 1e3d, DensityUnit.KilogramPerCubicCentimeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.KilogramPerCubicMillimeter) => new Density((value.Value * 1e-6) / 1e3d, DensityUnit.KilogramPerCubicMillimeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.KilogramPerLiter) => new Density(value.Value / 1e3, DensityUnit.KilogramPerLiter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.KilopoundPerCubicFoot) => new Density((value.Value * 0.062427961) / 1e3d, DensityUnit.KilopoundPerCubicFoot),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.KilopoundPerCubicInch) => new Density((value.Value * 3.6127298147753e-5) / 1e3d, DensityUnit.KilopoundPerCubicInch),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.MicrogramPerCubicMeter) => new Density((value.Value * 1e3) / 1e-6d, DensityUnit.MicrogramPerCubicMeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.MicrogramPerDeciliter) => new Density((value.Value * 1e-1) / 1e-6d, DensityUnit.MicrogramPerDeciliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.MicrogramPerLiter) => new Density((value.Value * 1) / 1e-6d, DensityUnit.MicrogramPerLiter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.MicrogramPerMilliliter) => new Density((value.Value * 1e-3) / 1e-6d, DensityUnit.MicrogramPerMilliliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.MilligramPerCubicMeter) => new Density((value.Value * 1e3) / 1e-3d, DensityUnit.MilligramPerCubicMeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.MilligramPerDeciliter) => new Density((value.Value * 1e-1) / 1e-3d, DensityUnit.MilligramPerDeciliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.MilligramPerLiter) => new Density((value.Value * 1) / 1e-3d, DensityUnit.MilligramPerLiter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.MilligramPerMilliliter) => new Density((value.Value * 1e-3) / 1e-3d, DensityUnit.MilligramPerMilliliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.NanogramPerDeciliter) => new Density((value.Value * 1e-1) / 1e-9d, DensityUnit.NanogramPerDeciliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.NanogramPerLiter) => new Density((value.Value * 1) / 1e-9d, DensityUnit.NanogramPerLiter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.NanogramPerMilliliter) => new Density((value.Value * 1e-3) / 1e-9d, DensityUnit.NanogramPerMilliliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.PicogramPerDeciliter) => new Density((value.Value * 1e-1) / 1e-12d, DensityUnit.PicogramPerDeciliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.PicogramPerLiter) => new Density((value.Value * 1) / 1e-12d, DensityUnit.PicogramPerLiter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.PicogramPerMilliliter) => new Density((value.Value * 1e-3) / 1e-12d, DensityUnit.PicogramPerMilliliter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.PoundPerCubicCentimeter) => new Density(value.Value * 2.204622621848775e-6, DensityUnit.PoundPerCubicCentimeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.PoundPerCubicFoot) => new Density(value.Value * 0.062427961, DensityUnit.PoundPerCubicFoot),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.PoundPerCubicInch) => new Density(value.Value * 3.6127298147753e-5, DensityUnit.PoundPerCubicInch),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.PoundPerCubicMeter) => new Density(value.Value * 2.204622621848775, DensityUnit.PoundPerCubicMeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.PoundPerCubicMillimeter) => new Density(value.Value * 2.204622621848775e-9, DensityUnit.PoundPerCubicMillimeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.PoundPerImperialGallon) => new Density(value.Value / 9.9776398e1, DensityUnit.PoundPerImperialGallon),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.PoundPerUSGallon) => new Density(value.Value / 1.19826427e2, DensityUnit.PoundPerUSGallon),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.SlugPerCubicCentimeter) => new Density(value.Value / 14593903, DensityUnit.SlugPerCubicCentimeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.SlugPerCubicFoot) => new Density(value.Value * 0.00194032033, DensityUnit.SlugPerCubicFoot),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.SlugPerCubicInch) => new Density(value.Value / 890574.60201535, DensityUnit.SlugPerCubicInch),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.SlugPerCubicMeter) => new Density(value.Value / 14.5939, DensityUnit.SlugPerCubicMeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.SlugPerCubicMillimeter) => new Density(value.Value / 14593903000, DensityUnit.SlugPerCubicMillimeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.TonnePerCubicCentimeter) => new Density(value.Value * 1e-9, DensityUnit.TonnePerCubicCentimeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.TonnePerCubicFoot) => new Density(value.Value / 3.53146667214886e4, DensityUnit.TonnePerCubicFoot),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.TonnePerCubicInch) => new Density(value.Value / 6.10237440947323e7, DensityUnit.TonnePerCubicInch),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.TonnePerCubicMeter) => new Density(value.Value * 0.001, DensityUnit.TonnePerCubicMeter),
                (DensityUnit.KilogramPerCubicMeter, DensityUnit.TonnePerCubicMillimeter) => new Density(value.Value * 1e-12, DensityUnit.TonnePerCubicMillimeter),
