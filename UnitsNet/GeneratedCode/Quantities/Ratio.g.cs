...
namespace UnitsNet
{
    ...
    public partial struct Ratio : IQuantity<RatioUnit>, IEquatable<Ratio>, IComparable, IComparable<Ratio>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="RatioUnit.DecimalFraction"/>
        /// </summary>
        public QuantityValue DecimalFractions => As(RatioUnit.DecimalFraction);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="RatioUnit.PartPerBillion"/>
        /// </summary>
        public QuantityValue PartsPerBillion => As(RatioUnit.PartPerBillion);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="RatioUnit.PartPerMillion"/>
        /// </summary>
        public QuantityValue PartsPerMillion => As(RatioUnit.PartPerMillion);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="RatioUnit.PartPerThousand"/>
        /// </summary>
        public QuantityValue PartsPerThousand => As(RatioUnit.PartPerThousand);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="RatioUnit.PartPerTrillion"/>
        /// </summary>
        public QuantityValue PartsPerTrillion => As(RatioUnit.PartPerTrillion);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="RatioUnit.Percent"/>
        /// </summary>
        ...
        /// <remarks>Consider using <see cref="Equals(Ratio, QuantityValue, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(Ratio left, Ratio right)
        {
        ...
        public bool Equals(Ratio other, QuantityValue tolerance, ComparisonType comparisonType)
        {
            if (tolerance < 0)
        ...
        public Ratio ToUnit(RatioUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (Enum.IsDefined(typeof(RatioUnit), unit))
            {
