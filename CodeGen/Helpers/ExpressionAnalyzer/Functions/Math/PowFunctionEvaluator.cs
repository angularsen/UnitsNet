...
{
    private static readonly Fraction OneHalf = new(BigInteger.One, new BigInteger(2));
        ...
        Func<ExpressionEvaluationTerm, CompositeExpression> expressionResolver)
    {
        ...
        {
            return new ExpressionTerm(1, 1, new CustomFunction(FunctionName, functionBody, power.ToDecimal().ToString(CultureInfo.InvariantCulture)));
        }
