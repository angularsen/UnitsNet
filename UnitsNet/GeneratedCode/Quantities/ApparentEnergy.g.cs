...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ApparentEnergy()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ApparentEnergyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ApparentEnergyUnit Unit), List<string>> Abbreviations { get; }
