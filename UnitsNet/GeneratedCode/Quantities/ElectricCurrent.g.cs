...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricCurrent()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, ElectricCurrentUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, ElectricCurrentUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(ElectricCurrentUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(ElectricCurrentUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.ElectricCurrent";
                var resourceManager = new ResourceManager(resourceName, typeof(ElectricCurrent).Assembly);
