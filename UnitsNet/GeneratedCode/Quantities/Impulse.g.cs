...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<ImpulseUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.ImpulseUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<ImpulseUnit>(str, culture, out unit);
        }
