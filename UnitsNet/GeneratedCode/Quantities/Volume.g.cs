...
namespace UnitsNet
{
    ...
    public partial struct Volume : IQuantity<VolumeUnit>, IEquatable<Volume>, IComparable, IComparable<Volume>, IConvertible, IFormattable
    {
        ...
        private static bool TryConvert(Volume value, VolumeUnit targetUnit, out Volume? converted)
        {
            converted = (value.Unit, targetUnit) switch
            {
                // VolumeUnit -> BaseUnit
                (VolumeUnit.AcreFoot, VolumeUnit.CubicMeter) => new Volume(value.Value / 0.000810714, VolumeUnit.CubicMeter),
                (VolumeUnit.AuTablespoon, VolumeUnit.CubicMeter) => new Volume(value.Value * 2e-5, VolumeUnit.CubicMeter),
                (VolumeUnit.BoardFoot, VolumeUnit.CubicMeter) => new Volume(value.Value * 2.3597372158e-3, VolumeUnit.CubicMeter),
                (VolumeUnit.Centiliter, VolumeUnit.CubicMeter) => new Volume((value.Value / 1e3) * 1e-2d, VolumeUnit.CubicMeter),
                (VolumeUnit.CubicCentimeter, VolumeUnit.CubicMeter) => new Volume(value.Value / 1e6, VolumeUnit.CubicMeter),
                (VolumeUnit.CubicDecimeter, VolumeUnit.CubicMeter) => new Volume(value.Value / 1e3, VolumeUnit.CubicMeter),
                (VolumeUnit.CubicFoot, VolumeUnit.CubicMeter) => new Volume(value.Value * 2.8316846592e-2, VolumeUnit.CubicMeter),
                (VolumeUnit.CubicHectometer, VolumeUnit.CubicMeter) => new Volume(value.Value * 1e6, VolumeUnit.CubicMeter),
                (VolumeUnit.CubicInch, VolumeUnit.CubicMeter) => new Volume(value.Value * 1.6387 * 1e-5, VolumeUnit.CubicMeter),
                (VolumeUnit.CubicKilometer, VolumeUnit.CubicMeter) => new Volume(value.Value * 1e9, VolumeUnit.CubicMeter),
                (VolumeUnit.CubicMicrometer, VolumeUnit.CubicMeter) => new Volume(value.Value / 1e18, VolumeUnit.CubicMeter),
                (VolumeUnit.CubicMile, VolumeUnit.CubicMeter) => new Volume(value.Value * 4.16818182544058e9, VolumeUnit.CubicMeter),
                (VolumeUnit.CubicMillimeter, VolumeUnit.CubicMeter) => new Volume(value.Value / 1e9, VolumeUnit.CubicMeter),
                (VolumeUnit.CubicYard, VolumeUnit.CubicMeter) => new Volume(value.Value * 0.764554858, VolumeUnit.CubicMeter),
                (VolumeUnit.Decaliter, VolumeUnit.CubicMeter) => new Volume((value.Value / 1e3) * 1e1d, VolumeUnit.CubicMeter),
                (VolumeUnit.DecausGallon, VolumeUnit.CubicMeter) => new Volume((value.Value * 0.00378541) * 1e1d, VolumeUnit.CubicMeter),
                (VolumeUnit.Deciliter, VolumeUnit.CubicMeter) => new Volume((value.Value / 1e3) * 1e-1d, VolumeUnit.CubicMeter),
                (VolumeUnit.DeciusGallon, VolumeUnit.CubicMeter) => new Volume((value.Value * 0.00378541) * 1e-1d, VolumeUnit.CubicMeter),
                (VolumeUnit.HectocubicFoot, VolumeUnit.CubicMeter) => new Volume((value.Value * 2.8316846592e-2) * 1e2d, VolumeUnit.CubicMeter),
                (VolumeUnit.HectocubicMeter, VolumeUnit.CubicMeter) => new Volume((value.Value) * 1e2d, VolumeUnit.CubicMeter),
                (VolumeUnit.Hectoliter, VolumeUnit.CubicMeter) => new Volume((value.Value / 1e3) * 1e2d, VolumeUnit.CubicMeter),
                (VolumeUnit.HectousGallon, VolumeUnit.CubicMeter) => new Volume((value.Value * 0.00378541) * 1e2d, VolumeUnit.CubicMeter),
                (VolumeUnit.ImperialBeerBarrel, VolumeUnit.CubicMeter) => new Volume(value.Value * 0.16365924, VolumeUnit.CubicMeter),
                (VolumeUnit.ImperialGallon, VolumeUnit.CubicMeter) => new Volume(value.Value * 0.00454609000000181429905810072407, VolumeUnit.CubicMeter),
                (VolumeUnit.ImperialOunce, VolumeUnit.CubicMeter) => new Volume(value.Value * 2.8413062499962901241875439064617e-5, VolumeUnit.CubicMeter),
                (VolumeUnit.ImperialPint, VolumeUnit.CubicMeter) => new Volume(value.Value * 5.6826125e-4, VolumeUnit.CubicMeter),
                (VolumeUnit.KilocubicFoot, VolumeUnit.CubicMeter) => new Volume((value.Value * 2.8316846592e-2) * 1e3d, VolumeUnit.CubicMeter),
                (VolumeUnit.KilocubicMeter, VolumeUnit.CubicMeter) => new Volume((value.Value) * 1e3d, VolumeUnit.CubicMeter),
                (VolumeUnit.KiloimperialGallon, VolumeUnit.CubicMeter) => new Volume((value.Value * 0.00454609000000181429905810072407) * 1e3d, VolumeUnit.CubicMeter),
                (VolumeUnit.Kiloliter, VolumeUnit.CubicMeter) => new Volume((value.Value / 1e3) * 1e3d, VolumeUnit.CubicMeter),
                (VolumeUnit.KilousGallon, VolumeUnit.CubicMeter) => new Volume((value.Value * 0.00378541) * 1e3d, VolumeUnit.CubicMeter),
                (VolumeUnit.Liter, VolumeUnit.CubicMeter) => new Volume(value.Value / 1e3, VolumeUnit.CubicMeter),
                (VolumeUnit.MegacubicFoot, VolumeUnit.CubicMeter) => new Volume((value.Value * 2.8316846592e-2) * 1e6d, VolumeUnit.CubicMeter),
                (VolumeUnit.MegaimperialGallon, VolumeUnit.CubicMeter) => new Volume((value.Value * 0.00454609000000181429905810072407) * 1e6d, VolumeUnit.CubicMeter),
                (VolumeUnit.Megaliter, VolumeUnit.CubicMeter) => new Volume((value.Value / 1e3) * 1e6d, VolumeUnit.CubicMeter),
                (VolumeUnit.MegausGallon, VolumeUnit.CubicMeter) => new Volume((value.Value * 0.00378541) * 1e6d, VolumeUnit.CubicMeter),
                (VolumeUnit.MetricCup, VolumeUnit.CubicMeter) => new Volume(value.Value * 0.00025, VolumeUnit.CubicMeter),
                (VolumeUnit.MetricTeaspoon, VolumeUnit.CubicMeter) => new Volume(value.Value * 0.5e-5, VolumeUnit.CubicMeter),
                (VolumeUnit.Microliter, VolumeUnit.CubicMeter) => new Volume((value.Value / 1e3) * 1e-6d, VolumeUnit.CubicMeter),
                (VolumeUnit.Milliliter, VolumeUnit.CubicMeter) => new Volume((value.Value / 1e3) * 1e-3d, VolumeUnit.CubicMeter),
                (VolumeUnit.OilBarrel, VolumeUnit.CubicMeter) => new Volume(value.Value * 0.158987294928, VolumeUnit.CubicMeter),
                (VolumeUnit.UkTablespoon, VolumeUnit.CubicMeter) => new Volume(value.Value * 1.5e-5, VolumeUnit.CubicMeter),
                (VolumeUnit.UsBeerBarrel, VolumeUnit.CubicMeter) => new Volume(value.Value * 0.1173477658, VolumeUnit.CubicMeter),
                (VolumeUnit.UsCustomaryCup, VolumeUnit.CubicMeter) => new Volume(value.Value * 0.0002365882365, VolumeUnit.CubicMeter),
                (VolumeUnit.UsGallon, VolumeUnit.CubicMeter) => new Volume(value.Value * 0.00378541, VolumeUnit.CubicMeter),
                (VolumeUnit.UsLegalCup, VolumeUnit.CubicMeter) => new Volume(value.Value * 0.00024, VolumeUnit.CubicMeter),
                (VolumeUnit.UsOunce, VolumeUnit.CubicMeter) => new Volume(value.Value * 2.957352956253760505068307980135e-5, VolumeUnit.CubicMeter),
                (VolumeUnit.UsPint, VolumeUnit.CubicMeter) => new Volume(value.Value * 4.73176473e-4, VolumeUnit.CubicMeter),
                (VolumeUnit.UsQuart, VolumeUnit.CubicMeter) => new Volume(value.Value * 9.46352946e-4, VolumeUnit.CubicMeter),
                (VolumeUnit.UsTablespoon, VolumeUnit.CubicMeter) => new Volume(value.Value * 1.478676478125e-5, VolumeUnit.CubicMeter),
                (VolumeUnit.UsTeaspoon, VolumeUnit.CubicMeter) => new Volume(value.Value * 4.92892159375e-6, VolumeUnit.CubicMeter),

                // BaseUnit <-> BaseUnit
                (VolumeUnit.CubicMeter, VolumeUnit.CubicMeter) => value,

                // BaseUnit -> VolumeUnit
                (VolumeUnit.CubicMeter, VolumeUnit.AcreFoot) => new Volume(value.Value * 0.000810714, VolumeUnit.AcreFoot),
                (VolumeUnit.CubicMeter, VolumeUnit.AuTablespoon) => new Volume(value.Value / 2e-5, VolumeUnit.AuTablespoon),
                (VolumeUnit.CubicMeter, VolumeUnit.BoardFoot) => new Volume(value.Value / 2.3597372158e-3, VolumeUnit.BoardFoot),
                (VolumeUnit.CubicMeter, VolumeUnit.Centiliter) => new Volume((value.Value * 1e3) / 1e-2d, VolumeUnit.Centiliter),
                (VolumeUnit.CubicMeter, VolumeUnit.CubicCentimeter) => new Volume(value.Value * 1e6, VolumeUnit.CubicCentimeter),
                (VolumeUnit.CubicMeter, VolumeUnit.CubicDecimeter) => new Volume(value.Value * 1e3, VolumeUnit.CubicDecimeter),
                (VolumeUnit.CubicMeter, VolumeUnit.CubicFoot) => new Volume(value.Value / 2.8316846592e-2, VolumeUnit.CubicFoot),
                (VolumeUnit.CubicMeter, VolumeUnit.CubicHectometer) => new Volume(value.Value / 1e6, VolumeUnit.CubicHectometer),
                (VolumeUnit.CubicMeter, VolumeUnit.CubicInch) => new Volume(value.Value / (1.6387 * 1e-5), VolumeUnit.CubicInch),
                (VolumeUnit.CubicMeter, VolumeUnit.CubicKilometer) => new Volume(value.Value / 1e9, VolumeUnit.CubicKilometer),
                (VolumeUnit.CubicMeter, VolumeUnit.CubicMicrometer) => new Volume(value.Value * 1e18, VolumeUnit.CubicMicrometer),
                (VolumeUnit.CubicMeter, VolumeUnit.CubicMile) => new Volume(value.Value / 4.16818182544058e9, VolumeUnit.CubicMile),
                (VolumeUnit.CubicMeter, VolumeUnit.CubicMillimeter) => new Volume(value.Value * 1e9, VolumeUnit.CubicMillimeter),
                (VolumeUnit.CubicMeter, VolumeUnit.CubicYard) => new Volume(value.Value / 0.764554858, VolumeUnit.CubicYard),
                (VolumeUnit.CubicMeter, VolumeUnit.Decaliter) => new Volume((value.Value * 1e3) / 1e1d, VolumeUnit.Decaliter),
                (VolumeUnit.CubicMeter, VolumeUnit.DecausGallon) => new Volume((value.Value / 0.00378541) / 1e1d, VolumeUnit.DecausGallon),
                (VolumeUnit.CubicMeter, VolumeUnit.Deciliter) => new Volume((value.Value * 1e3) / 1e-1d, VolumeUnit.Deciliter),
                (VolumeUnit.CubicMeter, VolumeUnit.DeciusGallon) => new Volume((value.Value / 0.00378541) / 1e-1d, VolumeUnit.DeciusGallon),
                (VolumeUnit.CubicMeter, VolumeUnit.HectocubicFoot) => new Volume((value.Value / 2.8316846592e-2) / 1e2d, VolumeUnit.HectocubicFoot),
                (VolumeUnit.CubicMeter, VolumeUnit.HectocubicMeter) => new Volume((value.Value) / 1e2d, VolumeUnit.HectocubicMeter),
                (VolumeUnit.CubicMeter, VolumeUnit.Hectoliter) => new Volume((value.Value * 1e3) / 1e2d, VolumeUnit.Hectoliter),
                (VolumeUnit.CubicMeter, VolumeUnit.HectousGallon) => new Volume((value.Value / 0.00378541) / 1e2d, VolumeUnit.HectousGallon),
                (VolumeUnit.CubicMeter, VolumeUnit.ImperialBeerBarrel) => new Volume(value.Value / 0.16365924, VolumeUnit.ImperialBeerBarrel),
                (VolumeUnit.CubicMeter, VolumeUnit.ImperialGallon) => new Volume(value.Value / 0.00454609000000181429905810072407, VolumeUnit.ImperialGallon),
                (VolumeUnit.CubicMeter, VolumeUnit.ImperialOunce) => new Volume(value.Value / 2.8413062499962901241875439064617e-5, VolumeUnit.ImperialOunce),
                (VolumeUnit.CubicMeter, VolumeUnit.ImperialPint) => new Volume(value.Value / 5.6826125e-4, VolumeUnit.ImperialPint),
                (VolumeUnit.CubicMeter, VolumeUnit.KilocubicFoot) => new Volume((value.Value / 2.8316846592e-2) / 1e3d, VolumeUnit.KilocubicFoot),
                (VolumeUnit.CubicMeter, VolumeUnit.KilocubicMeter) => new Volume((value.Value) / 1e3d, VolumeUnit.KilocubicMeter),
                (VolumeUnit.CubicMeter, VolumeUnit.KiloimperialGallon) => new Volume((value.Value / 0.00454609000000181429905810072407) / 1e3d, VolumeUnit.KiloimperialGallon),
                (VolumeUnit.CubicMeter, VolumeUnit.Kiloliter) => new Volume((value.Value * 1e3) / 1e3d, VolumeUnit.Kiloliter),
                (VolumeUnit.CubicMeter, VolumeUnit.KilousGallon) => new Volume((value.Value / 0.00378541) / 1e3d, VolumeUnit.KilousGallon),
                (VolumeUnit.CubicMeter, VolumeUnit.Liter) => new Volume(value.Value * 1e3, VolumeUnit.Liter),
                (VolumeUnit.CubicMeter, VolumeUnit.MegacubicFoot) => new Volume((value.Value / 2.8316846592e-2) / 1e6d, VolumeUnit.MegacubicFoot),
                (VolumeUnit.CubicMeter, VolumeUnit.MegaimperialGallon) => new Volume((value.Value / 0.00454609000000181429905810072407) / 1e6d, VolumeUnit.MegaimperialGallon),
                (VolumeUnit.CubicMeter, VolumeUnit.Megaliter) => new Volume((value.Value * 1e3) / 1e6d, VolumeUnit.Megaliter),
                (VolumeUnit.CubicMeter, VolumeUnit.MegausGallon) => new Volume((value.Value / 0.00378541) / 1e6d, VolumeUnit.MegausGallon),
                (VolumeUnit.CubicMeter, VolumeUnit.MetricCup) => new Volume(value.Value / 0.00025, VolumeUnit.MetricCup),
                (VolumeUnit.CubicMeter, VolumeUnit.MetricTeaspoon) => new Volume(value.Value / 0.5e-5, VolumeUnit.MetricTeaspoon),
                (VolumeUnit.CubicMeter, VolumeUnit.Microliter) => new Volume((value.Value * 1e3) / 1e-6d, VolumeUnit.Microliter),
                (VolumeUnit.CubicMeter, VolumeUnit.Milliliter) => new Volume((value.Value * 1e3) / 1e-3d, VolumeUnit.Milliliter),
                (VolumeUnit.CubicMeter, VolumeUnit.OilBarrel) => new Volume(value.Value / 0.158987294928, VolumeUnit.OilBarrel),
                (VolumeUnit.CubicMeter, VolumeUnit.UkTablespoon) => new Volume(value.Value / 1.5e-5, VolumeUnit.UkTablespoon),
                (VolumeUnit.CubicMeter, VolumeUnit.UsBeerBarrel) => new Volume(value.Value / 0.1173477658, VolumeUnit.UsBeerBarrel),
                (VolumeUnit.CubicMeter, VolumeUnit.UsCustomaryCup) => new Volume(value.Value / 0.0002365882365, VolumeUnit.UsCustomaryCup),
                (VolumeUnit.CubicMeter, VolumeUnit.UsGallon) => new Volume(value.Value / 0.00378541, VolumeUnit.UsGallon),
                (VolumeUnit.CubicMeter, VolumeUnit.UsLegalCup) => new Volume(value.Value / 0.00024, VolumeUnit.UsLegalCup),
                (VolumeUnit.CubicMeter, VolumeUnit.UsOunce) => new Volume(value.Value / 2.957352956253760505068307980135e-5, VolumeUnit.UsOunce),
                (VolumeUnit.CubicMeter, VolumeUnit.UsPint) => new Volume(value.Value / 4.73176473e-4, VolumeUnit.UsPint),
                (VolumeUnit.CubicMeter, VolumeUnit.UsQuart) => new Volume(value.Value / 9.46352946e-4, VolumeUnit.UsQuart),
                (VolumeUnit.CubicMeter, VolumeUnit.UsTablespoon) => new Volume(value.Value / 1.478676478125e-5, VolumeUnit.UsTablespoon),
                (VolumeUnit.CubicMeter, VolumeUnit.UsTeaspoon) => new Volume(value.Value / 4.92892159375e-6, VolumeUnit.UsTeaspoon),
