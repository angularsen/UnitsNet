...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = AmplitudeRatio.From(1.0, AmplitudeRatio.BaseUnit);
        ...
        {
            var inBaseUnit = AmplitudeRatio.From(1.0, AmplitudeRatio.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(AmplitudeRatioUnit)));
        }
        ...
        {
            var quantity = AmplitudeRatio.FromDecibelVolts(1.0);
            Assert.Equal(AmplitudeRatio.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
