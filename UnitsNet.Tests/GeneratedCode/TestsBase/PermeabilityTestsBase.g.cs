...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = Permeability.From(1.0, Permeability.BaseUnit);
        ...
        {
            var inBaseUnit = Permeability.From(1.0, Permeability.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(PermeabilityUnit)));
        }
        ...
        {
            var quantity = Permeability.FromHenriesPerMeter(1.0);
            Assert.Equal(Permeability.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
