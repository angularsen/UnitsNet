...
namespace UnitsNet
{
    ...
    public partial struct SpecificWeight : IQuantity<SpecificWeightUnit>, IEquatable<SpecificWeight>, IComparable, IComparable<SpecificWeight>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="SpecificWeight" /> instances.
        /// </summary>
        ...
        private double GetValueAs(SpecificWeightUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<SpecificWeight>(inBaseUnits.Unit, unit, out var conversionFunction))
