...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<CompressibilityUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.CompressibilityUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<CompressibilityUnit>(str, culture, out unit);
        }
