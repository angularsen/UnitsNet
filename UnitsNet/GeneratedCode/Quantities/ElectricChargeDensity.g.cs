...
namespace UnitsNet
{
    ...
    public partial struct ElectricChargeDensity : IQuantity<ElectricChargeDensityUnit>, IEquatable<ElectricChargeDensity>, IComparable, IComparable<ElectricChargeDensity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="ElectricChargeDensity"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="ElectricChargeDensity"/> from.</param>
        public static implicit operator ElectricChargeDensity(ValueTuple<QuantityValue, ElectricChargeDensityUnit> tuple) => new ElectricChargeDensity((double)tuple.Item1, tuple.Item2);
