    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(CloudCoverUnit), (int)CloudCoverUnit.Fraction, new string[]{""}),
                ("en-US", typeof(CloudCoverUnit), (int)CloudCoverUnit.Okta, new string[]{"oktas"}),
                ("en-US", typeof(CloudCoverUnit), (int)CloudCoverUnit.Percent, new string[]{"%"}),
