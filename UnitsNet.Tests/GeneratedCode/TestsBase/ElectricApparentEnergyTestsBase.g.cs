...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ToString_WithSwedishCulture_ReturnsUnitAbbreviationForEnglishCultureSinceThereAreNoMappings()
        {
            ...
            Assert.Equal("1 kVAh", new ElectricApparentEnergy(1, ElectricApparentEnergyUnit.KilovoltampereHour).ToString(null, swedishCulture));
            Assert.Equal("1 MVAh", new ElectricApparentEnergy(1, ElectricApparentEnergyUnit.MegavoltampereHour).ToString(null, swedishCulture));
            Assert.Equal("1 VAh", new ElectricApparentEnergy(1, ElectricApparentEnergyUnit.VoltampereHour).ToString(null, swedishCulture));
        }
