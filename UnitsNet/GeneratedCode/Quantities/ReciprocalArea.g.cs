...
namespace UnitsNet
{
    ...
    public partial struct ReciprocalArea : IQuantity<ReciprocalAreaUnit>, IEquatable<ReciprocalArea>, IComparable, IComparable<ReciprocalArea>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ReciprocalArea" /> instances.
        /// </summary>
        ...
        private double GetValueAs(ReciprocalAreaUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ReciprocalArea>(inBaseUnits.Unit, unit, out var conversionFunction))
