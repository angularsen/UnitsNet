...
namespace UnitsNet
{
    ...
    public partial struct ThermalConductivity : IQuantity<ThermalConductivityUnit>, IEquatable<ThermalConductivity>, IComparable, IComparable<ThermalConductivity>, IConvertible
    {
        ...
        public ThermalConductivity(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static ThermalConductivityUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static ThermalConductivityUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
