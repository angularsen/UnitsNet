...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = TemperatureChangeRate.From(1.0, TemperatureChangeRate.BaseUnit);
        ...
        {
            var inBaseUnit = TemperatureChangeRate.From(1.0, TemperatureChangeRate.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(TemperatureChangeRateUnit)));
        }
        ...
        {
            var quantity = TemperatureChangeRate.FromDegreesCelsiusPerSecond(1.0);
            Assert.Equal(TemperatureChangeRate.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
