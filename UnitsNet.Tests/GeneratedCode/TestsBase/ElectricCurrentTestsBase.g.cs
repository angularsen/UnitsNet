...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricCurrent.From(1.0, ElectricCurrent.BaseUnit);
        ...
        {
            var inBaseUnit = ElectricCurrent.From(1.0, ElectricCurrent.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricCurrentUnit)));
        }
        ...
        {
            var quantity = ElectricCurrent.FromAmperes(1.0);
            Assert.Equal(ElectricCurrent.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
