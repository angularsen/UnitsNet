        ...
        IFormattable
    {
        ...
        private bool TryToUnit(ThermalConductivityUnit unit, [NotNullWhen(true)] out ThermalConductivity? converted)
        {
            ...
            ThermalConductivity? convertedOrNull = (Unit, unit) switch
            {
                ...
                (ThermalConductivityUnit.BtuPerHourFootFahrenheit, ThermalConductivityUnit.WattPerMeterKelvin) => new ThermalConductivity(_value * new QuantityValue(173073467, 100000000, false), ThermalConductivityUnit.WattPerMeterKelvin),

                // BaseUnit -> ThermalConductivityUnit
                (ThermalConductivityUnit.WattPerMeterKelvin, ThermalConductivityUnit.BtuPerHourFootFahrenheit) => new ThermalConductivity(_value * new QuantityValue(100000000, 173073467, false), ThermalConductivityUnit.BtuPerHourFootFahrenheit),
