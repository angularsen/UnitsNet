...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<AccelerationUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.AccelerationUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<AccelerationUnit>(str, culture, out unit);
        }
