...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Irradiation()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, IrradiationUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, IrradiationUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(IrradiationUnit unit) => GetAbbreviation(unit, null);
