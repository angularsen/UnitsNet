...
namespace UnitsNet
{
    ...
    public partial struct Irradiance : IQuantity<IrradianceUnit>, IEquatable<Irradiance>, IComparable, IComparable<Irradiance>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Irradiance" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<Irradiance>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(IrradianceUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Irradiance>(inBaseUnits.Unit, unit, out var conversionFunction))
