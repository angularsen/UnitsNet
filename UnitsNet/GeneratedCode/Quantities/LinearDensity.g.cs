...
namespace UnitsNet
{
    ...
    public partial struct LinearDensity : IQuantity<LinearDensityUnit>, IEquatable<LinearDensity>, IComparable, IComparable<LinearDensity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="LinearDensity" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<LinearDensity>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(LinearDensityUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<LinearDensity>(inBaseUnits.Unit, unit, out var conversionFunction))
