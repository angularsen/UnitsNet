...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static SolidAngle()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, SolidAngleUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, SolidAngleUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(SolidAngleUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(SolidAngleUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.SolidAngle";
                var resourceManager = new ResourceManager(resourceName, typeof(SolidAngle).Assembly);
