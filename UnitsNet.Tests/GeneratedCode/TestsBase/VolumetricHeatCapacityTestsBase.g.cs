...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = VolumetricHeatCapacity.From(1.0, VolumetricHeatCapacity.BaseUnit);
        ...
        {
            var inBaseUnit = VolumetricHeatCapacity.From(1.0, VolumetricHeatCapacity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(VolumetricHeatCapacityUnit)));
        }
        ...
        {
            var quantity = VolumetricHeatCapacity.FromJoulesPerCubicMeterKelvin(1.0);
            Assert.Equal(VolumetricHeatCapacity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
