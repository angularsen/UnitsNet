...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MolarEntropy()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MolarEntropyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MolarEntropyUnit Unit), List<string>> Abbreviations { get; }
