...
namespace UnitsNet
{
    ...
    public partial struct LinearDensity : IQuantity<LinearDensityUnit>, IEquatable<LinearDensity>, IComparable, IComparable<LinearDensity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="LinearDensity"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="LinearDensity"/> from.</param>
        public static implicit operator LinearDensity(ValueTuple<QuantityValue, LinearDensityUnit> tuple) => new LinearDensity((double)tuple.Item1, tuple.Item2);
