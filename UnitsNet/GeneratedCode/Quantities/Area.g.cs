...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Area()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, AreaUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, AreaUnit Unit), List<string>> Abbreviations { get; }
