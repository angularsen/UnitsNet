...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Entropy()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, EntropyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, EntropyUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(EntropyUnit unit) => GetAbbreviation(unit, null);
