...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricInductance()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricInductanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricInductanceUnit Unit), List<string>> Abbreviations { get; }
