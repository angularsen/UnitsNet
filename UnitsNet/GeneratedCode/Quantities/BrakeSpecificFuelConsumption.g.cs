...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static BrakeSpecificFuelConsumption()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, BrakeSpecificFuelConsumptionUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, BrakeSpecificFuelConsumptionUnit Unit), List<string>> Abbreviations { get; }
