...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static AmplitudeRatio()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, AmplitudeRatioUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, AmplitudeRatioUnit Unit), List<string>> Abbreviations { get; }
