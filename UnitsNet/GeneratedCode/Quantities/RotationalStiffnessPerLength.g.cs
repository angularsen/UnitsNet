...
namespace UnitsNet
{
    ...
    public partial struct RotationalStiffnessPerLength : IQuantity<RotationalStiffnessPerLengthUnit>, IEquatable<RotationalStiffnessPerLength>, IComparable, IComparable<RotationalStiffnessPerLength>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="RotationalStiffnessPerLength" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<RotationalStiffnessPerLength>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(RotationalStiffnessPerLengthUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<RotationalStiffnessPerLength>(inBaseUnits.Unit, unit, out var conversionFunction))
