...
namespace UnitsNet
{
    ...
    public partial struct ElectricCharge : IQuantity<ElectricChargeUnit>, IComparable, IComparable<ElectricCharge>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ElectricChargeUnit>)this).As(unitAsElectricChargeUnit);
        }
        ...
        /// <summary>
        ///     Converts this ElectricCharge to another ElectricCharge with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ElectricCharge with the specified unit.</returns>
        public QuantityValue ToQuantity(ElectricChargeUnit unit)
        {
