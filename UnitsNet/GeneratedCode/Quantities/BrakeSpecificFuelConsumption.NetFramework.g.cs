...
namespace UnitsNet
{
    ...
    /// </summary>
    public partial struct BrakeSpecificFuelConsumption : IQuantity<BrakeSpecificFuelConsumptionUnit>, IEquatable<BrakeSpecificFuelConsumption>, IComparable, IComparable<BrakeSpecificFuelConsumption>, IConvertible
    {
        /// <summary>
        ...
        public BrakeSpecificFuelConsumption(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static BrakeSpecificFuelConsumptionUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static BrakeSpecificFuelConsumptionUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
