...
namespace UnitsNet
{
    ...
    public partial struct MassFlux : IQuantity<MassFluxUnit>, IEquatable<MassFlux>, IComparable, IComparable<MassFlux>, IConvertible
    {
        ...
        public MassFlux(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static MassFluxUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static MassFluxUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
