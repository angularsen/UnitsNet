...
namespace UnitsNet
{
    public sealed partial class UnitConverter
    {
        ...
        public static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.FootPerMillisecondPerMicrosecond, q => q.ToUnit(AccelerationUnit.FootPerMillisecondPerMicrosecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.FootPerMillisecondPerMicrosecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.FootPerMillisecondPerMillisecond, q => q.ToUnit(AccelerationUnit.FootPerMillisecondPerMillisecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.FootPerMillisecondPerMillisecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.FootPerMillisecondPerSecond, q => q.ToUnit(AccelerationUnit.FootPerMillisecondPerSecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.FootPerMillisecondPerSecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.FootPerMillisecondSquared, q => q.ToUnit(AccelerationUnit.FootPerMillisecondSquared));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.FootPerMillisecondSquared, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.FootPerSecondPerMicrosecond, q => q.ToUnit(AccelerationUnit.FootPerSecondPerMicrosecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.FootPerSecondPerMicrosecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.FootPerSecondPerMillisecond, q => q.ToUnit(AccelerationUnit.FootPerSecondPerMillisecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.FootPerSecondPerMillisecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.FootPerSecondPerSecond, q => q.ToUnit(AccelerationUnit.FootPerSecondPerSecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.FootPerSecondPerSecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.MeterPerMillisecondPerMicrosecond, q => q.ToUnit(AccelerationUnit.MeterPerMillisecondPerMicrosecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.MeterPerMillisecondPerMicrosecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.MeterPerMillisecondPerMillisecond, q => q.ToUnit(AccelerationUnit.MeterPerMillisecondPerMillisecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.MeterPerMillisecondPerMillisecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.MeterPerMillisecondPerSecond, q => q.ToUnit(AccelerationUnit.MeterPerMillisecondPerSecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.MeterPerMillisecondPerSecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.MeterPerMillisecondSquared, q => q.ToUnit(AccelerationUnit.MeterPerMillisecondSquared));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.MeterPerMillisecondSquared, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.MeterPerSecondPerMicrosecond, q => q.ToUnit(AccelerationUnit.MeterPerSecondPerMicrosecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.MeterPerSecondPerMicrosecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.MeterPerSecondPerMillisecond, q => q.ToUnit(AccelerationUnit.MeterPerSecondPerMillisecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.MeterPerSecondPerMillisecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Acceleration>(Acceleration.BaseUnit, AccelerationUnit.MeterPerSecondPerSecond, q => q.ToUnit(AccelerationUnit.MeterPerSecondPerSecond));
            unitConverter.SetConversionFunction<Acceleration>(AccelerationUnit.MeterPerSecondPerSecond, Acceleration.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Area>(Area.BaseUnit, AreaUnit.Section, q => q.ToUnit(AreaUnit.Section));
            unitConverter.SetConversionFunction<Area>(AreaUnit.Section, Area.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<AreaDensity>(AreaDensity.BaseUnit, AreaDensityUnit.KilogramPerSquareFoot, q => q.ToUnit(AreaDensityUnit.KilogramPerSquareFoot));
            unitConverter.SetConversionFunction<AreaDensity>(AreaDensityUnit.KilogramPerSquareFoot, AreaDensity.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<AreaDensity>(AreaDensity.BaseUnit, AreaDensity.BaseUnit, q => q);
            unitConverter.SetConversionFunction<AreaDensity>(AreaDensity.BaseUnit, AreaDensityUnit.PoundPerSquareFoot, q => q.ToUnit(AreaDensityUnit.PoundPerSquareFoot));
            unitConverter.SetConversionFunction<AreaDensity>(AreaDensityUnit.PoundPerSquareFoot, AreaDensity.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<AreaDensity>(AreaDensity.BaseUnit, AreaDensityUnit.PoundPerSquareMeter, q => q.ToUnit(AreaDensityUnit.PoundPerSquareMeter));
            unitConverter.SetConversionFunction<AreaDensity>(AreaDensityUnit.PoundPerSquareMeter, AreaDensity.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.BarPerMeterEq, q => q.ToUnit(DensityUnit.BarPerMeterEq));
            unitConverter.SetConversionFunction<Density>(DensityUnit.BarPerMeterEq, Density.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.DegreeApi, q => q.ToUnit(DensityUnit.DegreeApi));
            unitConverter.SetConversionFunction<Density>(DensityUnit.DegreeApi, Density.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.KilogramPerSquareCentimeterPerFoot, q => q.ToUnit(DensityUnit.KilogramPerSquareCentimeterPerFoot));
            unitConverter.SetConversionFunction<Density>(DensityUnit.KilogramPerSquareCentimeterPerFoot, Density.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.KilogramPerSquareCentimeterPerMeter, q => q.ToUnit(DensityUnit.KilogramPerSquareCentimeterPerMeter));
            unitConverter.SetConversionFunction<Density>(DensityUnit.KilogramPerSquareCentimeterPerMeter, Density.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.KilopascalPerFootEq, q => q.ToUnit(DensityUnit.KilopascalPerFootEq));
            unitConverter.SetConversionFunction<Density>(DensityUnit.KilopascalPerFootEq, Density.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.KilopascalPerMeterEq, q => q.ToUnit(DensityUnit.KilopascalPerMeterEq));
            unitConverter.SetConversionFunction<Density>(DensityUnit.KilopascalPerMeterEq, Density.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PascalPerMeterEq, q => q.ToUnit(DensityUnit.PascalPerMeterEq));
            unitConverter.SetConversionFunction<Density>(DensityUnit.PascalPerMeterEq, Density.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PoundForcePerSquareInchPerFoot, q => q.ToUnit(DensityUnit.PoundForcePerSquareInchPerFoot));
            unitConverter.SetConversionFunction<Density>(DensityUnit.PoundForcePerSquareInchPerFoot, Density.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PoundForcePerSquareInchPerMeter, q => q.ToUnit(DensityUnit.PoundForcePerSquareInchPerMeter));
            unitConverter.SetConversionFunction<Density>(DensityUnit.PoundForcePerSquareInchPerMeter, Density.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PoundForcePerSquareInchPerThousandFoot, q => q.ToUnit(DensityUnit.PoundForcePerSquareInchPerThousandFoot));
            unitConverter.SetConversionFunction<Density>(DensityUnit.PoundForcePerSquareInchPerThousandFoot, Density.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PoundPerBarrel, q => q.ToUnit(DensityUnit.PoundPerBarrel));
            unitConverter.SetConversionFunction<Density>(DensityUnit.PoundPerBarrel, Density.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PoundPerGallon, q => q.ToUnit(DensityUnit.PoundPerGallon));
            unitConverter.SetConversionFunction<Density>(DensityUnit.PoundPerGallon, Density.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.SpecificGravityApiDef, q => q.ToUnit(DensityUnit.SpecificGravityApiDef));
            unitConverter.SetConversionFunction<Density>(DensityUnit.SpecificGravityApiDef, Density.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.SpecificGravityToAir, q => q.ToUnit(DensityUnit.SpecificGravityToAir));
            unitConverter.SetConversionFunction<Density>(DensityUnit.SpecificGravityToAir, Density.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.TonPerCubicMeter, q => q.ToUnit(DensityUnit.TonPerCubicMeter));
            unitConverter.SetConversionFunction<Density>(DensityUnit.TonPerCubicMeter, Density.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Duration>(Duration.BaseUnit, DurationUnit.MillionYears, q => q.ToUnit(DurationUnit.MillionYears));
            unitConverter.SetConversionFunction<Duration>(DurationUnit.MillionYears, Duration.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Duration>(Duration.BaseUnit, DurationUnit.Month, q => q.ToUnit(DurationUnit.Month));
            unitConverter.SetConversionFunction<Duration>(DurationUnit.Month, Duration.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Duration>(Duration.BaseUnit, DurationUnit.Year, q => q.ToUnit(DurationUnit.Year));
            unitConverter.SetConversionFunction<Duration>(DurationUnit.Year, Duration.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<ElectricConductance>(ElectricConductance.BaseUnit, ElectricConductanceUnit.Mho, q => q.ToUnit(ElectricConductanceUnit.Mho));
            unitConverter.SetConversionFunction<ElectricConductance>(ElectricConductanceUnit.Mho, ElectricConductance.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<ElectricConductance>(ElectricConductance.BaseUnit, ElectricConductanceUnit.Millimho, q => q.ToUnit(ElectricConductanceUnit.Millimho));
            unitConverter.SetConversionFunction<ElectricConductance>(ElectricConductanceUnit.Millimho, ElectricConductance.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<ElectricCurrent>(ElectricCurrent.BaseUnit, ElectricCurrentUnit.GramPerMole, q => q.ToUnit(ElectricCurrentUnit.GramPerMole));
            unitConverter.SetConversionFunction<ElectricCurrent>(ElectricCurrentUnit.GramPerMole, ElectricCurrent.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<ElectricCurrent>(ElectricCurrent.BaseUnit, ElectricCurrentUnit.KilogramPerMole, q => q.ToUnit(ElectricCurrentUnit.KilogramPerMole));
            unitConverter.SetConversionFunction<ElectricCurrent>(ElectricCurrentUnit.KilogramPerMole, ElectricCurrent.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<ElectricCurrent>(ElectricCurrent.BaseUnit, ElectricCurrentUnit.PoundPerMole, q => q.ToUnit(ElectricCurrentUnit.PoundPerMole));
            unitConverter.SetConversionFunction<ElectricCurrent>(ElectricCurrentUnit.PoundPerMole, ElectricCurrent.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<ElectricPotential>(ElectricPotential.BaseUnit, ElectricPotentialUnit.Nanovolt, q => q.ToUnit(ElectricPotentialUnit.Nanovolt));
            unitConverter.SetConversionFunction<ElectricPotential>(ElectricPotentialUnit.Nanovolt, ElectricPotential.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<ElectricResistance>(ElectricResistance.BaseUnit, ElectricResistanceUnit.Kilohm, q => q.ToUnit(ElectricResistanceUnit.Kilohm));
            unitConverter.SetConversionFunction<ElectricResistance>(ElectricResistanceUnit.Kilohm, ElectricResistance.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<ElectricResistance>(ElectricResistance.BaseUnit, ElectricResistanceUnit.Megohm, q => q.ToUnit(ElectricResistanceUnit.Megohm));
            unitConverter.SetConversionFunction<ElectricResistance>(ElectricResistanceUnit.Megohm, ElectricResistance.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<ElectricResistivity>(ElectricResistivity.BaseUnit, ElectricResistivityUnit.OhmFoot, q => q.ToUnit(ElectricResistivityUnit.OhmFoot));
            unitConverter.SetConversionFunction<ElectricResistivity>(ElectricResistivityUnit.OhmFoot, ElectricResistivity.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<ElectricResistivity>(ElectricResistivity.BaseUnit, ElectricResistivityUnit.OhmInch, q => q.ToUnit(ElectricResistivityUnit.OhmInch));
            unitConverter.SetConversionFunction<ElectricResistivity>(ElectricResistivityUnit.OhmInch, ElectricResistivity.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.BritishThermalUnitThermochemical, q => q.ToUnit(EnergyUnit.BritishThermalUnitThermochemical));
            unitConverter.SetConversionFunction<Energy>(EnergyUnit.BritishThermalUnitThermochemical, Energy.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.CalorieThermochemical, q => q.ToUnit(EnergyUnit.CalorieThermochemical));
            unitConverter.SetConversionFunction<Energy>(EnergyUnit.CalorieThermochemical, Energy.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.DecanewtonMeter, q => q.ToUnit(EnergyUnit.DecanewtonMeter));
            unitConverter.SetConversionFunction<Energy>(EnergyUnit.DecanewtonMeter, Energy.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.KilocalorieThermochemical, q => q.ToUnit(EnergyUnit.KilocalorieThermochemical));
            unitConverter.SetConversionFunction<Energy>(EnergyUnit.KilocalorieThermochemical, Energy.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.KilodecanewtonMeter, q => q.ToUnit(EnergyUnit.KilodecanewtonMeter));
            unitConverter.SetConversionFunction<Energy>(EnergyUnit.KilodecanewtonMeter, Energy.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.KilonewtonMeter, q => q.ToUnit(EnergyUnit.KilonewtonMeter));
            unitConverter.SetConversionFunction<Energy>(EnergyUnit.KilonewtonMeter, Energy.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.KilopoundForceFoot, q => q.ToUnit(EnergyUnit.KilopoundForceFoot));
            unitConverter.SetConversionFunction<Energy>(EnergyUnit.KilopoundForceFoot, Energy.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.NewtonMeter, q => q.ToUnit(EnergyUnit.NewtonMeter));
            unitConverter.SetConversionFunction<Energy>(EnergyUnit.NewtonMeter, Energy.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Energy>(Energy.BaseUnit, EnergyUnit.PoundForceFoot, q => q.ToUnit(EnergyUnit.PoundForceFoot));
            unitConverter.SetConversionFunction<Energy>(EnergyUnit.PoundForceFoot, Energy.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Entropy>(Entropy.BaseUnit, EntropyUnit.BritishThermalUnitPerDegreeRankin, q => q.ToUnit(EntropyUnit.BritishThermalUnitPerDegreeRankin));
            unitConverter.SetConversionFunction<Entropy>(EntropyUnit.BritishThermalUnitPerDegreeRankin, Entropy.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Force>(Force.BaseUnit, ForceUnit.Dekanewton, q => q.ToUnit(ForceUnit.Dekanewton));
            unitConverter.SetConversionFunction<Force>(ForceUnit.Dekanewton, Force.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Force>(Force.BaseUnit, ForceUnit.Dyne, q => q.ToUnit(ForceUnit.Dyne));
            unitConverter.SetConversionFunction<Force>(ForceUnit.Dyne, Force.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Force>(Force.BaseUnit, ForceUnit.GramForce, q => q.ToUnit(ForceUnit.GramForce));
            unitConverter.SetConversionFunction<Force>(ForceUnit.GramForce, Force.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Force>(Force.BaseUnit, ForceUnit.Kilodekanewton, q => q.ToUnit(ForceUnit.Kilodekanewton));
            unitConverter.SetConversionFunction<Force>(ForceUnit.Kilodekanewton, Force.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Force>(Force.BaseUnit, ForceUnit.Kilodyne, q => q.ToUnit(ForceUnit.Kilodyne));
            unitConverter.SetConversionFunction<Force>(ForceUnit.Kilodyne, Force.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Frequency>(Frequency.BaseUnit, FrequencyUnit.PerMicrosecond, q => q.ToUnit(FrequencyUnit.PerMicrosecond));
            unitConverter.SetConversionFunction<Frequency>(FrequencyUnit.PerMicrosecond, Frequency.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Frequency>(Frequency.BaseUnit, FrequencyUnit.PerMillisecond, q => q.ToUnit(FrequencyUnit.PerMillisecond));
            unitConverter.SetConversionFunction<Frequency>(FrequencyUnit.PerMillisecond, Frequency.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<KinematicViscosity>(KinematicViscosity.BaseUnit, KinematicViscosityUnit.Centipoise, q => q.ToUnit(KinematicViscosityUnit.Centipoise));
            unitConverter.SetConversionFunction<KinematicViscosity>(KinematicViscosityUnit.Centipoise, KinematicViscosity.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<KinematicViscosity>(KinematicViscosity.BaseUnit, KinematicViscosityUnit.KilopascalDay, q => q.ToUnit(KinematicViscosityUnit.KilopascalDay));
            unitConverter.SetConversionFunction<KinematicViscosity>(KinematicViscosityUnit.KilopascalDay, KinematicViscosity.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<KinematicViscosity>(KinematicViscosity.BaseUnit, KinematicViscosityUnit.MillipascalSecond, q => q.ToUnit(KinematicViscosityUnit.MillipascalSecond));
            unitConverter.SetConversionFunction<KinematicViscosity>(KinematicViscosityUnit.MillipascalSecond, KinematicViscosity.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<KinematicViscosity>(KinematicViscosity.BaseUnit, KinematicViscosityUnit.PascalSecond, q => q.ToUnit(KinematicViscosityUnit.PascalSecond));
            unitConverter.SetConversionFunction<KinematicViscosity>(KinematicViscosityUnit.PascalSecond, KinematicViscosity.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.BillionCubicFeetPerAcre, q => q.ToUnit(LengthUnit.BillionCubicFeetPerAcre));
            unitConverter.SetConversionFunction<Length>(LengthUnit.BillionCubicFeetPerAcre, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.BillionCubicFeetPerHundredAcres, q => q.ToUnit(LengthUnit.BillionCubicFeetPerHundredAcres));
            unitConverter.SetConversionFunction<Length>(LengthUnit.BillionCubicFeetPerHundredAcres, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.BillionCubicFeetPerSection, q => q.ToUnit(LengthUnit.BillionCubicFeetPerSection));
            unitConverter.SetConversionFunction<Length>(LengthUnit.BillionCubicFeetPerSection, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.BritishChainSearsOne9TwoTwo, q => q.ToUnit(LengthUnit.BritishChainSearsOne9TwoTwo));
            unitConverter.SetConversionFunction<Length>(LengthUnit.BritishChainSearsOne9TwoTwo, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.BritishChainSearsOne9TwoTwoTruncated, q => q.ToUnit(LengthUnit.BritishChainSearsOne9TwoTwoTruncated));
            unitConverter.SetConversionFunction<Length>(LengthUnit.BritishChainSearsOne9TwoTwoTruncated, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.BritishFootSearsOne9TwoTwo, q => q.ToUnit(LengthUnit.BritishFootSearsOne9TwoTwo));
            unitConverter.SetConversionFunction<Length>(LengthUnit.BritishFootSearsOne9TwoTwo, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.BritishYardSearsOne9TwoTwo, q => q.ToUnit(LengthUnit.BritishYardSearsOne9TwoTwo));
            unitConverter.SetConversionFunction<Length>(LengthUnit.BritishYardSearsOne9TwoTwo, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.BritishYardSearsOne9TwoTwoTruncated, q => q.ToUnit(LengthUnit.BritishYardSearsOne9TwoTwoTruncated));
            unitConverter.SetConversionFunction<Length>(LengthUnit.BritishYardSearsOne9TwoTwoTruncated, Length.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.ClarkesFoot, q => q.ToUnit(LengthUnit.ClarkesFoot));
            unitConverter.SetConversionFunction<Length>(LengthUnit.ClarkesFoot, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.ClarkesLink, q => q.ToUnit(LengthUnit.ClarkesLink));
            unitConverter.SetConversionFunction<Length>(LengthUnit.ClarkesLink, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.ClarkesYard, q => q.ToUnit(LengthUnit.ClarkesYard));
            unitConverter.SetConversionFunction<Length>(LengthUnit.ClarkesYard, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.CubicFootPerSquareFoot, q => q.ToUnit(LengthUnit.CubicFootPerSquareFoot));
            unitConverter.SetConversionFunction<Length>(LengthUnit.CubicFootPerSquareFoot, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.CubicMeterPerSquareMeter, q => q.ToUnit(LengthUnit.CubicMeterPerSquareMeter));
            unitConverter.SetConversionFunction<Length>(LengthUnit.CubicMeterPerSquareMeter, Length.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.GermanLegalMeter, q => q.ToUnit(LengthUnit.GermanLegalMeter));
            unitConverter.SetConversionFunction<Length>(LengthUnit.GermanLegalMeter, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.GoldCoastFoot, q => q.ToUnit(LengthUnit.GoldCoastFoot));
            unitConverter.SetConversionFunction<Length>(LengthUnit.GoldCoastFoot, Length.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.InchBy3Two, q => q.ToUnit(LengthUnit.InchBy3Two));
            unitConverter.SetConversionFunction<Length>(LengthUnit.InchBy3Two, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.IndianYard, q => q.ToUnit(LengthUnit.IndianYard));
            unitConverter.SetConversionFunction<Length>(LengthUnit.IndianYard, Length.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.MillionBarrelsPerAcre, q => q.ToUnit(LengthUnit.MillionBarrelsPerAcre));
            unitConverter.SetConversionFunction<Length>(LengthUnit.MillionBarrelsPerAcre, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.MillionBarrelsPerSection, q => q.ToUnit(LengthUnit.MillionBarrelsPerSection));
            unitConverter.SetConversionFunction<Length>(LengthUnit.MillionBarrelsPerSection, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.MillionBarrelsPerSquareKilometer, q => q.ToUnit(LengthUnit.MillionBarrelsPerSquareKilometer));
            unitConverter.SetConversionFunction<Length>(LengthUnit.MillionBarrelsPerSquareKilometer, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.MillionCubicFeetPerAcre, q => q.ToUnit(LengthUnit.MillionCubicFeetPerAcre));
            unitConverter.SetConversionFunction<Length>(LengthUnit.MillionCubicFeetPerAcre, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.MillionCubicFeetPerSection, q => q.ToUnit(LengthUnit.MillionCubicFeetPerSection));
            unitConverter.SetConversionFunction<Length>(LengthUnit.MillionCubicFeetPerSection, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.MillionCubicFeetPerSquareKilometer, q => q.ToUnit(LengthUnit.MillionCubicFeetPerSquareKilometer));
            unitConverter.SetConversionFunction<Length>(LengthUnit.MillionCubicFeetPerSquareKilometer, Length.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.ThousandBarrelsPerAcre, q => q.ToUnit(LengthUnit.ThousandBarrelsPerAcre));
            unitConverter.SetConversionFunction<Length>(LengthUnit.ThousandBarrelsPerAcre, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.ThousandBarrelsPerSquareKilometer, q => q.ToUnit(LengthUnit.ThousandBarrelsPerSquareKilometer));
            unitConverter.SetConversionFunction<Length>(LengthUnit.ThousandBarrelsPerSquareKilometer, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.ThousandCubicFeetPerAcre, q => q.ToUnit(LengthUnit.ThousandCubicFeetPerAcre));
            unitConverter.SetConversionFunction<Length>(LengthUnit.ThousandCubicFeetPerAcre, Length.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Length>(Length.BaseUnit, LengthUnit.ThousandCubicFeetPerSquareKilometer, q => q.ToUnit(LengthUnit.ThousandCubicFeetPerSquareKilometer));
            unitConverter.SetConversionFunction<Length>(LengthUnit.ThousandCubicFeetPerSquareKilometer, Length.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Mass>(Mass.BaseUnit, MassUnit.MetricTon, q => q.ToUnit(MassUnit.MetricTon));
            unitConverter.SetConversionFunction<Mass>(MassUnit.MetricTon, Mass.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Mass>(Mass.BaseUnit, MassUnit.UkTonne, q => q.ToUnit(MassUnit.UkTonne));
            unitConverter.SetConversionFunction<Mass>(MassUnit.UkTonne, Mass.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Mass>(Mass.BaseUnit, MassUnit.UsTonne, q => q.ToUnit(MassUnit.UsTonne));
            unitConverter.SetConversionFunction<Mass>(MassUnit.UsTonne, Mass.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<MassFlow>(MassFlow.BaseUnit, MassFlowUnit.UkTonnePerDay, q => q.ToUnit(MassFlowUnit.UkTonnePerDay));
            unitConverter.SetConversionFunction<MassFlow>(MassFlowUnit.UkTonnePerDay, MassFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MassFlow>(MassFlow.BaseUnit, MassFlowUnit.UsTonnePerDay, q => q.ToUnit(MassFlowUnit.UsTonnePerDay));
            unitConverter.SetConversionFunction<MassFlow>(MassFlowUnit.UsTonnePerDay, MassFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<MassFraction>(MassFraction.BaseUnit, MassFractionUnit.One, q => q.ToUnit(MassFractionUnit.One));
            unitConverter.SetConversionFunction<MassFraction>(MassFractionUnit.One, MassFraction.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<MassFraction>(MassFraction.BaseUnit, MassFractionUnit.PoundPerPound, q => q.ToUnit(MassFractionUnit.PoundPerPound));
            unitConverter.SetConversionFunction<MassFraction>(MassFractionUnit.PoundPerPound, MassFraction.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergy.BaseUnit, MolarEnergyUnit.BritishThermalUnitPerMole, q => q.ToUnit(MolarEnergyUnit.BritishThermalUnitPerMole));
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergyUnit.BritishThermalUnitPerMole, MolarEnergy.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergy.BaseUnit, MolarEnergyUnit.BritishThermalUnitPerPoundMole, q => q.ToUnit(MolarEnergyUnit.BritishThermalUnitPerPoundMole));
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergyUnit.BritishThermalUnitPerPoundMole, MolarEnergy.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergy.BaseUnit, MolarEnergyUnit.BritishThermalUnitThermochemicalPerMole, q => q.ToUnit(MolarEnergyUnit.BritishThermalUnitThermochemicalPerMole));
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergyUnit.BritishThermalUnitThermochemicalPerMole, MolarEnergy.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergy.BaseUnit, MolarEnergyUnit.BritishThermalUnitThermochemicalPerPoundMole, q => q.ToUnit(MolarEnergyUnit.BritishThermalUnitThermochemicalPerPoundMole));
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergyUnit.BritishThermalUnitThermochemicalPerPoundMole, MolarEnergy.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergy.BaseUnit, MolarEnergyUnit.CaloriePerMole, q => q.ToUnit(MolarEnergyUnit.CaloriePerMole));
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergyUnit.CaloriePerMole, MolarEnergy.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergy.BaseUnit, MolarEnergyUnit.CalorieThermochemicalPerMole, q => q.ToUnit(MolarEnergyUnit.CalorieThermochemicalPerMole));
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergyUnit.CalorieThermochemicalPerMole, MolarEnergy.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergy.BaseUnit, MolarEnergy.BaseUnit, q => q);
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergy.BaseUnit, MolarEnergyUnit.KilocaloriePerMole, q => q.ToUnit(MolarEnergyUnit.KilocaloriePerMole));
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergyUnit.KilocaloriePerMole, MolarEnergy.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergy.BaseUnit, MolarEnergyUnit.KilocalorieThermochemicalPerMole, q => q.ToUnit(MolarEnergyUnit.KilocalorieThermochemicalPerMole));
            unitConverter.SetConversionFunction<MolarEnergy>(MolarEnergyUnit.KilocalorieThermochemicalPerMole, MolarEnergy.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<MolarEntropy>(MolarEntropy.BaseUnit, MolarEntropyUnit.BritishThermalUnitPerPoundMoleDegreeRankin, q => q.ToUnit(MolarEntropyUnit.BritishThermalUnitPerPoundMoleDegreeRankin));
            unitConverter.SetConversionFunction<MolarEntropy>(MolarEntropyUnit.BritishThermalUnitPerPoundMoleDegreeRankin, MolarEntropy.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Molarity>(Molarity.BaseUnit, MolarityUnit.KilomolePerCubicFoot, q => q.ToUnit(MolarityUnit.KilomolePerCubicFoot));
            unitConverter.SetConversionFunction<Molarity>(MolarityUnit.KilomolePerCubicFoot, Molarity.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Molarity>(Molarity.BaseUnit, MolarityUnit.KilomolePerCubicMeter, q => q.ToUnit(MolarityUnit.KilomolePerCubicMeter));
            unitConverter.SetConversionFunction<Molarity>(MolarityUnit.KilomolePerCubicMeter, Molarity.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Molarity>(Molarity.BaseUnit, MolarityUnit.MolePerCubicFoot, q => q.ToUnit(MolarityUnit.MolePerCubicFoot));
            unitConverter.SetConversionFunction<Molarity>(MolarityUnit.MolePerCubicFoot, Molarity.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Molarity>(Molarity.BaseUnit, MolarityUnit.PoundMolePerCubicFoot, q => q.ToUnit(MolarityUnit.PoundMolePerCubicFoot));
            unitConverter.SetConversionFunction<Molarity>(MolarityUnit.PoundMolePerCubicFoot, Molarity.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Permeability>(Permeability.BaseUnit, PermeabilityUnit.Darcy, q => q.ToUnit(PermeabilityUnit.Darcy));
            unitConverter.SetConversionFunction<Permeability>(PermeabilityUnit.Darcy, Permeability.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Permeability>(Permeability.BaseUnit, Permeability.BaseUnit, q => q);
            unitConverter.SetConversionFunction<Permeability>(Permeability.BaseUnit, PermeabilityUnit.Microdarcy, q => q.ToUnit(PermeabilityUnit.Microdarcy));
            unitConverter.SetConversionFunction<Permeability>(PermeabilityUnit.Microdarcy, Permeability.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Permeability>(Permeability.BaseUnit, PermeabilityUnit.Millidarcy, q => q.ToUnit(PermeabilityUnit.Millidarcy));
            unitConverter.SetConversionFunction<Permeability>(PermeabilityUnit.Millidarcy, Permeability.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Permeability>(Permeability.BaseUnit, PermeabilityUnit.Nanodarcy, q => q.ToUnit(PermeabilityUnit.Nanodarcy));
            unitConverter.SetConversionFunction<Permeability>(PermeabilityUnit.Nanodarcy, Permeability.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Permeability>(Permeability.BaseUnit, PermeabilityUnit.SquareMeter, q => q.ToUnit(PermeabilityUnit.SquareMeter));
            unitConverter.SetConversionFunction<Permeability>(PermeabilityUnit.SquareMeter, Permeability.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Permeability>(Permeability.BaseUnit, PermeabilityUnit.SquareMicrometer, q => q.ToUnit(PermeabilityUnit.SquareMicrometer));
            unitConverter.SetConversionFunction<Permeability>(PermeabilityUnit.SquareMicrometer, Permeability.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.BarAbsolute, q => q.ToUnit(PressureUnit.BarAbsolute));
            unitConverter.SetConversionFunction<Pressure>(PressureUnit.BarAbsolute, Pressure.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.BarGauge, q => q.ToUnit(PressureUnit.BarGauge));
            unitConverter.SetConversionFunction<Pressure>(PressureUnit.BarGauge, Pressure.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.CentimeterWater4C, q => q.ToUnit(PressureUnit.CentimeterWater4C));
            unitConverter.SetConversionFunction<Pressure>(PressureUnit.CentimeterWater4C, Pressure.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.GramForcePerHundredSquareCentimeter, q => q.ToUnit(PressureUnit.GramForcePerHundredSquareCentimeter));
            unitConverter.SetConversionFunction<Pressure>(PressureUnit.GramForcePerHundredSquareCentimeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.MegapoundForcePerSquareInch, q => q.ToUnit(PressureUnit.MegapoundForcePerSquareInch));
            unitConverter.SetConversionFunction<Pressure>(PressureUnit.MegapoundForcePerSquareInch, Pressure.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.MillimeterMercury0C, q => q.ToUnit(PressureUnit.MillimeterMercury0C));
            unitConverter.SetConversionFunction<Pressure>(PressureUnit.MillimeterMercury0C, Pressure.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.PoundForcePerHundredSquareFoot, q => q.ToUnit(PressureUnit.PoundForcePerHundredSquareFoot));
            unitConverter.SetConversionFunction<Pressure>(PressureUnit.PoundForcePerHundredSquareFoot, Pressure.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.PoundForcePerSquareFeet, q => q.ToUnit(PressureUnit.PoundForcePerSquareFeet));
            unitConverter.SetConversionFunction<Pressure>(PressureUnit.PoundForcePerSquareFeet, Pressure.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.PoundForcePerSquareInchAbsolute, q => q.ToUnit(PressureUnit.PoundForcePerSquareInchAbsolute));
            unitConverter.SetConversionFunction<Pressure>(PressureUnit.PoundForcePerSquareInchAbsolute, Pressure.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.PoundForcePerSquareInchGauge, q => q.ToUnit(PressureUnit.PoundForcePerSquareInchGauge));
            unitConverter.SetConversionFunction<Pressure>(PressureUnit.PoundForcePerSquareInchGauge, Pressure.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.ThousandPoundForcePerSquareInch, q => q.ToUnit(PressureUnit.ThousandPoundForcePerSquareInch));
            unitConverter.SetConversionFunction<Pressure>(PressureUnit.ThousandPoundForcePerSquareInch, Pressure.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRate.BaseUnit, PressureChangeRateUnit.BarPerMinute, q => q.ToUnit(PressureChangeRateUnit.BarPerMinute));
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRateUnit.BarPerMinute, PressureChangeRate.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRate.BaseUnit, PressureChangeRateUnit.BarPerSecond, q => q.ToUnit(PressureChangeRateUnit.BarPerSecond));
            unitConverter.SetConversionFunction<PressureChangeRate>(PressureChangeRateUnit.BarPerSecond, PressureChangeRate.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Ratio>(Ratio.BaseUnit, RatioUnit.One, q => q.ToUnit(RatioUnit.One));
            unitConverter.SetConversionFunction<Ratio>(RatioUnit.One, Ratio.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<RotationalSpeed>(RotationalSpeed.BaseUnit, RotationalSpeedUnit.RotationPerMinute, q => q.ToUnit(RotationalSpeedUnit.RotationPerMinute));
            unitConverter.SetConversionFunction<RotationalSpeed>(RotationalSpeedUnit.RotationPerMinute, RotationalSpeed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<RotationalSpeed>(RotationalSpeed.BaseUnit, RotationalSpeedUnit.RotationPerSecond, q => q.ToUnit(RotationalSpeedUnit.RotationPerSecond));
            unitConverter.SetConversionFunction<RotationalSpeed>(RotationalSpeedUnit.RotationPerSecond, RotationalSpeed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<SolidAngle>(SolidAngle.BaseUnit, SolidAngleUnit.SquareDegree, q => q.ToUnit(SolidAngleUnit.SquareDegree));
            unitConverter.SetConversionFunction<SolidAngle>(SolidAngleUnit.SquareDegree, SolidAngle.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<SpecificVolume>(SpecificVolume.BaseUnit, SpecificVolumeUnit.CubicCentimeterPerGram, q => q.ToUnit(SpecificVolumeUnit.CubicCentimeterPerGram));
            unitConverter.SetConversionFunction<SpecificVolume>(SpecificVolumeUnit.CubicCentimeterPerGram, SpecificVolume.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<SpecificVolume>(SpecificVolume.BaseUnit, SpecificVolumeUnit.CubicMeterPerTonne, q => q.ToUnit(SpecificVolumeUnit.CubicMeterPerTonne));
            unitConverter.SetConversionFunction<SpecificVolume>(SpecificVolumeUnit.CubicMeterPerTonne, SpecificVolume.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<SpecificVolume>(SpecificVolume.BaseUnit, SpecificVolumeUnit.StandardCubicFootPerLongTonne, q => q.ToUnit(SpecificVolumeUnit.StandardCubicFootPerLongTonne));
            unitConverter.SetConversionFunction<SpecificVolume>(SpecificVolumeUnit.StandardCubicFootPerLongTonne, SpecificVolume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<SpecificVolume>(SpecificVolume.BaseUnit, SpecificVolumeUnit.StandardCubicFootPerTonne, q => q.ToUnit(SpecificVolumeUnit.StandardCubicFootPerTonne));
            unitConverter.SetConversionFunction<SpecificVolume>(SpecificVolumeUnit.StandardCubicFootPerTonne, SpecificVolume.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.CentimeterPerDay, q => q.ToUnit(SpeedUnit.CentimeterPerDay));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.CentimeterPerDay, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.CentimeterPerMicrosecond, q => q.ToUnit(SpeedUnit.CentimeterPerMicrosecond));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.CentimeterPerMicrosecond, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.CentimeterPerMillisecond, q => q.ToUnit(SpeedUnit.CentimeterPerMillisecond));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.CentimeterPerMillisecond, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.CentimeterPerYear, q => q.ToUnit(SpeedUnit.CentimeterPerYear));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.CentimeterPerYear, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.DayPerFootEq, q => q.ToUnit(SpeedUnit.DayPerFootEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.DayPerFootEq, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.DayPerKilometerEq, q => q.ToUnit(SpeedUnit.DayPerKilometerEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.DayPerKilometerEq, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.DayPerMeterEq, q => q.ToUnit(SpeedUnit.DayPerMeterEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.DayPerMeterEq, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.FootPerDay, q => q.ToUnit(SpeedUnit.FootPerDay));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.FootPerDay, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.FootPerMicrosecond, q => q.ToUnit(SpeedUnit.FootPerMicrosecond));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.FootPerMicrosecond, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.FootPerMillisecond, q => q.ToUnit(SpeedUnit.FootPerMillisecond));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.FootPerMillisecond, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.FootPerYear, q => q.ToUnit(SpeedUnit.FootPerYear));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.FootPerYear, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.KmPerHour, q => q.ToUnit(SpeedUnit.KmPerHour));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.KmPerHour, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.MeterPerDay, q => q.ToUnit(SpeedUnit.MeterPerDay));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.MeterPerDay, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.MeterPerMicrosecond, q => q.ToUnit(SpeedUnit.MeterPerMicrosecond));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.MeterPerMicrosecond, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.MeterPerMillisecond, q => q.ToUnit(SpeedUnit.MeterPerMillisecond));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.MeterPerMillisecond, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.MeterPerYear, q => q.ToUnit(SpeedUnit.MeterPerYear));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.MeterPerYear, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.MicrosecondPerCentimeterEq, q => q.ToUnit(SpeedUnit.MicrosecondPerCentimeterEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.MicrosecondPerCentimeterEq, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.MicrosecondPerFootEq, q => q.ToUnit(SpeedUnit.MicrosecondPerFootEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.MicrosecondPerFootEq, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.MicrosecondPerMeterEq, q => q.ToUnit(SpeedUnit.MicrosecondPerMeterEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.MicrosecondPerMeterEq, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.MillisecondPerCentimeterEq, q => q.ToUnit(SpeedUnit.MillisecondPerCentimeterEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.MillisecondPerCentimeterEq, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.MillisecondPerFootEq, q => q.ToUnit(SpeedUnit.MillisecondPerFootEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.MillisecondPerFootEq, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.MillisecondPerMeterEq, q => q.ToUnit(SpeedUnit.MillisecondPerMeterEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.MillisecondPerMeterEq, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.SecondPerCentimeterEq, q => q.ToUnit(SpeedUnit.SecondPerCentimeterEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.SecondPerCentimeterEq, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.SecondPerFootEq, q => q.ToUnit(SpeedUnit.SecondPerFootEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.SecondPerFootEq, Speed.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Speed>(Speed.BaseUnit, SpeedUnit.SecondPerMeterEq, q => q.ToUnit(SpeedUnit.SecondPerMeterEq));
            unitConverter.SetConversionFunction<Speed>(SpeedUnit.SecondPerMeterEq, Speed.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Temperature>(Temperature.BaseUnit, TemperatureUnit.DeltaDegreeCelsius, q => q.ToUnit(TemperatureUnit.DeltaDegreeCelsius));
            unitConverter.SetConversionFunction<Temperature>(TemperatureUnit.DeltaDegreeCelsius, Temperature.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Temperature>(Temperature.BaseUnit, TemperatureUnit.DeltaDegreeFahrenheit, q => q.ToUnit(TemperatureUnit.DeltaDegreeFahrenheit));
            unitConverter.SetConversionFunction<Temperature>(TemperatureUnit.DeltaDegreeFahrenheit, Temperature.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<ThermalConductivity>(ThermalConductivity.BaseUnit, ThermalConductivityUnit.BritishThermalUnitPerDayFootDegreeRankin, q => q.ToUnit(ThermalConductivityUnit.BritishThermalUnitPerDayFootDegreeRankin));
            unitConverter.SetConversionFunction<ThermalConductivity>(ThermalConductivityUnit.BritishThermalUnitPerDayFootDegreeRankin, ThermalConductivity.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Torque>(Torque.BaseUnit, TorqueUnit.Joule, q => q.ToUnit(TorqueUnit.Joule));
            unitConverter.SetConversionFunction<Torque>(TorqueUnit.Joule, Torque.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.Barrel, q => q.ToUnit(VolumeUnit.Barrel));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.Barrel, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.BillionCubicFeet, q => q.ToUnit(VolumeUnit.BillionCubicFeet));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.BillionCubicFeet, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.BillionCubicMeter, q => q.ToUnit(VolumeUnit.BillionCubicMeter));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.BillionCubicMeter, Volume.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MillionBarrels, q => q.ToUnit(VolumeUnit.MillionBarrels));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.MillionBarrels, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MillionCubicFeet, q => q.ToUnit(VolumeUnit.MillionCubicFeet));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.MillionCubicFeet, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MillionCubicMeter, q => q.ToUnit(VolumeUnit.MillionCubicMeter));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.MillionCubicMeter, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MillionReservoirBarrels, q => q.ToUnit(VolumeUnit.MillionReservoirBarrels));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.MillionReservoirBarrels, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MillionStandardCubicFeet, q => q.ToUnit(VolumeUnit.MillionStandardCubicFeet));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.MillionStandardCubicFeet, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MillionUkGallons, q => q.ToUnit(VolumeUnit.MillionUkGallons));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.MillionUkGallons, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MillionUsGallons, q => q.ToUnit(VolumeUnit.MillionUsGallons));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.MillionUsGallons, Volume.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ReservoirBarrel, q => q.ToUnit(VolumeUnit.ReservoirBarrel));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.ReservoirBarrel, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ReservoirCubicFoot, q => q.ToUnit(VolumeUnit.ReservoirCubicFoot));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.ReservoirCubicFoot, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.StandardCubicFoot, q => q.ToUnit(VolumeUnit.StandardCubicFoot));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.StandardCubicFoot, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.StockTankBarrel, q => q.ToUnit(VolumeUnit.StockTankBarrel));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.StockTankBarrel, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ThousandBarrels, q => q.ToUnit(VolumeUnit.ThousandBarrels));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.ThousandBarrels, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ThousandCubicFeet, q => q.ToUnit(VolumeUnit.ThousandCubicFeet));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.ThousandCubicFeet, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ThousandReservoirBarrels, q => q.ToUnit(VolumeUnit.ThousandReservoirBarrels));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.ThousandReservoirBarrels, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ThousandStandardCubicFeet, q => q.ToUnit(VolumeUnit.ThousandStandardCubicFeet));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.ThousandStandardCubicFeet, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ThousandUkGallons, q => q.ToUnit(VolumeUnit.ThousandUkGallons));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.ThousandUkGallons, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ThousandUsGallons, q => q.ToUnit(VolumeUnit.ThousandUsGallons));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.ThousandUsGallons, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.TrillionCubicFoot, q => q.ToUnit(VolumeUnit.TrillionCubicFoot));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.TrillionCubicFoot, Volume.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.UkGallon, q => q.ToUnit(VolumeUnit.UkGallon));
            unitConverter.SetConversionFunction<Volume>(VolumeUnit.UkGallon, Volume.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.BarrelPerDay, q => q.ToUnit(VolumeFlowUnit.BarrelPerDay));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.BarrelPerDay, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.BarrelPerHour, q => q.ToUnit(VolumeFlowUnit.BarrelPerHour));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.BarrelPerHour, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.BarrelPerMinute, q => q.ToUnit(VolumeFlowUnit.BarrelPerMinute));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.BarrelPerMinute, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.CubicCentimeterPerSecond, q => q.ToUnit(VolumeFlowUnit.CubicCentimeterPerSecond));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.CubicCentimeterPerSecond, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.CubicInchPerSecond, q => q.ToUnit(VolumeFlowUnit.CubicInchPerSecond));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.CubicInchPerSecond, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.GallonPerMinute, q => q.ToUnit(VolumeFlowUnit.GallonPerMinute));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.GallonPerMinute, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.MillionCubicFootPerDay, q => q.ToUnit(VolumeFlowUnit.MillionCubicFootPerDay));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.MillionCubicFootPerDay, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.MillionCubicMeterPerDay, q => q.ToUnit(VolumeFlowUnit.MillionCubicMeterPerDay));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.MillionCubicMeterPerDay, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.MillionStandardCubicFeetPerDay, q => q.ToUnit(VolumeFlowUnit.MillionStandardCubicFeetPerDay));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.MillionStandardCubicFeetPerDay, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.ReservoirBarrelPerDay, q => q.ToUnit(VolumeFlowUnit.ReservoirBarrelPerDay));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.ReservoirBarrelPerDay, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.ThousandBarrelPerDay, q => q.ToUnit(VolumeFlowUnit.ThousandBarrelPerDay));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.ThousandBarrelPerDay, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.ThousandReservoirBarrelPerDay, q => q.ToUnit(VolumeFlowUnit.ThousandReservoirBarrelPerDay));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.ThousandReservoirBarrelPerDay, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlow.BaseUnit, VolumeFlowUnit.ThousandStandardCubicFeetPerDay, q => q.ToUnit(VolumeFlowUnit.ThousandStandardCubicFeetPerDay));
            unitConverter.SetConversionFunction<VolumeFlow>(VolumeFlowUnit.ThousandStandardCubicFeetPerDay, VolumeFlow.BaseUnit, q => q.ToBaseUnit());
