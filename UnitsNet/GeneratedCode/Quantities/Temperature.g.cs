...
namespace UnitsNet
{
    ...
    public partial struct Temperature : IQuantity<TemperatureUnit>, IEquatable<Temperature>, IComparable, IComparable<Temperature>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Temperature" /> instances.
        /// </summary>
        ...
        private double GetValueAs(TemperatureUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Temperature>(inBaseUnits.Unit, unit, out var conversionFunction))
