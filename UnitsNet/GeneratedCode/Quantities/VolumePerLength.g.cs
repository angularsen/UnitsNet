...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static VolumePerLength()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, VolumePerLengthUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, VolumePerLengthUnit Unit), List<string>> Abbreviations { get; }
