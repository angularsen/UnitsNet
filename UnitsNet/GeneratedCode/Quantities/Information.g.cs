...
namespace UnitsNet
{
    ...
    public partial struct Information : IQuantity<InformationUnit>, IEquatable<Information>, IComparable, IComparable<Information>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="Information"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="Information"/> from.</param>
        public static implicit operator Information(ValueTuple<QuantityValue, InformationUnit> tuple) => new Information((decimal)tuple.Item1, tuple.Item2);
