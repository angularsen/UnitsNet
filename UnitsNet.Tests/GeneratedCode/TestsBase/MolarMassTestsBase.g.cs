...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = MolarMass.From(1.0, MolarMass.BaseUnit);
        ...
        {
            var inBaseUnit = MolarMass.From(1.0, MolarMass.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(MolarMassUnit)));
        }
        ...
        {
            var quantity = MolarMass.FromKilogramsPerMole(1.0);
            Assert.Equal(MolarMass.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
