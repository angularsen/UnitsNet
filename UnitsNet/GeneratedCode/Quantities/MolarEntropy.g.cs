...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MolarEntropy()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, MolarEntropyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, MolarEntropyUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(MolarEntropyUnit unit) => GetAbbreviation(unit, null);
