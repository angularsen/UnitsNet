...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = PorousMediumPermeability.From(1.0, PorousMediumPermeability.BaseUnit);
        ...
        {
            var inBaseUnit = PorousMediumPermeability.From(1.0, PorousMediumPermeability.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(PorousMediumPermeabilityUnit)));
        }
        ...
        {
            var quantity = PorousMediumPermeability.FromSquareMeters(1.0);
            Assert.Equal(PorousMediumPermeability.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
