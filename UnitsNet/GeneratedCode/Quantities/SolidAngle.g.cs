...
namespace UnitsNet
{
    ...
    public partial struct SolidAngle : IQuantity<SolidAngleUnit>, IEquatable<SolidAngle>, IComparable, IComparable<SolidAngle>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="SolidAngle" /> instances.
        /// </summary>
        ...
        internal SolidAngle ToBaseUnit()
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<SolidAngle>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(SolidAngleUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<SolidAngle>(inBaseUnits.Unit, unit, out var conversionFunction))
