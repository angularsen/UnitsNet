        ...
        IFormattable
    {
        ...
        private bool TryToUnit(VolumeUnit unit, [NotNullWhen(true)] out Volume? converted)
        {
            ...
            Volume? convertedOrNull = (Unit, unit) switch
            {
                ...
                (VolumeUnit.CubicInch, VolumeUnit.CubicMeter) => new Volume(_value * 1.6387064-5, VolumeUnit.CubicMeter),
                ...
                (VolumeUnit.CubicMeter, VolumeUnit.CubicInch) => new Volume(_value / 1.6387064-5, VolumeUnit.CubicInch),
