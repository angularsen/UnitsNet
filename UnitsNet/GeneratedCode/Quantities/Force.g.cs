...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public readonly partial struct Force : IArithmeticQuantity<Force, ForceUnit, double>, IEquatable<Force>, IComparable, IComparable<Force>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        /// <param name="provider">Format to use for localization and number formatting. Defaults to <see cref="CultureInfo.CurrentCulture" /> if null.</param>
        /// <returns>The string representation.</returns>
        public string ToString(string? format, IFormatProvider? provider) => QuantityFormatter.Format<ForceUnit>(this, format, provider);
