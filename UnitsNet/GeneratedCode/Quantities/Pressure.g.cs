...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Pressure()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, PressureUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, PressureUnit Unit), List<string>> Abbreviations { get; }
