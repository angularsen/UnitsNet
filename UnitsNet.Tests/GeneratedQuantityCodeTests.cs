    ...
    public class GeneratedQuantityCodeTests
    {
        ...
        public class QuantitiesWithFractions
        {
            ...
            public void LengthEquals_GivenMaxError_ReturnsTrueIfWithinError()
            {
                ...
                Assert.True(Length.FromMeters(1).Equals(Length.FromMeters(1), Length.FromMillimeters(1e-5)), "Using a max difference value should not change that fact.");
                ...
                Assert.False((1.39 / double.MaxValue).Equals(Length.FromMeters(1.39 / double.MaxValue).Value),
            ...
            public void QuantityValueComparisonEqualsAbsolute_ReturnsTrueIfWithinError()
            {
                ...
                Assert.True(Comparison.EqualsAbsolute(1, 1, 0.001));
                Assert.True(Comparison.EqualsAbsolute(1, 0.9999, 0.001));
                Assert.False(Comparison.EqualsAbsolute(1, 0.99, 0.001));
                Assert.False(Comparison.EqualsAbsolute(1, 0, 0.001));
            }
            ...
            public void QuantityValueComparisonEquals_GivenAbsoluteTolerance_ReturnsTrueIfWithinError()
            {
                ...
                Assert.True(Comparison.Equals(1, 1, 0.001, ComparisonType.Absolute));
                Assert.True(Comparison.Equals(1, 0.9999, 0.001, ComparisonType.Absolute));
                Assert.False(Comparison.Equals(1, 0.99, 0.001, ComparisonType.Absolute));
                Assert.False(Comparison.Equals(1, 0, 0.001, ComparisonType.Absolute));
            }
            ...
            {
                Assert.True(Comparison.EqualsRelative(1, 1, 1e-5));
                Assert.False(Comparison.EqualsRelative(1, 0, 1e-5));
                Assert.True(Comparison.EqualsRelative(100, 120, 0.3));
                Assert.False(Comparison.EqualsRelative(100, 120, 0.1));
            }
            ...
            {
                Assert.True(Comparison.Equals(1, 1, 1e-5, ComparisonType.Relative));
                Assert.False(Comparison.Equals(1, 0, 1e-5, ComparisonType.Relative));
                Assert.True(Comparison.Equals(100, 120, 0.3, ComparisonType.Relative));
                Assert.False(Comparison.Equals(100, 120, 0.1, ComparisonType.Relative));
            }
