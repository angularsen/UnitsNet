...
namespace UnitsNet
{
    ...
    public partial struct ElectricCurrentGradient : IQuantity<ElectricCurrentGradientUnit>, IEquatable<ElectricCurrentGradient>, IComparable, IComparable<ElectricCurrentGradient>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="ElectricCurrentGradient"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="ElectricCurrentGradient"/> from.</param>
        public static implicit operator ElectricCurrentGradient(ValueTuple<QuantityValue, ElectricCurrentGradientUnit> tuple) => new ElectricCurrentGradient((double)tuple.Item1, tuple.Item2);
