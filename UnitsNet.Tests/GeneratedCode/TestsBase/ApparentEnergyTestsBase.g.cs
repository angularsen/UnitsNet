...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void Ctor_UnitSystem_ThrowsArgumentExceptionIfNotSupported()
        {
            ...
            Assert.Throws<ArgumentException>(() => new ApparentEnergy(value: 1, unitSystem: unsupportedUnitSystem));
        }
        ...
        {
            var baseUnitInfo = ApparentEnergy.Info.BaseUnitInfo;
        ...
        public virtual void As_UnitSystem_SI_ReturnsQuantityInSIUnits()
        {
            ...
            var expectedValue = quantity.As(ApparentEnergy.Info.GetDefaultUnit(UnitSystem.SI));
        ...
        {
            var quantity = new ApparentEnergy(value: 1, unit: ApparentEnergy.BaseUnit);
            var expectedUnit = ApparentEnergy.Info.GetDefaultUnit(UnitSystem.SI);
            var expectedValue = quantity.As(expectedUnit);

            Assert.Multiple(() =>
            {
                ApparentEnergy quantityToConvert = quantity;

                ApparentEnergy convertedQuantity = quantityToConvert.ToUnit(UnitSystem.SI);

                Assert.Equal(expectedUnit, convertedQuantity.Unit);
                Assert.Equal(expectedValue, convertedQuantity.Value);
            }, () =>
            {
                IQuantity<ApparentEnergyUnit> quantityToConvert = quantity;

                IQuantity<ApparentEnergyUnit> convertedQuantity = quantityToConvert.ToUnit(UnitSystem.SI);
        ...
        public void ToUnit_UnitSystem_ThrowsArgumentNullExceptionIfNull()
        {
            ...
            {
                IQuantity<ApparentEnergyUnit> quantity = new ApparentEnergy(value: 1, unit: ApparentEnergy.BaseUnit);
                Assert.Throws<ArgumentNullException>(() => quantity.ToUnit(nullUnitSystem));
            }, () =>
            {
                IQuantity quantity = new ApparentEnergy(value: 1, unit: ApparentEnergy.BaseUnit);
                Assert.Throws<ArgumentNullException>(() => quantity.ToUnit(nullUnitSystem));
            });
        }
