...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = VolumeConcentration.From(1.0, VolumeConcentration.BaseUnit);
        ...
        {
            var inBaseUnit = VolumeConcentration.From(1.0, VolumeConcentration.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(VolumeConcentrationUnit)));
        }
        ...
        {
            var quantity = VolumeConcentration.FromDecimalFractions(1.0);
            Assert.Equal(VolumeConcentration.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
