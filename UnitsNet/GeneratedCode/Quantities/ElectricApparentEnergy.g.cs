...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<ElectricApparentEnergyUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.ElectricApparentEnergyUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<ElectricApparentEnergyUnit>(str, culture, out unit);
        }
