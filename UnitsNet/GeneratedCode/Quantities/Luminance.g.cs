...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public readonly partial struct Luminance : IQuantity<LuminanceUnit>, IEquatable<Luminance>, IComparable, IComparable<Luminance>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        /// <remarks>Consider using <see cref="Equals(Luminance, double, ComparisonType)"/> for comparing floating point values with rounding error tolerances.</remarks>
        public static bool operator ==(Luminance left, Luminance right)
        {
