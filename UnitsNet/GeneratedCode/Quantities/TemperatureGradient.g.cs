...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static TemperatureGradient()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, TemperatureGradientUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, TemperatureGradientUnit Unit), List<string>> Abbreviations { get; }
