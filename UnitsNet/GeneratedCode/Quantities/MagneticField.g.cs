...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MagneticField()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MagneticFieldUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MagneticFieldUnit Unit), List<string>> Abbreviations { get; }
