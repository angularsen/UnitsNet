...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static RotationalStiffness()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, RotationalStiffnessUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, RotationalStiffnessUnit Unit), List<string>> Abbreviations { get; }
