...
namespace UnitsNet
{
    ...
    public partial struct AmountOfSubstance : IQuantity<AmountOfSubstanceUnit>, IEquatable<AmountOfSubstance>, IComparable, IComparable<AmountOfSubstance>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="AmountOfSubstance" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<AmountOfSubstance>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(AmountOfSubstanceUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<AmountOfSubstance>(inBaseUnits.Unit, unit, out var conversionFunction))
