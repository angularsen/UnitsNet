...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricPotential()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricPotentialUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricPotentialUnit Unit), List<string>> Abbreviations { get; }
