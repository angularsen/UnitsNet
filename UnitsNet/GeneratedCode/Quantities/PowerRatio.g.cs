...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static PowerRatio()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, PowerRatioUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, PowerRatioUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(PowerRatioUnit unit) => GetAbbreviation(unit, null);
