...
public sealed class CompatibilityTests
{
    ...
    public void GeneratedCatalog_SiUnitSystemSelectionMatchesUnitsNet()
    {
        ...
        Type generatedUnitSystemType = GeneratedAssembly
            ...
            .Select(assembly => assembly.GetType("UnitsNetGen.UnitSystem"))
    ...
    {
        UnitsNetGen.QuantityRegistry registry = Generated::UnitsNetGen.Generated.UnitsNetGenRegistry.Instance;

        Assert.Equal(129, registry.Quantities.Count);
        UnitsNetGen.IQuantityDescriptor length = registry.Get(new UnitsNet.Core.QuantityId("UnitsNet.Length"));
        ...
        {
            UnitsNetGen.IQuantityDescriptor descriptor = registry.Get(generatedType);
        ...
        string[] quantitySpecificMembers)
    {
        ...
        string[] unexpected = generatedSurface
            ...
            .Where(member =>
                ...
                !member.Contains("UnitsNetGen.UnitSystem", StringComparison.Ordinal))
