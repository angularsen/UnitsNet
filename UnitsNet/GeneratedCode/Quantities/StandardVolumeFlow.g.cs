...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static StandardVolumeFlow()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, StandardVolumeFlowUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, StandardVolumeFlowUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(StandardVolumeFlowUnit unit) => GetAbbreviation(unit, null);
