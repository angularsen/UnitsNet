...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricPotential.From(1.0, ElectricPotential.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricPotentialUnit)));
        }
        ...
        {
            var quantity = ElectricPotential.FromVolts(1.0);
            Assert.Equal(ElectricPotential.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
