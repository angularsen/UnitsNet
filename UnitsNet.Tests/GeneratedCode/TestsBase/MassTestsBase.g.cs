...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ConversionRoundTrip()
        {
            ...
            Assert.Equal(3, Mass.FromDaltons(kilogram.Daltons).Kilograms);
            ...
            Assert.Equal(3, Mass.FromGigadaltons(kilogram.Gigadaltons).Kilograms);
            ...
            Assert.Equal(3, Mass.FromKilodaltons(kilogram.Kilodaltons).Kilograms);
            ...
            Assert.Equal(3, Mass.FromMegadaltons(kilogram.Megadaltons).Kilograms);
