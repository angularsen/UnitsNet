...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Angle()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, AngleUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, AngleUnit Unit), List<string>> Abbreviations { get; }
