...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricInductance.From(1.0, ElectricInductance.BaseUnit);
        ...
        {
            var inBaseUnit = ElectricInductance.From(1.0, ElectricInductance.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricInductanceUnit)));
        }
        ...
        {
            var quantity = ElectricInductance.FromHenries(1.0);
            Assert.Equal(ElectricInductance.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
