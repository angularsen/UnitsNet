...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricChargeDensity.From(1.0, ElectricChargeDensity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricChargeDensityUnit)));
        }
        ...
        {
            var quantity = ElectricChargeDensity.FromCoulombsPerCubicMeter(1.0);
            Assert.Equal(ElectricChargeDensity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
