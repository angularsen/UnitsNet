...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ToString_WithSwedishCulture_ReturnsUnitAbbreviationForEnglishCultureSinceThereAreNoMappings()
        {
            ...
            Assert.Equal("1 BTU", new Energy(1, EnergyUnit.BritishThermalUnit).ToString(null, swedishCulture));
            Assert.Equal("1 cal", new Energy(1, EnergyUnit.Calorie).ToString(null, swedishCulture));
            Assert.Equal("1 Dth (E.C.)", new Energy(1, EnergyUnit.DecathermEc).ToString(null, swedishCulture));
            Assert.Equal("1 Dth (imp.)", new Energy(1, EnergyUnit.DecathermImperial).ToString(null, swedishCulture));
            Assert.Equal("1 Dth (U.S.)", new Energy(1, EnergyUnit.DecathermUs).ToString(null, swedishCulture));
            Assert.Equal("1 eV", new Energy(1, EnergyUnit.ElectronVolt).ToString(null, swedishCulture));
            Assert.Equal("1 erg", new Energy(1, EnergyUnit.Erg).ToString(null, swedishCulture));
            Assert.Equal("1 ft·lb", new Energy(1, EnergyUnit.FootPound).ToString(null, swedishCulture));
            Assert.Equal("1 GBTU", new Energy(1, EnergyUnit.GigabritishThermalUnit).ToString(null, swedishCulture));
            Assert.Equal("1 GeV", new Energy(1, EnergyUnit.GigaelectronVolt).ToString(null, swedishCulture));
            Assert.Equal("1 GJ", new Energy(1, EnergyUnit.Gigajoule).ToString(null, swedishCulture));
            Assert.Equal("1 GWd", new Energy(1, EnergyUnit.GigawattDay).ToString(null, swedishCulture));
            Assert.Equal("1 GWh", new Energy(1, EnergyUnit.GigawattHour).ToString(null, swedishCulture));
            Assert.Equal("1 hp·h", new Energy(1, EnergyUnit.HorsepowerHour).ToString(null, swedishCulture));
            Assert.Equal("1 J", new Energy(1, EnergyUnit.Joule).ToString(null, swedishCulture));
            Assert.Equal("1 kBTU", new Energy(1, EnergyUnit.KilobritishThermalUnit).ToString(null, swedishCulture));
            Assert.Equal("1 kcal", new Energy(1, EnergyUnit.Kilocalorie).ToString(null, swedishCulture));
            Assert.Equal("1 keV", new Energy(1, EnergyUnit.KiloelectronVolt).ToString(null, swedishCulture));
            Assert.Equal("1 kJ", new Energy(1, EnergyUnit.Kilojoule).ToString(null, swedishCulture));
            Assert.Equal("1 kWd", new Energy(1, EnergyUnit.KilowattDay).ToString(null, swedishCulture));
            Assert.Equal("1 kWh", new Energy(1, EnergyUnit.KilowattHour).ToString(null, swedishCulture));
            Assert.Equal("1 MBTU", new Energy(1, EnergyUnit.MegabritishThermalUnit).ToString(null, swedishCulture));
            Assert.Equal("1 Mcal", new Energy(1, EnergyUnit.Megacalorie).ToString(null, swedishCulture));
            Assert.Equal("1 MeV", new Energy(1, EnergyUnit.MegaelectronVolt).ToString(null, swedishCulture));
            Assert.Equal("1 MJ", new Energy(1, EnergyUnit.Megajoule).ToString(null, swedishCulture));
            Assert.Equal("1 MWd", new Energy(1, EnergyUnit.MegawattDay).ToString(null, swedishCulture));
            Assert.Equal("1 MWh", new Energy(1, EnergyUnit.MegawattHour).ToString(null, swedishCulture));
            Assert.Equal("1 µJ", new Energy(1, EnergyUnit.Microjoule).ToString(null, swedishCulture));
            Assert.Equal("1 mJ", new Energy(1, EnergyUnit.Millijoule).ToString(null, swedishCulture));
            Assert.Equal("1 nJ", new Energy(1, EnergyUnit.Nanojoule).ToString(null, swedishCulture));
            Assert.Equal("1 PJ", new Energy(1, EnergyUnit.Petajoule).ToString(null, swedishCulture));
            Assert.Equal("1 TeV", new Energy(1, EnergyUnit.TeraelectronVolt).ToString(null, swedishCulture));
            Assert.Equal("1 TJ", new Energy(1, EnergyUnit.Terajoule).ToString(null, swedishCulture));
            Assert.Equal("1 TWd", new Energy(1, EnergyUnit.TerawattDay).ToString(null, swedishCulture));
            Assert.Equal("1 TWh", new Energy(1, EnergyUnit.TerawattHour).ToString(null, swedishCulture));
            Assert.Equal("1 th (E.C.)", new Energy(1, EnergyUnit.ThermEc).ToString(null, swedishCulture));
            Assert.Equal("1 th (imp.)", new Energy(1, EnergyUnit.ThermImperial).ToString(null, swedishCulture));
            Assert.Equal("1 th (U.S.)", new Energy(1, EnergyUnit.ThermUs).ToString(null, swedishCulture));
            Assert.Equal("1 Wd", new Energy(1, EnergyUnit.WattDay).ToString(null, swedishCulture));
            Assert.Equal("1 Wh", new Energy(1, EnergyUnit.WattHour).ToString(null, swedishCulture));
        }
