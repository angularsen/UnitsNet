...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricPotentialDc()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, ElectricPotentialDcUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, ElectricPotentialDcUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(ElectricPotentialDcUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(ElectricPotentialDcUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.ElectricPotentialDc";
                var resourceManager = new ResourceManager(resourceName, typeof(ElectricPotentialDc).Assembly);
