...
namespace UnitsNet
{
    ...
    /// </summary>
    public partial struct SpecificVolume : IQuantity<SpecificVolumeUnit>, IEquatable<SpecificVolume>, IComparable, IComparable<SpecificVolume>, IConvertible
    {
        /// <summary>
        ...
        public SpecificVolume(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static SpecificVolumeUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static SpecificVolumeUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
