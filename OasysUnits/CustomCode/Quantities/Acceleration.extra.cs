...
namespace OasysUnits
{
    public partial struct Acceleration
    {
        ...
        {
            return new SpecificWeight(acceleration.MetersPerSecondSquared * density.KilogramsPerCubicMeter, OasysUnits.Units.SpecificWeightUnit.NewtonPerCubicMeter);
        }
        ...
        {
            return new Speed(acceleration.MetersPerSecondSquared * duration.Seconds, OasysUnits.Units.SpeedUnit.MeterPerSecond);
        }
        ...
        {
            return new Jerk(acceleration.MetersPerSecondSquared / duration.Seconds, OasysUnits.Units.JerkUnit.MeterPerSecondCubed);
        }
    }
}
