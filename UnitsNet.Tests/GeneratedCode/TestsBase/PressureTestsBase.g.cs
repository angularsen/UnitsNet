...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ToString_WithSwedishCulture_ReturnsUnitAbbreviationForEnglishCultureSinceThereAreNoMappings()
        {
            ...
            Assert.Equal("1 atm", new Pressure(1, PressureUnit.Atmosphere).ToString(null, swedishCulture));
            Assert.Equal("1 bar", new Pressure(1, PressureUnit.Bar).ToString(null, swedishCulture));
            Assert.Equal("1 cbar", new Pressure(1, PressureUnit.Centibar).ToString(null, swedishCulture));
            Assert.Equal("1 cmH₂O", new Pressure(1, PressureUnit.CentimeterOfWaterColumn).ToString(null, swedishCulture));
            Assert.Equal("1 daPa", new Pressure(1, PressureUnit.Decapascal).ToString(null, swedishCulture));
            Assert.Equal("1 dbar", new Pressure(1, PressureUnit.Decibar).ToString(null, swedishCulture));
            Assert.Equal("1 dyn/cm²", new Pressure(1, PressureUnit.DynePerSquareCentimeter).ToString(null, swedishCulture));
            Assert.Equal("1 ft of head", new Pressure(1, PressureUnit.FootOfHead).ToString(null, swedishCulture));
            Assert.Equal("1 GPa", new Pressure(1, PressureUnit.Gigapascal).ToString(null, swedishCulture));
            Assert.Equal("1 hPa", new Pressure(1, PressureUnit.Hectopascal).ToString(null, swedishCulture));
            Assert.Equal("1 inHg", new Pressure(1, PressureUnit.InchOfMercury).ToString(null, swedishCulture));
            Assert.Equal("1 inH2O", new Pressure(1, PressureUnit.InchOfWaterColumn).ToString(null, swedishCulture));
            Assert.Equal("1 kbar", new Pressure(1, PressureUnit.Kilobar).ToString(null, swedishCulture));
            Assert.Equal("1 kgf/cm²", new Pressure(1, PressureUnit.KilogramForcePerSquareCentimeter).ToString(null, swedishCulture));
            Assert.Equal("1 kgf/m²", new Pressure(1, PressureUnit.KilogramForcePerSquareMeter).ToString(null, swedishCulture));
            Assert.Equal("1 kgf/mm²", new Pressure(1, PressureUnit.KilogramForcePerSquareMillimeter).ToString(null, swedishCulture));
            Assert.Equal("1 kN/cm²", new Pressure(1, PressureUnit.KilonewtonPerSquareCentimeter).ToString(null, swedishCulture));
            Assert.Equal("1 kN/m²", new Pressure(1, PressureUnit.KilonewtonPerSquareMeter).ToString(null, swedishCulture));
            Assert.Equal("1 kN/mm²", new Pressure(1, PressureUnit.KilonewtonPerSquareMillimeter).ToString(null, swedishCulture));
            Assert.Equal("1 kPa", new Pressure(1, PressureUnit.Kilopascal).ToString(null, swedishCulture));
            Assert.Equal("1 kipf/ft²", new Pressure(1, PressureUnit.KilopoundForcePerSquareFoot).ToString(null, swedishCulture));
            Assert.Equal("1 ksi", new Pressure(1, PressureUnit.KilopoundForcePerSquareInch).ToString(null, swedishCulture));
            Assert.Equal("1 kipf/mil²", new Pressure(1, PressureUnit.KilopoundForcePerSquareMil).ToString(null, swedishCulture));
            Assert.Equal("1 Mbar", new Pressure(1, PressureUnit.Megabar).ToString(null, swedishCulture));
            Assert.Equal("1 MN/m²", new Pressure(1, PressureUnit.MeganewtonPerSquareMeter).ToString(null, swedishCulture));
            Assert.Equal("1 MPa", new Pressure(1, PressureUnit.Megapascal).ToString(null, swedishCulture));
            Assert.Equal("1 m of head", new Pressure(1, PressureUnit.MeterOfHead).ToString(null, swedishCulture));
            Assert.Equal("1 mH₂O", new Pressure(1, PressureUnit.MeterOfWaterColumn).ToString(null, swedishCulture));
            Assert.Equal("1 µbar", new Pressure(1, PressureUnit.Microbar).ToString(null, swedishCulture));
            Assert.Equal("1 µPa", new Pressure(1, PressureUnit.Micropascal).ToString(null, swedishCulture));
            Assert.Equal("1 mbar", new Pressure(1, PressureUnit.Millibar).ToString(null, swedishCulture));
            Assert.Equal("1 mmHg", new Pressure(1, PressureUnit.MillimeterOfMercury).ToString(null, swedishCulture));
            Assert.Equal("1 mmH₂O", new Pressure(1, PressureUnit.MillimeterOfWaterColumn).ToString(null, swedishCulture));
            Assert.Equal("1 mPa", new Pressure(1, PressureUnit.Millipascal).ToString(null, swedishCulture));
            Assert.Equal("1 N/cm²", new Pressure(1, PressureUnit.NewtonPerSquareCentimeter).ToString(null, swedishCulture));
            Assert.Equal("1 N/m²", new Pressure(1, PressureUnit.NewtonPerSquareMeter).ToString(null, swedishCulture));
            Assert.Equal("1 N/mm²", new Pressure(1, PressureUnit.NewtonPerSquareMillimeter).ToString(null, swedishCulture));
            Assert.Equal("1 Pa", new Pressure(1, PressureUnit.Pascal).ToString(null, swedishCulture));
            Assert.Equal("1 lb/ft²", new Pressure(1, PressureUnit.PoundForcePerSquareFoot).ToString(null, swedishCulture));
            Assert.Equal("1 psi", new Pressure(1, PressureUnit.PoundForcePerSquareInch).ToString(null, swedishCulture));
            Assert.Equal("1 lb/mil²", new Pressure(1, PressureUnit.PoundForcePerSquareMil).ToString(null, swedishCulture));
            Assert.Equal("1 lbm/(in·s²)", new Pressure(1, PressureUnit.PoundPerInchSecondSquared).ToString(null, swedishCulture));
            Assert.Equal("1 at", new Pressure(1, PressureUnit.TechnicalAtmosphere).ToString(null, swedishCulture));
            Assert.Equal("1 tf/cm²", new Pressure(1, PressureUnit.TonneForcePerSquareCentimeter).ToString(null, swedishCulture));
            Assert.Equal("1 tf/m²", new Pressure(1, PressureUnit.TonneForcePerSquareMeter).ToString(null, swedishCulture));
            Assert.Equal("1 tf/mm²", new Pressure(1, PressureUnit.TonneForcePerSquareMillimeter).ToString(null, swedishCulture));
            Assert.Equal("1 torr", new Pressure(1, PressureUnit.Torr).ToString(null, swedishCulture));
        }
