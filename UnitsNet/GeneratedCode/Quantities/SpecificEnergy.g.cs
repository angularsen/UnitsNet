...
namespace UnitsNet
{
    ...
    public partial struct SpecificEnergy : IQuantity<SpecificEnergyUnit>, IComparable, IComparable<SpecificEnergy>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<SpecificEnergyUnit>)this).As(unitAsSpecificEnergyUnit);
        }
        ...
        /// <summary>
        ///     Converts this SpecificEnergy to another SpecificEnergy with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A SpecificEnergy with the specified unit.</returns>
        public QuantityValue ToQuantity(SpecificEnergyUnit unit)
        {
