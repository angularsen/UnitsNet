...
namespace UnitsNet
{
    ...
    public partial struct SpecificEnergy : IQuantity<SpecificEnergyUnit>, IEquatable<SpecificEnergy>, IComparable, IComparable<SpecificEnergy>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="SpecificEnergy"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="SpecificEnergy"/> from.</param>
        public static implicit operator SpecificEnergy(ValueTuple<QuantityValue, SpecificEnergyUnit> tuple) => new SpecificEnergy((double)tuple.Item1, tuple.Item2);
