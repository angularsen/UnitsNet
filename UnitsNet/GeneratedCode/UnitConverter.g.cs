...
namespace UnitsNet
{
    public sealed partial class UnitConverter
    {
        ...
        public static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<Temperature>(Temperature.BaseUnit, TemperatureUnit.CentidegreeCelsius, q => q.ToUnit(TemperatureUnit.CentidegreeCelsius));
            unitConverter.SetConversionFunction<Temperature>(TemperatureUnit.CentidegreeCelsius, Temperature.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Temperature>(Temperature.BaseUnit, TemperatureUnit.DecidegreeCelsius, q => q.ToUnit(TemperatureUnit.DecidegreeCelsius));
            unitConverter.SetConversionFunction<Temperature>(TemperatureUnit.DecidegreeCelsius, Temperature.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Temperature>(Temperature.BaseUnit, TemperatureUnit.HectodegreeCelsius, q => q.ToUnit(TemperatureUnit.HectodegreeCelsius));
            unitConverter.SetConversionFunction<Temperature>(TemperatureUnit.HectodegreeCelsius, Temperature.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Temperature>(Temperature.BaseUnit, Temperature.BaseUnit, q => q);
            unitConverter.SetConversionFunction<Temperature>(Temperature.BaseUnit, TemperatureUnit.KilodegreeCelsius, q => q.ToUnit(TemperatureUnit.KilodegreeCelsius));
            unitConverter.SetConversionFunction<Temperature>(TemperatureUnit.KilodegreeCelsius, Temperature.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Temperature>(Temperature.BaseUnit, TemperatureUnit.MicrodegreeCelsius, q => q.ToUnit(TemperatureUnit.MicrodegreeCelsius));
            unitConverter.SetConversionFunction<Temperature>(TemperatureUnit.MicrodegreeCelsius, Temperature.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Temperature>(Temperature.BaseUnit, TemperatureUnit.NanodegreeCelsius, q => q.ToUnit(TemperatureUnit.NanodegreeCelsius));
            unitConverter.SetConversionFunction<Temperature>(TemperatureUnit.NanodegreeCelsius, Temperature.BaseUnit, q => q.ToBaseUnit());
