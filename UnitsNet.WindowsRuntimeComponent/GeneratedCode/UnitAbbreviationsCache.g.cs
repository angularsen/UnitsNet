    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(TemperatureUnit), (int)TemperatureUnit.CentidegreeCelsius, new string[]{"c°C"}),
                ("en-US", typeof(TemperatureUnit), (int)TemperatureUnit.DecidegreeCelsius, new string[]{"d°C"}),
                ...
                ("en-US", typeof(TemperatureUnit), (int)TemperatureUnit.HectodegreeCelsius, new string[]{"h°C"}),
                ("en-US", typeof(TemperatureUnit), (int)TemperatureUnit.Kelvin, new string[]{"K"}),
                ("en-US", typeof(TemperatureUnit), (int)TemperatureUnit.KilodegreeCelsius, new string[]{"k°C"}),
                ("en-US", typeof(TemperatureUnit), (int)TemperatureUnit.MicrodegreeCelsius, new string[]{"µ°C"}),
                ("en-US", typeof(TemperatureUnit), (int)TemperatureUnit.MillidegreeCelsius, new string[]{"m°C"}),
                ("en-US", typeof(TemperatureUnit), (int)TemperatureUnit.NanodegreeCelsius, new string[]{"n°C"}),
