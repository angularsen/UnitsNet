...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricAdmittance.From(1.0, ElectricAdmittance.BaseUnit);
        ...
        {
            var inBaseUnit = ElectricAdmittance.From(1.0, ElectricAdmittance.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricAdmittanceUnit)));
        }
        ...
        {
            var quantity = ElectricAdmittance.FromSiemens(1.0);
            Assert.Equal(ElectricAdmittance.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
