...
namespace UnitsNet
{
    ...
    public partial struct ReactivePower : IQuantity<ReactivePowerUnit>, IEquatable<ReactivePower>, IComparable, IComparable<ReactivePower>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="ReactivePowerUnit.GigavoltampereReactive"/>
        /// </summary>
        public QuantityValue GigavoltamperesReactive => As(ReactivePowerUnit.GigavoltampereReactive);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="ReactivePowerUnit.KilovoltampereReactive"/>
        /// </summary>
        public QuantityValue KilovoltamperesReactive => As(ReactivePowerUnit.KilovoltampereReactive);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="ReactivePowerUnit.MegavoltampereReactive"/>
        /// </summary>
        public QuantityValue MegavoltamperesReactive => As(ReactivePowerUnit.MegavoltampereReactive);

        /// <summary>
        ///     Gets the numeric value of this quantity converted into <see cref="ReactivePowerUnit.VoltampereReactive"/>
        /// </summary>
        ...
        /// <remarks>Consider using <see cref="Equals(ReactivePower, QuantityValue, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(ReactivePower left, ReactivePower right)
        {
        ...
        public bool Equals(ReactivePower other, QuantityValue tolerance, ComparisonType comparisonType)
        {
            if (tolerance < 0)
        ...
        public ReactivePower ToUnit(ReactivePowerUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (Enum.IsDefined(typeof(ReactivePowerUnit), unit))
            {
