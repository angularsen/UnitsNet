...
namespace UnitsNet
{
    ...
    /// </remarks>
    public partial struct Illuminance : IQuantity<IlluminanceUnit>, IEquatable<Illuminance>, IComparable, IComparable<Illuminance>, IConvertible
    {
        /// <summary>
        ...
        public static IlluminanceUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static IlluminanceUnit GetUnitFor(BaseUnits baseUnits)
        {
