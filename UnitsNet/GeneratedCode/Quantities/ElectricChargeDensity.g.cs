...
namespace UnitsNet
{
    ...
    public partial struct ElectricChargeDensity : IQuantity<ElectricChargeDensityUnit>, IComparable, IComparable<ElectricChargeDensity>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ElectricChargeDensityUnit>)this).As(unitAsElectricChargeDensityUnit);
        }
        ...
        /// <summary>
        ///     Converts this ElectricChargeDensity to another ElectricChargeDensity with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ElectricChargeDensity with the specified unit.</returns>
        public QuantityValue ToQuantity(ElectricChargeDensityUnit unit)
        {
