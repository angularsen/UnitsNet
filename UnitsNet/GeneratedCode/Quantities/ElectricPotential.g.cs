...
namespace UnitsNet
{
    ...
    public partial struct ElectricPotential : IQuantity<ElectricPotentialUnit>, IComparable, IComparable<ElectricPotential>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ElectricPotentialUnit>)this).As(unitAsElectricPotentialUnit);
        }
        ...
        /// <summary>
        ///     Converts this ElectricPotential to another ElectricPotential with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ElectricPotential with the specified unit.</returns>
        public QuantityValue ToQuantity(ElectricPotentialUnit unit)
        {
