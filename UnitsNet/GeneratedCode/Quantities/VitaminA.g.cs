...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial struct VitaminA : IQuantity<VitaminAUnit>, IComparable, IComparable<VitaminA>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<VitaminAUnit>)this).As(unitAsVitaminAUnit);
        }
