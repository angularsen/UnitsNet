...
namespace UnitsNet
{
    ...
    public partial struct ApparentEnergy : IQuantity<ApparentEnergyUnit>, IComparable, IComparable<ApparentEnergy>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ApparentEnergyUnit>)this).As(unitAsApparentEnergyUnit);
        }
        ...
        /// <summary>
        ///     Converts this ApparentEnergy to another ApparentEnergy with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ApparentEnergy with the specified unit.</returns>
        public QuantityValue ToQuantity(ApparentEnergyUnit unit)
        {
