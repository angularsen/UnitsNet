...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Scalar()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ScalarUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ScalarUnit Unit), List<string>> Abbreviations { get; }
