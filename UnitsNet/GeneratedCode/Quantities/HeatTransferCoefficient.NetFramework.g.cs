...
namespace UnitsNet
{
    ...
    /// </summary>
    public partial struct HeatTransferCoefficient : IQuantity<HeatTransferCoefficientUnit>, IEquatable<HeatTransferCoefficient>, IComparable, IComparable<HeatTransferCoefficient>, IConvertible
    {
        /// <summary>
        ...
        public HeatTransferCoefficient(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static HeatTransferCoefficientUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static HeatTransferCoefficientUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
