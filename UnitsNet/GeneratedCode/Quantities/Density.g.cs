...
namespace UnitsNet
{
    ...
    public partial struct Density : IQuantity<DensityUnit>, IEquatable<Density>, IComparable, IComparable<Density>, IConvertible, IFormattable
    {
        ...
        static Density()
        {
            ...
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.CentigramPerDeciliter, q => q.ToUnit(DensityUnit.CentigramPerDeciliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.CentigramPerDeciliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.CentigramPerLiter, q => q.ToUnit(DensityUnit.CentigramPerLiter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.CentigramPerLiter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.CentigramPerMilliliter, q => q.ToUnit(DensityUnit.CentigramPerMilliliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.CentigramPerMilliliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.DecigramPerDeciliter, q => q.ToUnit(DensityUnit.DecigramPerDeciliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.DecigramPerDeciliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.DecigramPerLiter, q => q.ToUnit(DensityUnit.DecigramPerLiter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.DecigramPerLiter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.DecigramPerMilliliter, q => q.ToUnit(DensityUnit.DecigramPerMilliliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.DecigramPerMilliliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.GramPerCubicCentimeter, q => q.ToUnit(DensityUnit.GramPerCubicCentimeter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.GramPerCubicCentimeter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.GramPerCubicMeter, q => q.ToUnit(DensityUnit.GramPerCubicMeter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.GramPerCubicMeter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.GramPerCubicMillimeter, q => q.ToUnit(DensityUnit.GramPerCubicMillimeter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.GramPerCubicMillimeter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.GramPerDeciliter, q => q.ToUnit(DensityUnit.GramPerDeciliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.GramPerDeciliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.GramPerLiter, q => q.ToUnit(DensityUnit.GramPerLiter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.GramPerLiter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.GramPerMilliliter, q => q.ToUnit(DensityUnit.GramPerMilliliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.GramPerMilliliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.KilogramPerCubicCentimeter, q => q.ToUnit(DensityUnit.KilogramPerCubicCentimeter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.KilogramPerCubicCentimeter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, Density.BaseUnit, q => q);
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.KilogramPerCubicMillimeter, q => q.ToUnit(DensityUnit.KilogramPerCubicMillimeter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.KilogramPerCubicMillimeter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.KilogramPerLiter, q => q.ToUnit(DensityUnit.KilogramPerLiter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.KilogramPerLiter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.KilopoundPerCubicFoot, q => q.ToUnit(DensityUnit.KilopoundPerCubicFoot));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.KilopoundPerCubicFoot, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.KilopoundPerCubicInch, q => q.ToUnit(DensityUnit.KilopoundPerCubicInch));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.KilopoundPerCubicInch, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.MicrogramPerCubicMeter, q => q.ToUnit(DensityUnit.MicrogramPerCubicMeter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.MicrogramPerCubicMeter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.MicrogramPerDeciliter, q => q.ToUnit(DensityUnit.MicrogramPerDeciliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.MicrogramPerDeciliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.MicrogramPerLiter, q => q.ToUnit(DensityUnit.MicrogramPerLiter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.MicrogramPerLiter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.MicrogramPerMilliliter, q => q.ToUnit(DensityUnit.MicrogramPerMilliliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.MicrogramPerMilliliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.MilligramPerCubicMeter, q => q.ToUnit(DensityUnit.MilligramPerCubicMeter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.MilligramPerCubicMeter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.MilligramPerDeciliter, q => q.ToUnit(DensityUnit.MilligramPerDeciliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.MilligramPerDeciliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.MilligramPerLiter, q => q.ToUnit(DensityUnit.MilligramPerLiter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.MilligramPerLiter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.MilligramPerMilliliter, q => q.ToUnit(DensityUnit.MilligramPerMilliliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.MilligramPerMilliliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.NanogramPerDeciliter, q => q.ToUnit(DensityUnit.NanogramPerDeciliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.NanogramPerDeciliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.NanogramPerLiter, q => q.ToUnit(DensityUnit.NanogramPerLiter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.NanogramPerLiter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.NanogramPerMilliliter, q => q.ToUnit(DensityUnit.NanogramPerMilliliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.NanogramPerMilliliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PicogramPerDeciliter, q => q.ToUnit(DensityUnit.PicogramPerDeciliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.PicogramPerDeciliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PicogramPerLiter, q => q.ToUnit(DensityUnit.PicogramPerLiter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.PicogramPerLiter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PicogramPerMilliliter, q => q.ToUnit(DensityUnit.PicogramPerMilliliter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.PicogramPerMilliliter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PoundPerCubicFoot, q => q.ToUnit(DensityUnit.PoundPerCubicFoot));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.PoundPerCubicFoot, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PoundPerCubicInch, q => q.ToUnit(DensityUnit.PoundPerCubicInch));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.PoundPerCubicInch, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PoundPerImperialGallon, q => q.ToUnit(DensityUnit.PoundPerImperialGallon));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.PoundPerImperialGallon, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.PoundPerUSGallon, q => q.ToUnit(DensityUnit.PoundPerUSGallon));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.PoundPerUSGallon, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.SlugPerCubicFoot, q => q.ToUnit(DensityUnit.SlugPerCubicFoot));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.SlugPerCubicFoot, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.TonnePerCubicCentimeter, q => q.ToUnit(DensityUnit.TonnePerCubicCentimeter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.TonnePerCubicCentimeter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.TonnePerCubicMeter, q => q.ToUnit(DensityUnit.TonnePerCubicMeter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.TonnePerCubicMeter, Density.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Density>(Density.BaseUnit, DensityUnit.TonnePerCubicMillimeter, q => q.ToUnit(DensityUnit.TonnePerCubicMillimeter));
            UnitConverter.Default.SetConversionFunction<Density>(DensityUnit.TonnePerCubicMillimeter, Density.BaseUnit, q => q.ToBaseUnit());
        }
