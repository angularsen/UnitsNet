...
namespace UnitsNet
{
    ...
    public partial struct TemperatureChangeRate : IQuantity<TemperatureChangeRateUnit>, IComparable, IComparable<TemperatureChangeRate>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Converts this TemperatureChangeRate to another TemperatureChangeRate with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A TemperatureChangeRate with the specified unit.</returns>
        public QuantityValue ToQuantity(TemperatureChangeRateUnit unit)
        {
