...
namespace UnitsNet
{
    ...
    /// </remarks>
    public partial struct MagneticFlux : IQuantity<MagneticFluxUnit>, IEquatable<MagneticFlux>, IComparable, IComparable<MagneticFlux>, IConvertible
    {
        /// <summary>
        ...
        public MagneticFlux(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static MagneticFluxUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static MagneticFluxUnit GetUnitFor(BaseUnits baseUnits)
        {
