...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static DynamicViscosity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, DynamicViscosityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, DynamicViscosityUnit Unit), List<string>> Abbreviations { get; }
