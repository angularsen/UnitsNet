...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static RotationalStiffnessPerLength()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, RotationalStiffnessPerLengthUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, RotationalStiffnessPerLengthUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(RotationalStiffnessPerLengthUnit unit) => GetAbbreviation(unit, null);
