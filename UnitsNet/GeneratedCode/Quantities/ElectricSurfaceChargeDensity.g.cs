...
namespace UnitsNet
{
    ...
    public partial struct ElectricSurfaceChargeDensity : IQuantity<ElectricSurfaceChargeDensityUnit>, IEquatable<ElectricSurfaceChargeDensity>, IComparable, IComparable<ElectricSurfaceChargeDensity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ElectricSurfaceChargeDensity" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<ElectricSurfaceChargeDensity>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(ElectricSurfaceChargeDensityUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ElectricSurfaceChargeDensity>(inBaseUnits.Unit, unit, out var conversionFunction))
