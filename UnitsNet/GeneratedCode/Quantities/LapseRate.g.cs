...
namespace UnitsNet
{
    ...
    public partial struct LapseRate : IQuantity<LapseRateUnit>, IComparable, IComparable<LapseRate>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<LapseRateUnit>)this).As(unitAsLapseRateUnit);
        }
        ...
        /// <summary>
        ///     Converts this LapseRate to another LapseRate with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A LapseRate with the specified unit.</returns>
        public QuantityValue ToQuantity(LapseRateUnit unit)
        {
