...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = Turbidity.From(1.0, Turbidity.BaseUnit);
        ...
        {
            var inBaseUnit = Turbidity.From(1.0, Turbidity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(TurbidityUnit)));
        }
        ...
        {
            var quantity = Turbidity.FromNTU(1.0);
            Assert.Equal(Turbidity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
