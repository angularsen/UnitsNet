...
{    
    public class NumberToTemperatureExtensionsTests
    {
        ...
        public void NumberToCentidegreesCelsiusTest() =>
            Assert.Equal(Temperature.FromCentidegreesCelsius(2), 2.CentidegreesCelsius());

        [Fact]
        public void NumberToDecidegreesCelsiusTest() =>
            Assert.Equal(Temperature.FromDecidegreesCelsius(2), 2.DecidegreesCelsius());
        ...
        public void NumberToHectodegreesCelsiusTest() =>
            Assert.Equal(Temperature.FromHectodegreesCelsius(2), 2.HectodegreesCelsius());
        ...
        public void NumberToKilodegreesCelsiusTest() =>
            Assert.Equal(Temperature.FromKilodegreesCelsius(2), 2.KilodegreesCelsius());

        [Fact]
        public void NumberToMicrodegreesCelsiusTest() =>
            Assert.Equal(Temperature.FromMicrodegreesCelsius(2), 2.MicrodegreesCelsius());
        ...
        public void NumberToNanodegreesCelsiusTest() =>
            Assert.Equal(Temperature.FromNanodegreesCelsius(2), 2.NanodegreesCelsius());
