...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static FuelEfficiency()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, FuelEfficiencyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, FuelEfficiencyUnit Unit), List<string>> Abbreviations { get; }
