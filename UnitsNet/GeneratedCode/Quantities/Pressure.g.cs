...
namespace UnitsNet
{
    ...
    public partial struct Pressure : IQuantity<PressureUnit>, IEquatable<Pressure>, IComparable, IComparable<Pressure>, IConvertible, IFormattable
    {
        ...
        static Pressure()
        {
            ...
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Atmosphere, q => q.ToUnit(PressureUnit.Atmosphere));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Bar, q => q.ToUnit(PressureUnit.Bar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Centibar, q => q.ToUnit(PressureUnit.Centibar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Decapascal, q => q.ToUnit(PressureUnit.Decapascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Decibar, q => q.ToUnit(PressureUnit.Decibar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.DynePerSquareCentimeter, q => q.ToUnit(PressureUnit.DynePerSquareCentimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.FootOfElevation, q => q.ToUnit(PressureUnit.FootOfElevation));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.FootOfHead, q => q.ToUnit(PressureUnit.FootOfHead));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Gigapascal, q => q.ToUnit(PressureUnit.Gigapascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Hectopascal, q => q.ToUnit(PressureUnit.Hectopascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.InchOfMercury, q => q.ToUnit(PressureUnit.InchOfMercury));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.InchOfWaterColumn, q => q.ToUnit(PressureUnit.InchOfWaterColumn));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Kilobar, q => q.ToUnit(PressureUnit.Kilobar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.KilogramForcePerSquareCentimeter, q => q.ToUnit(PressureUnit.KilogramForcePerSquareCentimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.KilogramForcePerSquareMeter, q => q.ToUnit(PressureUnit.KilogramForcePerSquareMeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.KilogramForcePerSquareMillimeter, q => q.ToUnit(PressureUnit.KilogramForcePerSquareMillimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.KilonewtonPerSquareCentimeter, q => q.ToUnit(PressureUnit.KilonewtonPerSquareCentimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.KilonewtonPerSquareMeter, q => q.ToUnit(PressureUnit.KilonewtonPerSquareMeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.KilonewtonPerSquareMillimeter, q => q.ToUnit(PressureUnit.KilonewtonPerSquareMillimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Kilopascal, q => q.ToUnit(PressureUnit.Kilopascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.KilopoundForcePerSquareFoot, q => q.ToUnit(PressureUnit.KilopoundForcePerSquareFoot));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.KilopoundForcePerSquareInch, q => q.ToUnit(PressureUnit.KilopoundForcePerSquareInch));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Megabar, q => q.ToUnit(PressureUnit.Megabar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.MeganewtonPerSquareMeter, q => q.ToUnit(PressureUnit.MeganewtonPerSquareMeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Megapascal, q => q.ToUnit(PressureUnit.Megapascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.MeterOfElevation, q => q.ToUnit(PressureUnit.MeterOfElevation));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.MeterOfHead, q => q.ToUnit(PressureUnit.MeterOfHead));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Microbar, q => q.ToUnit(PressureUnit.Microbar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Micropascal, q => q.ToUnit(PressureUnit.Micropascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Millibar, q => q.ToUnit(PressureUnit.Millibar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.MillimeterOfMercury, q => q.ToUnit(PressureUnit.MillimeterOfMercury));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.MillimeterOfWaterColumn, q => q.ToUnit(PressureUnit.MillimeterOfWaterColumn));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Millipascal, q => q.ToUnit(PressureUnit.Millipascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.NewtonPerSquareCentimeter, q => q.ToUnit(PressureUnit.NewtonPerSquareCentimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.NewtonPerSquareMeter, q => q.ToUnit(PressureUnit.NewtonPerSquareMeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.NewtonPerSquareMillimeter, q => q.ToUnit(PressureUnit.NewtonPerSquareMillimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.PoundForcePerSquareFoot, q => q.ToUnit(PressureUnit.PoundForcePerSquareFoot));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.PoundForcePerSquareInch, q => q.ToUnit(PressureUnit.PoundForcePerSquareInch));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.PoundPerInchSecondSquared, q => q.ToUnit(PressureUnit.PoundPerInchSecondSquared));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.TechnicalAtmosphere, q => q.ToUnit(PressureUnit.TechnicalAtmosphere));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.TonneForcePerSquareCentimeter, q => q.ToUnit(PressureUnit.TonneForcePerSquareCentimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.TonneForcePerSquareMeter, q => q.ToUnit(PressureUnit.TonneForcePerSquareMeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.TonneForcePerSquareMillimeter, q => q.ToUnit(PressureUnit.TonneForcePerSquareMillimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Torr, q => q.ToUnit(PressureUnit.Torr));
            
            // Register in default unit converter: BaseUnit <-> BaseUnit
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Pascal, PressureUnit.Pascal, q => q);

            // Register in default unit converter: PressureUnit -> BaseUnit
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Atmosphere, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Bar, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Centibar, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Decapascal, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Decibar, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.DynePerSquareCentimeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.FootOfElevation, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.FootOfHead, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Gigapascal, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Hectopascal, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.InchOfMercury, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.InchOfWaterColumn, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Kilobar, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilogramForcePerSquareCentimeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilogramForcePerSquareMeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilogramForcePerSquareMillimeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilonewtonPerSquareCentimeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilonewtonPerSquareMeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilonewtonPerSquareMillimeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Kilopascal, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilopoundForcePerSquareFoot, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilopoundForcePerSquareInch, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Megabar, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.MeganewtonPerSquareMeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Megapascal, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.MeterOfElevation, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.MeterOfHead, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Microbar, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Micropascal, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Millibar, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.MillimeterOfMercury, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.MillimeterOfWaterColumn, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Millipascal, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.NewtonPerSquareCentimeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.NewtonPerSquareMeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.NewtonPerSquareMillimeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.PoundForcePerSquareFoot, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.PoundForcePerSquareInch, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.PoundPerInchSecondSquared, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.TechnicalAtmosphere, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.TonneForcePerSquareCentimeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.TonneForcePerSquareMeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.TonneForcePerSquareMillimeter, PressureUnit.Pascal, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Torr, PressureUnit.Pascal, q => q.ToBaseUnit());
        }
