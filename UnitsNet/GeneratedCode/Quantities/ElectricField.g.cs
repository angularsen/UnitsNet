...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricField()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricFieldUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricFieldUnit Unit), List<string>> Abbreviations { get; }
