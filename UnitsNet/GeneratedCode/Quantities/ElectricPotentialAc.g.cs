...
namespace UnitsNet
{
    ...
    public partial struct ElectricPotentialAc : IQuantity<ElectricPotentialAcUnit>, IEquatable<ElectricPotentialAc>, IComparable, IComparable<ElectricPotentialAc>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ElectricPotentialAc" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<ElectricPotentialAc>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(ElectricPotentialAcUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ElectricPotentialAc>(inBaseUnits.Unit, unit, out var conversionFunction))
