...
namespace UnitsNet
{
    ...
    public partial struct ElectricCurrentGradient : IQuantity<ElectricCurrentGradientUnit>, IComparable, IComparable<ElectricCurrentGradient>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Converts this ElectricCurrentGradient to another ElectricCurrentGradient with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ElectricCurrentGradient with the specified unit.</returns>
        public QuantityValue ToQuantity(ElectricCurrentGradientUnit unit)
        {
