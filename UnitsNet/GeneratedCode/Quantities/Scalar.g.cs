...
namespace UnitsNet
{
    ...
    public partial struct Scalar : IQuantity<ScalarUnit>, IComparable, IComparable<Scalar>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ScalarUnit>)this).As(unitAsScalarUnit);
        }
        ...
        /// <summary>
        ///     Converts this Scalar to another Scalar with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A Scalar with the specified unit.</returns>
        public QuantityValue ToQuantity(ScalarUnit unit)
        {
