...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial struct SolidAngle : IQuantity<SolidAngleUnit>, IComparable, IComparable<SolidAngle>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<SolidAngleUnit>)this).As(unitAsSolidAngleUnit);
        }
        ...
        /// <summary>
        ///     Converts this SolidAngle to another SolidAngle with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A SolidAngle with the specified unit.</returns>
        public QuantityValue ToQuantity(SolidAngleUnit unit)
        {
