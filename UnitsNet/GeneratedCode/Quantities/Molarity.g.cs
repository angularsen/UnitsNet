...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Molarity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MolarityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MolarityUnit Unit), List<string>> Abbreviations { get; }
