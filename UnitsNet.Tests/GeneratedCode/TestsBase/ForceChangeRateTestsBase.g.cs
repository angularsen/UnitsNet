...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ForceChangeRate.From(1.0, ForceChangeRate.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ForceChangeRateUnit)));
        }
        ...
        {
            var quantity = ForceChangeRate.FromNewtonsPerSecond(1.0);
            Assert.Equal(ForceChangeRate.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
