...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static VitaminA()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, VitaminAUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, VitaminAUnit Unit), List<string>> Abbreviations { get; }
