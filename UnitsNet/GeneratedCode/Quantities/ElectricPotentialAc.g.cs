...
namespace UnitsNet
{
    ...
    public readonly partial struct ElectricPotentialAc :
        ...
        IComparisonOperators<ElectricPotentialAc, ElectricPotentialAc, bool>,
        IParsable<ElectricPotentialAc>,
#endif
        IComparable,
        ...
        static ElectricPotentialAc()
        {
            ...
            Info = new QuantityInfo<ElectricPotentialAcUnit>("ElectricPotentialAc",
                new UnitInfo<ElectricPotentialAcUnit>[]
                {
                    ...
                    new UnitInfo<ElectricPotentialAcUnit>(ElectricPotentialAcUnit.VoltAc, "VoltsAc", new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second, current: ElectricCurrentUnit.Ampere), "ElectricPotentialAc"),
                },
