...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = VolumePerLength.From(1.0, VolumePerLength.BaseUnit);
        ...
        {
            var inBaseUnit = VolumePerLength.From(1.0, VolumePerLength.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(VolumePerLengthUnit)));
        }
        ...
        {
            var quantity = VolumePerLength.FromCubicMetersPerMeter(1.0);
            Assert.Equal(VolumePerLength.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
