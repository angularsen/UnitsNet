...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ReactiveEnergy()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, ReactiveEnergyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, ReactiveEnergyUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(ReactiveEnergyUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(ReactiveEnergyUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.ReactiveEnergy";
                var resourceManager = new ResourceManager(resourceName, typeof(ReactiveEnergy).Assembly);
        ...
        [Obsolete("For null checks, use `x is null` syntax to not invoke overloads. For quantity comparisons, use Equals(ReactiveEnergy, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator ==(ReactiveEnergy left, ReactiveEnergy right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(ReactiveEnergy, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("For null checks, use `x is not null` syntax to not invoke overloads. For quantity comparisons, use Equals(ReactiveEnergy, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
        public static bool operator !=(ReactiveEnergy left, ReactiveEnergy right)
        {
            return !(left == right);
        }
        ...
        /// <summary>Indicates strict equality of two <see cref="ReactiveEnergy"/> quantities, where both <see cref="Value" /> and <see cref="Unit" /> are exactly equal.</summary>
        /// <remarks>Consider using <see cref="Equals(ReactiveEnergy, double, ComparisonType)"/> to check equality across different units and to specify a floating-point number error tolerance.</remarks>
        [Obsolete("Consider using Equals(ReactiveEnergy, double, ComparisonType) to check equality across different units and to specify a floating-point number error tolerance.")]
