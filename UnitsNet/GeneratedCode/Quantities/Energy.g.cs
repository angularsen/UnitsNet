...
namespace UnitsNet
{
    ...
    public partial struct Energy : IQuantity<EnergyUnit>, IEquatable<Energy>, IComparable, IComparable<Energy>, IConvertible, IFormattable
    {
        ...
        static Energy()
        {
            ...
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.BritishThermalUnit, q => q.ToUnit(EnergyUnit.BritishThermalUnit));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.Calorie, q => q.ToUnit(EnergyUnit.Calorie));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.DecathermEc, q => q.ToUnit(EnergyUnit.DecathermEc));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.DecathermImperial, q => q.ToUnit(EnergyUnit.DecathermImperial));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.DecathermUs, q => q.ToUnit(EnergyUnit.DecathermUs));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.ElectronVolt, q => q.ToUnit(EnergyUnit.ElectronVolt));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.Erg, q => q.ToUnit(EnergyUnit.Erg));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.FootPound, q => q.ToUnit(EnergyUnit.FootPound));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.GigabritishThermalUnit, q => q.ToUnit(EnergyUnit.GigabritishThermalUnit));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.GigaelectronVolt, q => q.ToUnit(EnergyUnit.GigaelectronVolt));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.Gigajoule, q => q.ToUnit(EnergyUnit.Gigajoule));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.GigawattDay, q => q.ToUnit(EnergyUnit.GigawattDay));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.GigawattHour, q => q.ToUnit(EnergyUnit.GigawattHour));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.HorsepowerHour, q => q.ToUnit(EnergyUnit.HorsepowerHour));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.KilobritishThermalUnit, q => q.ToUnit(EnergyUnit.KilobritishThermalUnit));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.Kilocalorie, q => q.ToUnit(EnergyUnit.Kilocalorie));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.KiloelectronVolt, q => q.ToUnit(EnergyUnit.KiloelectronVolt));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.Kilojoule, q => q.ToUnit(EnergyUnit.Kilojoule));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.KilowattDay, q => q.ToUnit(EnergyUnit.KilowattDay));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.KilowattHour, q => q.ToUnit(EnergyUnit.KilowattHour));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.MegabritishThermalUnit, q => q.ToUnit(EnergyUnit.MegabritishThermalUnit));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.Megacalorie, q => q.ToUnit(EnergyUnit.Megacalorie));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.MegaelectronVolt, q => q.ToUnit(EnergyUnit.MegaelectronVolt));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.Megajoule, q => q.ToUnit(EnergyUnit.Megajoule));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.MegawattDay, q => q.ToUnit(EnergyUnit.MegawattDay));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.MegawattHour, q => q.ToUnit(EnergyUnit.MegawattHour));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.Millijoule, q => q.ToUnit(EnergyUnit.Millijoule));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.TeraelectronVolt, q => q.ToUnit(EnergyUnit.TeraelectronVolt));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.TerawattDay, q => q.ToUnit(EnergyUnit.TerawattDay));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.TerawattHour, q => q.ToUnit(EnergyUnit.TerawattHour));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.ThermEc, q => q.ToUnit(EnergyUnit.ThermEc));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.ThermImperial, q => q.ToUnit(EnergyUnit.ThermImperial));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.ThermUs, q => q.ToUnit(EnergyUnit.ThermUs));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.WattDay, q => q.ToUnit(EnergyUnit.WattDay));
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.WattHour, q => q.ToUnit(EnergyUnit.WattHour));
            
            // Register in default unit converter: BaseUnit <-> BaseUnit
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Joule, EnergyUnit.Joule, q => q);

            // Register in default unit converter: EnergyUnit -> BaseUnit
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.BritishThermalUnit, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Calorie, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.DecathermEc, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.DecathermImperial, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.DecathermUs, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.ElectronVolt, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Erg, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.FootPound, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.GigabritishThermalUnit, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.GigaelectronVolt, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Gigajoule, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.GigawattDay, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.GigawattHour, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.HorsepowerHour, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.KilobritishThermalUnit, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Kilocalorie, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.KiloelectronVolt, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Kilojoule, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.KilowattDay, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.KilowattHour, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.MegabritishThermalUnit, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Megacalorie, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.MegaelectronVolt, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Megajoule, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.MegawattDay, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.MegawattHour, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.Millijoule, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.TeraelectronVolt, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.TerawattDay, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.TerawattHour, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.ThermEc, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.ThermImperial, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.ThermUs, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.WattDay, EnergyUnit.Joule, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Energy>(EnergyUnit.WattHour, EnergyUnit.Joule, q => q.ToBaseUnit());
        }
