...
namespace UnitsNet
{
    ...
    public partial struct RelativeHumidity : IQuantity<RelativeHumidityUnit>, IComparable, IComparable<RelativeHumidity>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<RelativeHumidityUnit>)this).As(unitAsRelativeHumidityUnit);
        }
        ...
        /// <summary>
        ///     Converts this RelativeHumidity to another RelativeHumidity with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A RelativeHumidity with the specified unit.</returns>
        public QuantityValue ToQuantity(RelativeHumidityUnit unit)
        {
