...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<AmountOfSubstanceUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.AmountOfSubstanceUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<AmountOfSubstanceUnit>(str, culture, out unit);
        }
