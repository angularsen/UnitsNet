...
namespace UnitsNet
{
    ...
    public partial struct Force : IQuantity<ForceUnit>, IEquatable<Force>, IComparable, IComparable<Force>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="Force"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="Force"/> from.</param>
        public static implicit operator Force(ValueTuple<QuantityValue, ForceUnit> tuple) => new Force((double)tuple.Item1, tuple.Item2);
