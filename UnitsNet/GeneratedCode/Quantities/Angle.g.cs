...
namespace UnitsNet
{
    ...
    public partial struct Angle : IQuantity<AngleUnit>, IEquatable<Angle>, IComparable, IComparable<Angle>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="Angle" /> instances.
        /// </summary>
        ...
        public Angle ToUnit(AngleUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<Angle>(inBaseUnits.Unit, unit, out var conversionFunction))
