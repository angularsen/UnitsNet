...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static RelativeHumidity()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, RelativeHumidityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, RelativeHumidityUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(RelativeHumidityUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(RelativeHumidityUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.RelativeHumidity";
                var resourceManager = new ResourceManager(resourceName, typeof(RelativeHumidity).Assembly);
