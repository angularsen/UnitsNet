...
namespace UnitsNet
{
    ...
    public partial struct DynamicViscosity : IQuantity<DynamicViscosityUnit>, IEquatable<DynamicViscosity>, IComparable, IComparable<DynamicViscosity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="DynamicViscosity"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="DynamicViscosity"/> from.</param>
        public static implicit operator DynamicViscosity(ValueTuple<QuantityValue, DynamicViscosityUnit> tuple) => new DynamicViscosity((double)tuple.Item1, tuple.Item2);
