...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricChargeDensity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricChargeDensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricChargeDensityUnit Unit), List<string>> Abbreviations { get; }
