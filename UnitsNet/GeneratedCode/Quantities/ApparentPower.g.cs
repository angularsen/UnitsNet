...
namespace UnitsNet
{
    ...
    public readonly partial struct ApparentPower :
        ...
        IComparisonOperators<ApparentPower, ApparentPower, bool>,
        IParsable<ApparentPower>,
#endif
        IComparable,
        ...
        static ApparentPower()
        {
            ...
            Info = new QuantityInfo<ApparentPowerUnit>("ApparentPower",
                new UnitInfo<ApparentPowerUnit>[]
                {
                    ...
                    new UnitInfo<ApparentPowerUnit>(ApparentPowerUnit.Voltampere, "Voltamperes", new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second), "ApparentPower"),
                },
