...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = RelativeHumidity.From(1.0, RelativeHumidity.BaseUnit);
        ...
        {
            var inBaseUnit = RelativeHumidity.From(1.0, RelativeHumidity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(RelativeHumidityUnit)));
        }
        ...
        {
            var quantity = RelativeHumidity.FromPercent(1.0);
            Assert.Equal(RelativeHumidity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
