...
namespace UnitsNet
{
    ...
    public partial struct ElectricResistivity : IQuantity<ElectricResistivityUnit>, IEquatable<ElectricResistivity>, IComparable, IComparable<ElectricResistivity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ElectricResistivity" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<ElectricResistivity>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(ElectricResistivityUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ElectricResistivity>(inBaseUnits.Unit, unit, out var conversionFunction))
