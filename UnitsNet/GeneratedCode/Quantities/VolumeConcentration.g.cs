...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static VolumeConcentration()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, VolumeConcentrationUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, VolumeConcentrationUnit Unit), List<string>> Abbreviations { get; }
