...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static HeatTransferCoefficient()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, HeatTransferCoefficientUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, HeatTransferCoefficientUnit Unit), List<string>> Abbreviations { get; }
