...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MolarMass()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MolarMassUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MolarMassUnit Unit), List<string>> Abbreviations { get; }
