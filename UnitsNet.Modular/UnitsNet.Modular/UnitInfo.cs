    ...
    where TUnit : struct, Enum
{
    ...
    public UnitInfo(
        ...
        string pluralName,
        BaseUnits baseUnits,
        params UnitLocalization[] localizations)
    {
        ArgumentNullException.ThrowIfNull(singularName);
    ...
    /// <summary>Gets the constituent base units represented by this unit.</summary>
