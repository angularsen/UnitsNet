...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = Ratio.From(1.0, Ratio.BaseUnit);
        ...
        {
            var inBaseUnit = Ratio.From(1.0, Ratio.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(RatioUnit)));
        }
        ...
        {
            var quantity = Ratio.FromDecimalFractions(1.0);
            Assert.Equal(Ratio.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
