...
namespace UnitsNet
{
    ...
    public partial struct ElectricCurrentDensity : IQuantity<ElectricCurrentDensityUnit>, IEquatable<ElectricCurrentDensity>, IComparable, IComparable<ElectricCurrentDensity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ElectricCurrentDensity" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<ElectricCurrentDensity>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(ElectricCurrentDensityUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ElectricCurrentDensity>(inBaseUnits.Unit, unit, out var conversionFunction))
