...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static LinearDensity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, LinearDensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, LinearDensityUnit Unit), List<string>> Abbreviations { get; }
