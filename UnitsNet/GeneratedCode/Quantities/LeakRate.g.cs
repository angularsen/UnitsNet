...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public static string GetAbbreviation(LeakRateUnit unit, CultureInfo? culture)
        {
        ...
        /// <exception cref="ArgumentNullException">The value of 'str' cannot be null. </exception>
        /// <exception cref="UnitsNetException">Error parsing string.</exception>
        public static LeakRateUnit ParseUnit(string str, CultureInfo? culture)
        {
            return UnitsNetSetup.Default.UnitParser.Parse<LeakRateUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.LeakRateUnit)"/>
        ...
        /// </example>
        /// <param name="culture">The localization culture. Defaults to <see cref="CultureInfo.CurrentCulture" /> if null.</param>
        public static bool TryParseUnit([NotNullWhen(true)]string? str, CultureInfo? culture, out LeakRateUnit unit)
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<LeakRateUnit>(str, culture, out unit);
        }
