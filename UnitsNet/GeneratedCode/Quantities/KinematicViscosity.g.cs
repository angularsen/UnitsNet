...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial struct KinematicViscosity : IQuantity<KinematicViscosityUnit>, IComparable, IComparable<KinematicViscosity>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public KinematicViscosityUnit Unit => _unit.GetValueOrDefault(ConversionBaseUnit);
        ...
        internal KinematicViscosity ToBaseUnit()
        {
            ...
            return new KinematicViscosity(baseUnitValue, ConversionBaseUnit);
        }
