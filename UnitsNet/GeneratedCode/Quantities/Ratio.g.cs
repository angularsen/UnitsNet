...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial struct Ratio : IQuantity<RatioUnit>, IComparable, IComparable<Ratio>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<RatioUnit>)this).As(unitAsRatioUnit);
        }
        ...
        /// <summary>
        ///     Converts this Ratio to another Ratio with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A Ratio with the specified unit.</returns>
        public QuantityValue ToQuantity(RatioUnit unit)
        {
