...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MolarFlow()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, MolarFlowUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, MolarFlowUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(MolarFlowUnit unit) => GetAbbreviation(unit, null);
