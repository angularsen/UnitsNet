...
namespace UnitsNet
{
    ...
    public partial struct RelativeHumidity<T> : IQuantityT<RelativeHumidityUnit, T>, IEquatable<RelativeHumidity<T>>, IComparable, IComparable<RelativeHumidity<T>>, IConvertible, IFormattable
    {
        ...
        /// </summary>
        public static RelativeHumidity<T> MaxValue { get; } = new RelativeHumidity<T>(double.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of <see cref="RelativeHumidity{T}" />
        /// </summary>
        public static RelativeHumidity<T> MinValue { get; } = new RelativeHumidity<T>(double.MinValue, BaseUnit);
        ...
        /// </summary>
        public static RelativeHumidity<T> Zero { get; } = new RelativeHumidity<T>((T)0, BaseUnit);
        ...
        {
            return QuantityParser.Default.Parse<RelativeHumidity<T>, RelativeHumidityUnit>(
                str,
                provider,
                From);
        }
        ...
        {
            return QuantityParser.Default.TryParse<RelativeHumidity<T>, RelativeHumidityUnit>(
                str,
                provider,
                From,
                out result);
        ...
        public bool Equals(RelativeHumidity<T> other, double tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
