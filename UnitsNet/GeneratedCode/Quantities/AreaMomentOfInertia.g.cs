...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static AreaMomentOfInertia()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, AreaMomentOfInertiaUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, AreaMomentOfInertiaUnit Unit), List<string>> Abbreviations { get; }
