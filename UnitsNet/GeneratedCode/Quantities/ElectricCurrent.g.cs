...
namespace UnitsNet
{
    ...
    public partial struct ElectricCurrent : IQuantity<ElectricCurrentUnit>, IComparable, IComparable<ElectricCurrent>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ElectricCurrentUnit>)this).As(unitAsElectricCurrentUnit);
        }
        ...
        /// <summary>
        ///     Converts this ElectricCurrent to another ElectricCurrent with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ElectricCurrent with the specified unit.</returns>
        public QuantityValue ToQuantity(ElectricCurrentUnit unit)
        {
