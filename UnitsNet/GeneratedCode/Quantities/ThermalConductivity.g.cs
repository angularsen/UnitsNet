...
namespace UnitsNet
{
    ...
    public partial struct ThermalConductivity : IQuantity<ThermalConductivityUnit>, IEquatable<ThermalConductivity>, IComparable, IComparable<ThermalConductivity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ThermalConductivity" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<ThermalConductivity>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(ThermalConductivityUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ThermalConductivity>(inBaseUnits.Unit, unit, out var conversionFunction))
