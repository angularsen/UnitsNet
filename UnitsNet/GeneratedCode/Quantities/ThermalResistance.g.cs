...
namespace UnitsNet
{
    ...
    /// </summary>
    public partial struct ThermalResistance<T> : IQuantity<ThermalResistanceUnit>, IEquatable<ThermalResistance<T>>, IComparable, IComparable<ThermalResistance<T>>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        /// </summary>
        public static ThermalResistance<T> MaxValue { get; } = new ThermalResistance<T>(double.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of <see cref="ThermalResistance{T}" />
        /// </summary>
        public static ThermalResistance<T> MinValue { get; } = new ThermalResistance<T>(double.MinValue, BaseUnit);
        ...
        /// </summary>
        public static ThermalResistance<T> Zero { get; } = new ThermalResistance<T>(0, BaseUnit);
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ThermalResistance<T> FromHourSquareFeetDegreesFahrenheitPerBtu(QuantityValue hoursquarefeetdegreesfahrenheitperbtu)
        {
            double value = (double) hoursquarefeetdegreesfahrenheitperbtu;
            return new ThermalResistance<T>(value, ThermalResistanceUnit.HourSquareFeetDegreeFahrenheitPerBtu);
        }
        /// <summary>
        ///     Get <see cref="ThermalResistance{T}" /> from SquareCentimeterHourDegreesCelsiusPerKilocalorie.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ThermalResistance<T> FromSquareCentimeterHourDegreesCelsiusPerKilocalorie(QuantityValue squarecentimeterhourdegreescelsiusperkilocalorie)
        {
            double value = (double) squarecentimeterhourdegreescelsiusperkilocalorie;
            return new ThermalResistance<T>(value, ThermalResistanceUnit.SquareCentimeterHourDegreeCelsiusPerKilocalorie);
        }
        /// <summary>
        ///     Get <see cref="ThermalResistance{T}" /> from SquareCentimeterKelvinsPerWatt.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ThermalResistance<T> FromSquareCentimeterKelvinsPerWatt(QuantityValue squarecentimeterkelvinsperwatt)
        {
            double value = (double) squarecentimeterkelvinsperwatt;
            return new ThermalResistance<T>(value, ThermalResistanceUnit.SquareCentimeterKelvinPerWatt);
        }
        /// <summary>
        ///     Get <see cref="ThermalResistance{T}" /> from SquareMeterDegreesCelsiusPerWatt.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ThermalResistance<T> FromSquareMeterDegreesCelsiusPerWatt(QuantityValue squaremeterdegreescelsiusperwatt)
        {
            double value = (double) squaremeterdegreescelsiusperwatt;
            return new ThermalResistance<T>(value, ThermalResistanceUnit.SquareMeterDegreeCelsiusPerWatt);
        }
        /// <summary>
        ///     Get <see cref="ThermalResistance{T}" /> from SquareMeterKelvinsPerKilowatt.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static ThermalResistance<T> FromSquareMeterKelvinsPerKilowatt(QuantityValue squaremeterkelvinsperkilowatt)
        {
            double value = (double) squaremeterkelvinsperkilowatt;
            return new ThermalResistance<T>(value, ThermalResistanceUnit.SquareMeterKelvinPerKilowatt);
        }
        ...
        public static ThermalResistance<T> From(QuantityValue value, ThermalResistanceUnit fromUnit)
        {
            return new ThermalResistance<T>((double)value, fromUnit);
        }
        ...
        public static ThermalResistance<T> Parse(string str, [CanBeNull] IFormatProvider provider)
        {
            return QuantityParser.Default.Parse<ThermalResistance<T>, ThermalResistanceUnit>(
                str,
                provider,
                From);
        }
        ...
        ///     Length.Parse("5.5 m", new CultureInfo("en-US"));
        /// </example>
        public static bool TryParse([CanBeNull] string str, out ThermalResistance<T> result)
        {
        ...
        /// </example>
        /// <param name="provider">Format to use when parsing number and unit. Defaults to <see cref="CultureInfo.CurrentUICulture" /> if null.</param>
        public static bool TryParse([CanBeNull] string str, [CanBeNull] IFormatProvider provider, out ThermalResistance<T> result)
        {
            return QuantityParser.Default.TryParse<ThermalResistance<T>, ThermalResistanceUnit>(
                str,
                provider,
                From,
                out result);
        ...
        {
            return new ThermalResistance<T>(-right.Value, right.Unit);
        }
        ...
        {
            return new ThermalResistance<T>(left.Value + right.GetValueAs(left.Unit), left.Unit);
        }
        ...
        public static ThermalResistance<T> operator *(double left, ThermalResistance<T> right)
        {
            return new ThermalResistance<T>(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="ThermalResistance{T}"/> from multiplying value and <see cref="ThermalResistance{T}"/>.</summary>
        public static ThermalResistance<T> operator *(ThermalResistance<T> left, double right)
        {
            return new ThermalResistance<T>(left.Value * right, left.Unit);
        }
        ...
        public static double operator /(ThermalResistance<T> left, ThermalResistance<T> right)
        {
        ...
        public bool Equals(ThermalResistance<T> other, double tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
