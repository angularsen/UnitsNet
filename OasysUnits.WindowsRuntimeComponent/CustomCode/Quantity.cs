        ...
        internal partial class Quantity
    {
        ...
        internal static IQuantity From(double value, Enum unit)
        {
            ...
            throw new ArgumentException(
                $"Unit value {unit} of type {unit.GetType()} is not a known unit enum type. Expected types like OasysUnits.Units.LengthUnit. Did you pass in a third-party enum type defined outside OasysUnits library?");
        }
    }
}
