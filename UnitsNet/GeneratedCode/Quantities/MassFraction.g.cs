...
namespace UnitsNet
{
    ...
    public partial struct MassFraction : IQuantity<MassFractionUnit>, IEquatable<MassFraction>, IComparable, IComparable<MassFraction>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="MassFraction" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<MassFraction>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(MassFractionUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<MassFraction>(inBaseUnits.Unit, unit, out var conversionFunction))
