...
namespace UnitsNet
{
    ...
    public partial struct VolumeConcentration : IQuantity<VolumeConcentrationUnit>, IComparable, IComparable<VolumeConcentration>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<VolumeConcentrationUnit>)this).As(unitAsVolumeConcentrationUnit);
        }
        ...
        /// <summary>
        ///     Converts this VolumeConcentration to another VolumeConcentration with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A VolumeConcentration with the specified unit.</returns>
        public QuantityValue ToQuantity(VolumeConcentrationUnit unit)
        {
