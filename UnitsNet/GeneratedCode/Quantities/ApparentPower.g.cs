...
namespace UnitsNet
{
    ...
    public partial struct ApparentPower : IQuantity<ApparentPowerUnit>, IEquatable<ApparentPower>, IComparable, IComparable<ApparentPower>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ApparentPower" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<ApparentPower>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(ApparentPowerUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ApparentPower>(inBaseUnits.Unit, unit, out var conversionFunction))
