...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Illuminance()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, IlluminanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, IlluminanceUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(IlluminanceUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(IlluminanceUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.Illuminance";
                var resourceManager = new ResourceManager(resourceName, typeof(Illuminance).Assembly);
