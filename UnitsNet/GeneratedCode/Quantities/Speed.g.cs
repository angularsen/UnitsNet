...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Speed()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, SpeedUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, SpeedUnit Unit), List<string>> Abbreviations { get; }
