...
namespace UnitsNet
{
    ...
    /// </summary>
    public partial struct MolarEntropy : IQuantity<MolarEntropyUnit>, IEquatable<MolarEntropy>, IComparable, IComparable<MolarEntropy>, IConvertible
    {
        /// <summary>
        ...
        public MolarEntropy(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static MolarEntropyUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static MolarEntropyUnit GetUnitFor(BaseUnits baseUnits)
        {
