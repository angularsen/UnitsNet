...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = Capacitance.From(1.0, Capacitance.BaseUnit);
        ...
        {
            var inBaseUnit = Capacitance.From(1.0, Capacitance.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(CapacitanceUnit)));
        }
        ...
        {
            var quantity = Capacitance.FromFarads(1.0);
            Assert.Equal(Capacitance.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
