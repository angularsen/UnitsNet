...
namespace UnitsNet
{
    ...
    public partial struct MolarMass : IQuantity<MolarMassUnit>, IEquatable<MolarMass>, IComparable, IComparable<MolarMass>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="MolarMass" /> instances.
        /// </summary>
        ...
        internal MolarMass ToBaseUnit()
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<MolarMass>(Unit, BaseUnit, out var conversionFunction))
