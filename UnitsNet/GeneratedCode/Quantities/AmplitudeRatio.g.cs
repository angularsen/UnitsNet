...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<AmplitudeRatioUnit>(str, culture);
        }
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<AmplitudeRatioUnit>(str, culture, out unit);
        }
