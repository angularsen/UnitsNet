...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ElectricResistance.From(1.0, ElectricResistance.BaseUnit);
        ...
        {
            var inBaseUnit = ElectricResistance.From(1.0, ElectricResistance.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ElectricResistanceUnit)));
        }
        ...
        {
            var quantity = ElectricResistance.FromOhms(1.0);
            Assert.Equal(ElectricResistance.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
