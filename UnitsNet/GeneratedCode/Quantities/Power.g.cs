...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Power()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, PowerUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, PowerUnit Unit), List<string>> Abbreviations { get; }
