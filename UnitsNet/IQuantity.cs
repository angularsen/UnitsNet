...
namespace UnitsNet
{
    ...
    public interface IQuantity : IFormattable
    {
        ...
        /// </summary>
        /// <param name="unit">
        ///     The unit enum value. The unit must be compatible, so for <see cref="Length" /> you should provide a
        ///     <see cref="LengthUnit" /> value.
        /// </param>
        ...
        /// <summary>
        ///     Converts to a quantity with the given unit representation, which affects things like
        ...
        /// <summary>
        ///     Converts to a quantity with a unit determined by the given <see cref="UnitSystem" />, which affects things like
        ///     <see cref="IQuantity.ToString(System.IFormatProvider)" />.
        ...
        /// </param>
        [Obsolete(
            @"This method is deprecated and will be removed at a future release. Please use ToString(""s2"") or ToString(""s2"", provider) where 2 is an example of the number passed to significantDigitsAfterRadix.")]
