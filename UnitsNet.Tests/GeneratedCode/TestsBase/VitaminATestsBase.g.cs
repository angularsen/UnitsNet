...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = VitaminA.From(1.0, VitaminA.BaseUnit);
        ...
        {
            var inBaseUnit = VitaminA.From(1.0, VitaminA.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(VitaminAUnit)));
        }
        ...
        {
            var quantity = VitaminA.FromInternationalUnits(1.0);
            Assert.Equal(VitaminA.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
