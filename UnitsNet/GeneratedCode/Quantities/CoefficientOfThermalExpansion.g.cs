...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial struct CoefficientOfThermalExpansion : IQuantity<CoefficientOfThermalExpansionUnit>, IComparable, IComparable<CoefficientOfThermalExpansion>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        /// <summary>
        ///     Converts this CoefficientOfThermalExpansion to another CoefficientOfThermalExpansion with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A CoefficientOfThermalExpansion with the specified unit.</returns>
        public QuantityValue ToQuantity(CoefficientOfThermalExpansionUnit unit)
        {
