...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Volume()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, VolumeUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, VolumeUnit Unit), List<string>> Abbreviations { get; }
