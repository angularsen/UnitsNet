...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static SpecificVolume()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, SpecificVolumeUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, SpecificVolumeUnit Unit), List<string>> Abbreviations { get; }
