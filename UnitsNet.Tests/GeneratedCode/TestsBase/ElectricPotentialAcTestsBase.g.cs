...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void Ctor_UnitSystem_ThrowsArgumentExceptionIfNotSupported()
        {
            ...
            Assert.Throws<ArgumentException>(() => new ElectricPotentialAc(value: 1, unitSystem: unsupportedUnitSystem));
        }
        ...
        {
            var baseUnitInfo = ElectricPotentialAc.Info.BaseUnitInfo;
        ...
        public virtual void As_UnitSystem_SI_ReturnsQuantityInSIUnits()
        {
            ...
            var expectedValue = quantity.As(ElectricPotentialAc.Info.GetDefaultUnit(UnitSystem.SI));
        ...
        {
            var quantity = new ElectricPotentialAc(value: 1, unit: ElectricPotentialAc.BaseUnit);
            var expectedUnit = ElectricPotentialAc.Info.GetDefaultUnit(UnitSystem.SI);
            var expectedValue = quantity.As(expectedUnit);

            Assert.Multiple(() =>
            {
                ElectricPotentialAc quantityToConvert = quantity;

                ElectricPotentialAc convertedQuantity = quantityToConvert.ToUnit(UnitSystem.SI);

                Assert.Equal(expectedUnit, convertedQuantity.Unit);
                Assert.Equal(expectedValue, convertedQuantity.Value);
            }, () =>
            {
                IQuantity<ElectricPotentialAcUnit> quantityToConvert = quantity;

                IQuantity<ElectricPotentialAcUnit> convertedQuantity = quantityToConvert.ToUnit(UnitSystem.SI);
        ...
        public void ToUnit_UnitSystem_ThrowsArgumentNullExceptionIfNull()
        {
            ...
            {
                IQuantity<ElectricPotentialAcUnit> quantity = new ElectricPotentialAc(value: 1, unit: ElectricPotentialAc.BaseUnit);
                Assert.Throws<ArgumentNullException>(() => quantity.ToUnit(nullUnitSystem));
            }, () =>
            {
                IQuantity quantity = new ElectricPotentialAc(value: 1, unit: ElectricPotentialAc.BaseUnit);
                Assert.Throws<ArgumentNullException>(() => quantity.ToUnit(nullUnitSystem));
            });
        }
