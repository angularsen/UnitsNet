...
namespace UnitsNet
{
    ...
    /// </remarks>
    public partial struct LuminousIntensity : IQuantity<LuminousIntensityUnit>, IEquatable<LuminousIntensity>, IComparable, IComparable<LuminousIntensity>, IConvertible
    {
        /// <summary>
        ...
        public LuminousIntensity(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static LuminousIntensityUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static LuminousIntensityUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
