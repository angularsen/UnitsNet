...
namespace UnitsNet
{
    ...
    public partial struct ElectricInductance : IQuantity<ElectricInductanceUnit>, IComparable, IComparable<ElectricInductance>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ElectricInductanceUnit>)this).As(unitAsElectricInductanceUnit);
        }
        ...
        /// <summary>
        ///     Converts this ElectricInductance to another ElectricInductance with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ElectricInductance with the specified unit.</returns>
        public QuantityValue ToQuantity(ElectricInductanceUnit unit)
        {
