...
namespace UnitsNet
{
    ...
    public partial struct MassFlux : IQuantity<MassFluxUnit>, IEquatable<MassFlux>, IComparable, IComparable<MassFlux>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="MassFlux" /> instances.
        /// </summary>
        ...
        public MassFlux ToUnit(MassFluxUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<MassFlux>(inBaseUnits.Unit, unit, out var conversionFunction))
