...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Level()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, LevelUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, LevelUnit Unit), List<string>> Abbreviations { get; }
