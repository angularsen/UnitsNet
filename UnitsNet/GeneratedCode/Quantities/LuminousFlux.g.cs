...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static LuminousFlux()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, LuminousFluxUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, LuminousFluxUnit Unit), List<string>> Abbreviations { get; }
