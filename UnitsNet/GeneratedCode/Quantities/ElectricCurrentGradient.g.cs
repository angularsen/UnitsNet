...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricCurrentGradient()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricCurrentGradientUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricCurrentGradientUnit Unit), List<string>> Abbreviations { get; }
