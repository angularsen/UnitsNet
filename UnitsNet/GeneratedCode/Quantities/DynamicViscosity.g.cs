...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<DynamicViscosityUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.DynamicViscosityUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<DynamicViscosityUnit>(str, culture, out unit);
        }
