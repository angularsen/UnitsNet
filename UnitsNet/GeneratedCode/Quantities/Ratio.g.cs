...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Ratio()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, RatioUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, RatioUnit Unit), List<string>> Abbreviations { get; }
