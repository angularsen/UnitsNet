...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial struct LuminousFlux : IQuantity<LuminousFluxUnit>, IComparable, IComparable<LuminousFlux>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<LuminousFluxUnit>)this).As(unitAsLuminousFluxUnit);
        }
        ...
        /// <summary>
        ///     Converts this LuminousFlux to another LuminousFlux with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A LuminousFlux with the specified unit.</returns>
        public QuantityValue ToQuantity(LuminousFluxUnit unit)
        {
