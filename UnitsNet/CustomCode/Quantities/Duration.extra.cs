...
namespace UnitsNet
{
    public partial struct Duration
    {
        ...
        {
            if (Seconds.ToDouble() > TimeSpan.MaxValue.TotalSeconds) throw new ArgumentOutOfRangeException(nameof(Seconds),
                    "The duration is too large for a TimeSpan, which would roll over from positive to negative.");

            if (Seconds.ToDouble() < TimeSpan.MinValue.TotalSeconds) throw new ArgumentOutOfRangeException(nameof(Seconds),
        ...
        {
            return FromSeconds(Fraction.FromDoubleRounded(duration.TotalSeconds));
        }
        ...
        {
            return duration.Seconds.ToDouble() < timeSpan.TotalSeconds;
        }
        ...
        {
            return timeSpan.TotalSeconds < duration.Seconds.ToDouble();
        }
