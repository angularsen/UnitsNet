...
namespace UnitsNet
{
    ...
    public partial struct Volume : IQuantity<VolumeUnit>, IEquatable<Volume>, IComparable, IComparable<Volume>, IConvertible, IFormattable
    {
        ...
        static Volume()
        {
            ...
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.AcreFoot, q => q.ToUnit(VolumeUnit.AcreFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.AcreFoot, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.AuTablespoon, q => q.ToUnit(VolumeUnit.AuTablespoon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.AuTablespoon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.BoardFoot, q => q.ToUnit(VolumeUnit.BoardFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.BoardFoot, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.Centiliter, q => q.ToUnit(VolumeUnit.Centiliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Centiliter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.CubicCentimeter, q => q.ToUnit(VolumeUnit.CubicCentimeter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicCentimeter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.CubicDecimeter, q => q.ToUnit(VolumeUnit.CubicDecimeter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicDecimeter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.CubicFoot, q => q.ToUnit(VolumeUnit.CubicFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicFoot, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.CubicHectometer, q => q.ToUnit(VolumeUnit.CubicHectometer));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicHectometer, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.CubicInch, q => q.ToUnit(VolumeUnit.CubicInch));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicInch, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.CubicKilometer, q => q.ToUnit(VolumeUnit.CubicKilometer));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicKilometer, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, Volume.BaseUnit, q => q);
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.CubicMicrometer, q => q.ToUnit(VolumeUnit.CubicMicrometer));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMicrometer, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.CubicMile, q => q.ToUnit(VolumeUnit.CubicMile));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMile, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.CubicMillimeter, q => q.ToUnit(VolumeUnit.CubicMillimeter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicMillimeter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.CubicYard, q => q.ToUnit(VolumeUnit.CubicYard));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.CubicYard, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.DecausGallon, q => q.ToUnit(VolumeUnit.DecausGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.DecausGallon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.Deciliter, q => q.ToUnit(VolumeUnit.Deciliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Deciliter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.DeciusGallon, q => q.ToUnit(VolumeUnit.DeciusGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.DeciusGallon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.HectocubicFoot, q => q.ToUnit(VolumeUnit.HectocubicFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.HectocubicFoot, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.HectocubicMeter, q => q.ToUnit(VolumeUnit.HectocubicMeter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.HectocubicMeter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.Hectoliter, q => q.ToUnit(VolumeUnit.Hectoliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Hectoliter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.HectousGallon, q => q.ToUnit(VolumeUnit.HectousGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.HectousGallon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ImperialBeerBarrel, q => q.ToUnit(VolumeUnit.ImperialBeerBarrel));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.ImperialBeerBarrel, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ImperialGallon, q => q.ToUnit(VolumeUnit.ImperialGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.ImperialGallon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ImperialOunce, q => q.ToUnit(VolumeUnit.ImperialOunce));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.ImperialOunce, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.ImperialPint, q => q.ToUnit(VolumeUnit.ImperialPint));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.ImperialPint, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.KilocubicFoot, q => q.ToUnit(VolumeUnit.KilocubicFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.KilocubicFoot, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.KilocubicMeter, q => q.ToUnit(VolumeUnit.KilocubicMeter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.KilocubicMeter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.KiloimperialGallon, q => q.ToUnit(VolumeUnit.KiloimperialGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.KiloimperialGallon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.Kiloliter, q => q.ToUnit(VolumeUnit.Kiloliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Kiloliter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.KilousGallon, q => q.ToUnit(VolumeUnit.KilousGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.KilousGallon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.Liter, q => q.ToUnit(VolumeUnit.Liter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Liter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MegacubicFoot, q => q.ToUnit(VolumeUnit.MegacubicFoot));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.MegacubicFoot, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MegaimperialGallon, q => q.ToUnit(VolumeUnit.MegaimperialGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.MegaimperialGallon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.Megaliter, q => q.ToUnit(VolumeUnit.Megaliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Megaliter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MegausGallon, q => q.ToUnit(VolumeUnit.MegausGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.MegausGallon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MetricCup, q => q.ToUnit(VolumeUnit.MetricCup));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.MetricCup, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.MetricTeaspoon, q => q.ToUnit(VolumeUnit.MetricTeaspoon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.MetricTeaspoon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.Microliter, q => q.ToUnit(VolumeUnit.Microliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Microliter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.Milliliter, q => q.ToUnit(VolumeUnit.Milliliter));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.Milliliter, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.OilBarrel, q => q.ToUnit(VolumeUnit.OilBarrel));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.OilBarrel, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.UkTablespoon, q => q.ToUnit(VolumeUnit.UkTablespoon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UkTablespoon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.UsBeerBarrel, q => q.ToUnit(VolumeUnit.UsBeerBarrel));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsBeerBarrel, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.UsCustomaryCup, q => q.ToUnit(VolumeUnit.UsCustomaryCup));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsCustomaryCup, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.UsGallon, q => q.ToUnit(VolumeUnit.UsGallon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsGallon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.UsLegalCup, q => q.ToUnit(VolumeUnit.UsLegalCup));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsLegalCup, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.UsOunce, q => q.ToUnit(VolumeUnit.UsOunce));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsOunce, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.UsPint, q => q.ToUnit(VolumeUnit.UsPint));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsPint, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.UsQuart, q => q.ToUnit(VolumeUnit.UsQuart));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsQuart, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.UsTablespoon, q => q.ToUnit(VolumeUnit.UsTablespoon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsTablespoon, Volume.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Volume>(Volume.BaseUnit, VolumeUnit.UsTeaspoon, q => q.ToUnit(VolumeUnit.UsTeaspoon));
            UnitConverter.Default.SetConversionFunction<Volume>(VolumeUnit.UsTeaspoon, Volume.BaseUnit, q => q.ToBaseUnit());
        }
