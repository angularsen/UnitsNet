...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static SpecificEnergy()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, SpecificEnergyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, SpecificEnergyUnit Unit), List<string>> Abbreviations { get; }
