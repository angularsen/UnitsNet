...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = VolumeFlowPerArea.From(1.0, VolumeFlowPerArea.BaseUnit);
        ...
        {
            var inBaseUnit = VolumeFlowPerArea.From(1.0, VolumeFlowPerArea.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(VolumeFlowPerAreaUnit)));
        }
        ...
        {
            var quantity = VolumeFlowPerArea.FromCubicMetersPerSecondPerSquareMeter(1.0);
            Assert.Equal(VolumeFlowPerArea.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
