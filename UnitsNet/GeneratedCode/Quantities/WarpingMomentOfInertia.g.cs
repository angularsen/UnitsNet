...
namespace UnitsNet
{
    ...
    public partial struct WarpingMomentOfInertia : IQuantity<WarpingMomentOfInertiaUnit>, IComparable, IComparable<WarpingMomentOfInertia>, IConvertible, IFormattable
    {
        ...
        /// </summary>
        public static WarpingMomentOfInertiaUnit[] Units { get; } = Enum.GetValues(typeof(WarpingMomentOfInertiaUnit)).Cast<WarpingMomentOfInertiaUnit>().ToArray();
        ...
        /// <inheritdoc />
        public WarpingMomentOfInertiaUnit Unit => _unit.GetValueOrDefault(ConversionBaseUnit);
        ...
        internal WarpingMomentOfInertia ToBaseUnit()
        {
            ...
            return new WarpingMomentOfInertia(baseUnitValue, ConversionBaseUnit);
        }
