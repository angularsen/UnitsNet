...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static BrakeSpecificFuelConsumption()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, BrakeSpecificFuelConsumptionUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, BrakeSpecificFuelConsumptionUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(BrakeSpecificFuelConsumptionUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(BrakeSpecificFuelConsumptionUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.BrakeSpecificFuelConsumption";
                var resourceManager = new ResourceManager(resourceName, typeof(BrakeSpecificFuelConsumption).Assembly);
