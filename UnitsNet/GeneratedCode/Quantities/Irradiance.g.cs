...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Irradiance()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, IrradianceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, IrradianceUnit Unit), List<string>> Abbreviations { get; }
