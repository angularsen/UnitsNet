...
namespace UnitsNet
{
    ...
    public partial struct VolumePerLength : IQuantity<VolumePerLengthUnit>, IComparable, IComparable<VolumePerLength>, IConvertible, IFormattable
    {
        ...
        /// </summary>
        public static VolumePerLengthUnit[] Units { get; } = Enum.GetValues(typeof(VolumePerLengthUnit)).Cast<VolumePerLengthUnit>().ToArray();
        ...
        /// <inheritdoc />
        public VolumePerLengthUnit Unit => _unit.GetValueOrDefault(ConversionBaseUnit);
        ...
        internal VolumePerLength ToBaseUnit()
        {
            ...
            return new VolumePerLength(baseUnitValue, ConversionBaseUnit);
        }
