...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ReactiveEnergy()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ReactiveEnergyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ReactiveEnergyUnit Unit), List<string>> Abbreviations { get; }
