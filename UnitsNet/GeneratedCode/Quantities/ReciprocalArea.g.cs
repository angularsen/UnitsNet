...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ReciprocalArea()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ReciprocalAreaUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ReciprocalAreaUnit Unit), List<string>> Abbreviations { get; }
