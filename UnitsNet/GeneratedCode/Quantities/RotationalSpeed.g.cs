...
namespace UnitsNet
{
    ...
    public partial struct RotationalSpeed : IQuantity<RotationalSpeedUnit>, IComparable, IComparable<RotationalSpeed>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<RotationalSpeedUnit>)this).As(unitAsRotationalSpeedUnit);
        }
        ...
        /// <summary>
        ///     Converts this RotationalSpeed to another RotationalSpeed with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A RotationalSpeed with the specified unit.</returns>
        public QuantityValue ToQuantity(RotationalSpeedUnit unit)
        {
