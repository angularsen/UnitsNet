...
namespace UnitsNet
{
    public sealed partial class UnitConverter
    {
        ...
        public static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.DecawattPeak, q => q.ToUnit(NominalPowerUnit.DecawattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.DecawattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.DeciwattPeak, q => q.ToUnit(NominalPowerUnit.DeciwattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.DeciwattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.FemtowattPeak, q => q.ToUnit(NominalPowerUnit.FemtowattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.FemtowattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.GigawattPeak, q => q.ToUnit(NominalPowerUnit.GigawattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.GigawattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.KilowattPeak, q => q.ToUnit(NominalPowerUnit.KilowattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.KilowattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.MegawattPeak, q => q.ToUnit(NominalPowerUnit.MegawattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.MegawattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.MicrowattPeak, q => q.ToUnit(NominalPowerUnit.MicrowattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.MicrowattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.MilliwattPeak, q => q.ToUnit(NominalPowerUnit.MilliwattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.MilliwattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.NanowattPeak, q => q.ToUnit(NominalPowerUnit.NanowattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.NanowattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.PetawattPeak, q => q.ToUnit(NominalPowerUnit.PetawattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.PetawattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.PicowattPeak, q => q.ToUnit(NominalPowerUnit.PicowattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.PicowattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPowerUnit.TerawattPeak, q => q.ToUnit(NominalPowerUnit.TerawattPeak));
            unitConverter.SetConversionFunction<NominalPower>(NominalPowerUnit.TerawattPeak, NominalPower.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<NominalPower>(NominalPower.BaseUnit, NominalPower.BaseUnit, q => q);
