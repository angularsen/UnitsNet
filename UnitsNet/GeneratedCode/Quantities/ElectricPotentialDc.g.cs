...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricPotentialDc()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricPotentialDcUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricPotentialDcUnit Unit), List<string>> Abbreviations { get; }
