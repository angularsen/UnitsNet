...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static RotationalAcceleration()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, RotationalAccelerationUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, RotationalAccelerationUnit Unit), List<string>> Abbreviations { get; }
