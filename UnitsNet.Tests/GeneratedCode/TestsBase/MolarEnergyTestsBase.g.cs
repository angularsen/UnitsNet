...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = MolarEnergy.From(1.0, MolarEnergy.BaseUnit);
        ...
        {
            var inBaseUnit = MolarEnergy.From(1.0, MolarEnergy.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(MolarEnergyUnit)));
        }
        ...
        {
            var quantity = MolarEnergy.FromJoulesPerMole(1.0);
            Assert.Equal(MolarEnergy.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
