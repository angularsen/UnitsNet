...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static PowerRatio()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, PowerRatioUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, PowerRatioUnit Unit), List<string>> Abbreviations { get; }
