...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = RotationalAcceleration.From(1.0, RotationalAcceleration.BaseUnit);
        ...
        {
            var inBaseUnit = RotationalAcceleration.From(1.0, RotationalAcceleration.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(RotationalAccelerationUnit)));
        }
        ...
        {
            var quantity = RotationalAcceleration.FromRadiansPerSecondSquared(1.0);
            Assert.Equal(RotationalAcceleration.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
