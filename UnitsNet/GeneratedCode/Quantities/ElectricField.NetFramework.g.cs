...
namespace UnitsNet
{
    ...
    /// </remarks>
    public partial struct ElectricField : IQuantity<ElectricFieldUnit>, IEquatable<ElectricField>, IComparable, IComparable<ElectricField>, IConvertible
    {
        /// <summary>
        ...
        public ElectricField(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static ElectricFieldUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static ElectricFieldUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
