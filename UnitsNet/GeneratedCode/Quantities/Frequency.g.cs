...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<FrequencyUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.FrequencyUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<FrequencyUnit>(str, culture, out unit);
        }
