...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MassFlow()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MassFlowUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MassFlowUnit Unit), List<string>> Abbreviations { get; }
