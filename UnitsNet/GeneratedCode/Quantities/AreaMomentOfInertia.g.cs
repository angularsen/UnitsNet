...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static AreaMomentOfInertia()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, AreaMomentOfInertiaUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, AreaMomentOfInertiaUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(AreaMomentOfInertiaUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(AreaMomentOfInertiaUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.AreaMomentOfInertia";
                var resourceManager = new ResourceManager(resourceName, typeof(AreaMomentOfInertia).Assembly);
