...
namespace UnitsNet
{
    ...
    public partial struct Speed : IQuantity<SpeedUnit>, IEquatable<Speed>, IComparable, IComparable<Speed>, IConvertible, IFormattable
    {
        ...
        static Speed()
        {
            ...
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.CentimeterPerHour, q => q.ToUnit(SpeedUnit.CentimeterPerHour));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.CentimeterPerMinute, q => q.ToUnit(SpeedUnit.CentimeterPerMinute));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.CentimeterPerSecond, q => q.ToUnit(SpeedUnit.CentimeterPerSecond));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.DecimeterPerMinute, q => q.ToUnit(SpeedUnit.DecimeterPerMinute));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.DecimeterPerSecond, q => q.ToUnit(SpeedUnit.DecimeterPerSecond));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.FootPerHour, q => q.ToUnit(SpeedUnit.FootPerHour));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.FootPerMinute, q => q.ToUnit(SpeedUnit.FootPerMinute));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.FootPerSecond, q => q.ToUnit(SpeedUnit.FootPerSecond));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.InchPerHour, q => q.ToUnit(SpeedUnit.InchPerHour));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.InchPerMinute, q => q.ToUnit(SpeedUnit.InchPerMinute));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.InchPerSecond, q => q.ToUnit(SpeedUnit.InchPerSecond));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.KilometerPerHour, q => q.ToUnit(SpeedUnit.KilometerPerHour));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.KilometerPerMinute, q => q.ToUnit(SpeedUnit.KilometerPerMinute));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.KilometerPerSecond, q => q.ToUnit(SpeedUnit.KilometerPerSecond));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.Knot, q => q.ToUnit(SpeedUnit.Knot));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.MeterPerHour, q => q.ToUnit(SpeedUnit.MeterPerHour));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.MeterPerMinute, q => q.ToUnit(SpeedUnit.MeterPerMinute));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.MicrometerPerMinute, q => q.ToUnit(SpeedUnit.MicrometerPerMinute));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.MicrometerPerSecond, q => q.ToUnit(SpeedUnit.MicrometerPerSecond));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.MilePerHour, q => q.ToUnit(SpeedUnit.MilePerHour));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.MillimeterPerHour, q => q.ToUnit(SpeedUnit.MillimeterPerHour));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.MillimeterPerMinute, q => q.ToUnit(SpeedUnit.MillimeterPerMinute));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.MillimeterPerSecond, q => q.ToUnit(SpeedUnit.MillimeterPerSecond));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.NanometerPerMinute, q => q.ToUnit(SpeedUnit.NanometerPerMinute));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.NanometerPerSecond, q => q.ToUnit(SpeedUnit.NanometerPerSecond));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.UsSurveyFootPerHour, q => q.ToUnit(SpeedUnit.UsSurveyFootPerHour));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.UsSurveyFootPerMinute, q => q.ToUnit(SpeedUnit.UsSurveyFootPerMinute));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.UsSurveyFootPerSecond, q => q.ToUnit(SpeedUnit.UsSurveyFootPerSecond));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.YardPerHour, q => q.ToUnit(SpeedUnit.YardPerHour));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.YardPerMinute, q => q.ToUnit(SpeedUnit.YardPerMinute));
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.YardPerSecond, q => q.ToUnit(SpeedUnit.YardPerSecond));
            
            // Register in default unit converter: BaseUnit <-> BaseUnit
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerSecond, SpeedUnit.MeterPerSecond, q => q);

            // Register in default unit converter: SpeedUnit -> BaseUnit
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.CentimeterPerHour, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.CentimeterPerMinute, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.CentimeterPerSecond, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.DecimeterPerMinute, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.DecimeterPerSecond, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.FootPerHour, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.FootPerMinute, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.FootPerSecond, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.InchPerHour, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.InchPerMinute, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.InchPerSecond, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.KilometerPerHour, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.KilometerPerMinute, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.KilometerPerSecond, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.Knot, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerHour, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MeterPerMinute, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MicrometerPerMinute, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MicrometerPerSecond, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MilePerHour, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MillimeterPerHour, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MillimeterPerMinute, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.MillimeterPerSecond, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.NanometerPerMinute, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.NanometerPerSecond, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.UsSurveyFootPerHour, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.UsSurveyFootPerMinute, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.UsSurveyFootPerSecond, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.YardPerHour, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.YardPerMinute, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Speed>(SpeedUnit.YardPerSecond, SpeedUnit.MeterPerSecond, q => q.ToBaseUnit());
        }
