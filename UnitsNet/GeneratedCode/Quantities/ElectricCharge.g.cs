...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricCharge()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricChargeUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricChargeUnit Unit), List<string>> Abbreviations { get; }
