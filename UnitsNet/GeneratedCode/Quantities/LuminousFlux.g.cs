...
namespace UnitsNet
{
    ...
    public partial struct LuminousFlux : IQuantity<LuminousFluxUnit>, IEquatable<LuminousFlux>, IComparable, IComparable<LuminousFlux>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="LuminousFlux" /> instances.
        /// </summary>
        ...
        private double GetValueAs(LuminousFluxUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<LuminousFlux>(inBaseUnits.Unit, unit, out var conversionFunction))
