...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static RotationalAcceleration()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, RotationalAccelerationUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, RotationalAccelerationUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(RotationalAccelerationUnit unit) => GetAbbreviation(unit, null);
