...
namespace UnitsNet
{
    ...
    public partial struct Pressure : IQuantity<PressureUnit>, IEquatable<Pressure>, IComparable, IComparable<Pressure>, IConvertible, IFormattable
    {
        ...
        static Pressure()
        {
            ...
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Atmosphere, q => q.ToUnit(PressureUnit.Atmosphere));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Atmosphere, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Bar, q => q.ToUnit(PressureUnit.Bar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Bar, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Centibar, q => q.ToUnit(PressureUnit.Centibar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Centibar, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Decapascal, q => q.ToUnit(PressureUnit.Decapascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Decapascal, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Decibar, q => q.ToUnit(PressureUnit.Decibar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Decibar, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.DynePerSquareCentimeter, q => q.ToUnit(PressureUnit.DynePerSquareCentimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.DynePerSquareCentimeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.FootOfElevation, q => q.ToUnit(PressureUnit.FootOfElevation));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.FootOfElevation, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.FootOfHead, q => q.ToUnit(PressureUnit.FootOfHead));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.FootOfHead, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Gigapascal, q => q.ToUnit(PressureUnit.Gigapascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Gigapascal, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Hectopascal, q => q.ToUnit(PressureUnit.Hectopascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Hectopascal, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.InchOfMercury, q => q.ToUnit(PressureUnit.InchOfMercury));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.InchOfMercury, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.InchOfWaterColumn, q => q.ToUnit(PressureUnit.InchOfWaterColumn));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.InchOfWaterColumn, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Kilobar, q => q.ToUnit(PressureUnit.Kilobar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Kilobar, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.KilogramForcePerSquareCentimeter, q => q.ToUnit(PressureUnit.KilogramForcePerSquareCentimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilogramForcePerSquareCentimeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.KilogramForcePerSquareMeter, q => q.ToUnit(PressureUnit.KilogramForcePerSquareMeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilogramForcePerSquareMeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.KilogramForcePerSquareMillimeter, q => q.ToUnit(PressureUnit.KilogramForcePerSquareMillimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilogramForcePerSquareMillimeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.KilonewtonPerSquareCentimeter, q => q.ToUnit(PressureUnit.KilonewtonPerSquareCentimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilonewtonPerSquareCentimeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.KilonewtonPerSquareMeter, q => q.ToUnit(PressureUnit.KilonewtonPerSquareMeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilonewtonPerSquareMeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.KilonewtonPerSquareMillimeter, q => q.ToUnit(PressureUnit.KilonewtonPerSquareMillimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilonewtonPerSquareMillimeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Kilopascal, q => q.ToUnit(PressureUnit.Kilopascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Kilopascal, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.KilopoundForcePerSquareFoot, q => q.ToUnit(PressureUnit.KilopoundForcePerSquareFoot));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilopoundForcePerSquareFoot, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.KilopoundForcePerSquareInch, q => q.ToUnit(PressureUnit.KilopoundForcePerSquareInch));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.KilopoundForcePerSquareInch, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Megabar, q => q.ToUnit(PressureUnit.Megabar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Megabar, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.MeganewtonPerSquareMeter, q => q.ToUnit(PressureUnit.MeganewtonPerSquareMeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.MeganewtonPerSquareMeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Megapascal, q => q.ToUnit(PressureUnit.Megapascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Megapascal, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.MeterOfElevation, q => q.ToUnit(PressureUnit.MeterOfElevation));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.MeterOfElevation, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.MeterOfHead, q => q.ToUnit(PressureUnit.MeterOfHead));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.MeterOfHead, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Microbar, q => q.ToUnit(PressureUnit.Microbar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Microbar, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Micropascal, q => q.ToUnit(PressureUnit.Micropascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Micropascal, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Millibar, q => q.ToUnit(PressureUnit.Millibar));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Millibar, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.MillimeterOfMercury, q => q.ToUnit(PressureUnit.MillimeterOfMercury));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.MillimeterOfMercury, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.MillimeterOfWaterColumn, q => q.ToUnit(PressureUnit.MillimeterOfWaterColumn));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.MillimeterOfWaterColumn, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Millipascal, q => q.ToUnit(PressureUnit.Millipascal));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Millipascal, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.NewtonPerSquareCentimeter, q => q.ToUnit(PressureUnit.NewtonPerSquareCentimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.NewtonPerSquareCentimeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.NewtonPerSquareMeter, q => q.ToUnit(PressureUnit.NewtonPerSquareMeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.NewtonPerSquareMeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.NewtonPerSquareMillimeter, q => q.ToUnit(PressureUnit.NewtonPerSquareMillimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.NewtonPerSquareMillimeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, Pressure.BaseUnit, q => q);
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.PoundForcePerSquareFoot, q => q.ToUnit(PressureUnit.PoundForcePerSquareFoot));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.PoundForcePerSquareFoot, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.PoundForcePerSquareInch, q => q.ToUnit(PressureUnit.PoundForcePerSquareInch));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.PoundForcePerSquareInch, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.PoundPerInchSecondSquared, q => q.ToUnit(PressureUnit.PoundPerInchSecondSquared));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.PoundPerInchSecondSquared, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.TechnicalAtmosphere, q => q.ToUnit(PressureUnit.TechnicalAtmosphere));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.TechnicalAtmosphere, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.TonneForcePerSquareCentimeter, q => q.ToUnit(PressureUnit.TonneForcePerSquareCentimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.TonneForcePerSquareCentimeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.TonneForcePerSquareMeter, q => q.ToUnit(PressureUnit.TonneForcePerSquareMeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.TonneForcePerSquareMeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.TonneForcePerSquareMillimeter, q => q.ToUnit(PressureUnit.TonneForcePerSquareMillimeter));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.TonneForcePerSquareMillimeter, Pressure.BaseUnit, q => q.ToBaseUnit());
            UnitConverter.Default.SetConversionFunction<Pressure>(Pressure.BaseUnit, PressureUnit.Torr, q => q.ToUnit(PressureUnit.Torr));
            UnitConverter.Default.SetConversionFunction<Pressure>(PressureUnit.Torr, Pressure.BaseUnit, q => q.ToBaseUnit());
        }
