...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial struct ThermalResistance : IQuantity<ThermalResistanceUnit>, IComparable, IComparable<ThermalResistance>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public ThermalResistanceUnit Unit => _unit.GetValueOrDefault(ConversionBaseUnit);
        ...
        internal ThermalResistance ToBaseUnit()
        {
            ...
            return new ThermalResistance(baseUnitValue, ConversionBaseUnit);
        }
