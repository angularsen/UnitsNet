...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricConductivity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricConductivityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricConductivityUnit Unit), List<string>> Abbreviations { get; }
