...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial struct LinearDensity : IQuantity<LinearDensityUnit>, IComparable, IComparable<LinearDensity>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public LinearDensityUnit Unit => _unit.GetValueOrDefault(ConversionBaseUnit);
        ...
        internal LinearDensity ToBaseUnit()
        {
            ...
            return new LinearDensity(baseUnitValue, ConversionBaseUnit);
        }
