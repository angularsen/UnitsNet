...
namespace UnitsNet
{
    ...
    public partial struct WarpingMomentOfInertia<T> : IQuantityT<WarpingMomentOfInertiaUnit, T>, IEquatable<WarpingMomentOfInertia<T>>, IComparable, IComparable<WarpingMomentOfInertia<T>>, IConvertible, IFormattable
    {
        ...
        /// </summary>
        public static WarpingMomentOfInertia<T> MaxValue { get; } = new WarpingMomentOfInertia<T>(double.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of <see cref="WarpingMomentOfInertia{T}" />
        /// </summary>
        public static WarpingMomentOfInertia<T> MinValue { get; } = new WarpingMomentOfInertia<T>(double.MinValue, BaseUnit);
        ...
        /// </summary>
        public static WarpingMomentOfInertia<T> Zero { get; } = new WarpingMomentOfInertia<T>((T)0, BaseUnit);
        ...
        {
            return QuantityParser.Default.Parse<WarpingMomentOfInertia<T>, WarpingMomentOfInertiaUnit>(
                str,
                provider,
                From);
        }
        ...
        {
            return QuantityParser.Default.TryParse<WarpingMomentOfInertia<T>, WarpingMomentOfInertiaUnit>(
                str,
                provider,
                From,
                out result);
        ...
        public bool Equals(WarpingMomentOfInertia<T> other, double tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
