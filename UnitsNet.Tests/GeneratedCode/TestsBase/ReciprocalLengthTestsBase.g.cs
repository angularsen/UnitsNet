...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ReciprocalLength.From(1.0, ReciprocalLength.BaseUnit);
        ...
        {
            var inBaseUnit = ReciprocalLength.From(1.0, ReciprocalLength.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ReciprocalLengthUnit)));
        }
        ...
        {
            var quantity = ReciprocalLength.FromInverseMeters(1.0);
            Assert.Equal(ReciprocalLength.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
