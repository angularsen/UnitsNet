        ...
        public static bool Equals(QuantityValue referenceValue, QuantityValue otherValue, QuantityValue tolerance, ComparisonType comparisonType)
        {
            ...
            switch (comparisonType)
            {
                case ComparisonType.Relative:
                    return referenceValue.IsDecimal || otherValue.IsDecimal || tolerance.IsDecimal
                        ? EqualsRelative((decimal)referenceValue, (decimal)otherValue, (decimal)tolerance)
                        : EqualsRelative((double)referenceValue, (double)otherValue, (double)tolerance);
                case ComparisonType.Absolute:
                    return referenceValue.IsDecimal || otherValue.IsDecimal || tolerance.IsDecimal
                        ? EqualsAbsolute((decimal)referenceValue, (decimal)otherValue, (decimal)tolerance)
                        : EqualsAbsolute((double)referenceValue, (double)otherValue, (double)tolerance);
                default:
