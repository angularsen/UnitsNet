...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static EnergyDensity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, EnergyDensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, EnergyDensityUnit Unit), List<string>> Abbreviations { get; }
