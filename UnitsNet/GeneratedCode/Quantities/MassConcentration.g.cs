...
namespace UnitsNet
{
    ...
    public partial struct MassConcentration : IQuantity<MassConcentrationUnit>, IEquatable<MassConcentration>, IComparable, IComparable<MassConcentration>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="MassConcentration" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<MassConcentration>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(MassConcentrationUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<MassConcentration>(inBaseUnits.Unit, unit, out var conversionFunction))
