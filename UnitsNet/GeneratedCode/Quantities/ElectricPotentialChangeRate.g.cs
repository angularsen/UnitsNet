...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial struct ElectricPotentialChangeRate : IQuantity<ElectricPotentialChangeRateUnit>, IComparable, IComparable<ElectricPotentialChangeRate>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        /// <summary>
        ///     Converts this ElectricPotentialChangeRate to another ElectricPotentialChangeRate with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ElectricPotentialChangeRate with the specified unit.</returns>
        public QuantityValue ToQuantity(ElectricPotentialChangeRateUnit unit)
        {
