...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Illuminance()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, IlluminanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, IlluminanceUnit Unit), List<string>> Abbreviations { get; }
