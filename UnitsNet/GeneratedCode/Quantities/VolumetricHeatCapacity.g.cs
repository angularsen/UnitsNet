...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<VolumetricHeatCapacityUnit>(str, culture);
        }
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<VolumetricHeatCapacityUnit>(str, culture, out unit);
        }
