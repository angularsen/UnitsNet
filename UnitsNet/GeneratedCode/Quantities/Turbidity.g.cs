...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial struct Turbidity : IQuantity<TurbidityUnit>, IComparable, IComparable<Turbidity>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<TurbidityUnit>)this).As(unitAsTurbidityUnit);
        }
        ...
        /// <summary>
        ///     Converts this Turbidity to another Turbidity with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A Turbidity with the specified unit.</returns>
        public QuantityValue ToQuantity(TurbidityUnit unit)
        {
