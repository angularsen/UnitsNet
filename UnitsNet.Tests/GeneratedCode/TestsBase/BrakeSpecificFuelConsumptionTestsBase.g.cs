...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            BrakeSpecificFuelConsumptionUnit[] unitsOrderedByName = EnumHelper.GetValues<BrakeSpecificFuelConsumptionUnit>().OrderBy(x => x.ToString(), StringComparer.Ordinal).ToArray();
        ...
        {
            Assert.All(EnumHelper.GetValues<BrakeSpecificFuelConsumptionUnit>(), unit =>
            {
                var quantity = BrakeSpecificFuelConsumption.From(1, unit);
                Assert.Equal(1, quantity.Value);
