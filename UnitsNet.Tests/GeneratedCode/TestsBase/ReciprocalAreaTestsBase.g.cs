...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ReciprocalArea.From(1.0, ReciprocalArea.BaseUnit);
        ...
        {
            var inBaseUnit = ReciprocalArea.From(1.0, ReciprocalArea.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ReciprocalAreaUnit)));
        }
        ...
        {
            var quantity = ReciprocalArea.FromInverseSquareMeters(1.0);
            Assert.Equal(ReciprocalArea.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
