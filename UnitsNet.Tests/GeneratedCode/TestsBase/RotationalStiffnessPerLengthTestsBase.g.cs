...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = RotationalStiffnessPerLength.From(1.0, RotationalStiffnessPerLength.BaseUnit);
        ...
        {
            var inBaseUnit = RotationalStiffnessPerLength.From(1.0, RotationalStiffnessPerLength.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(RotationalStiffnessPerLengthUnit)));
        }
        ...
        {
            var quantity = RotationalStiffnessPerLength.FromNewtonMetersPerRadianPerMeter(1.0);
            Assert.Equal(RotationalStiffnessPerLength.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
