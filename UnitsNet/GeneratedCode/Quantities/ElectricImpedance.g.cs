...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<ElectricImpedanceUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.ElectricImpedanceUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<ElectricImpedanceUnit>(str, culture, out unit);
        }
