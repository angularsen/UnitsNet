...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<VitaminAUnit>(str, culture);
        }
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<VitaminAUnit>(str, culture, out unit);
        }
