...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Mass()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MassUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MassUnit Unit), List<string>> Abbreviations { get; }
