...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<ForceUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.ForceUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<ForceUnit>(str, culture, out unit);
        }
