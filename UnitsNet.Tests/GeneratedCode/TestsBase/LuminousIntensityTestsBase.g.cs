...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = LuminousIntensity.From(1.0, LuminousIntensity.BaseUnit);
        ...
        {
            var inBaseUnit = LuminousIntensity.From(1.0, LuminousIntensity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(LuminousIntensityUnit)));
        }
        ...
        {
            var quantity = LuminousIntensity.FromCandela(1.0);
            Assert.Equal(LuminousIntensity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
