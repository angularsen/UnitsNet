...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = Speed.From(1.0, Speed.BaseUnit);
        ...
        {
            var inBaseUnit = Speed.From(1.0, Speed.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(SpeedUnit)));
        }
        ...
        {
            var quantity = Speed.FromMetersPerSecond(1.0);
            Assert.Equal(Speed.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
