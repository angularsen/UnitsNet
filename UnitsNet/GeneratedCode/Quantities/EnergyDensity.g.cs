...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<EnergyDensityUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.EnergyDensityUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<EnergyDensityUnit>(str, culture, out unit);
        }
