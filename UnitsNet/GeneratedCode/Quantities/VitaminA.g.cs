...
namespace UnitsNet
{
    ...
    public partial struct VitaminA : IQuantity<VitaminAUnit>, IEquatable<VitaminA>, IComparable, IComparable<VitaminA>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="VitaminA" /> instances.
        /// </summary>
        ...
        internal VitaminA ToBaseUnit()
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<VitaminA>(Unit, BaseUnit, out var conversionFunction))
