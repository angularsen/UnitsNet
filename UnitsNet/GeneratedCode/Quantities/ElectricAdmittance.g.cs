...
namespace UnitsNet
{
    ...
    public partial struct ElectricAdmittance : IQuantity<ElectricAdmittanceUnit>, IComparable, IComparable<ElectricAdmittance>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<ElectricAdmittanceUnit>)this).As(unitAsElectricAdmittanceUnit);
        }
        ...
        /// <summary>
        ///     Converts this ElectricAdmittance to another ElectricAdmittance with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A ElectricAdmittance with the specified unit.</returns>
        public QuantityValue ToQuantity(ElectricAdmittanceUnit unit)
        {
