...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = AreaMomentOfInertia.From(1.0, AreaMomentOfInertia.BaseUnit);
        ...
        {
            var inBaseUnit = AreaMomentOfInertia.From(1.0, AreaMomentOfInertia.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(AreaMomentOfInertiaUnit)));
        }
        ...
        {
            var quantity = AreaMomentOfInertia.FromMetersToTheFourth(1.0);
            Assert.Equal(AreaMomentOfInertia.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
