...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static BitRate()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, BitRateUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, BitRateUnit Unit), List<string>> Abbreviations { get; }
