...
namespace UnitsNet
{
    ...
    /// </summary>
    [DataContract]
    public partial struct WarpingMomentOfInertia : IQuantity<WarpingMomentOfInertiaUnit>, IComparable, IComparable<WarpingMomentOfInertia>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<WarpingMomentOfInertiaUnit>)this).As(unitAsWarpingMomentOfInertiaUnit);
        }
        ...
        /// <summary>
        ///     Converts this WarpingMomentOfInertia to another WarpingMomentOfInertia with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A WarpingMomentOfInertia with the specified unit.</returns>
        public QuantityValue ToQuantity(WarpingMomentOfInertiaUnit unit)
        {
