...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = Permittivity.From(1.0, Permittivity.BaseUnit);
        ...
        {
            var inBaseUnit = Permittivity.From(1.0, Permittivity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(PermittivityUnit)));
        }
        ...
        {
            var quantity = Permittivity.FromFaradsPerMeter(1.0);
            Assert.Equal(Permittivity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
