...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Arcminute).Arcminutes, ArcminutesTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Arcsecond).Arcseconds, ArcsecondsTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Centiradian).Centiradians, CentiradiansTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Deciradian).Deciradians, DeciradiansTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Degree).Degrees, DegreesTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Gradian).Gradians, GradiansTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Microdegree).Microdegrees, MicrodegreesTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Microradian).Microradians, MicroradiansTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Millidegree).Millidegrees, MillidegreesTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Milliradian).Milliradians, MilliradiansTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Nanodegree).Nanodegrees, NanodegreesTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Nanoradian).Nanoradians, NanoradiansTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Radian).Radians, RadiansTolerance);
            AssertEx.EqualTolerance(1, Angle<double>.From(1, AngleUnit.Revolution).Revolutions, RevolutionsTolerance);
        }
