    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.CentinewtonMeterPerDegrees, new string[]{"cN·m/deg", "cNm/deg", "cN·m/°", "cNm/°"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.CentinewtonMillimeterPerDegrees, new string[]{"cN·mm/deg", "cNmm/deg", "cN·mm/°", "cNmm/°"}),
                ...
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.DecanewtonMeterPerDegrees, new string[]{"daN·m/deg", "daNm/deg", "daN·m/°", "daNm/°"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.DecanewtonMillimeterPerDegrees, new string[]{"daN·mm/deg", "daNmm/deg", "daN·mm/°", "daNmm/°"}),
                ...
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.DecinewtonMeterPerDegrees, new string[]{"dN·m/deg", "dNm/deg", "dN·m/°", "dNm/°"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.DecinewtonMillimeterPerDegrees, new string[]{"dN·mm/deg", "dNmm/deg", "dN·mm/°", "dNmm/°"}),
                ...
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.KilonewtonMeterPerDegrees, new string[]{"kN·m/deg", "kNm/deg", "kN·m/°", "kNm/°"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.KilonewtonMeterPerRadian, new string[]{"kN·m/rad", "kNm/rad"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.KilonewtonMillimeterPerDegrees, new string[]{"kN·mm/deg", "kNmm/deg", "kN·mm/°", "kNmm/°"}),
                ...
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.MeganewtonMeterPerDegrees, new string[]{"MN·m/deg", "MNm/deg", "MN·m/°", "MNm/°"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.MeganewtonMeterPerRadian, new string[]{"MN·m/rad", "MNm/rad"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.MeganewtonMillimeterPerDegrees, new string[]{"MN·mm/deg", "MNmm/deg", "MN·mm/°", "MNmm/°"}),
                ...
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.MicronewtonMeterPerDegrees, new string[]{"µN·m/deg", "µNm/deg", "µN·m/°", "µNm/°"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.MicronewtonMillimeterPerDegrees, new string[]{"µN·mm/deg", "µNmm/deg", "µN·mm/°", "µNmm/°"}),
                ...
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.MillinewtonMeterPerDegrees, new string[]{"mN·m/deg", "mNm/deg", "mN·m/°", "mNm/°"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.MillinewtonMillimeterPerDegrees, new string[]{"mN·mm/deg", "mNmm/deg", "mN·mm/°", "mNmm/°"}),
                ...
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.NanonewtonMeterPerDegrees, new string[]{"nN·m/deg", "nNm/deg", "nN·m/°", "nNm/°"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.NanonewtonMillimeterPerDegrees, new string[]{"nN·mm/deg", "nNmm/deg", "nN·mm/°", "nNmm/°"}),
                ...
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.NewtonMeterPerDegrees, new string[]{"N·m/deg", "Nm/deg", "N·m/°", "Nm/°"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.NewtonMeterPerRadian, new string[]{"N·m/rad", "Nm/rad"}),
                ("en-US", typeof(RotationalStiffnessUnit), (int)RotationalStiffnessUnit.NewtonMillimeterPerDegrees, new string[]{"N·mm/deg", "Nmm/deg", "N·mm/°", "Nmm/°"}),
