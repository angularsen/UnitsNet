        ...
        IFormattable
    {
        ...
        private bool TryToUnit(ElectricCurrentDensityUnit unit, [NotNullWhen(true)] out ElectricCurrentDensity? converted)
        {
            ...
            ElectricCurrentDensity? convertedOrNull = (Unit, unit) switch
            {
                ...
                (ElectricCurrentDensityUnit.AmperePerSquareFoot, ElectricCurrentDensityUnit.AmperePerSquareMeter) => new ElectricCurrentDensity(_value * new QuantityValue(5381955208354861, 500000000000000, false), ElectricCurrentDensityUnit.AmperePerSquareMeter),
                (ElectricCurrentDensityUnit.AmperePerSquareInch, ElectricCurrentDensityUnit.AmperePerSquareMeter) => new ElectricCurrentDensity(_value * new QuantityValue(7750015500031, 5000000000, false), ElectricCurrentDensityUnit.AmperePerSquareMeter),

                // BaseUnit -> ElectricCurrentDensityUnit
                (ElectricCurrentDensityUnit.AmperePerSquareMeter, ElectricCurrentDensityUnit.AmperePerSquareFoot) => new ElectricCurrentDensity(_value * new QuantityValue(500000000000000, 5381955208354861, false), ElectricCurrentDensityUnit.AmperePerSquareFoot),
                (ElectricCurrentDensityUnit.AmperePerSquareMeter, ElectricCurrentDensityUnit.AmperePerSquareInch) => new ElectricCurrentDensity(_value * new QuantityValue(5000000000, 7750015500031, false), ElectricCurrentDensityUnit.AmperePerSquareInch),
