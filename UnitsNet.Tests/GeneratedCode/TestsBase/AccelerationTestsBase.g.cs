...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = Acceleration.From(1.0, Acceleration.BaseUnit);
        ...
        {
            var inBaseUnit = Acceleration.From(1.0, Acceleration.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(AccelerationUnit)));
        }
        ...
        {
            var quantity = Acceleration.FromMetersPerSecondSquared(1.0);
            Assert.Equal(Acceleration.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
