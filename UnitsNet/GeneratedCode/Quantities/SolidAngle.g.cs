...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        public SolidAngle(Fraction value, SolidAngleUnit unit)
        {
            _value = value;
            _unit = unit;
        }
        ...
        public SolidAngle(Fraction value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public Fraction Steradians => As(SolidAngleUnit.Steradian);
        ...
        /// </summary>
        public static SolidAngle FromSteradians(Fraction value)
        {
        ...
        public static SolidAngle From(Fraction value, SolidAngleUnit fromUnit)
        {
        ...
        {
            return new SolidAngle(right.Value.Invert(), right.Unit);
        }
        ...
        public static SolidAngle operator *(Fraction left, SolidAngle right)
        {
            return new SolidAngle(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="SolidAngle"/> from multiplying value and <see cref="SolidAngle"/>.</summary>
        public static SolidAngle operator *(SolidAngle left, Fraction right)
        {
        ...
        public static Fraction operator /(SolidAngle left, SolidAngle right)
        {
        ...
        public Fraction As(SolidAngleUnit unit)
        {
            if (Unit == unit)
                return Value;
