...
namespace UnitsNet
{
    ...
    public class QuantityFormatter
    {
        ...
        ///     "a0", "a1", ..., "aN": The Nth unit abbreviation for <see cref="IQuantity{TUnitType}.Unit" />. "a0" is the same as
        ///     "a".
        ...
        ///     "s1", "s2", ..., "sN": The value with N significant digits after the radix followed by the unit abbreviation. For
        ///     example,
            ...
            where TUnitType : Enum
        {
            ...
            var formatArgs = UnitFormatter.GetFormatArgs(quantity.Unit, quantity.Value, formatProvider, Enumerable.Empty<object>());
