...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        public void ToString_WithSwedishCulture_ReturnsUnitAbbreviationForEnglishCultureSinceThereAreNoMappings()
        {
            ...
            Assert.Equal("1 b", new Information(1, InformationUnit.Bit).ToString(null, swedishCulture));
            Assert.Equal("1 B", new Information(1, InformationUnit.Byte).ToString(null, swedishCulture));
            Assert.Equal("1 Eb", new Information(1, InformationUnit.Exabit).ToString(null, swedishCulture));
            Assert.Equal("1 EB", new Information(1, InformationUnit.Exabyte).ToString(null, swedishCulture));
            Assert.Equal("1 Eo", new Information(1, InformationUnit.Exaoctet).ToString(null, swedishCulture));
            Assert.Equal("1 Eib", new Information(1, InformationUnit.Exbibit).ToString(null, swedishCulture));
            Assert.Equal("1 EiB", new Information(1, InformationUnit.Exbibyte).ToString(null, swedishCulture));
            Assert.Equal("1 Eio", new Information(1, InformationUnit.Exbioctet).ToString(null, swedishCulture));
            Assert.Equal("1 Gib", new Information(1, InformationUnit.Gibibit).ToString(null, swedishCulture));
            Assert.Equal("1 GiB", new Information(1, InformationUnit.Gibibyte).ToString(null, swedishCulture));
            Assert.Equal("1 Gio", new Information(1, InformationUnit.Gibioctet).ToString(null, swedishCulture));
            Assert.Equal("1 Gb", new Information(1, InformationUnit.Gigabit).ToString(null, swedishCulture));
            Assert.Equal("1 GB", new Information(1, InformationUnit.Gigabyte).ToString(null, swedishCulture));
            Assert.Equal("1 Go", new Information(1, InformationUnit.Gigaoctet).ToString(null, swedishCulture));
            Assert.Equal("1 Kib", new Information(1, InformationUnit.Kibibit).ToString(null, swedishCulture));
            Assert.Equal("1 KiB", new Information(1, InformationUnit.Kibibyte).ToString(null, swedishCulture));
            Assert.Equal("1 Kio", new Information(1, InformationUnit.Kibioctet).ToString(null, swedishCulture));
            Assert.Equal("1 kb", new Information(1, InformationUnit.Kilobit).ToString(null, swedishCulture));
            Assert.Equal("1 kB", new Information(1, InformationUnit.Kilobyte).ToString(null, swedishCulture));
            Assert.Equal("1 ko", new Information(1, InformationUnit.Kilooctet).ToString(null, swedishCulture));
            Assert.Equal("1 Mib", new Information(1, InformationUnit.Mebibit).ToString(null, swedishCulture));
            Assert.Equal("1 MiB", new Information(1, InformationUnit.Mebibyte).ToString(null, swedishCulture));
            Assert.Equal("1 Mio", new Information(1, InformationUnit.Mebioctet).ToString(null, swedishCulture));
            Assert.Equal("1 Mb", new Information(1, InformationUnit.Megabit).ToString(null, swedishCulture));
            Assert.Equal("1 MB", new Information(1, InformationUnit.Megabyte).ToString(null, swedishCulture));
            Assert.Equal("1 Mo", new Information(1, InformationUnit.Megaoctet).ToString(null, swedishCulture));
            Assert.Equal("1 o", new Information(1, InformationUnit.Octet).ToString(null, swedishCulture));
            Assert.Equal("1 Pib", new Information(1, InformationUnit.Pebibit).ToString(null, swedishCulture));
            Assert.Equal("1 PiB", new Information(1, InformationUnit.Pebibyte).ToString(null, swedishCulture));
            Assert.Equal("1 Pio", new Information(1, InformationUnit.Pebioctet).ToString(null, swedishCulture));
            Assert.Equal("1 Pb", new Information(1, InformationUnit.Petabit).ToString(null, swedishCulture));
            Assert.Equal("1 PB", new Information(1, InformationUnit.Petabyte).ToString(null, swedishCulture));
            Assert.Equal("1 Po", new Information(1, InformationUnit.Petaoctet).ToString(null, swedishCulture));
            Assert.Equal("1 Tib", new Information(1, InformationUnit.Tebibit).ToString(null, swedishCulture));
            Assert.Equal("1 TiB", new Information(1, InformationUnit.Tebibyte).ToString(null, swedishCulture));
            Assert.Equal("1 Tio", new Information(1, InformationUnit.Tebioctet).ToString(null, swedishCulture));
            Assert.Equal("1 Tb", new Information(1, InformationUnit.Terabit).ToString(null, swedishCulture));
            Assert.Equal("1 TB", new Information(1, InformationUnit.Terabyte).ToString(null, swedishCulture));
            Assert.Equal("1 To", new Information(1, InformationUnit.Teraoctet).ToString(null, swedishCulture));
        }
