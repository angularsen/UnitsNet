...
namespace UnitsNet
{
    ...
    public partial struct Density : IQuantity<DensityUnit>, IEquatable<Density>, IComparable, IComparable<Density>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="Density"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="Density"/> from.</param>
        public static implicit operator Density(ValueTuple<QuantityValue, DensityUnit> tuple) => new Density((double)tuple.Item1, tuple.Item2);
