...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = Irradiation.From(1.0, Irradiation.BaseUnit);
        ...
        {
            var inBaseUnit = Irradiation.From(1.0, Irradiation.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(IrradiationUnit)));
        }
        ...
        {
            var quantity = Irradiation.FromJoulesPerSquareMeter(1.0);
            Assert.Equal(Irradiation.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
