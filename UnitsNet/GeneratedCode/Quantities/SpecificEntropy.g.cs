...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static SpecificEntropy()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, SpecificEntropyUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, SpecificEntropyUnit Unit), List<string>> Abbreviations { get; }
