    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.CentimeterPerKilogramForce, new string[]{"cm/kgf"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.CentimeterPerNewton, new string[]{"cm/N"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.DecameterPerKilogramForce, new string[]{"dam/kgf"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.DecameterPerNewton, new string[]{"dam/N"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.DecimeterPerKilogramForce, new string[]{"dm/kgf"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.DecimeterPerNewton, new string[]{"dm/N"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.KilometerPerKilogramForce, new string[]{"km/kgf"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.KilometerPerNewton, new string[]{"km/N"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.MegameterPerKilogramForce, new string[]{"Mm/kgf"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.MegameterPerNewton, new string[]{"Mm/N"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.MeterPerKilogramForce, new string[]{"m/kgf"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.MeterPerNewton, new string[]{"m/N"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.MicrometerPerKilogramForce, new string[]{"µm/kgf"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.MicrometerPerNewton, new string[]{"µm/N"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.MillimeterPerKilogramForce, new string[]{"mm/kgf"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.MillimeterPerNewton, new string[]{"mm/N"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.NanometerPerKilogramForce, new string[]{"nm/kgf"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.NanometerPerNewton, new string[]{"nm/N"}),
                ("en-US", typeof(SpecificRangeUnit), (int)SpecificRangeUnit.NauticalMilePerPoundForce, new string[]{"nmi/lbf"}),
