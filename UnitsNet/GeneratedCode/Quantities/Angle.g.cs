...
namespace UnitsNet
{
    ...
    public partial struct Angle : IQuantity<AngleUnit>, IComparable, IComparable<Angle>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<AngleUnit>)this).As(unitAsAngleUnit);
        }
        ...
        /// <summary>
        ///     Converts this Angle to another Angle with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A Angle with the specified unit.</returns>
        public QuantityValue ToQuantity(AngleUnit unit)
        {
