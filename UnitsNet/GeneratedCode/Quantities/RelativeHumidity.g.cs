...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static RelativeHumidity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, RelativeHumidityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, RelativeHumidityUnit Unit), List<string>> Abbreviations { get; }
