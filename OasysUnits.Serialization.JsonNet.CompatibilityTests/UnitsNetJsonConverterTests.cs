...
namespace OasysUnits.Serialization.JsonNet.CompatibilityTests
{
    public class OasysUnitsJsonConverterTests
    {
        private readonly JsonSerializerSettings _jsonSerializerSettings;

        protected OasysUnitsJsonConverterTests()
        {
            _jsonSerializerSettings = new JsonSerializerSettings {Formatting = Formatting.Indented};
            _jsonSerializerSettings.Converters.Add(new OasysUnitsJsonConverter());
        }
        ...
        public class Serialize : OasysUnitsJsonConverterTests
        {
            [Fact]
        ...
        public class Deserialize : OasysUnitsJsonConverterTests
        {
            [Fact]
            ...
            private static JsonSerializerSettings CreateJsonSerializerSettings()
            {
                ...
                jsonSerializerSettings.Converters.Add(new OasysUnitsJsonConverter());
