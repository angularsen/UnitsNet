...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static MolarFlow()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, MolarFlowUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, MolarFlowUnit Unit), List<string>> Abbreviations { get; }
