...
namespace UnitsNet
{
    ...
    public partial struct CoefficientOfThermalExpansion : IQuantity<CoefficientOfThermalExpansionUnit>, IComparable, IComparable<CoefficientOfThermalExpansion>, IConvertible, IFormattable
    {
        ...
        /// </summary>
        public static CoefficientOfThermalExpansionUnit[] Units { get; } = Enum.GetValues(typeof(CoefficientOfThermalExpansionUnit)).Cast<CoefficientOfThermalExpansionUnit>().ToArray();
