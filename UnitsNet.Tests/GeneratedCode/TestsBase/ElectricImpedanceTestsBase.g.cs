...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            Assert.Throws<ArgumentException>(() => new ElectricImpedance(double.PositiveInfinity, ElectricImpedanceUnit.Ohm));
            Assert.Throws<ArgumentException>(() => new ElectricImpedance(double.NegativeInfinity, ElectricImpedanceUnit.Ohm));
        }

        [Fact]
        public void Ctor_WithNaNValue_ThrowsArgumentException()
        {
            Assert.Throws<ArgumentException>(() => new ElectricImpedance(double.NaN, ElectricImpedanceUnit.Ohm));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => ElectricImpedance.FromOhms(double.PositiveInfinity));
            Assert.Throws<ArgumentException>(() => ElectricImpedance.FromOhms(double.NegativeInfinity));
        }

        [Fact]
        public void FromOhms_WithNanValue_ThrowsArgumentException()
        {
            Assert.Throws<ArgumentException>(() => ElectricImpedance.FromOhms(double.NaN));
        }
        ...
        public void Equals_RelativeTolerance_IsImplemented()
        {
            ...
            Assert.True(ElectricImpedance.FromOhms(100).Equals(ElectricImpedance.FromOhms(120), (double)0.3m, ComparisonType.Relative));
            Assert.False(ElectricImpedance.FromOhms(100).Equals(ElectricImpedance.FromOhms(120), (double)0.1m, ComparisonType.Relative));
        }
