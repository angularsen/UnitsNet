...
namespace UnitsNet
{
    ...
    public partial struct SpecificFuelConsumption : IQuantity<SpecificFuelConsumptionUnit>, IComparable, IComparable<SpecificFuelConsumption>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<SpecificFuelConsumptionUnit>)this).As(unitAsSpecificFuelConsumptionUnit);
        }
        ...
        /// <summary>
        ///     Converts this SpecificFuelConsumption to another SpecificFuelConsumption with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A SpecificFuelConsumption with the specified unit.</returns>
        public QuantityValue ToQuantity(SpecificFuelConsumptionUnit unit)
        {
