...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = CoefficientOfThermalExpansion.From(1.0, CoefficientOfThermalExpansion.BaseUnit);
        ...
        {
            var inBaseUnit = CoefficientOfThermalExpansion.From(1.0, CoefficientOfThermalExpansion.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(CoefficientOfThermalExpansionUnit)));
        }
        ...
        {
            var quantity = CoefficientOfThermalExpansion.FromInverseKelvin(1.0);
            Assert.Equal(CoefficientOfThermalExpansion.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
