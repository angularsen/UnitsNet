...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static CoefficientOfThermalExpansion()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, CoefficientOfThermalExpansionUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, CoefficientOfThermalExpansionUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(CoefficientOfThermalExpansionUnit unit) => GetAbbreviation(unit, null);
