...
namespace OasysUnitsNet.NumberExtensions.NumberToJerk
{
    /// <summary>
    ...
    public static class NumberToJerkExtensions
    {
        ...
        /// <inheritdoc cref="Jerk.FromNanometersPerSecondCubed(OasysUnitsNet.QuantityValue)" />
        public static Jerk NanometersPerSecondCubed<T>(this T value) =>
            Jerk.FromNanometersPerSecondCubed(Convert.ToDouble(value));

        /// <inheritdoc cref="Jerk.FromStandardGravitiesPerSecond(OasysUnitsNet.QuantityValue)" />
