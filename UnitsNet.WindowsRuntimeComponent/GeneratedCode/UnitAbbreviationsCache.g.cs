    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(RatioUnit), (int)RatioUnit.Microstrain, new string[]{"µε"}),
                ("fr-FR", typeof(RatioUnit), (int)RatioUnit.Microstrain, new string[]{"µdef"}),
                ...
                ("en-US", typeof(RatioUnit), (int)RatioUnit.Strain, new string[]{"ε"}),
                ("fr-FR", typeof(RatioUnit), (int)RatioUnit.Strain, new string[]{"def"}),
