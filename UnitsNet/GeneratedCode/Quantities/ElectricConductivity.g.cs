...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<ElectricConductivityUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.ElectricConductivityUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<ElectricConductivityUnit>(str, culture, out unit);
        }
