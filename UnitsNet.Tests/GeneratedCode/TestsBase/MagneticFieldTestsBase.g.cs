...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = MagneticField.From(1.0, MagneticField.BaseUnit);
        ...
        {
            var inBaseUnit = MagneticField.From(1.0, MagneticField.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(MagneticFieldUnit)));
        }
        ...
        {
            var quantity = MagneticField.FromTeslas(1.0);
            Assert.Equal(MagneticField.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
