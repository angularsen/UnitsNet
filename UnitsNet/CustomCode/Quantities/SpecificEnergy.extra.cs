...
namespace UnitsNet
{
    public partial struct SpecificEnergy
    {
        ...
        /// <summary>
        ///     Get <see cref="BrakeSpecificFuelConsumption" /> from <see cref="double" /> divided by
        ///     <see cref="SpecificEnergy" />.
        /// </summary>
        ...
        /// <summary>
        ///     Get <see cref="double" /> from <see cref="SpecificEnergy" /> times <see cref="BrakeSpecificFuelConsumption" />
        ///     .
        /// </summary>
