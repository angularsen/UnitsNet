...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static LinearPowerDensity()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, LinearPowerDensityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, LinearPowerDensityUnit Unit), List<string>> Abbreviations { get; }
