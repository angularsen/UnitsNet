...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = PowerRatio.From(1.0, PowerRatio.BaseUnit);
        ...
        {
            var inBaseUnit = PowerRatio.From(1.0, PowerRatio.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(PowerRatioUnit)));
        }
        ...
        {
            var quantity = PowerRatio.FromDecibelWatts(1.0);
            Assert.Equal(PowerRatio.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
