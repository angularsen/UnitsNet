...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = WarpingMomentOfInertia.From(1.0, WarpingMomentOfInertia.BaseUnit);
        ...
        {
            var inBaseUnit = WarpingMomentOfInertia.From(1.0, WarpingMomentOfInertia.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(WarpingMomentOfInertiaUnit)));
        }
        ...
        {
            var quantity = WarpingMomentOfInertia.FromMetersToTheSixth(1.0);
            Assert.Equal(WarpingMomentOfInertia.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
