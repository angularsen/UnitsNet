...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ThermalConductivity.From(1.0, ThermalConductivity.BaseUnit);
        ...
        {
            var inBaseUnit = ThermalConductivity.From(1.0, ThermalConductivity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ThermalConductivityUnit)));
        }
        ...
        {
            var quantity = ThermalConductivity.FromWattsPerMeterKelvin(1.0);
            Assert.Equal(ThermalConductivity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
