...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ApparentPower()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ApparentPowerUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ApparentPowerUnit Unit), List<string>> Abbreviations { get; }
