...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = ReactivePower.From(1.0, ReactivePower.BaseUnit);
        ...
        {
            var inBaseUnit = ReactivePower.From(1.0, ReactivePower.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(ReactivePowerUnit)));
        }
        ...
        {
            var quantity = ReactivePower.FromVoltamperesReactive(1.0);
            Assert.Equal(ReactivePower.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
