...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Molarity()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, MolarityUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, MolarityUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(MolarityUnit unit) => GetAbbreviation(unit, null);
