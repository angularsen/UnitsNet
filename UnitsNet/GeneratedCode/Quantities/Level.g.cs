...
namespace UnitsNet
{
    ...
    public partial struct Level : IQuantity<LevelUnit>, IComparable, IComparable<Level>, IConvertible, IFormattable
    {
        ...
        double IQuantity.As(Enum unit)
        {
            ...
            return ((IQuantity<LevelUnit>)this).As(unitAsLevelUnit);
        }
        ...
        /// <summary>
        ///     Converts this Level to another Level with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A Level with the specified unit.</returns>
        public QuantityValue ToQuantity(LevelUnit unit)
        {
