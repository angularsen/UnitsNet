...
namespace UnitsNet
{
    ...
    public partial struct ElectricAdmittance : IQuantity<ElectricAdmittanceUnit>, IEquatable<ElectricAdmittance>, IComparable, IComparable<ElectricAdmittance>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ElectricAdmittance" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<ElectricAdmittance>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(ElectricAdmittanceUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ElectricAdmittance>(inBaseUnits.Unit, unit, out var conversionFunction))
