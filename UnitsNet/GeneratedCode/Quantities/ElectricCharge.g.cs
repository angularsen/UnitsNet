...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricCharge()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, ElectricChargeUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, ElectricChargeUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(ElectricChargeUnit unit) => GetAbbreviation(unit, null);
