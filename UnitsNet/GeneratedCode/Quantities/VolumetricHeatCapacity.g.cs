...
namespace UnitsNet
{
    ...
    public partial struct VolumetricHeatCapacity : IQuantity<VolumetricHeatCapacityUnit>, IComparable, IComparable<VolumetricHeatCapacity>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Converts this VolumetricHeatCapacity to another VolumetricHeatCapacity with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A VolumetricHeatCapacity with the specified unit.</returns>
        public QuantityValue ToQuantity(VolumetricHeatCapacityUnit unit)
        {
