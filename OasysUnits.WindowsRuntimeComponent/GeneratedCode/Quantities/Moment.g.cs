...
namespace OasysUnits
{
    ...
    public sealed partial class Moment : IQuantity
    {
        /// <summary>
        ...
        static Moment()
        {
            ...
            Info = new QuantityInfo(QuantityType.Moment, Units.Cast<Enum>().ToArray(), BaseUnit, Zero, BaseDimensions);
        }
        ...
        private Moment(double value, MomentUnit unit)
        {
        ...
        /// </summary>
        [Obsolete("QuantityType will be removed in the future. Use the Info property instead.")]
        public QuantityType Type => Moment.QuantityType;
        ...
        public static string GetAbbreviation(MomentUnit unit, [CanBeNull] string cultureName)
        {
        ...
        public static Moment FromKilogramForceCentimeters(double kilogramforcecentimeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromKilogramForceMeters(double kilogramforcemeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromKilogramForceMillimeters(double kilogramforcemillimeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromKilonewtonCentimeters(double kilonewtoncentimeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromKilonewtonMeters(double kilonewtonmeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromKilonewtonMillimeters(double kilonewtonmillimeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromKilopoundForceFeet(double kilopoundforcefeet)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromKilopoundForceInches(double kilopoundforceinches)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromMeganewtonCentimeters(double meganewtoncentimeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromMeganewtonMeters(double meganewtonmeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromMeganewtonMillimeters(double meganewtonmillimeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromMegapoundForceFeet(double megapoundforcefeet)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromMegapoundForceInches(double megapoundforceinches)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromNewtonCentimeters(double newtoncentimeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromNewtonMeters(double newtonmeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromNewtonMillimeters(double newtonmillimeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromPoundalFeet(double poundalfeet)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromPoundForceFeet(double poundforcefeet)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromPoundForceInches(double poundforceinches)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromTonneForceCentimeters(double tonneforcecentimeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromTonneForceMeters(double tonneforcemeters)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Moment FromTonneForceMillimeters(double tonneforcemillimeters)
        {
        ...
        /// </exception>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static Moment Parse(string str, [CanBeNull] string cultureName)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        ///     Length.Parse("5.5 m", new CultureInfo("en-US"));
        /// </example>
        public static bool TryParse([CanBeNull] string str, out Moment result)
        {
        ...
        /// </example>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static bool TryParse([CanBeNull] string str, [CanBeNull] string cultureName, out Moment result)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        /// <exception cref="OasysUnitsException">Error parsing string.</exception>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static MomentUnit ParseUnit(string str, [CanBeNull] string cultureName)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        /// </example>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static bool TryParseUnit(string str, [CanBeNull] string cultureName, out MomentUnit unit)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        internal int CompareTo(Moment other)
        {
        ...
        double IQuantity.As(object unit) => As((MomentUnit)unit);
        ...
        private double AsBaseNumericType(MomentUnit unit)
        {
            if (Unit == unit)
                return _value;
