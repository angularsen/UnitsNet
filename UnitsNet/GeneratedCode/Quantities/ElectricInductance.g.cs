...
namespace UnitsNet
{
    ...
    public partial struct ElectricInductance : IQuantity<ElectricInductanceUnit>, IEquatable<ElectricInductance>, IComparable, IComparable<ElectricInductance>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ElectricInductance" /> instances.
        /// </summary>
        ...
        {
            if(!ConversionFunctions.TryGetConversionFunction<ElectricInductance>(Unit, BaseUnit, out var conversionFunction))
        ...
        private double GetValueAs(ElectricInductanceUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ElectricInductance>(inBaseUnits.Unit, unit, out var conversionFunction))
