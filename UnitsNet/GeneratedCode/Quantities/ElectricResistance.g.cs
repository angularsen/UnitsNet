...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ElectricResistance()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, ElectricResistanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, ElectricResistanceUnit Unit), List<string>> Abbreviations { get; }
