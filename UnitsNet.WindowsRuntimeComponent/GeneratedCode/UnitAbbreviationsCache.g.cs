    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(TemperatureDeltaUnit), (int)TemperatureDeltaUnit.CentidegreeCelsius, new string[]{"c∆°C"}),
                ("en-US", typeof(TemperatureDeltaUnit), (int)TemperatureDeltaUnit.DecidegreeCelsius, new string[]{"d∆°C"}),
                ...
                ("en-US", typeof(TemperatureDeltaUnit), (int)TemperatureDeltaUnit.HectodegreeCelsius, new string[]{"h∆°C"}),
                ("en-US", typeof(TemperatureDeltaUnit), (int)TemperatureDeltaUnit.Kelvin, new string[]{"∆K"}),
                ("en-US", typeof(TemperatureDeltaUnit), (int)TemperatureDeltaUnit.KilodegreeCelsius, new string[]{"k∆°C"}),
                ("en-US", typeof(TemperatureDeltaUnit), (int)TemperatureDeltaUnit.MicrodegreeCelsius, new string[]{"µ∆°C"}),
                ("en-US", typeof(TemperatureDeltaUnit), (int)TemperatureDeltaUnit.MillidegreeCelsius, new string[]{"m∆°C"}),
                ("en-US", typeof(TemperatureDeltaUnit), (int)TemperatureDeltaUnit.NanodegreeCelsius, new string[]{"n∆°C"}),
