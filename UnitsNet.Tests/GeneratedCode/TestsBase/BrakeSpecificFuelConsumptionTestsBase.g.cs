...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = BrakeSpecificFuelConsumption.From(1.0, BrakeSpecificFuelConsumption.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(BrakeSpecificFuelConsumptionUnit)));
        }
        ...
        {
            var quantity = BrakeSpecificFuelConsumption.FromKilogramsPerJoule(1.0);
            Assert.Equal(BrakeSpecificFuelConsumption.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
