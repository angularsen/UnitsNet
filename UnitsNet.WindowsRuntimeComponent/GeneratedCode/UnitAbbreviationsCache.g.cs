    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(RadioactivityUnit), (int)RadioactivityUnit.Becquerel, new string[]{"Bq"}),
                ("en-AU", typeof(RadioactivityUnit), (int)RadioactivityUnit.Becquerel, new string[]{"Bq"}),
                ("en-US", typeof(RadioactivityUnit), (int)RadioactivityUnit.Curie, new string[]{"Ci"}),
                ("en-AU", typeof(RadioactivityUnit), (int)RadioactivityUnit.Curie, new string[]{"Ci"}),
                ("en-US", typeof(RadioactivityUnit), (int)RadioactivityUnit.Gigabecquerel, new string[]{"GBq"}),
                ("en-AU", typeof(RadioactivityUnit), (int)RadioactivityUnit.Gigabecquerel, new string[]{"GBq"}),
                ("en-US", typeof(RadioactivityUnit), (int)RadioactivityUnit.Kilobecquerel, new string[]{"kBq"}),
                ("en-AU", typeof(RadioactivityUnit), (int)RadioactivityUnit.Kilobecquerel, new string[]{"kBq"}),
                ("en-US", typeof(RadioactivityUnit), (int)RadioactivityUnit.Megabecquerel, new string[]{"MBq"}),
                ("en-AU", typeof(RadioactivityUnit), (int)RadioactivityUnit.Megabecquerel, new string[]{"MBq"}),
                ("en-US", typeof(RadioactivityUnit), (int)RadioactivityUnit.Microcurie, new string[]{"µCi"}),
                ("en-AU", typeof(RadioactivityUnit), (int)RadioactivityUnit.Microcurie, new string[]{"µCi"}),
                ("en-US", typeof(RadioactivityUnit), (int)RadioactivityUnit.Millicurie, new string[]{"mCi"}),
                ("en-AU", typeof(RadioactivityUnit), (int)RadioactivityUnit.Millicurie, new string[]{"mCi"}),
                ("en-US", typeof(RadioactivityUnit), (int)RadioactivityUnit.Terabecquerel, new string[]{"TBq"}),
                ("en-AU", typeof(RadioactivityUnit), (int)RadioactivityUnit.Terabecquerel, new string[]{"TBq"}),
