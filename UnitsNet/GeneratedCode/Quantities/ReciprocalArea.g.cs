...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static ReciprocalArea()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, ReciprocalAreaUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, ReciprocalAreaUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(ReciprocalAreaUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(ReciprocalAreaUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.ReciprocalArea";
                var resourceManager = new ResourceManager(resourceName, typeof(ReciprocalArea).Assembly);
