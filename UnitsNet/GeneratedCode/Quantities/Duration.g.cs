...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            return UnitsNetSetup.Default.UnitParser.Parse<DurationUnit>(str, culture);
        }

        /// <inheritdoc cref="TryParseUnit(string,CultureInfo?,out UnitsNet.Units.DurationUnit)"/>
        ...
        {
            return UnitsNetSetup.Default.UnitParser.TryParse<DurationUnit>(str, culture, out unit);
        }
