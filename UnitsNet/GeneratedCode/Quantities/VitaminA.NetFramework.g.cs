...
namespace UnitsNet
{
    ...
    public partial struct VitaminA : IQuantity<VitaminAUnit>, IEquatable<VitaminA>, IComparable, IComparable<VitaminA>, IConvertible
    {
        ...
        public VitaminA(double numericValue, BaseUnits baseUnits)
        {
        ...
        public static VitaminAUnit GetUnitFor(UnitSystem unitSystem)
        {
            if(unitSystem == null)
        ...
        public static VitaminAUnit GetUnitFor(BaseUnits baseUnits)
        {
            if(baseUnits == null)
