...
namespace UnitsNet
{
    ...
    public struct  Moment
    {
        ...
        private double GetValueInBaseUnit()
        {
            return Unit switch
            {
                MomentUnit.KilogramForceCentimeter => x*0.0980665019960652,
                MomentUnit.KilogramForceMeter => x*9.80665019960652,
                MomentUnit.KilogramForceMillimeter => x*0.00980665019960652,
                MomentUnit.KilonewtonCentimeter => (x*0.01) * 1e3d,
                MomentUnit.KilonewtonMeter => (x) * 1e3d,
                MomentUnit.KilonewtonMillimeter => (x*0.001) * 1e3d,
                MomentUnit.KilopoundForceFoot => (x*1.3558179483314) * 1e3d,
                MomentUnit.KilopoundForceInch => (x*1.129848290276167e-1) * 1e3d,
                MomentUnit.MeganewtonCentimeter => (x*0.01) * 1e6d,
                MomentUnit.MeganewtonMeter => (x) * 1e6d,
                MomentUnit.MeganewtonMillimeter => (x*0.001) * 1e6d,
                MomentUnit.MegapoundForceFoot => (x*1.3558179483314) * 1e6d,
                MomentUnit.MegapoundForceInch => (x*1.129848290276167e-1) * 1e6d,
                MomentUnit.NewtonCentimeter => x*0.01,
                MomentUnit.NewtonMeter => x,
                MomentUnit.NewtonMillimeter => x*0.001,
                MomentUnit.PoundalFoot => x*4.21401100938048e-2,
                MomentUnit.PoundForceFoot => x*1.3558179483314,
                MomentUnit.PoundForceInch => x*1.129848290276167e-1,
                MomentUnit.TonneForceCentimeter => x*98.0665019960652,
                MomentUnit.TonneForceMeter => x*9806.65019960653,
                MomentUnit.TonneForceMillimeter => x*9.80665019960652,
        ...
        private double GetValueAs(MomentUnit unit)
        {
            ...
            return unit switch
            {
                MomentUnit.KilogramForceCentimeter => x*10.1971619222242,
                MomentUnit.KilogramForceMeter => x*0.101971619222242,
                MomentUnit.KilogramForceMillimeter => x*101.971619222242,
                MomentUnit.KilonewtonCentimeter => (x*100) / 1e3d,
                MomentUnit.KilonewtonMeter => (x) / 1e3d,
                MomentUnit.KilonewtonMillimeter => (x*1000) / 1e3d,
                MomentUnit.KilopoundForceFoot => (x/1.3558179483314) / 1e3d,
                MomentUnit.KilopoundForceInch => (x/1.129848290276167e-1) / 1e3d,
                MomentUnit.MeganewtonCentimeter => (x*100) / 1e6d,
                MomentUnit.MeganewtonMeter => (x) / 1e6d,
                MomentUnit.MeganewtonMillimeter => (x*1000) / 1e6d,
                MomentUnit.MegapoundForceFoot => (x/1.3558179483314) / 1e6d,
                MomentUnit.MegapoundForceInch => (x/1.129848290276167e-1) / 1e6d,
                MomentUnit.NewtonCentimeter => x*100,
                MomentUnit.NewtonMeter => x,
                MomentUnit.NewtonMillimeter => x*1000,
                MomentUnit.PoundalFoot => x/4.21401100938048e-2,
                MomentUnit.PoundForceFoot => x/1.3558179483314,
                MomentUnit.PoundForceInch => x/1.129848290276167e-1,
                MomentUnit.TonneForceCentimeter => x*0.0101971619222242,
                MomentUnit.TonneForceMeter => x*0.000101971619222242,
                MomentUnit.TonneForceMillimeter => x*0.101971619222242,
