...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = DynamicViscosity.From(1.0, DynamicViscosity.BaseUnit);
        ...
        {
            var inBaseUnit = DynamicViscosity.From(1.0, DynamicViscosity.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(DynamicViscosityUnit)));
        }
        ...
        {
            var quantity = DynamicViscosity.FromNewtonSecondsPerMeterSquared(1.0);
            Assert.Equal(DynamicViscosity.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
