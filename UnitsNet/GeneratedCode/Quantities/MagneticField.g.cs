...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial struct MagneticField : IQuantity<MagneticFieldUnit>, IComparable, IComparable<MagneticField>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        /// <summary>
        ///     Converts this MagneticField to another MagneticField with the unit representation <paramref name="unit" /> and returns its see <cref name="QuantityValue" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <returns>A MagneticField with the specified unit.</returns>
        public QuantityValue ToQuantity(MagneticFieldUnit unit)
        {
