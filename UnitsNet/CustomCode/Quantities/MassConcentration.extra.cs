...
namespace UnitsNet
{
    ...
    {
        /// <summary>
        ///     Get <see cref="Molarity" /> from this <see cref="MassConcentration" /> using the known component
        ///     <see cref="MolarMass" />.
        /// </summary>
        ...
        /// <summary>
        ///     Get <see cref="VolumeConcentration" /> from this <see cref="MassConcentration" /> using the known component
        ///     <see cref="Density" />.
        /// </summary>
        ...
        /// <summary>
        ///     Get <see cref="Molarity" /> from <see cref="MassConcentration" /> divided by the component's
        ///     <see cref="MolarMass" />.
        /// </summary>
        ...
        /// <summary>
        ///     Get <see cref="VolumeConcentration" /> from <see cref="MassConcentration" /> divided by the component's
        ///     <see cref="Density" />.
        /// </summary>
