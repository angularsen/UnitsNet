...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static Luminance()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, LuminanceUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, LuminanceUnit Unit), List<string>> Abbreviations { get; }
