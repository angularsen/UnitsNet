...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = RatioChangeRate.From(1.0, RatioChangeRate.BaseUnit);
        ...
        {
            var inBaseUnit = RatioChangeRate.From(1.0, RatioChangeRate.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(RatioChangeRateUnit)));
        }
        ...
        {
            var quantity = RatioChangeRate.FromDecimalFractionsPerSecond(1.0);
            Assert.Equal(RatioChangeRate.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
