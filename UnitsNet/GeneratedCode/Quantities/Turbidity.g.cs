...
namespace UnitsNet
{
    ...
    public partial struct Turbidity<T> : IQuantityT<TurbidityUnit, T>, IEquatable<Turbidity<T>>, IComparable, IComparable<Turbidity<T>>, IConvertible, IFormattable
    {
        ...
        /// </summary>
        public static Turbidity<T> MaxValue { get; } = new Turbidity<T>(double.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of <see cref="Turbidity{T}" />
        /// </summary>
        public static Turbidity<T> MinValue { get; } = new Turbidity<T>(double.MinValue, BaseUnit);
        ...
        /// </summary>
        public static Turbidity<T> Zero { get; } = new Turbidity<T>((T)0, BaseUnit);
        ...
        {
            return QuantityParser.Default.Parse<Turbidity<T>, TurbidityUnit>(
                str,
                provider,
                From);
        }
        ...
        {
            return QuantityParser.Default.TryParse<Turbidity<T>, TurbidityUnit>(
                str,
                provider,
                From,
                out result);
        ...
        public bool Equals(Turbidity<T> other, double tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
