...
namespace UnitsNet
{
    ...
    public partial struct BitRate : IQuantity<BitRateUnit>, IEquatable<BitRate>, IComparable, IComparable<BitRate>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="BitRate"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="BitRate"/> from.</param>
        public static implicit operator BitRate(ValueTuple<QuantityValue, BitRateUnit> tuple) => new BitRate((decimal)tuple.Item1, tuple.Item2);
