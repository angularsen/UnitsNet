...
namespace UnitsNet
{
    ...
    public partial struct MolarEnergy : IQuantity<MolarEnergyUnit>, IEquatable<MolarEnergy>, IComparable, IComparable<MolarEnergy>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="MolarEnergy"/> from the given tuple.
        /// </summary>
        /// <param name="tuple">The tuple to create the <see cref="MolarEnergy"/> from.</param>
        public static implicit operator MolarEnergy(ValueTuple<QuantityValue, MolarEnergyUnit> tuple) => new MolarEnergy((double)tuple.Item1, tuple.Item2);
