...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            var inBaseUnit = FuelEfficiency.From(1.0, FuelEfficiency.BaseUnit);
        ...
        {
            var inBaseUnit = FuelEfficiency.From(1.0, FuelEfficiency.BaseUnit);
            Assert.Throws<NotSupportedException>(() => inBaseUnit.ToUnit(default(FuelEfficiencyUnit)));
        }
        ...
        {
            var quantity = FuelEfficiency.FromLitersPer100Kilometers(1.0);
            Assert.Equal(FuelEfficiency.Info.Name.GetHashCode(), quantity.GetHashCode());
        }
