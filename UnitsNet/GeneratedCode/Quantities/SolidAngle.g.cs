...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static SolidAngle()
        {
            ...
            Abbreviations = new Dictionary<(CultureInfo Culture, SolidAngleUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static Dictionary<(CultureInfo Culture, SolidAngleUnit Unit), List<string>> Abbreviations { get; }
