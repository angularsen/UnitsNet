...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        static LeakRate()
        {
            ...
            Abbreviations = new ConcurrentDictionary<(CultureInfo Culture, LeakRateUnit Unit), List<string>>();
        }
        ...
        /// </summary>
        public static IDictionary<(CultureInfo Culture, LeakRateUnit Unit), List<string>> Abbreviations { get; }
        ...
        public static string GetAbbreviation(LeakRateUnit unit) => GetAbbreviation(unit, null);
        ...
        /// <returns></returns>
        public static IReadOnlyList<string> GetAbbreviations(LeakRateUnit unit, CultureInfo? culture = null)
        {
            ...
            if(!Abbreviations.TryGetValue((culture, unit), out var abbreviations))
            {
                ...
                const string resourceName = $"UnitsNet.GeneratedCode.Resources.LeakRate";
                var resourceManager = new ResourceManager(resourceName, typeof(LeakRate).Assembly);
