...
namespace UnitsNet
{
    ...
    public partial struct ElectricCurrentGradient : IQuantity<ElectricCurrentGradientUnit>, IEquatable<ElectricCurrentGradient>, IComparable, IComparable<ElectricCurrentGradient>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     The <see cref="UnitConverter" /> containing conversion functions for <see cref="ElectricCurrentGradient" /> instances.
        /// </summary>
        ...
        private double GetValueAs(ElectricCurrentGradientUnit unit)
        {
            ...
            if(!ConversionFunctions.TryGetConversionFunction<ElectricCurrentGradient>(inBaseUnits.Unit, unit, out var conversionFunction))
